...
public class RenderSalamander extends RenderLiving {
	...
	public void doRender(EntitySalamander entitysalamander, double d, double d1, double d2,
			float f, float f1) {
		doRenderLiving(entitysalamander, d, d1, d2, f, f1);
	}
	public void doRenderLiving(EntitySalamander entitySalamander, double d, double d1,
