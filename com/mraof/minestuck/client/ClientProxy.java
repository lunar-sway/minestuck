...
import com.mraof.minestuck.client.renderer.entity.RenderGiclops;
...
import com.mraof.minestuck.client.renderer.entity.RenderOgre;
...
//            MinecraftForgeClient.preloadTexture(BLOCKS_PNG);
            ...
            RenderingRegistry.registerEntityRenderingHandler(EntityOgre.class, new RenderOgre(new ModelOgre(), 2.8F));
            RenderingRegistry.registerEntityRenderingHandler(EntityGiclops.class, new RenderGiclops(new ModelGiclops(), 7.6F));
            RenderingRegistry.registerEntityRenderingHandler(EntityPawn.class, new RenderBiped(new ModelBiped(), 0.5F));
            RenderingRegistry.registerEntityRenderingHandler(EntityBishop.class, new RenderBishop(new ModelBishop(), 1.8F));
