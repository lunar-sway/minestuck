...
public class ComponentCastleLibraryPiece extends ComponentCastleRoomPiece 
{
	...
	public boolean addComponentParts(World world, Random random,StructureBoundingBox structureboundingbox) 
	{
		...
		this.fillWithBlocks(world, structureboundingbox, 1, 1, 1, 1, 3, 6, Blocks.bookshelf, Blocks.air, false);
		this.fillWithBlocks(world, structureboundingbox, 6, 1, 1, 6, 3, 6, Blocks.bookshelf, Blocks.air, false);
		return true;
	}
