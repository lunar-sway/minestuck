...
public class ComponentCastleStaircasePiece extends
		ComponentCastleRoomPiece {
...
//		do what that would have done but the offset correctly
...
//        	System.out.println(this.boundingBox.minY);
        ...
        this.fillWithAlternatingBlocks(world, structureboundingbox, 0, 14, 0, 7, 14, 7, Minestuck.chessTile.blockID, chessTileMetadata, Minestuck.chessTile.blockID, chessTileMetadata1, false);
