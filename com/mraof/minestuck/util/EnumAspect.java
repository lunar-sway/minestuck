...
public enum EnumAspect {
	 ...
	 * @param unavailableAspects An <code>ArrayList&#60;EnumAspect&#62;</code> that includes the aspects that it won't choose from.
	 ...
	 */
	public static EnumAspect getRandomAspect(ArrayList<EnumAspect> unavailableAspects){
		if(unavailableAspects == null)
			unavailableAspects = new ArrayList<EnumAspect>();
