...
public abstract class ButtonListProgram extends ComputerProgram
{
	...
	public final void onInitGui(ComputerScreen gui, ComputerProgram prevProgram)
	{
		...
		upButton = new ExtendedButton((gui.width - ComputerScreen.xSize) / 2 + 140, (gui.height - ComputerScreen.ySize) / 2 + 60, 20, 20, new StringTextComponent("^"), button1 -> onButtonPressed(gui.te, button1));
		gui.addButton(upButton);
		downButton = new ExtendedButton((gui.width - ComputerScreen.xSize) / 2 + 140, (gui.height - ComputerScreen.ySize) / 2 + 132, 20, 20, new StringTextComponent("v"), button1 -> onButtonPressed(gui.te, button1));
