...
public final class DeployList
{
	...
	public static void registerItems()
	{
		...
		//Atheneum
		registerItem("stone", new ItemStack(Blocks.STONE), new GristSet(GristTypes.BUILD, 1), 0, EntryLists.ATHENEUM);
		...
		registerItem("birch_slab", new ItemStack(Blocks.BIRCH_FENCE), new GristSet(GristTypes.BUILD, 2), 0, EntryLists.ATHENEUM);
		...
		registerItem("spruce_slab", new ItemStack(Blocks.SPRUCE_FENCE), new GristSet(GristTypes.BUILD, 2), 0, EntryLists.ATHENEUM);
		...
		registerItem("dark_oak_slab", new ItemStack(Blocks.DARK_OAK_FENCE), new GristSet(GristTypes.BUILD, 2), 0, EntryLists.ATHENEUM);
		...
		registerItem("acacia_slab", new ItemStack(Blocks.ACACIA_FENCE), new GristSet(GristTypes.BUILD, 2), 0, EntryLists.ATHENEUM);
		...
		registerItem("jungle_slab", new ItemStack(Blocks.JUNGLE_FENCE), new GristSet(GristTypes.BUILD, 2), 0, EntryLists.ATHENEUM);
