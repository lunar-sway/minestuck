...
{
	public static final ResourceLocation BLANK_DISK_DUNGEON_LOOT_INJECT = ResourceLocation.fromNamespaceAndPath("minestuck", "chests/injections/blank_disk_dungeon_inject");
	public static final ResourceLocation SBURB_CODE_LIBRARY_LOOT_INJECT = ResourceLocation.fromNamespaceAndPath("minestuck", "chests/injections/sburb_code_library_inject");
	public static final ResourceLocation FROG_TEMPLE_CHEST = ResourceLocation.fromNamespaceAndPath("minestuck", "chests/frog_temple");
	public static final ResourceLocation BASIC_MEDIUM_CHEST = ResourceLocation.fromNamespaceAndPath("minestuck", "chests/medium_basic");
	public static final ResourceLocation CONSORT_JUNK_REWARD = ResourceLocation.fromNamespaceAndPath("minestuck", "gameplay/consort_junk");
	public static final ResourceLocation CONSORT_FOOD_STOCK = ResourceLocation.fromNamespaceAndPath("minestuck", "gameplay/consort_food");
	public static final ResourceLocation CONSORT_GENERAL_STOCK = ResourceLocation.fromNamespaceAndPath("minestuck", "gameplay/consort_general");
	public static final ResourceLocation KUNDLER_SUPRISES = ResourceLocation.fromNamespaceAndPath("minestuck", "gameplay/kundler_suprises");
	public static final ResourceLocation LOTUS_FLOWER_DEFAULT = ResourceLocation.fromNamespaceAndPath("minestuck", "gameplay/lotus_flower_default");
