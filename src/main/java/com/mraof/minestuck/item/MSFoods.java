...
public class MSFoods
{
    ...
    public static final Food CHOCOLATE_BEETLE = (new Food.Builder()).hunger(5).saturation(0.5F).build();
    ...
    public static final Food CICADA = (new Food.Builder()).hunger(5).saturation(0.5F).build();
