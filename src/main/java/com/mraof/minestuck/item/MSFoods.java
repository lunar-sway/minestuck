...
public class MSFoods
{
    ...
    public static final FoodProperties SOPOR_SLIME_PIE = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.0F).effect(() -> new MobEffectInstance(MSEffects.SOPOR_SICKNESS.get(), 200, 0), 1.0F).build();
