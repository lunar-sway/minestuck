...
public class MSFoods
{
    ...
    //foods
    public static final Food BUG_ON_A_STICK = (new Food.Builder()).nutrition(1).saturationMod(0.1F).build();
    public static final Food CHOCOLATE_BEETLE = (new Food.Builder()).nutrition(3).saturationMod(0.4F).build();
    ...
    public static final Food JAR_OF_BUGS = (new Food.Builder()).nutrition(3).saturationMod(0.2F).build();
    public static final Food ONION = (new Food.Builder()).nutrition(2).saturationMod(0.2F).build();
    public static final Food DESERT_FRUIT = (new Food.Builder()).nutrition(1).saturationMod(0.1F).build();
    ...
    public static final Food IRRADIATED_STEAK = (new Food.Builder()).nutrition(4).saturationMod(0.4F).effect(new EffectInstance(Effects.WITHER, 100, 1), 0.9F).build();
