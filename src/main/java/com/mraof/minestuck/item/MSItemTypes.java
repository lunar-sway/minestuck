...
public class MSItemTypes
{
	...
	public static final Tier ICE_TIER = new ModItemTier(0, 60, 11.0F, 1.0F, 25, () -> Ingredient.of(MSItems.ICE_SHARD9j));
	...
	public static final Tier URANIUM_TIER = new ModItemTier(2, 512, 5.0F, 4.0F, 5, () -> Ingredient.of(MSItems.RAW_URANIUM9j));
	...
	public static final Tier WELSH_TIER = new ModItemTier(5, 5120, 15.0F, 5.0F, 25, () -> Ingredient.of(MSItems.CUEBALL9j));
