...
public class MSItemTypes
{
	...
	public static final IArmorMaterial CLOTH_ARMOR = new ModArmorMaterial("minestuck:cloth", -1, new int[]{0, 0, 0, 0}, 5, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F, 0F, () -> Ingredient.EMPTY);
