...
public class MSItems
{
	...
	public static final RegistryObject<Item> UNION_BUSTER = REGISTER.register("union_buster", () -> new WeaponItem(new WeaponItem.Builder(Tiers.GOLD, 7, -2.4F).efficiency(1.0f).set(MSItemTypes.SWORD_TOOL).add(OnHitEffect.SPREAD_SWEEP).add(OnHitEffect.enemyKnockback(1.5f)), new Item.Properties().defaultDurability(1933).tab(MSItemGroup.WEAPONS).rarity(Rarity.UNCOMMON)));
