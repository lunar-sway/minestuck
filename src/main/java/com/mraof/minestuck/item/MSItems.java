...
public class MSItems
{
	...
	// 1/2 Blades
	public static final DeferredItem<Item> HALF_CLAYMORE = REGISTER.register("half_claymore", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -2.6F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(OnHitEffect.SWEEP), new MSItemProperties().durability(300)));
	...
	public static final DeferredItem<Item> YALDABAOTHS_KEYTON = REGISTER.register("yaldabaoths_keyton", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.DENIZEN_TIER, 3, -1.0F).efficiency(1.0F).set(MSItemTypes.KEY_TOOL).add(OnHitEffect.enemyKnockback(2.0F)).add(OnHitEffect.BOSS_BUSTER).add(OnHitEffect.playSound(MSSoundEvents.ITEM_BATON_ORCHESTRA)), new MSItemProperties().durability(4000).rarity(Rarity.RARE)));
	...
	public static final DeferredItem<Item> WIND_WAKER = REGISTER.register("wind_waker", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 1, -1.0F).efficiency(1.0F).set(MSItemTypes.BATON_TOOL).set(MagicRangedRightClickEffect.STANDARD_MAGIC).add(OnHitEffect.enemyKnockback(1.3F)).add(OnHitEffect.playSound(MSSoundEvents.ITEM_BATON_ORCHESTRA, 1, 1.2F)).add(OnHitEffect.spawnParticles(ParticleTypes.NOTE, 8, 1.0, 2.0, 1.0, 2.0)), new MSItemProperties().durability(750)));
	public static final DeferredItem<Item> CELESTIAL_FULCRUM = REGISTER.register("celestial_fulcrum", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.REGI_TIER, 3, -1.0F).efficiency(1.0F).set(MSItemTypes.BATON_TOOL).set(MagicRangedRightClickEffect.STANDARD_MAGIC).add(OnHitEffect.enemyKnockback(2.0F)).add(OnHitEffect.playSound(MSSoundEvents.ITEM_BATON_ORCHESTRA, 1, 1.5F)).add(OnHitEffect.spawnParticles(ParticleTypes.NOTE, 14, 1.0, 2.0, 1.0, 2.0)), new MSItemProperties().durability(1200)));
	public static final DeferredItem<Item> HYMN_FOR_HORRORTERRORS = REGISTER.register("hymn_for_horrorterrors", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.HORRORTERROR_TIER, 1, -1.0F).efficiency(1.0F).set(MSItemTypes.BATON_TOOL).add(OnHitEffect.HORRORTERROR).set(MagicRangedRightClickEffect.HORRORTERROR_MAGIC).add(OnHitEffect.enemyKnockback(2.0F)).add(OnHitEffect.playSound(MSSoundEvents.ITEM_BATON_ORCHESTRA, 1, 0.2F)).add(OnHitEffect.spawnParticles(ParticleTypes.SCULK_SOUL, 15, 1.0, 2.0, 1.0, 2.0)), new MSItemProperties().durability(2500).rarity(Rarity.RARE)));
	...
	public static final DeferredItem<Item> FIRESTARTER = REGISTER.register("firestarter", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).add(OnHitEffect.enemyKnockback(1.5F)).add(OnHitEffect.setOnFire(35)), new MSItemProperties().durability(300)));
	...
	//Staffs
	public static final DeferredItem<Item> BO_STAFF = REGISTER.register("bo_staff", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 0, -2.0F).efficiency(1.0F).set(MSItemTypes.STAFF_TOOL).add(OnHitEffect.SWEEP).add(OnHitEffect.enemyKnockback(0.5F)), new MSItemProperties().durability(100)));
	public static final DeferredItem<Item> BAMBOO_BEATSTICK = REGISTER.register("bamboo_beatstick", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 4, -2.0F).efficiency(1.0F).set(MSItemTypes.STAFF_TOOL).add(OnHitEffect.SWEEP).add(OnHitEffect.enemyKnockback(0.5F)), new MSItemProperties().durability(350)));
	public static final DeferredItem<Item> TELESCOPIC_BEATDOWN_BRUISER = REGISTER.register("telescopic_beatdown_bruiser", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 3, -2.0F).efficiency(1.0F).set(MSItemTypes.STAFF_TOOL).add(OnHitEffect.enemyKnockback(0.5F)), new MSItemProperties().durability(550)));
	public static final DeferredItem<Item> ION_DESTABILIZER = REGISTER.register("ion_destabilizer", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.URANIUM_TIER, 2, -2.0F).efficiency(4.0F).set(MSItemTypes.STAFF_TOOL).add(OnHitEffect.SWEEP).add(OnHitEffect.enemyKnockback(0.5F)).add(OnHitEffect.setOnFire(4)).add(OnHitEffect.spawnParticles(ParticleTypes.ITEM_SLIME, 6, 2.0, 1.0, 2.0, 1.0)), new MSItemProperties().durability(1400).rarity(Rarity.UNCOMMON)));
