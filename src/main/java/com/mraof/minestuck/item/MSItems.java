...
public class MSItems
{
	...
	public static void registerItems(final RegistryEvent.Register<Item> event)
	{
		...
		registry.register(new ConsumableWeaponItem(MSItemTypes.MEAT_TIER, 5, -2.4F, 5.0F, 4, 0.4F, 25, MSItemTypes.SWORD_TOOL, new Item.Properties().defaultMaxDamage(300).group(MSItemGroup.WEAPONS)).setPotionEffect(new EffectInstance(Effects.WITHER, 100, 1), 0.9F).setRegistryName("irradiated_steak_sword"));
		...
		//Dice
		registry.register(new WeaponItem(ItemTier.STONE, 5, -3.0F, 1.0F, MSItemTypes.NONE, new Item.Properties().group(MSItemGroup.WEAPONS)).setRegistryName("dice"));
		registry.register(new WeaponItem(ItemTier.DIAMOND, 4, -3.0F, 1.0F, MSItemTypes.NONE, new Item.Properties().group(MSItemGroup.WEAPONS).rarity(Rarity.EPIC)).setRegistryName("fluorite_octet"));
		//misc weapons
		...
		registry.register(new BaguetteWeaponItem(MSItemTypes.ORGANIC_TIER, 3, -2.8F, 2.0F, 3, 0.2F, MSItemTypes.MISC_TOOL, new Item.Properties().group(MSItemGroup.WEAPONS)).setRegistryName("stale_baguette"));
		...
		registry.register(new BaguetteWeaponItem(MSItemTypes.ORGANIC_TIER, 3, -2.0F, 2.0F, 4, 0.5F, MSItemTypes.MISC_TOOL, new Item.Properties().group(MSItemGroup.WEAPONS)).setRegistryName("upper_crust_crust_cane"));
		...
		registry.register(new CandyCaneWeaponItem(MSItemTypes.CANDY_TIER, 3, -2.0F, 1.0F, 2, 0.3F, MSItemTypes.MISC_TOOL, new Item.Properties().group(MSItemGroup.WEAPONS)).setRegistryName("candy_cane"));
		...
		registry.register(new DualWeaponItem(ItemTier.WOOD, 7, -2.0F, 1.0F, () -> MSItems.DRAGON_CANE_UNSHEATHED, MSItemTypes.MISC_TOOL, new Item.Properties().defaultMaxDamage(2048).group(MSItemGroup.WEAPONS).rarity(Rarity.RARE)).setRegistryName("dragon_cane"));
		registry.register(new DualWeaponItem(ItemTier.DIAMOND, 6, -2.0F, 1.0F, () -> MSItems.DRAGON_CANE, MSItemTypes.MISC_TOOL, new Item.Properties().defaultMaxDamage(2048).rarity(Rarity.RARE)).setRegistryName("dragon_cane_unsheathed"));
		...
		registry.register(new DualWeaponItem(ItemTier.DIAMOND, 5, -2.4F, 1.0F, () -> MSItems.CROCKER_FORK, MSItemTypes.SHOVEL_TOOL, new Item.Properties().group(MSItemGroup.WEAPONS).rarity(Rarity.UNCOMMON)).setRegistryName("crocker_spoon"));
		registry.register(new DualWeaponItem(ItemTier.DIAMOND, 6, -2.6F, 1.0F, () -> MSItems.CROCKER_SPOON, MSItemTypes.MISC_TOOL, new Item.Properties().rarity(Rarity.UNCOMMON)).setRegistryName("crocker_fork"));
