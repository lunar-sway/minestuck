...
public class MSItems
{
	...
	public static void registerItems(final RegistryEvent.Register<Item> event)
	{
		...
		registerItemBlock(registry, FLOWERY_MOSSY_STONE, MSItemGroup.LANDS);
		registerItemBlock(registry, POLISHED_FLOWERY_MOSSY_STONE, MSItemGroup.LANDS);
		registerItemBlock(registry, FLOWERY_MOSSY_STONE_BRICKS, MSItemGroup.LANDS);
		registerItemBlock(registry, FLOWERY_MOSSY_STONE_COLUMN, MSItemGroup.LANDS);
		registerItemBlock(registry, CHISELED_FLOWERY_MOSSY_STONE_BRICKS, MSItemGroup.LANDS);
		registerItemBlock(registry, CRACKED_FLOWERY_MOSSY_STONE_BRICKS, MSItemGroup.LANDS);
		...
		registerItemBlock(registry, FLOWERY_MOSSY_STONE_STAIRS, MSItemGroup.LANDS);
