...
public class MSItems
{
	...
	public static final RegistryObject<Item> POGO_LANCE = REGISTER.register("pogo_lance", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.POGO_TIER, 4, -2.8F).efficiency(2.0F).set(MSItemTypes.MISC_TOOL).add(OnHitEffect.pogoMutualKnockback(1.0F)), new Item.Properties()));
