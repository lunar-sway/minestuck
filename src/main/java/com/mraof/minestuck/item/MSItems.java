...
public class MSItems
{
	...
	public static void registerItems(final RegistryEvent.Register<Item> event)
	{
		...
		registerItemBlock(registry, BLACK_CASTLE_BRICKS.get(), MSItemGroup.MAIN);
		registerItemBlock(registry, DARK_GRAY_CASTLE_BRICKS.get(), MSItemGroup.MAIN);
		registerItemBlock(registry, LIGHT_GRAY_CASTLE_BRICKS.get(), MSItemGroup.MAIN);
		registerItemBlock(registry, WHITE_CASTLE_BRICKS.get(), MSItemGroup.MAIN);
		registerItemBlock(registry, BLACK_CASTLE_BRICK_SMOOTH.get(), MSItemGroup.MAIN);
		registerItemBlock(registry, DARK_GRAY_CASTLE_BRICK_SMOOTH.get(), MSItemGroup.MAIN);
		registerItemBlock(registry, LIGHT_GRAY_CASTLE_BRICK_SMOOTH.get(), MSItemGroup.MAIN);
		registerItemBlock(registry, WHITE_CASTLE_BRICK_SMOOTH.get(), MSItemGroup.MAIN);
		registerItemBlock(registry, BLACK_CASTLE_BRICK_TRIM.get(), MSItemGroup.MAIN);
		registerItemBlock(registry, DARK_GRAY_CASTLE_BRICK_TRIM.get(), MSItemGroup.MAIN);
		registerItemBlock(registry, LIGHT_GRAY_CASTLE_BRICK_TRIM.get(), MSItemGroup.MAIN);
		registerItemBlock(registry, WHITE_CASTLE_BRICK_TRIM.get(), MSItemGroup.MAIN);
		...
		registerItemBlock(registry, MOSSY_COARSE_STONE.get(), MSItemGroup.LANDS);
		...
		registerItemBlock(registry, BLACK_CASTLE_BRICK_STAIRS.get(), MSItemGroup.MAIN);
		registerItemBlock(registry, DARK_GRAY_CASTLE_BRICK_STAIRS.get(), MSItemGroup.MAIN);
		registerItemBlock(registry, LIGHT_GRAY_CASTLE_BRICK_STAIRS.get(), MSItemGroup.MAIN);
		registerItemBlock(registry, WHITE_CASTLE_BRICK_STAIRS.get(), MSItemGroup.MAIN);
		...
		registerItemBlock(registry, BLACK_CASTLE_BRICK_SLAB.get(), MSItemGroup.MAIN);
		registerItemBlock(registry, DARK_GRAY_CASTLE_BRICK_SLAB.get(), MSItemGroup.MAIN);
		registerItemBlock(registry, LIGHT_GRAY_CASTLE_BRICK_SLAB.get(), MSItemGroup.MAIN);
		registerItemBlock(registry, WHITE_CASTLE_BRICK_SLAB.get(), MSItemGroup.MAIN);
