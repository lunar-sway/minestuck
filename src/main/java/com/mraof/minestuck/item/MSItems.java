...
public class MSItems
{
	...
	public static final RegistryObject<Item> BOOMBOX_BEATER = REGISTER.register("boombox_beater", () -> new MusicPlayerWeapon(new WeaponItem.Builder(Tiers.IRON, 7, -3.2F).efficiency(4.0F).set(MSItemTypes.HAMMER_TOOL), new Item.Properties().tab(MSItemGroup.WEAPONS).rarity(Rarity.UNCOMMON)));
	...
	public static final RegistryObject<Item> CHAINSAW_KATANA = REGISTER.register("chainsaw_katana", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 4, -2.4F).efficiency(3.0F).set(MSItemTypes.AXE_TOOL).add(OnHitEffect.SWEEP), new Item.Properties().defaultDurability(700).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> THORN_IN_YOUR_SIDE = REGISTER.register("thorn_in_your_side", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 3, -2.4F).efficiency(1.0F).set(MSItemTypes.SWORD_TOOL).add(OnHitEffect.SWEEP), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> ROSE_PROTOCOL = REGISTER.register("rose_protocol", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 3, -2.4F).efficiency(1.0F).set(MSItemTypes.SWORD_TOOL).add(OnHitEffect.SWEEP).add(OnHitEffect.setOnFire(6)), new Item.Properties().tab(MSItemGroup.WEAPONS).rarity(Rarity.UNCOMMON)));
	...
	public static final RegistryObject<Item> LATCHMELTER = REGISTER.register("latchmelter", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 1, -1.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).add(OnHitEffect.setOnFire(6)), new Item.Properties().defaultDurability(450).tab(MSItemGroup.WEAPONS)));
	...
	public static final RegistryObject<Item> INNER_HEART = REGISTER.register("inner_heart", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 1, -1.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).add(OnHitEffect.spawnParticles(ParticleTypes.HEART, 15, 2.0, 1.0, 2.0, 2.0)), new Item.Properties().defaultDurability(460).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> CRIMSON_LEAP = REGISTER.register("crimson_leap", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 2, -1.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL), new Item.Properties().defaultDurability(2100).tab(MSItemGroup.WEAPONS).rarity(Rarity.UNCOMMON)));
	...
	public static final RegistryObject<Item> LOCH_PICK = REGISTER.register("loch_pick", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.HORRORTERROR_TIER, 1, -1.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	...
	public static final RegistryObject<Item> CLOCKKEEPER = REGISTER.register("clockkeeper", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.REGI_TIER, 3, -1.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL), new Item.Properties().defaultDurability(3500).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> HOME_BY_MIDNIGHT = REGISTER.register("home_by_midnight", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.REGI_TIER, 4, -1.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).set(PogoEffect.EFFECT_07).add(PogoEffect.EFFECT_07), new Item.Properties().defaultDurability(4000).tab(MSItemGroup.WEAPONS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> NO_TIME_FOR_FLIES = REGISTER.register("no_time_for_flies", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 3, -1.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL), new Item.Properties().defaultDurability(2500).tab(MSItemGroup.WEAPONS).rarity(Rarity.UNCOMMON)));
	...
	public static final RegistryObject<Item> ALLWEDDOL = REGISTER.register("allweddol", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.WELSH_TIER, 6, -1.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	...
	public static final RegistryObject<Item> HYMN_FOR_HORRORTERRORS = REGISTER.register("hymn_for_horrorterrors", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.HORRORTERROR_TIER, 1, -1.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).add(OnHitEffect.HORRORTERROR).set(MagicAttackRightClickEffect.HORRORTERROR_MAGIC).add(OnHitEffect.enemyKnockback(2.0F)).add(OnHitEffect.playSound(MSSoundEvents.ITEM_BATON_ORCHESTRA, 1, 0.2F)).add(OnHitEffect.spawnParticles(ParticleTypes.SCULK_SOUL, 15, 1.0, 2.0, 1.0, 2.0)), new Item.Properties().defaultDurability(2500).tab(MSItemGroup.WEAPONS).rarity(Rarity.RARE)));
	...
	public static final RegistryObject<Item> HAND_CRANKED_VAMPIRE_ERASER = REGISTER.register("hand_cranked_vampire_eraser", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 4, -1.5F).efficiency(10.0F).set(MSItemTypes.AXE_TOOL).set(ItemRightClickEffect.switchTo(MSItems.SPLINTERSTICK)), new Item.Properties().defaultDurability(250).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> SPLINTERSTICK = REGISTER.register("splinterstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 1, -0.5F).efficiency(10.0F).set(ItemRightClickEffect.switchTo(MSItems.HAND_CRANKED_VAMPIRE_ERASER)), new Item.Properties().defaultDurability(250)));
...
=======
	...
	public static final RegistryObject<Item> MARASCHINO_CHERRY_SCYTHE = REGISTER.register("maraschino_cherry_scythe", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CANDY_TIER, 6, -2.6F).efficiency(1.5F).disableShield().set(MSItemTypes.SICKLE_TOOL).add(OnHitEffect.SET_CANDY_DROP_FLAG), new Item.Properties().tab(MSItemGroup.WEAPONS)));
...
>>>>>>> 0b2472e11 (added mutant cutie cell cutter/putter created by mspaintchef)
	...
	public static final RegistryObject<Item> CRICKET_BAT = REGISTER.register("cricket_bat", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 7, -2.8F).efficiency(2.0F).set(MSItemTypes.MISC_TOOL), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	...
	public static final RegistryObject<Item> TOFFEE_CLUB = REGISTER.register("toffee_club", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CANDY_TIER, 6, -2.8F).efficiency(2.0F).set(MSItemTypes.MISC_TOOL).add(OnHitEffect.SET_CANDY_DROP_FLAG), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	...
	//Staffs
	public static final RegistryObject<Item> BO_STAFF = REGISTER.register("bo_staff", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 0, -2.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).add(OnHitEffect.SWEEP).add(OnHitEffect.enemyKnockback(0.5F)), new Item.Properties().defaultDurability(100).tab(MSItemGroup.WEAPONS)));
	...
	public static final RegistryObject<Item> TELESCOPIC_BEATDOWN_BRUISER = REGISTER.register("telescopic_beatdown_bruiser", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 3, -2.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).add(OnHitEffect.SWEEP).add(OnHitEffect.enemyKnockback(0.5F)), new Item.Properties().defaultDurability(550).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> BARBERS_MAGIC_TOUCH = REGISTER.register("barbers_magic_touch", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 2, -2.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).add(OnHitEffect.SWEEP).add(OnHitEffect.enemyKnockback(0.5F)).set(MagicAttackRightClickEffect.STANDARD_MAGIC), new Item.Properties().defaultDurability(660).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> ION_DESTABILIZER = REGISTER.register("ion_destabilizer", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.URANIUM_TIER, 2, -2.0F).efficiency(4.0F).set(MSItemTypes.MULTI_TOOL).add(OnHitEffect.SWEEP).add(OnHitEffect.enemyKnockback(0.5F)).add(OnHitEffect.setOnFire(4)).add(OnHitEffect.spawnParticles(ParticleTypes.ITEM_SLIME, 6, 2.0, 1.0, 2.0, 1.0)), new Item.Properties().defaultDurability(1400).tab(MSItemGroup.WEAPONS).rarity(Rarity.UNCOMMON)));
...
>>>>>>> 0b2472e11 (added mutant cutie cell cutter/putter created by mspaintchef)
	...
	public static final RegistryObject<Item> WAND = REGISTER.register("wand", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, -2, -1.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).set(MagicAttackRightClickEffect.STANDARD_MAGIC), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	...
	public static final RegistryObject<Item> PARTICLE_ACCELERATOR = REGISTER.register("particle_accelerator", () -> new Item(new Item.Properties().tab(MSItemGroup.MAIN)));
	...
	//Consort Plushies
	public static final RegistryObject<Item> PLUSH_SALAMANDER = REGISTER.register("plush_salamander", () -> new Item(new Item.Properties().tab(MSItemGroup.MAIN)));
	public static final RegistryObject<Item> PLUSH_NAKAGATOR = REGISTER.register("plush_nakagator", () -> new Item(new Item.Properties().tab(MSItemGroup.MAIN)));
	public static final RegistryObject<Item> PLUSH_IGUANA = REGISTER.register("plush_iguana", () -> new Item(new Item.Properties().tab(MSItemGroup.MAIN)));
	public static final RegistryObject<Item> PLUSH_TURTLE = REGISTER.register("plush_turtle", () -> new Item(new Item.Properties().tab(MSItemGroup.MAIN)));
	
	public static final RegistryObject<Item> PLUSH_MUTINI = REGISTER.register("plush_mutini", () -> new Item(new Item.Properties().tab(MSItemGroup.MAIN)));
