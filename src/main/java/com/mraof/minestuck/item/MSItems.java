...
public class MSItems
{
	...
	public static final DeferredItem<Item> YALDABAOTHS_KEYTON = REGISTER.register("yaldabaoths_keyton", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.DENIZEN_TIER, 3, -1.0F).efficiency(1.0F).set(MSItemTypes.KEY_TOOL).addKnockbackEffect(2f).add(OnHitEffect.BOSS_BUSTER).add(OnHitEffect.playSound(MSSoundEvents.ITEM_BATON_ORCHESTRA)), new MSItemProperties().durability(4000).rarity(Rarity.RARE)));
	...
	public static final DeferredItem<Item> WIND_WAKER = REGISTER.register("wind_waker", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 1, -1.0F).efficiency(1.0F).set(MSItemTypes.BATON_TOOL).set(MagicRangedRightClickEffect.STANDARD_MAGIC).addKnockbackEffect(1.3f).add(OnHitEffect.playSound(MSSoundEvents.ITEM_BATON_ORCHESTRA, 1, 1.2F)).add(OnHitEffect.spawnParticles(ParticleTypes.NOTE, 8, 1.0, 2.0, 1.0, 2.0)), new MSItemProperties().durability(750)));
	public static final DeferredItem<Item> CELESTIAL_FULCRUM = REGISTER.register("celestial_fulcrum", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.REGI_TIER, 3, -1.0F).efficiency(1.0F).set(MSItemTypes.BATON_TOOL).set(MagicRangedRightClickEffect.STANDARD_MAGIC).addKnockbackEffect(2.0f).add(OnHitEffect.playSound(MSSoundEvents.ITEM_BATON_ORCHESTRA, 1, 1.5F)).add(OnHitEffect.spawnParticles(ParticleTypes.NOTE, 14, 1.0, 2.0, 1.0, 2.0)), new MSItemProperties().durability(1200)));
	public static final DeferredItem<Item> HYMN_FOR_HORRORTERRORS = REGISTER.register("hymn_for_horrorterrors", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.HORRORTERROR_TIER, 1, -1.0F).efficiency(1.0F).set(MSItemTypes.BATON_TOOL).add(OnHitEffect.HORRORTERROR).set(MagicRangedRightClickEffect.HORRORTERROR_MAGIC).addKnockbackEffect(2.0f).add(OnHitEffect.playSound(MSSoundEvents.ITEM_BATON_ORCHESTRA, 1, 0.2F)).add(OnHitEffect.spawnParticles(ParticleTypes.SCULK_SOUL, 15, 1.0, 2.0, 1.0, 2.0)), new MSItemProperties().durability(2500).rarity(Rarity.RARE)));
	...
	//Fans
	public static final DeferredItem<Item> FAN = REGISTER.register("fan", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.PAPER_TIER, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).set(ItemRightClickEffect.extinguishFire(1)).addKnockbackEffect(1.5f), new Item.Properties()));
	public static final DeferredItem<Item> CANDY_FAN = REGISTER.register("candy_fan", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CANDY_TIER, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).set(ItemRightClickEffect.extinguishFire(1)).addKnockbackEffect(1.5f).add(OnHitEffect.SET_CANDY_DROP_FLAG), new Item.Properties()));
	public static final DeferredItem<Item> SPINES_OF_FLUTHLU = REGISTER.register("spines_of_fluthlu", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.HORRORTERROR_TIER, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).set(ItemRightClickEffect.extinguishFire(1)).addKnockbackEffect(1.5f).add(OnHitEffect.HORRORTERROR), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> RAZOR_FAN = REGISTER.register("razor_fan", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).set(ItemRightClickEffect.extinguishFire(1)).addKnockbackEffect(1.5f), new Item.Properties()));
	public static final DeferredItem<Item> MOTOR_FAN = REGISTER.register("motor_fan", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).set(ItemRightClickEffect.extinguishFire(1)).addKnockbackEffect(2.0f), new Item.Properties()));
	public static final DeferredItem<Item> ATOMIC_VAPORIZER = REGISTER.register("atomic_vaporizer", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.URANIUM_TIER, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).set(ItemRightClickEffect.extinguishFire(1)).addKnockbackEffect(2.0f).add(OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MobEffects.WITHER, 100, 1))), new MSItemProperties().durability(2048)));
	public static final DeferredItem<Item> SHAVING_FAN = REGISTER.register("shaving_fan", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).set(ItemRightClickEffect.extinguishFire(1)).addKnockbackEffect(1.5f), new Item.Properties()));
	public static final DeferredItem<Item> FIRESTARTER = REGISTER.register("firestarter", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).addKnockbackEffect(1.5f).add(OnHitEffect.setOnFire(35)), new MSItemProperties().durability(300)));
	public static final DeferredItem<Item> STAR_RAY = REGISTER.register("star_ray", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).set(ItemRightClickEffect.extinguishFire(1)).addKnockbackEffect(1.5f).add(OnHitEffect.setOnFire(35)), new Item.Properties()));
	public static final DeferredItem<Item> TYPHONIC_TRIVIALIZER = REGISTER.register("typhonic_trivializer", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.DENIZEN_TIER, 2, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).set(ItemRightClickEffect.extinguishFire(3)).add(OnHitEffect.BREATH_LEVITATION_AOE).addKnockbackEffect(2.0f), new Item.Properties().rarity(Rarity.RARE)));
	...
	//Staffs
	public static final DeferredItem<Item> BO_STAFF = REGISTER.register("bo_staff", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 0, -2.0F).efficiency(1.0F).set(MSItemTypes.STAFF_TOOL).add(OnHitEffect.SWEEP).addKnockbackEffect(0.5f), new MSItemProperties().durability(100)));
	public static final DeferredItem<Item> BAMBOO_BEATSTICK = REGISTER.register("bamboo_beatstick", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 4, -2.0F).efficiency(1.0F).set(MSItemTypes.STAFF_TOOL).add(OnHitEffect.SWEEP).addKnockbackEffect(0.5f), new MSItemProperties().durability(350)));
	public static final DeferredItem<Item> TELESCOPIC_BEATDOWN_BRUISER = REGISTER.register("telescopic_beatdown_bruiser", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 3, -2.0F).efficiency(1.0F).set(MSItemTypes.STAFF_TOOL).addKnockbackEffect(0.5f), new MSItemProperties().durability(550)));
	public static final DeferredItem<Item> ION_DESTABILIZER = REGISTER.register("ion_destabilizer", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.URANIUM_TIER, 2, -2.0F).efficiency(4.0F).set(MSItemTypes.STAFF_TOOL).add(OnHitEffect.SWEEP).addKnockbackEffect(0.5f).add(OnHitEffect.setOnFire(4)).add(OnHitEffect.spawnParticles(ParticleTypes.ITEM_SLIME, 6, 2.0, 1.0, 2.0, 1.0)), new MSItemProperties().durability(1400).rarity(Rarity.UNCOMMON)));
	...
	public static final DeferredItem<Item> BARBERS_MAGIC_TOUCH = REGISTER.register("barbers_magic_touch", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 4, -2.8F).efficiency(1.0F).set(MSItemTypes.CLUB_TOOL).add(OnHitEffect.SWEEP).addKnockbackEffect(0.5f).set(MagicAOERightClickEffect.STANDARD_MAGIC), new MSItemProperties().durability(660)));
	...
	public static final DeferredItem<Item> TERRAIN_FLATENATOR = REGISTER.register("terrain_flatenator", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -2.4F).efficiency(10.0F).set(MSItemTypes.SPOON_TOOL).set(new FarmineEffect(Integer.MAX_VALUE, 50)).set(RightClickBlockEffect.flattenArea(1)), new MSItemProperties().durability(1024))); //TODO fix inability to use for terrain flattenation
