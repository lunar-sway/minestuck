...
public class MSItems
{
	...
	public static final RegistryObject<Item> CHEESE_KNIFE = REGISTER.register("cheese_knife", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 0, -2.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).add(OnHitEffect.backstab(3)), new Item.Properties()));
