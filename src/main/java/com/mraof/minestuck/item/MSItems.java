...
public class MSItems
{
	...
	public static final RegistryObject<Item> UNION_BUSTER = REGISTER.register("union_buster", () -> new WeaponItem(new WeaponItem.Builder(Tiers.GOLD, 7, -2.4F).efficiency(1.0f).set(MSItemTypes.SWORD_TOOL).add(OnHitEffect.SweepMultiEffect(OnHitEffect.SPREADING_KNOCKBACK, OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MSEffects.SUSPICION.get(), 300, 1, false, false)))), new Item.Properties().defaultDurability(1933).tab(MSItemGroup.WEAPONS).rarity(Rarity.UNCOMMON)));
