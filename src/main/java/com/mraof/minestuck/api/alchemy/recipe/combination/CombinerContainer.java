...
public interface CombinerContainer extends Container
{
	...
	final class ItemHandlerWrapper extends RecipeWrapper implements CombinerContainer
	{
		...
		public ItemHandlerWrapper(IItemHandlerModifiable inv, CombinationMode mode)
		{
			super(inv);
			this.mode = mode;
		}
	...
	final class Wrapper implements CombinerContainer
	{
		private final ItemStack item1, item2;
		private final CombinationMode mode;
		
		public Wrapper(ItemStack item1, ItemStack item2, CombinationMode mode)
		{
			this.item1 = item1;
			this.item2 = item2;
			this.mode = mode;
