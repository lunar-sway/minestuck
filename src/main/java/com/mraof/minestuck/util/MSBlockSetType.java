...
public class MSBlockSetType
{
	...
	//STONE
	public static final BlockSetType CRUXITE = register(new BlockSetType(Minestuck.MOD_ID + ":cruxite"));
	public static final BlockSetType URANIUM = register(new BlockSetType(Minestuck.MOD_ID + ":uranium"));
	public static final BlockSetType COARSE_STONE = register(new BlockSetType(Minestuck.MOD_ID + ":coarse_stone"));
	public static final BlockSetType SHADE_STONE = register(new BlockSetType(Minestuck.MOD_ID + ":shade_stone"));
	public static final BlockSetType CAST_IRON = register(new BlockSetType(Minestuck.MOD_ID + ":cast_iron"));
	public static final BlockSetType MYCELIUM_STONE = register(new BlockSetType(Minestuck.MOD_ID + ":mycelium_stone"));
	public static final BlockSetType BLACK_STONE = register(new BlockSetType(Minestuck.MOD_ID + ":black_stone"));
	public static final BlockSetType CHALK = register(new BlockSetType(Minestuck.MOD_ID + ":chalk"));
	public static final BlockSetType PINK_STONE = register(new BlockSetType(Minestuck.MOD_ID + ":pink_stone"));
	public static final BlockSetType BROWN_STONE = register(new BlockSetType(Minestuck.MOD_ID + ":brown_stone"));
	public static final BlockSetType BLACK_CHESS = register(new BlockSetType(Minestuck.MOD_ID + ":black_chess"));
	public static final BlockSetType DARK_GRAY_CHESS = register(new BlockSetType(Minestuck.MOD_ID + ":dark_gray_chess"));
	public static final BlockSetType LIGHT_GRAY_CHESS = register(new BlockSetType(Minestuck.MOD_ID + ":light_gray_chess"));
	public static final BlockSetType WHITE_CHESS = register(new BlockSetType(Minestuck.MOD_ID + ":white_chess"));
