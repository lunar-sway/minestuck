...
public class MiniTotemLatheTileEntity extends MachineProcessTileEntity implements MenuProvider
{
	...
	{
		return new CustomHandler(4, (index, stack) -> (index == 0 || index == 1) && stack.getItem() == MSItems.CAPTCHA_CARD.get() || index == 2 && stack.getItem() == MSItems.CRUXITE_DOWEL.get()); //was MSBlocks.CRUXITE_DOWEL.get().asItem()
	}
