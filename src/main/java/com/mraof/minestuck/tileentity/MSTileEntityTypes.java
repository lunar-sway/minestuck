...
public class MSTileEntityTypes	//TODO Use @ObjectHolder or DeferredRegister here
{
	...
	public static void registerTileEntityType(final RegistryEvent.Register<TileEntityType<?>> event)
	{
		...
		event.getRegistry().register((CASSETTE_PLAYER = TileEntityType.Builder.create(CassettePlayerTileEntity::new, MSBlocks.CASSETTE_PLAYER_CLOSED).build(null)).setRegistryName("cassette_player_closed"));
	}
}