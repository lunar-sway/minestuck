...
public class MSTileEntityTypes
{
	...
	public static final RegistryObject<BlockEntityType<CruxtruderTileEntity>> CRUXTRUDER = REGISTER.register("cruxtruder", () -> BlockEntityType.Builder.of(CruxtruderTileEntity::new, MSBlocks.CRUXTRUDER.get().CENTER.get()).build(null));
	public static final RegistryObject<BlockEntityType<TotemLatheTileEntity>> TOTEM_LATHE = REGISTER.register("totem_lathe", () -> BlockEntityType.Builder.of(TotemLatheTileEntity::new, MSBlocks.TOTEM_LATHE.get().CARD_SLOT.get()).build(null));
	public static final RegistryObject<BlockEntityType<AlchemiterTileEntity>> ALCHEMITER = REGISTER.register("alchemiter", () -> BlockEntityType.Builder.of(AlchemiterTileEntity::new, MSBlocks.ALCHEMITER.get().TOTEM_PAD.get()).build(null));
	public static final RegistryObject<BlockEntityType<PunchDesignixTileEntity>> PUNCH_DESIGNIX = REGISTER.register("punch_designix", () -> BlockEntityType.Builder.of(PunchDesignixTileEntity::new, MSBlocks.PUNCH_DESIGNIX.get().SLOT.get()).build(null));
	...
	public static final RegistryObject<BlockEntityType<ItemStackTileEntity>> ITEM_STACK = REGISTER.register("item_stack", () -> BlockEntityType.Builder.of(ItemStackTileEntity::new, MSBlocks.CRUXITE_DOWEL.get(), MSBlocks.TOTEM_LATHE.get().DOWEL_ROD.get()).build(null));
	...
	public static final RegistryObject<BlockEntityType<GateTileEntity>> GATE = REGISTER.register("gate", () -> BlockEntityType.Builder.of(GateTileEntity::new, MSBlocks.GATE.get(), MSBlocks.RETURN_NODE.get()).build(null));
