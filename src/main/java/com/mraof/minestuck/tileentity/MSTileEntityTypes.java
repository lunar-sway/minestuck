...
public class MSTileEntityTypes
{
	...
	public static final RegistryObject<TileEntityType<SendificatorTileEntity>> SENDIFICATOR = REGISTER.register("sendificator", () -> TileEntityType.Builder.of(SendificatorTileEntity::new, MSBlocks.SENDIFICATOR).build(null));
