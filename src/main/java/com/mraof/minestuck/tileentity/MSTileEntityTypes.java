...
public class MSTileEntityTypes
{
	...
	public static final RegistryObject<TileEntityType<LotusFlowerTileEntity>> LOTUS_FLOWER = REGISTER.register("lotus_flower", () -> TileEntityType.Builder.create(LotusFlowerTileEntity::new, MSBlocks.LOTUS_FLOWER).build(null));
