...
public class MSTileEntityTypes
{
	...
	public static final RegistryObject<TileEntityType<TotemLatheDowelTileEntity>> TOTEM_LATHE_DOWEL = REGISTER.register("totem_lathe_dowel", () -> TileEntityType.Builder.of(TotemLatheDowelTileEntity::new, MSBlocks.TOTEM_LATHE.DOWEL_ROD.get()).build(null));
