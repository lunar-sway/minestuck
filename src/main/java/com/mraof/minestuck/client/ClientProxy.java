...
//		MinecraftForgeClient.registerItemRenderer(Minestuck.captchaCard, new CardRenderer());
	...
	public static void init()
	{
		...
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.HOLOPAD, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.CRUXITE_DOWEL, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.BLENDER, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.CHESSBOARD, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.MINI_FROG_STATUE, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.MINI_WIZARD_STATUE, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.CASSETTE_PLAYER, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.PIPE, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.PARCEL_PYXIS, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.GLOWYSTONE_DUST, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.GOLD_SEEDS, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.RAINBOW_SAPLING, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.END_SAPLING, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.BREATH_ASPECT_SAPLING, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.LIFE_ASPECT_SAPLING, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.LIGHT_ASPECT_SAPLING, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.TIME_ASPECT_SAPLING, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.HEART_ASPECT_SAPLING, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.RAGE_ASPECT_SAPLING, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.BLOOD_ASPECT_SAPLING, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.DOOM_ASPECT_SAPLING, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.VOID_ASPECT_SAPLING, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.SPACE_ASPECT_SAPLING, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.MIND_ASPECT_SAPLING, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.HOPE_ASPECT_SAPLING, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.GLOWING_MUSHROOM, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.DESERT_BUSH, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.BLOOMING_CACTUS, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.PETRIFIED_GRASS, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.PETRIFIED_POPPY, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.TALL_END_GRASS, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.GLOWFLOWER, RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.CHECKERED_STAINED_GLASS, RenderType.translucent());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.BLACK_CROWN_STAINED_GLASS, RenderType.translucent());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.BLACK_PAWN_STAINED_GLASS, RenderType.translucent());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.WHITE_CROWN_STAINED_GLASS, RenderType.translucent());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.WHITE_PAWN_STAINED_GLASS, RenderType.translucent());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.LUNCHTOP, RenderType.translucent());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.PLATFORM_BLOCK, RenderType.translucent());
		ItemBlockRenderTypes.setRenderLayer(MSBlocks.ITEM_MAGNET, RenderType.translucent());
