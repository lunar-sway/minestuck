...
public class AmphibeanieModel
{
	public static LayerDefinition createBodyLayer()
	{
		...
		PartDefinition leftponytail = beanie.addOrReplaceChild("leftponytail", CubeListBuilder.create()
		...
		PartDefinition rightponytail = beanie.addOrReplaceChild("rightponytail", CubeListBuilder.create()
