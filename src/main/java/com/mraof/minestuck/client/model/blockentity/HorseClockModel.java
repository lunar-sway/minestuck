    ...
    public ResourceLocation getTextureResource(HorseClockBlockEntity object) {
        ...
        if(level != null)
        {
            ...
            if(dayTime < 3000) //beginning of the day
                return new ResourceLocation(Minestuck.MOD_ID, "textures/block/horseclock/0.png");
            else if(dayTime < 6000)
                return new ResourceLocation(Minestuck.MOD_ID, "textures/block/horseclock/1.png");
            else if(dayTime < 9000)
                return new ResourceLocation(Minestuck.MOD_ID, "textures/block/horseclock/2.png");
            else if(dayTime < 12000)
                return new ResourceLocation(Minestuck.MOD_ID, "textures/block/horseclock/3.png");
            else if(dayTime < 15000)
                return new ResourceLocation(Minestuck.MOD_ID, "textures/block/horseclock/4.png");
            else if(dayTime < 18000)
                return new ResourceLocation(Minestuck.MOD_ID, "textures/block/horseclock/5.png");
            else if(dayTime < 21000)
                return new ResourceLocation(Minestuck.MOD_ID, "textures/block/horseclock/6.png");
            else //end of the day
                return new ResourceLocation(Minestuck.MOD_ID, "textures/block/horseclock/7.png");
        }
