...
public class CrumplyHatModel
{
	public static LayerDefinition createBodyLayer()
	{
		...
		PartDefinition head = root.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 55)
						.addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.25F)),
				PartPose.offset(0, -8, 0));
		PartDefinition bone = head.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offset(-2, 0, 0));
		...
		PartDefinition bone2 = head.addOrReplaceChild("bone2", CubeListBuilder.create(), PartPose.offset(0, 0, 3));
		...
		PartDefinition bone3 = head.addOrReplaceChild("bone3", CubeListBuilder.create(), PartPose.offset(2, 0, 0));
		...
		PartDefinition bone4 = head.addOrReplaceChild("bone4", CubeListBuilder.create(), PartPose.offset(2, 0, 0));
		...
		PartDefinition bone5 = head.addOrReplaceChild("bone5", CubeListBuilder.create(), PartPose.offset(2, 0, 0));
