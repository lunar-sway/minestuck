...
public class GristToast implements Toast
{
	...
	public GristToast (Entry<GristType, Long> pDifference) {
	...
	public static void addOrUpdate(ToastComponent pToastGui, Entry<GristType, Long> pDifference) {
		GristToast gristToast = pToastGui.getToast(GristToast.class, pDifference.getKey());
		if (gristToast == null || !gristToast.difference.getKey().equals(pDifference.getKey())) {
			pToastGui.addToast(new GristToast(pDifference));
		} else {
