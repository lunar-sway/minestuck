...
public class StrifeSpecibusScreen extends PlayerStatsScreen
{
	...
	@Override
	public void render(GuiGraphics guiGraphics, int xcor, int ycor, float par3)
	{
		super.render(guiGraphics, xcor, ycor, par3);
		...
		drawActiveTabAndOther(guiGraphics, xcor, ycor);
