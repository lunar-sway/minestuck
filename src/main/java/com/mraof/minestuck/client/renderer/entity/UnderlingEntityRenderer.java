...
public class UnderlingEntityRenderer<T extends UnderlingEntity, M extends EntityModel<T>> extends MobRenderer<T, M>
{
	...
	{
		ResourceLocation underlingName = Objects.requireNonNull(ForgeRegistries.ENTITY_TYPES.getKey(entity.getType()), () -> "Getting texture for entity without a registry name! "+entity);
