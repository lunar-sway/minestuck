...
public class GristRenderer extends EntityRenderer<GristEntity>
{
	...
	public void render(GristEntity grist, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn)
	{
		...
		RenderSystem.setShaderColor(255, 0, 0, grist.shaderAlpha);
		poseStack.translate(Math.random() * grist.shaderAlpha -
				(grist.shaderAlpha / 2), Math.random() * grist.shaderAlpha -
				(grist.shaderAlpha / 2), Math.random() * grist.shaderAlpha - (grist.shaderAlpha / 2));
