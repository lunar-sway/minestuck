...
public class MinestuckGristCostsProvider extends RecipeProvider
{
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> recipeSaver)
	{
		...
		oreCost(MSTags.Items.URANIUM_ORES, MSItems.RAW_URANIUM9j, 1, recipeSaver, Minestuck.MOD_ID);
		oreCost(MSTags.Items.CRUXITE_ORES, MSItems.RAW_CRUXITE9j, 4, recipeSaver, Minestuck.MOD_ID);
		...
		GristCostRecipeBuilder.of(MSItems.GRIMOIRE9j).grist(BUILD, 120).grist(AMETHYST, 60).grist(GARNET, 33).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.LONG_FORGOTTEN_WARHORN9j).grist(BUILD, 550).grist(AMETHYST, 120).grist(TAR, 50).grist(GARNET, 80).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.SBURB_CODE9j).grist(CHALK, 16).grist(IODINE, 2).buildFor(recipeSaver, Minestuck.MOD_ID);
		GristCostRecipeBuilder.of(MSItems.COMPUTER_PARTS9j).grist(BUILD, 20).grist(RUST, 5).grist(GOLD, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.BLANK_DISK9j).grist(BUILD, 5).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.CRUXITE_APPLE9j).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CRUXITE_POTION9j).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.FLUORITE_OCTET9j).grist(DIAMOND, 5600).grist(COBALT, 8).grist(CHALK, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CAT_CLAWS_DRAWN9j).grist(BUILD, 105).grist(RUST, 9).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SKELETONIZER_DRAWN9j).grist(BUILD, 93).grist(CHALK, 20).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SKELETON_DISPLACER_DRAWN9j).grist(URANIUM, 209).grist(RUST, 314).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.TEARS_OF_THE_ENDERLICH_DRAWN9j).grist(QUARTZ, 1425).grist(RUST, 3205).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.LIPSTICK_CHAINSAW9j).grist(BUILD, 45).grist(MARBLE, 18).grist(SHALE, 30).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.LIPSTICK9j).grist(BUILD, 45).grist(MARBLE, 18).grist(SHALE, 30).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.THISTLEBLOWER9j).grist(SHALE, 56).grist(MERCURY, 45).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.EMERALD_IMMOLATOR9j).grist(BUILD, 198).grist(TAR, 99).grist(RUBY, 59).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.FROSTTOOTH9j).grist(BUILD, 291).grist(TAR, 145).grist(AMETHYST, 87).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.OBSIDIATOR9j).grist(BUILD, 405).grist(TAR, 405).grist(GARNET, 365).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.JOUSTING_LANCE9j).grist(RUST, 113).grist(QUARTZ, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CIGARETTE_LANCE9j).grist(SHALE, 74).grist(TAR, 111).grist(DIAMOND, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.LUCERNE_HAMMER9j).grist(BUILD, 35).grist(RUST, 11).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.LUCERNE_HAMMER_OF_UNDYING9j).grist(BUILD, 836).grist(DIAMOND, 76).grist(CHALK, 190).grist(MARBLE, 152).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.TYPHONIC_TRIVIALIZER9j).grist(BUILD, 7860).grist(RUBY, 983).grist(DIAMOND, 524).grist(SHALE, 1310).grist(URANIUM, 5).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.MAILBOX9j).grist(BUILD, 19).grist(MERCURY, 3).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.BLACKSMITH_HAMMER9j).grist(RUST, 11).grist(SULFUR, 15).grist(CAULK, 13).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.POGO_HAMMER9j).grist(BUILD, 152).grist(SHALE, 19).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.WRINKLEFUCKER9j).grist(BUILD, 238).grist(SHALE, 25).grist(TAR, 31).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.TELESCOPIC_SASSACRUSHER9j).grist(SHALE, 87).grist(TAR, 53).grist(MERCURY, 56).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.DEMOCRATIC_DEMOLITIONER9j).grist(BUILD, 50).grist(GOLD, 1).grist(MARBLE, 10).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.REGI_HAMMER9j).grist(AMETHYST, 32).grist(TAR, 77).grist(GOLD, 32).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.FEAR_NO_ANVIL9j).grist(BUILD, 5150).grist(GARNET, 3157).grist(DIAMOND, 206).grist(GOLD, 247).grist(QUARTZ, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.MELT_MASHER9j).grist(BUILD, 4566).grist(TAR, 913).grist(GARNET, 274).grist(DIAMOND, 310).grist(GOLD, 91).grist(SULFUR, 274).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.ESTROGEN_EMPOWERED_EVERYTHING_ERADICATOR9j).grist(BUILD, 1108).grist(SHALE, 92).grist(URANIUM, 17).grist(RUST, 13).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.EEEEEEEEEEEE9j).grist(ARTIFACT, -17).grist(BUILD, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.POPAMATIC_VRILLYHOO9j).grist(BUILD, 5500).grist(QUARTZ, 13200).grist(DIAMOND, 5500).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SCARLET_ZILLYHOO9j).grist(BUILD, 2000).grist(RUBY, 3600).grist(DIAMOND, 1600).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.MWRTHWL9j).grist(BUILD, 4063).grist(GOLD, 3088).grist(RUST, 1950).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.SORD9j).grist(BUILD, 0).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.PAPER_SWORD9j).grist(BUILD, 12).grist(TAR, 3).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SWONGE9j).grist(IODINE, 35).grist(QUARTZ, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.PUMORD9j).grist(MARBLE, 125).grist(GARNET, 5).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CACTACEAE_CUTLASS9j).grist(AMBER, 20).grist(MARBLE, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.BEEF_SWORD9j).grist(IODINE, 22).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.IRRADIATED_STEAK_SWORD9j).grist(IODINE, 3).grist(TAR, 3).grist(URANIUM, 8).build(recipeSaver); //does not follow grist cost
		GristCostRecipeBuilder.of(MSItems.MACUAHUITL9j).grist(BUILD, 52).grist(COBALT, 31).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.FROSTY_MACUAHUITL9j).grist(BUILD, 69).grist(COBALT, 69).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.UNBREAKABLE_KATANA9j).grist(BUILD, 4375).grist(URANIUM, 6325).grist(QUARTZ, 1200).grist(RUBY, 600).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.ANGEL_APOCALYPSE9j).grist(BUILD, 1300).grist(AMBER, 25).grist(QUARTZ, 80).grist(GOLD, 30).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.FIRE_POKER9j).grist(AMBER, 75).grist(RUBY, 9).grist(SULFUR, 40).grist(GOLD, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.TOO_HOT_TO_HANDLE9j).grist(AMBER, 40).grist(RUBY, 36).grist(SULFUR, 24).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CALEDSCRATCH9j).grist(BUILD, 6000).grist(GARNET, 360).grist(MERCURY, 720).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CALEDFWLCH9j).grist(BUILD, 6563).grist(GOLD, 4988).grist(RUST, 3150).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.ROYAL_DERINGER9j).grist(BUILD, 6150).grist(GOLD, 4715).grist(MARBLE, 4510).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CLAYMORE9j).grist(BUILD, 210).grist(RUST, 45).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.REGISWORD9j).grist(AMETHYST, 32).grist(TAR, 117).grist(GOLD, 32).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CRUEL_FATE_CRUCIBLE9j).grist(BUILD, 7500).grist(TAR, 5250).grist(COBALT, 400).grist(GOLD, 200).grist(QUARTZ, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SCARLET_RIBBITAR9j).grist(BUILD, 1250).grist(RUBY, 1725).grist(DIAMOND, 400).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.DOGG_MACHETE9j).grist(BUILD, 400).grist(CHALK, 200).grist(MERCURY, 160).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.COBALT_SABRE9j).grist(BUILD, 850).grist(URANIUM, 34).grist(COBALT, 204).grist(DIAMOND, 34).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.QUANTUM_SABRE9j).grist(BUILD, 413).grist(URANIUM, 796).grist(CAULK, 1659).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SHATTER_BEACON9j).grist(BUILD, 315).grist(COBALT, 294).grist(DIAMOND, 210).grist(URANIUM, 630).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SHATTER_BACON9j).grist(BUILD, 50).grist(IODINE, 25).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SUBTRACTSHUMIDIRE_ZOMORRODNEGATIVE9j).grist(BUILD, 666).grist(AMBER, 1167).grist(GARNET, 600).grist(DIAMOND, 333).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.NIFE9j).grist(ARTIFACT, -2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.LIGHT_OF_MY_KNIFE9j).grist(URANIUM, 43).grist(MERCURY, 85).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.STARSHARD_TRI_BLADE9j).grist(URANIUM, 474).grist(DIAMOND, 474).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.TOOTHRIPPER9j).grist(RUST, 73).grist(CAULK, 121).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.SILVER_SPOON9j).grist(BUILD, 10).grist(MERCURY, 8).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.MELONBALLER9j).grist(BUILD, 53).grist(RUBY, 16).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SIGHTSEEKER9j).grist(BUILD, 53).grist(RUST, 16).grist(CAULK, 27).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.TERRAIN_FLATENATOR9j).grist(BUILD, 170).grist(RUST, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.NOSFERATU_SPOON9j).grist(BUILD, 380).grist(MERCURY, 15).grist(AMETHYST, 46).grist(GARNET, 34).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CROCKER_SPOON9j).grist(BUILD, 850).grist(IODINE, 170).grist(CHALK, 170).grist(RUBY, 51).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CROCKER_FORK9j).grist(BUILD, 850).grist(IODINE, 170).grist(CHALK, 170).grist(RUBY, 51).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SKAIA_FORK9j).grist(BUILD, 225).grist(QUARTZ, 364).grist(GOLD, 58).grist(AMETHYST, 63).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CANDY_FORK9j).grist(BUILD, 42).grist(IODINE, 18).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.TUNING_FORK9j).grist(BUILD, 27).grist(RUST, 16).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.ELECTRIC_FORK9j).grist(BUILD, 180).grist(RUST, 122).grist(MERCURY, 144).grist(URANIUM, 63).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.EATING_FORK_GEM9j).grist(BUILD, 99).grist(AMBER, 7).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.DEVIL_FORK9j).grist(BUILD, 666).grist(SULFUR, 821).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.GOLDEN_SPORK9j).grist(BUILD, 19).grist(GOLD, 11).grist(DIAMOND, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.BIDENT9j).grist(BUILD, 239).grist(GARNET, 11).grist(AMETHYST, 11).grist(QUARTZ, 8).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.EDISONS_FURY9j).grist(RUST, 280).grist(GARNET, 240).grist(MERCURY, 267).grist(URANIUM, 27).grist(TAR, 67).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.BATLEACKS9j).grist(BUILD, 0).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.COPSE_CRUSHER9j).grist(BUILD, 62).grist(RUST, 28).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.QUENCH_CRUSHER9j).grist(BUILD, 134).grist(IODINE, 15).grist(CAULK, 15).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.MELONSBANE9j).grist(BUILD, 216).grist(IODINE, 24).grist(CAULK, 24).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CROP_CHOP9j).grist(BUILD, 78).grist(IODINE, 39).grist(AMBER, 22).grist(GOLD, 9).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.THE_LAST_STRAW9j).grist(BUILD, 180).grist(GOLD, 36).grist(IODINE, 90).grist(AMBER, 45).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.BATTLEAXE9j).grist(BUILD, 272).grist(RUST, 122).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CANDY_BATTLEAXE9j).grist(IODINE, 93).grist(GOLD, 19).grist(CHALK, 47).grist(AMBER, 16).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CHOCO_LOCO_WOODSPLITTER9j).grist(BUILD, 100).grist(IODINE, 75).grist(GOLD, 25).grist(CHALK, 38).grist(AMBER, 25).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.STEEL_EDGE_CANDYCUTTER9j).grist(BUILD, 400).grist(RUST, 180).grist(IODINE, 250).grist(GOLD, 60).grist(CHALK, 100).grist(AMBER, 50).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.BLACKSMITH_BANE9j).grist(BUILD, 82).grist(RUST, 49).grist(TAR, 82).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.REGIAXE9j).grist(AMETHYST, 32).grist(TAR, 92).grist(GOLD, 32).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.GOTHY_AXE9j).grist(RUST, 77).grist(TAR, 85).grist(RUBY, 77).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SURPRISE_AXE9j).grist(BUILD, 159).grist(RUST, 64).grist(AMBER, 53).grist(IODINE, 27).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SHOCK_AXE9j).grist(BUILD, 675).grist(RUST, 270).grist(GOLD, 135).grist(AMBER, 113).grist(URANIUM, 45).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SCRAXE9j).grist(BUILD, 272).grist(TAR, 102).grist(RUST, 41).grist(RUBY, 20).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.LORENTZ_DISTRANSFORMATIONER9j).grist(BUILD, 640).grist(URANIUM, 96).grist(TAR, 160).grist(RUST, 48).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.PISTON_POWERED_POGO_AXEHAMMER9j).grist(BUILD, 304).grist(SHALE, 152).grist(RUST, 46).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.RUBY_CROAK9j).grist(BUILD, 2800).grist(GARNET, 630).grist(RUBY, 420).grist(DIAMOND, 140).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.HEPHAESTUS_LUMBERJACK9j).grist(BUILD, 2150).grist(GOLD, 258).grist(RUBY, 258).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.FISSION_FOCUSED_FAULT_FELLER9j).grist(BUILD, 1360).grist(SHALE, 510).grist(URANIUM, 136).grist(RUST, 102).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.BISECTOR9j).grist(BUILD, 239).grist(GARNET, 81).grist(AMETHYST, 81).grist(QUARTZ, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.FINE_CHINA_AXE9j).grist(MARBLE, 269).grist(SHALE, 84).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.BISICKLE9j).grist(BUILD, 35).grist(RUST, 11).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.OW_THE_EDGE9j).grist(ARTIFACT, -1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.THORNY_SUBJECT9j).grist(BUILD, 87).grist(AMETHYST, 9).grist(RUBY, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.HOMES_SMELL_YA_LATER9j).grist(BUILD, 88).grist(AMBER, 44).grist(AMETHYST, 13).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.HEMEOREAPER9j).grist(BUILD, 195).grist(RUST, 23).grist(GARNET, 23).grist(IODINE, 20).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.FUDGESICKLE9j).grist(IODINE, 30).grist(AMBER, 25).grist(CHALK, 20).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.REGISICKLE9j).grist(AMETHYST, 32).grist(TAR, 77).grist(GOLD, 32).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.HERETICUS_AURURM9j).grist(GOLD, 240).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CLAW_SICKLE9j).grist(BUILD, 264).grist(IODINE, 116).grist(CHALK, 66).grist(GARNET, 10).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CLAW_OF_NRUBYIGLITH9j).grist(BUILD, 1056).grist(AMETHYST, 264).grist(CHALK, 44).grist(GARNET, 26).grist(SHALE, 44).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CANDY_SICKLE9j).grist(IODINE, 45).grist(GOLD, 12).grist(CHALK, 45).grist(AMBER, 15).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SCYTHE9j).grist(BUILD, 56).grist(RUST, 25).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.EIGHTBALL_SCYTHE9j).grist(BUILD, 715).grist(TAR, 743).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.STALE_BAGUETTE9j).grist(IODINE, 6).grist(AMBER, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.GLUB_CLUB9j).grist(BUILD, 10).grist(CAULK, 8).grist(AMBER, 3).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.NIGHT_CLUB9j).grist(TAR, 8).grist(SHALE, 8).grist(COBALT, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.NIGHTSTICK9j).grist(TAR, 18).grist(MARBLE, 7).grist(GOLD, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.RED_EYES9j).grist(TAR, 45).grist(SULFUR, 45).grist(AMETHYST, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.PRISMARINE_BASHER9j).grist(BUILD, 27).grist(COBALT, 18).grist(MARBLE, 7).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CLUB_ZERO9j).grist(BUILD, 44).grist(COBALT, 26).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.POGO_CLUB9j).grist(BUILD, 60).grist(SHALE, 35).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.BARBER_BASHER9j).grist(BUILD, 53).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.METAL_BAT9j).grist(BUILD, 36).grist(MERCURY, 22).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CLOWN_CLUB9j).grist(BUILD, 356).grist(MERCURY, 71).grist(COBALT, 71).grist(IODINE, 89).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.MACE9j).grist(BUILD, 90).grist(RUST, 15).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.M_ACE9j).grist(BUILD, 135).grist(MARBLE, 18).grist(CHALK, 30).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.DESOLATOR_MACE9j).grist(BUILD, 595).grist(RUST, 102).grist(TAR, 170).grist(MARBLE, 170).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.BLAZING_GLORY9j).grist(BUILD, 470).grist(SULFUR, 282).grist(GOLD, 5).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SPIKED_CLUB9j).grist(BUILD, 40).grist(GARNET, 2).grist(IODINE, 3).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.HORSE_HITCHER9j).grist(BUILD, 1080).grist(QUARTZ, 48).grist(URANIUM, 3).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CLUB_OF_FELONY9j).grist(BUILD, 1080).grist(COBALT, 48).grist(URANIUM, 3).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CUESTICK9j).grist(BUILD, 1080).grist(MERCURY, 48).grist(URANIUM, 3).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.VAUDEVILLE_HOOK9j).grist(IODINE, 6).grist(TAR, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.UPPER_CRUST_CRUST_CANE9j).grist(BUILD, 12).grist(IODINE, 8).grist(AMBER, 6).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.ZEPHYR_CANE9j).grist(BUILD, 840).grist(SHALE, 180).grist(CAULK, 180).grist(AMBER, 120).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SPEAR_CANE9j).grist(BUILD, 70).grist(MERCURY, 12).grist(AMBER, 10).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.PARADISES_PORTABELLO9j).grist(BUILD, 18).grist(IODINE, 5).grist(RUBY, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.REGI_CANE9j).grist(AMETHYST, 32).grist(TAR, 72).grist(GOLD, 32).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.POGO_CANE9j).grist(BUILD, 66).grist(SHALE, 22).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.URANIUM_POWERED_STICK9j).grist(URANIUM, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CANDY_CANE9j).grist(IODINE, 24).grist(CHALK, 20).grist(AMBER, 16).build(recipeSaver); //recipe is slightly lower than what is should be for the sharp variety
		GristCostRecipeBuilder.of(MSItems.SHARP_CANDY_CANE9j).grist(IODINE, 24).grist(CHALK, 20).grist(AMBER, 16).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.PRIM_AND_PROPER_WALKING_POLE9j).grist(BUILD, 15).grist(IODINE, 10).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.LESS_PROPER_WALKING_STICK9j).grist(BUILD, 75).grist(RUST, 18).grist(IODINE, 8).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.ROCKEFELLERS_WALKING_BLADECANE9j).grist(BUILD, 413).grist(RUST, 222).grist(TAR, 22).grist(DIAMOND, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.DRAGON_CANE9j).grist(BUILD, 7166).grist(RUBY, 666).grist(RUST, 111).grist(CHALK, 222).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CHANCEWYRMS_EXTRA_FORTUNATE_STABBING_IMPLEMENT9j).grist(BUILD, 41300).grist(COBALT, 22254).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.NEEDLE_WAND9j).grist(DIAMOND, 20).grist(CHALK, 30).grist(GARNET, 40).grist(GOLD, 16).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.ARTIFUCKER9j).grist(ARTIFACT, -100).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.POINTER_WAND9j).grist(BUILD, 200).grist(CAULK, 40).grist(AMBER, 50).grist(RUST, 30).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.POOL_CUE_WAND9j).grist(QUARTZ, 50).grist(CHALK, 70).grist(TAR, 90).grist(URANIUM, 45).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.THORN_OF_OGLOGOTH9j).grist(IODINE, 200).grist(CHALK, 160).grist(AMETHYST, 120).grist(GOLD, 100).grist(TAR, 64).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.SBAHJARANG9j).grist(ARTIFACT, 10).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CLUBS_SUITARANG9j).grist(BUILD, 20).grist(TAR, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.DIAMONDS_SUITARANG9j).grist(BUILD, 20).grist(TAR, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.HEARTS_SUITARANG9j).grist(BUILD, 20).grist(TAR, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SPADES_SUITARANG9j).grist(BUILD, 20).grist(TAR, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CHAKRAM9j).grist(BUILD, 200).grist(RUBY, 10).grist(RUST, 20).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.UMBRAL_INFILTRATOR9j).grist(BUILD, 600).grist(TAR, 450).grist(DIAMOND, 55).grist(MERCURY, 55).grist(QUARTZ, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SORCERERS_PINBALL9j).grist(BUILD, 200).grist(MERCURY, 30).grist(IODINE, 5).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.CAPTCHAROID_CAMERA9j).grist(BUILD, 5000).grist(CAULK, 500).grist(GOLD, 500).grist(MARBLE, 500).grist(MERCURY, 500).grist(SHALE, 500).build(recipeSaver);
		...
		GristCostRecipeBuilder.of(MSItems.QUEUESTACK_MODUS_CARD9j).grist(BUILD, 140).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.TREE_MODUS_CARD9j).grist(BUILD, 400).grist(AMBER, 35).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.HASHMAP_MODUS_CARD9j).grist(BUILD, 280).grist(RUBY, 23).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SET_MODUS_CARD9j).grist(BUILD, 350).grist(MERCURY, 29).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.IRON_BOAT9j).grist(RUST, 30).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.GOLD_BOAT9j).grist(GOLD, 30).build(recipeSaver);
		...
		GristCostRecipeBuilder.of(MSItems.MUSIC_DISC_EMISSARY_OF_DANCE9j).grist(BUILD, 15).grist(CAULK, 8).grist(GOLD, 5).grist(MARBLE, 5).buildFor(recipeSaver, Minestuck.MOD_ID);
		GristCostRecipeBuilder.of(MSItems.MUSIC_DISC_DANCE_STAB_DANCE9j).grist(BUILD, 15).grist(CAULK, 8).grist(COBALT, 5).grist(SULFUR, 5).buildFor(recipeSaver, Minestuck.MOD_ID);
		GristCostRecipeBuilder.of(MSItems.MUSIC_DISC_RETRO_BATTLE9j).grist(BUILD, 15).grist(CAULK, 8).grist(QUARTZ, 5).grist(RUST, 5).buildFor(recipeSaver, Minestuck.MOD_ID);
		GristCostRecipeBuilder.of(MSItems.CASSETTE_139j).grist(BUILD, 15).grist(CAULK, 8).grist(AMBER, 5).grist(CHALK, 5).buildFor(recipeSaver, Minestuck.MOD_ID);
		GristCostRecipeBuilder.of(MSItems.CASSETTE_BLOCKS9j).grist(BUILD, 15).grist(CAULK, 8).grist(RUBY, 5).grist(RUST, 5).buildFor(recipeSaver, Minestuck.MOD_ID);
		GristCostRecipeBuilder.of(MSItems.CASSETTE_CAT9j).grist(BUILD, 15).grist(CAULK, 8).grist(URANIUM, 5).grist(SHALE, 5).buildFor(recipeSaver, Minestuck.MOD_ID);
		GristCostRecipeBuilder.of(MSItems.CASSETTE_CHIRP9j).grist(BUILD, 15).grist(CAULK, 8).grist(RUBY, 5).grist(GARNET, 5).buildFor(recipeSaver, Minestuck.MOD_ID);
		GristCostRecipeBuilder.of(MSItems.CASSETTE_FAR9j).grist(BUILD, 15).grist(CAULK, 8).grist(URANIUM, 5).grist(SULFUR, 5).buildFor(recipeSaver, Minestuck.MOD_ID);
		GristCostRecipeBuilder.of(MSItems.CASSETTE_MALL9j).grist(BUILD, 15).grist(CAULK, 8).grist(AMETHYST, 5).grist(TAR, 5).buildFor(recipeSaver, Minestuck.MOD_ID);
		GristCostRecipeBuilder.of(MSItems.CASSETTE_MELLOHI9j).grist(BUILD, 15).grist(CAULK, 8).grist(MARBLE, 5).grist(SHALE, 5).buildFor(recipeSaver, Minestuck.MOD_ID);
		GristCostRecipeBuilder.of(MSItems.CASSETTE_EMISSARY9j).grist(BUILD, 15).grist(CAULK, 8).grist(GOLD, 5).grist(MARBLE, 5).buildFor(recipeSaver, Minestuck.MOD_ID);
		GristCostRecipeBuilder.of(MSItems.CASSETTE_DANCE_STAB9j).grist(BUILD, 15).grist(CAULK, 8).grist(COBALT, 5).grist(SULFUR, 5).buildFor(recipeSaver, Minestuck.MOD_ID);
		GristCostRecipeBuilder.of(MSItems.CASSETTE_RETRO_BATTLE9j).grist(BUILD, 15).grist(CAULK, 8).grist(QUARTZ, 5).grist(RUST, 5).buildFor(recipeSaver, Minestuck.MOD_ID);
		...
		GristCostRecipeBuilder.of(MSItems.COCOA_WART9j).grist(AMBER, 5).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.EMERALD_SWORD9j).grist(QUARTZ, 44).grist(DIAMOND, 76).grist(RUBY, 72).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.EMERALD_AXE9j).grist(AMBER, 40).grist(DIAMOND, 73).grist(RUBY, 70).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.EMERALD_PICKAXE9j).grist(RUST, 42).grist(DIAMOND, 72).grist(RUBY, 70).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.EMERALD_SHOVEL9j).grist(CHALK, 40).grist(DIAMOND, 70).grist(RUBY, 66).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.EMERALD_HOE9j).grist(IODINE, 32).grist(DIAMOND, 50).grist(RUBY, 45).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.MINE_AND_GRIST9j).grist(BUILD, 10000).grist(DIAMOND, 1).grist(RUBY, 1).grist(AMETHYST, 1).grist(QUARTZ, 1).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.PRISMARINE_HELMET9j).grist(BUILD, 75).grist(COBALT, 30).grist(MARBLE, 15).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.PRISMARINE_CHESTPLATE9j).grist(BUILD, 120).grist(COBALT, 48).grist(MARBLE, 24).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.PRISMARINE_LEGGINGS9j).grist(BUILD, 105).grist(COBALT, 42).grist(MARBLE, 21).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.PRISMARINE_BOOTS9j).grist(BUILD, 60).grist(COBALT, 24).grist(MARBLE, 12).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.IRON_LASS_GLASSES9j).grist(BUILD, 3500).grist(RUBY, 700).grist(AMBER, 350).grist(URANIUM, 125).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.IRON_LASS_CHESTPLATE9j).grist(BUILD, 3500).grist(RUBY, 700).grist(AMBER, 350).grist(URANIUM, 125).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.IRON_LASS_SKIRT9j).grist(BUILD, 3500).grist(RUBY, 700).grist(AMBER, 350).grist(URANIUM, 125).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.IRON_LASS_SHOES9j).grist(BUILD, 3500).grist(RUBY, 700).grist(AMBER, 350).grist(URANIUM, 125).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.PROSPIT_CIRCLET9j).grist(CHALK, 30).grist(AMBER, 5).grist(QUARTZ, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.PROSPIT_SHIRT9j).grist(CHALK, 45).grist(AMBER, 5).grist(QUARTZ, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.PROSPIT_PANTS9j).grist(CHALK, 40).grist(AMBER, 5).grist(QUARTZ, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.PROSPIT_SHOES9j).grist(CHALK, 25).grist(AMBER, 5).grist(QUARTZ, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.DERSE_CIRCLET9j).grist(CHALK, 30).grist(SHALE, 5).grist(MERCURY, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.DERSE_SHIRT9j).grist(CHALK, 45).grist(SHALE, 5).grist(MERCURY, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.DERSE_PANTS9j).grist(CHALK, 40).grist(SHALE, 5).grist(MERCURY, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.DERSE_SHOES9j).grist(CHALK, 25).grist(SHALE, 5).grist(MERCURY, 1).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.CARDBOARD_TUBE9j).grist(BUILD, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GLOWYSTONE_DUST.get()).grist(BUILD, 1).grist(AMBER, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.RAW_CRUXITE9j).grist(BUILD, 3).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.RAW_URANIUM9j).grist(URANIUM, 3).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.GOLDEN_GRASSHOPPER9j).grist(GOLD, 4000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.BUG_NET9j).grist(BUILD, 40).grist(CHALK, 25).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.STONE_SLAB9j).grist(BUILD, 30).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.SPORK9j).grist(BUILD, 50).grist(RUST, 9).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CANDY_CORN9j).grist(CHALK, 1).grist(SULFUR, 1).grist(IODINE, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.TUIX_BAR9j).grist(BUILD, 5).grist(IODINE, 1).build(recipeSaver);
		...
		GristCostRecipeBuilder.of(MSItems.APPLE_JUICE9j).grist(AMBER, 4).grist(SULFUR, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.TAB9j).grist(COBALT, 1).grist(IODINE, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.ORANGE_FAYGO9j).grist(COBALT, 1).grist(AMBER, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CANDY_APPLE_FAYGO9j).grist(COBALT, 1).grist(SHALE, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.FAYGO_COLA9j).grist(COBALT, 1).grist(IODINE, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.COTTON_CANDY_FAYGO9j).grist(COBALT, 1).grist(AMETHYST, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CREME_SODA_FAYGO9j).grist(COBALT, 1).grist(CHALK, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.GRAPE_FAYGO9j).grist(COBALT, 1).grist(SHALE, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.MOON_MIST_FAYGO9j).grist(COBALT, 1).grist(AMBER, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.PEACH_FAYGO9j).grist(COBALT, 1).grist(GARNET, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.REDPOP_FAYGO9j).grist(COBALT, 1).grist(SULFUR, 1).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.PHLEGM_GUSHERS9j).grist(BUILD, 24).grist(SHALE, 30).grist(MERCURY, 18).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SORROW_GUSHERS9j).grist(TAR, 50).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.BUG_ON_A_STICK9j).grist(BUILD, 1).grist(CHALK, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CHOCOLATE_BEETLE9j).grist(CHALK, 2).grist(IODINE, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CONE_OF_FLIES9j).grist(BUILD, 2).grist(AMBER, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.GRASSHOPPER9j).grist(IODINE, 3).grist(AMBER, 7).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CICADA9j).grist(CAULK, 3).grist(MARBLE, 8).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.JAR_OF_BUGS9j).grist(BUILD, 5).grist(CHALK, 3).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.ONION9j).grist(IODINE, 3).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.IRRADIATED_STEAK9j).grist(IODINE, 12).grist(URANIUM, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.ROCK_COOKIE9j).grist(BUILD, 10).grist(MARBLE, 5).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.WOODEN_CARROT9j).grist(BUILD, 8).grist(AMBER, 3).grist(CHALK, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.STRAWBERRY_CHUNK9j).grist(AMBER, 2).grist(BUILD, 1).grist(RUBY, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.FOOD_CAN9j).grist(IODINE, 10).grist(TAR, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.DESERT_FRUIT9j).grist(AMBER, 1).grist(CAULK, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.FUNGAL_SPORE9j).grist(IODINE, 2).grist(AMBER, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SPOREO9j).grist(IODINE, 3).grist(AMBER, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.MOREL_MUSHROOM9j).grist(IODINE, 20).grist(AMBER, 12).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.FRENCH_FRY9j).grist(BUILD, 1).grist(IODINE, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SURPRISE_EMBRYO9j).grist(AMBER, 15).grist(IODINE, 5).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.UNKNOWABLE_EGG9j).grist(AMBER, 15).grist(AMETHYST, 15).grist(TAR, 1).build(recipeSaver);
		...
		GristCostRecipeBuilder.of(MSItems.SBAHJ_POSTER9j).grist(BUILD, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CREW_POSTER9j).grist(TAR, 3).grist(RUST, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.FLARP_MANUAL9j).grist(AMBER, 10).grist(TAR, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SASSACRE_TEXT9j).grist(CAULK, 10).grist(MERCURY, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.WISEGUY9j).grist(CHALK, 10).grist(SULFUR, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.TABLESTUCK_MANUAL9j).grist(MARBLE, 10).grist(COBALT, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.TILLDEATH_HANDBOOK9j).grist(TAR, 10).grist(AMETHYST, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.BINARY_CODE9j).grist(IODINE, 10).grist(SHALE, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.NONBINARY_CODE9j).grist(BUILD, 10).grist(URANIUM, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.THRESH_DVD9j).grist(IODINE, 3).grist(AMETHYST, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.GAMEBRO_MAGAZINE9j).grist(CHALK, 3).grist(GARNET, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.GAMEGRL_MAGAZINE9j).grist(CHALK, 3).grist(AMBER, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.ICE_SHARD9j).grist(COBALT, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.BATTERY9j).grist(GOLD, 4).grist(URANIUM, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.INK_SQUID_PRO_QUO9j).grist(TAR, 8).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.HORN9j).grist(BUILD, 4).grist(RUST, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CAKE_MIX9j).grist(BUILD, 2).grist(IODINE, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.BARBASOL9j).grist(BUILD, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.BARBASOL_BOMB9j).grist(BUILD, 10).grist(SHALE, 10).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CLOTHES_IRON9j).grist(BUILD, 4).grist(SHALE, 4).grist(RUST, 4).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CARVING_TOOL9j).grist(BUILD, 10).grist(RUST, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.CRUMPLY_HAT9j).grist(BUILD, 20).build(recipeSaver);
		...
		GristCostRecipeBuilder.of(MSItems.SCALEMATE_APPLESCAB9j).grist(BUILD, 8).grist(RUBY, 8).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SCALEMATE_BERRYBREATH9j).grist(BUILD, 8).grist(COBALT, 8).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SCALEMATE_CINNAMONWHIFF9j).grist(BUILD, 8).grist(IODINE, 8).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SCALEMATE_HONEYTONGUE9j).grist(BUILD, 8).grist(AMBER, 8).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SCALEMATE_LEMONSNOUT9j).grist(BUILD, 8).grist(AMBER, 8).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SCALEMATE_PINESNOUT9j).grist(BUILD, 8).grist(COBALT, 8).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SCALEMATE_PUCEFOOT9j).grist(BUILD, 8).grist(GARNET, 8).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SCALEMATE_PUMPKINSNUFFLE9j).grist(BUILD, 8).grist(IODINE, 8).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SCALEMATE_PYRALSPITE9j).grist(BUILD, 8).grist(CAULK, 8).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SCALEMATE_WITNESS9j).grist(BUILD, 8).grist(URANIUM, 8).build(recipeSaver);
		...
		ContainerGristCostBuilder.of(MSItems.OIL_BUCKET9j).grist(TAR, 8).grist(SHALE, 8).build(recipeSaver);
		ContainerGristCostBuilder.of(MSItems.BLOOD_BUCKET9j).grist(GARNET, 8).grist(IODINE, 8).build(recipeSaver);
		ContainerGristCostBuilder.of(MSItems.BRAIN_JUICE_BUCKET9j).grist(AMETHYST, 8).grist(CHALK, 8).build(recipeSaver);
		ContainerGristCostBuilder.of(MSItems.WATER_COLORS_BUCKET9j).grist(AMETHYST, 4).grist(CHALK, 4).grist(GARNET, 4).grist(AMBER, 4).build(recipeSaver);
		ContainerGristCostBuilder.of(MSItems.ENDER_BUCKET9j).grist(MERCURY, 8).grist(URANIUM, 8).build(recipeSaver);
		ContainerGristCostBuilder.of(MSItems.OBSIDIAN_BUCKET9j).grist(BUILD, 4).grist(COBALT, 8).grist(TAR, 16).build(recipeSaver);
		
		WildcardGristCostBuilder.of(MSItems.CAPTCHA_CARD9j).cost(1).build(recipeSaver);
