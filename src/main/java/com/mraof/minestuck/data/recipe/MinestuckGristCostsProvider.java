...
public class MinestuckGristCostsProvider extends RecipeProvider
{
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> recipeSaver)
	{
		...
		GristCostRecipeBuilder.of(MSBlocks.BLACK_CASTLE_BRICKS.get()).grist(BUILD, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.DARK_GRAY_CASTLE_BRICKS.get()).grist(BUILD, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS.get()).grist(BUILD, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.WHITE_CASTLE_BRICKS.get()).grist(BUILD, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.BLACK_CASTLE_BRICK_SMOOTH.get()).grist(BUILD, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.DARK_GRAY_CASTLE_BRICK_SMOOTH.get()).grist(BUILD, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.LIGHT_GRAY_CASTLE_BRICK_SMOOTH.get()).grist(BUILD, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.WHITE_CASTLE_BRICK_SMOOTH.get()).grist(BUILD, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.BLACK_CASTLE_BRICK_TRIM.get()).grist(BUILD, 3).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.DARK_GRAY_CASTLE_BRICK_TRIM.get()).grist(BUILD, 3).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.LIGHT_GRAY_CASTLE_BRICK_TRIM.get()).grist(BUILD, 3).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.WHITE_CASTLE_BRICK_TRIM.get()).grist(BUILD, 3).build(recipeSaver);
