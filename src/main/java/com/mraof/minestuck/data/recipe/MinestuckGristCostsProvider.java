...
public class MinestuckGristCostsProvider extends RecipeProvider
{
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> recipeSaver)
	{
		...
		GristCostRecipeBuilder.of(MSItems.hereticusAurum).grist(AMETHYST, 8).grist(TAR, 64).grist(GOLD, 155).grist(QUARTZ, 2).build(recipeSaver);
		...
		GristCostRecipeBuilder.of(MSItems.fancyGlove).grist(BUILD, 5).grist(CHALK, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.spikedGlove).grist(BUILD, 25).grist(RUST, 5).grist(CHALK, 3).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.cobbleBasher).grist(BUILD, 30).grist(MARBLE, 5).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.pogoFist).grist(BUILD, 16).grist(SHALE, 21).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.fluoriteGauntlet).grist(COBALT, 803).grist(CAULK, 500).grist(QUARTZ, 10).grist(SHALE, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.goldenGenesisGauntlet).grist(BUILD, 8000).grist(GOLD, 5000).grist(URANIUM, 300).grist(DIAMOND, 250).grist(ARTIFACT, 10).build(recipeSaver);
		
		GristCostRecipeBuilder.of(MSItems.natureBow).grist(BUILD, 10).grist(AMBER, 4).grist(CHALK, 8).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.infernoShot).grist(BUILD, 25).grist(GARNET, 19).grist(TAR, 11).grist(AMBER, 3).grist(URANIUM, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.energyBow).grist(BUILD, 40).grist(URANIUM, 10).build(recipeSaver);
