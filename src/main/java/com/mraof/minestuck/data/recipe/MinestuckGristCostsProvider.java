...
public class MinestuckGristCostsProvider extends RecipeProvider
{
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> recipeSaver)
	{
		...
		GristCostRecipeBuilder.of(MSItems.REGIHAMMER).grist(AMETHYST, 25).grist(TAR, 70).grist(GOLD, 34).build(recipeSaver);
		...
		GristCostRecipeBuilder.of(MSItems.REGICANE).grist(AMETHYST, 30).grist(TAR, 55).grist(GOLD, 32).build(recipeSaver);
