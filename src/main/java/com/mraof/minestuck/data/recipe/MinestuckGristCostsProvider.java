...
public final class MinestuckGristCostsProvider
{
	public static void buildRecipes(Consumer<FinishedRecipe> recipeSaver)
	{
		...
		GristCostRecipeBuilder.of(SkaiaBlocks.BLACK_CHESS_DIRT.get()).grist(BUILD, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.DARK_GRAY_CHESS_DIRT.get()).grist(BUILD, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.LIGHT_GRAY_CHESS_DIRT.get()).grist(BUILD, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.WHITE_CHESS_DIRT.get()).grist(BUILD, 1).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.BLACK_CHESS_BRICKS.get()).grist(BUILD, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.DARK_GRAY_CHESS_BRICKS.get()).grist(BUILD, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.LIGHT_GRAY_CHESS_BRICKS.get()).grist(BUILD, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.WHITE_CHESS_BRICKS.get()).grist(BUILD, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.BLACK_CHESS_BRICK_SMOOTH.get()).grist(BUILD, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.DARK_GRAY_CHESS_BRICK_SMOOTH.get()).grist(BUILD, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.LIGHT_GRAY_CHESS_BRICK_SMOOTH.get()).grist(BUILD, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.WHITE_CHESS_BRICK_SMOOTH.get()).grist(BUILD, 2).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.BLACK_CHESS_BRICK_TRIM.get()).grist(BUILD, 3).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.DARK_GRAY_CHESS_BRICK_TRIM.get()).grist(BUILD, 3).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.LIGHT_GRAY_CHESS_BRICK_TRIM.get()).grist(BUILD, 3).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.WHITE_CHESS_BRICK_TRIM.get()).grist(BUILD, 3).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.CHECKERED_STAINED_GLASS.get()).grist(BUILD, 5).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.BLACK_PAWN_STAINED_GLASS.get()).grist(BUILD, 5).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.BLACK_CROWN_STAINED_GLASS.get()).grist(BUILD, 5).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.WHITE_PAWN_STAINED_GLASS.get()).grist(BUILD, 5).build(recipeSaver);
		GristCostRecipeBuilder.of(SkaiaBlocks.WHITE_CROWN_STAINED_GLASS.get()).grist(BUILD, 5).build(recipeSaver);
