...
public final class MinestuckGristCostsProvider
{
	public static void buildRecipes(RecipeOutput recipeSaver)
	{
		...
		GristCostRecipeBuilder.of(MSItems.CIGARETTE_LANCE.get()).grist(BUILD, 6484).grist(SHALE, 3242).grist(TAR, 3242).grist(DIAMOND, 8600).build(recipeSaver);
		...
		GristCostRecipeBuilder.of(MSItems.HALF_CLAYMORE.get()).grist(BUILD, 105).grist(RUST, 23).build(recipeSaver);
		...
		GristCostRecipeBuilder.of(MSItems.TRUE_BLUE.get()).grist(BUILD, 10000).grist(TAR, 684).grist(COBALT, 512).grist(DIAMOND, 512).grist(CHALK, 5).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.BLUE_BEAMS.get()).grist(BUILD, 12000).grist(COBALT, 6320).grist(DIAMOND, 1050).grist(URANIUM, 105).grist(MARBLE, 4).build(recipeSaver);
		...
		GristCostRecipeBuilder.of(MSItems.SKAIA_FORK.get()).grist(BUILD, 30000).grist(AMETHYST, 800).grist(QUARTZ, 800).grist(RUST, 580).grist(CAULK, 400).grist(MARBLE, 400).grist(GOLD, 58).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.SKAIAN_CROCKER_ROCKER.get()).grist(BUILD, 30000).grist(CHALK, 2732).grist(IODINE, 2732).grist(QUARTZ, 50000).grist(RUBY, 1639).build(recipeSaver);
		...
		GristCostRecipeBuilder.of(MSItems.EIGHTBALL_SCYTHE.get()).grist(BUILD, 2000).grist(TAR, 743).build(recipeSaver);
		GristCostRecipeBuilder.of(MSItems.TIME_FLAYER.get()).grist(BUILD, 2500).grist(TAR, 574).grist(COBALT, 459).grist(DIAMOND, 230).grist(GOLD, 230).build(recipeSaver);
		...
		GristCostRecipeBuilder.of(MSItems.SKAITHE.get()).grist(BUILD, 20000).grist(QUARTZ, 8600).grist(AMETHYST, 5120).grist(GOLD, 512).build(recipeSaver);
		...
		GristCostRecipeBuilder.of(MSBlocks.TRANSPORTALIZER.get()).grist(BUILD, 9000).grist(AMETHYST, 600).grist(RUST, 580).grist(URANIUM, 372).build(recipeSaver);
		...
		GristCostRecipeBuilder.of(MSItems.CASSETTE_RELIC.get()).grist(BUILD, 15).grist(MARBLE, 12).grist(RUST, 3).grist(SHALE, 5).buildFor(recipeSaver, Minestuck.MOD_ID);
		GristCostRecipeBuilder.of(MSItems.CASSETTE_PRECIPICE.get()).grist(BUILD, 15).grist(CAULK, 8).grist(DIAMOND, 5).grist(SHALE, 5).buildFor(recipeSaver, Minestuck.MOD_ID);
		GristCostRecipeBuilder.of(MSItems.CASSETTE_CREATOR.get()).grist(BUILD, 15).grist(CAULK, 8).grist(GOLD, 5).grist(SHALE, 5).buildFor(recipeSaver, Minestuck.MOD_ID);
		GristCostRecipeBuilder.of(MSItems.CASSETTE_CREATOR_MUSIC_BOX.get()).grist(BUILD, 15).grist(CAULK, 8).grist(GOLD, 5).grist(IODINE, 5).buildFor(recipeSaver, Minestuck.MOD_ID);
		...
		GristCostRecipeBuilder.of(MSBlocks.MOON_CAKE.get()).grist(AMBER, 50).grist(AMETHYST, 50).build(recipeSaver);
