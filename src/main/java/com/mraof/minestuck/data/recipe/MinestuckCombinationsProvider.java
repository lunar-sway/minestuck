...
public class MinestuckCombinationsProvider extends RecipeProvider
{
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer)
	{
		...
		CombinationRecipeBuilder.of(MSItems.CASSETTE_11).input(Items.MUSIC_DISC_11).or().namedInput(MSBlocks.CASSETTE_PLAYER.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.CASSETTE_PIGSTEP).input(Items.MUSIC_DISC_PIGSTEP).or().namedInput(MSBlocks.CASSETTE_PLAYER.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.CASSETTE_STAL).input(Items.MUSIC_DISC_STAL).or().namedInput(MSBlocks.CASSETTE_PLAYER.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.CASSETTE_STRAD).input(Items.MUSIC_DISC_STRAD).or().namedInput(MSBlocks.CASSETTE_PLAYER.get()).build(consumer);
