...
public class MinestuckCombinationsProvider extends RecipeProvider
{
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> consumer)
	{
		...
		CombinationRecipeBuilder.of(Items.COAL).input(ItemTags.PLANKS).and().input(Items.COAL).buildFor(consumer, Minestuck.MOD_ID);
		//Construction Blocks
		...
		CombinationRecipeBuilder.of(Items.CLAY).input(Items.SAND).and().input(Items.GRAVEL).buildFor(consumer, Minestuck.MOD_ID);
		//miscellaneous
		...
		CombinationRecipeBuilder.of(Items.COBWEB).input(Items.FLINT_AND_STEEL).or().input(Items.STICK).buildFor(consumer, Minestuck.MOD_ID);
		//Plants
		...
		CombinationRecipeBuilder.of(Items.SWEET_BERRIES).input(Items.WHEAT_SEEDS).or().input(Items.RED_DYE).buildFor(consumer, Minestuck.MOD_ID);
		...
		CombinationRecipeBuilder.of(Items.SUSPICIOUS_STEW).input(Items.MUSHROOM_STEW).and().input(Items.ROTTEN_FLESH).buildFor(consumer, Minestuck.MOD_ID);
		...
		CombinationRecipeBuilder.of(Items.CROSSBOW).input(Items.BOW).and().input(Items.IRON_INGOT).buildFor(consumer, Minestuck.MOD_ID);
		...
		CombinationRecipeBuilder.of(Items.SHIELD).namedInput(Items.IRON_CHESTPLATE).or().input(ItemTags.PLANKS).buildFor(consumer, Minestuck.MOD_ID);
		...
		CombinationRecipeBuilder.of(Items.BONE).input(Items.STICK).or().input(Items.BONE_MEAL).buildFor(consumer, Minestuck.MOD_ID);
