...
public class MinestuckCombinationsProvider extends RecipeProvider
{
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer)
	{
		...
		CombinationRecipeBuilder.of(MSItems.CACTACEAE_CUTLASS).input(Items.WOODEN_SWORD).and().namedInput(MSBlocks.BLOOMING_CACTUS.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.REGISWORD).namedInput(Items.IRON_SWORD).and().input(MSBlocks.CHESSBOARD.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.REGISWORD).namedInput(MSItems.KATANA).and().input(MSBlocks.CHESSBOARD.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.REGIAXE).input(MSItems.BLACKSMITH_BANE).and().input(MSBlocks.CHESSBOARD.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.LORENTZ_DISTRANSFORMATIONER).input(Items.IRON_AXE).and().namedInput(MSBlocks.TRANSPORTALIZER.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.REGISICKLE).input(MSItems.SICKLE).and().input(MSBlocks.CHESSBOARD.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.REGI_HAMMER).input(MSItems.CLAW_HAMMER).and().input(MSBlocks.CHESSBOARD.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.REGI_CANE).namedInput(MSItems.CANE).and().input(MSBlocks.CHESSBOARD.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.REGI_CANE).namedInput(MSItems.IRON_CANE).and().input(MSBlocks.CHESSBOARD.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.SKAIA_FORK).input(MSItems.FORK).and().input(MSBlocks.CHESSBOARD.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.TYPHONIC_TRIVIALIZER).input(MSItems.FAN).or().namedInput(MSBlocks.SMOOTH_SHADE_STONE.get()).build(consumer);
		
		CombinationRecipeBuilder.of(MSItems.NEEDLE_WAND).input(MSItems.KNITTING_NEEDLE).and().namedInput(MSBlocks.MINI_WIZARD_STATUE.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.POINTER_WAND).input(MSItems.NEEDLE_WAND).and().namedInput(MSBlocks.COMPUTER.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.SORCERERS_PINBALL).input(Items.IRON_BLOCK).or().namedInput(MSBlocks.MINI_WIZARD_STATUE.get()).build(consumer);
		
        CombinationRecipeBuilder.of(MSBlocks.LAPTOP.get()).input(MSBlocks.COMPUTER.get()).and().namedInput(MSItems.BATTERY).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.LAPTOP.get()).input(MSBlocks.COMPUTER.get()).and().namedInput(Items.BOOK).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.CROCKERTOP.get()).input(MSBlocks.LAPTOP.get()).and().namedInput(MSItems.CROCKER_SPOON).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.CROCKERTOP.get()).input(MSBlocks.LAPTOP.get()).and().namedInput(MSItems.CROCKER_FORK).build(consumer);
		...
		CombinationRecipeBuilder.of(MSBlocks.GRIST_WIDGET.get()).namedInput(MSItems.CROCKER_SPOON).or().input(MSItems.CAPTCHA_CARD).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_WIDGET.get()).namedInput(MSItems.CROCKER_FORK).or().input(MSItems.CAPTCHA_CARD).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.CAPTCHAROID_CAMERA).input(MSItems.CAPTCHA_CARD).and().namedInput(MSBlocks.COMPUTER.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.HASHMAP_MODUS_CARD).input(MSTags.Items.MODUS_CARD).and().input(MSBlocks.COMPUTER.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.CASSETTE_13).input(Items.MUSIC_DISC_13).or().namedInput(MSBlocks.CASSETTE_PLAYER.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.CASSETTE_CAT).input(Items.MUSIC_DISC_CAT).or().namedInput(MSBlocks.CASSETTE_PLAYER.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.CASSETTE_BLOCKS).input(Items.MUSIC_DISC_BLOCKS).or().namedInput(MSBlocks.CASSETTE_PLAYER.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.CASSETTE_CHIRP).input(Items.MUSIC_DISC_CHIRP).or().namedInput(MSBlocks.CASSETTE_PLAYER.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.CASSETTE_FAR).input(Items.MUSIC_DISC_FAR).or().namedInput(MSBlocks.CASSETTE_PLAYER.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.CASSETTE_MALL).input(Items.MUSIC_DISC_MALL).or().namedInput(MSBlocks.CASSETTE_PLAYER.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.CASSETTE_MELLOHI).input(Items.MUSIC_DISC_MELLOHI).or().namedInput(MSBlocks.CASSETTE_PLAYER.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.CASSETTE_EMISSARY).input(MSItems.MUSIC_DISC_EMISSARY_OF_DANCE).or().namedInput(MSBlocks.CASSETTE_PLAYER.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.CASSETTE_DANCE_STAB).input(MSItems.MUSIC_DISC_DANCE_STAB_DANCE).or().namedInput(MSBlocks.CASSETTE_PLAYER.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.CASSETTE_RETRO_BATTLE).input(MSItems.MUSIC_DISC_RETRO_BATTLE).or().namedInput(MSBlocks.CASSETTE_PLAYER.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSBlocks.BLACK_CASTLE_BRICKS).input(Items.STONE_BRICKS).or().input(MSBlocks.BLACK_CHESS_DIRT.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.DARK_GRAY_CASTLE_BRICKS).input(Items.STONE_BRICKS).or().input(MSBlocks.DARK_GRAY_CHESS_DIRT.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS).input(Items.STONE_BRICKS).or().input(MSBlocks.LIGHT_GRAY_CHESS_DIRT.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.WHITE_CASTLE_BRICKS).input(Items.STONE_BRICKS).or().input(MSBlocks.WHITE_CHESS_DIRT.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.BLACK_CASTLE_BRICK_SMOOTH).input(Items.STONE).or().input(MSBlocks.BLACK_CASTLE_BRICKS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.DARK_GRAY_CASTLE_BRICK_SMOOTH).input(Items.STONE).or().input(MSBlocks.DARK_GRAY_CASTLE_BRICKS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.LIGHT_GRAY_CASTLE_BRICK_SMOOTH).input(Items.STONE).or().input(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.WHITE_CASTLE_BRICK_SMOOTH).input(Items.STONE).or().input(MSBlocks.WHITE_CASTLE_BRICKS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.BLACK_CASTLE_BRICK_TRIM).input(Items.YELLOW_WOOL).and().input(MSBlocks.BLACK_CASTLE_BRICKS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.DARK_GRAY_CASTLE_BRICK_TRIM).input(Items.YELLOW_WOOL).and().input(MSBlocks.DARK_GRAY_CASTLE_BRICKS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.LIGHT_GRAY_CASTLE_BRICK_TRIM).input(Items.YELLOW_WOOL).and().input(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.WHITE_CASTLE_BRICK_TRIM).input(Items.YELLOW_WOOL).and().input(MSBlocks.WHITE_CASTLE_BRICKS.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSBlocks.BLACK_CROWN_STAINED_GLASS).input(MSBlocks.BLACK_PAWN_STAINED_GLASS.get()).and().input(MSItems.PRIM_AND_PROPER_WALKING_POLE).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.WHITE_CROWN_STAINED_GLASS).input(MSBlocks.WHITE_PAWN_STAINED_GLASS.get()).and().input(MSItems.PRIM_AND_PROPER_WALKING_POLE).build(consumer);
		...
		CombinationRecipeBuilder.of(MSBlocks.COAGULATED_BLOOD.get()).input(Items.SLIME_BLOCK).and().input(MSItems.BLOOD_BUCKET).build(consumer);
		...
		CombinationRecipeBuilder.of(MSBlocks.TAR_SHADE_BRICKS.get()).input(MSBlocks.SHADE_BRICKS.get()).and().namedInput(MSItems.OIL_BUCKET).build(consumer);
		...
		CombinationRecipeBuilder.of(MSBlocks.WOOD_SHAVINGS.get()).input(ItemTags.LOGS).or().namedInput(MSItems.CARVING_TOOL).build(consumer);
		...
		CombinationRecipeBuilder.of(MSBlocks.CRUXITE_BLOCK.get()).input(MSItems.RAW_CRUXITE).or().input(Items.STONE).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(MSBlocks.URANIUM_BLOCK.get()).input(MSItems.RAW_URANIUM).or().input(Items.STONE).buildFor(consumer, Minestuck.MOD_ID);
		...
		CombinationRecipeBuilder.of(MSBlocks.PARCEL_PYXIS.get()).input(MSBlocks.PIPE.get()).or().input(MSItems.MAILBOX).buildFor(consumer, Minestuck.MOD_ID);
		...
		CombinationRecipeBuilder.of(MSBlocks.STAT_STORER.get()).input(MSItems.COMPUTER_PARTS).and().input(MSBlocks.REMOTE_OBSERVER.get()).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(MSBlocks.REMOTE_OBSERVER.get()).input(Items.OBSERVER).or().input(MSItems.PLUTONIUM_CORE).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(MSBlocks.WIRELESS_REDSTONE_TRANSMITTER.get()).input(Items.REPEATER).or().input(MSItems.PLUTONIUM_CORE).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(MSBlocks.WIRELESS_REDSTONE_RECEIVER.get()).input(Items.COMPARATOR).or().input(MSItems.PLUTONIUM_CORE).buildFor(consumer, Minestuck.MOD_ID);
		...
		CombinationRecipeBuilder.of(MSBlocks.ITEM_MAGNET.get()).input(MSItems.PLUTONIUM_CORE).or().input(Items.FISHING_ROD).buildFor(consumer, Minestuck.MOD_ID);
		...
		CombinationRecipeBuilder.of(MSBlocks.REMOTE_COMPARATOR.get()).input(MSBlocks.BLOCK_PRESSURE_PLATE.get()).or().input(MSItems.PLUTONIUM_CORE).buildFor(consumer, Minestuck.MOD_ID);
		...
		CombinationRecipeBuilder.of(MSBlocks.STONE_CRUXITE_ORE.get()).input(MSItems.RAW_CRUXITE).and().input(Items.STONE).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(MSBlocks.NETHERRACK_CRUXITE_ORE.get()).input(MSItems.RAW_CRUXITE).and().input(Items.NETHERRACK).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(MSBlocks.COBBLESTONE_CRUXITE_ORE.get()).input(MSItems.RAW_CRUXITE).and().input(Items.COBBLESTONE).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(MSBlocks.SANDSTONE_CRUXITE_ORE.get()).input(MSItems.RAW_CRUXITE).and().input(Items.SANDSTONE).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(MSBlocks.RED_SANDSTONE_CRUXITE_ORE.get()).input(MSItems.RAW_CRUXITE).and().input(Items.RED_SANDSTONE).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(MSBlocks.END_STONE_CRUXITE_ORE.get()).input(MSItems.RAW_CRUXITE).and().input(Items.END_STONE).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(MSBlocks.SHADE_STONE_CRUXITE_ORE.get()).input(MSItems.RAW_CRUXITE).and().input(MSBlocks.SHADE_STONE.get()).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(MSBlocks.PINK_STONE_CRUXITE_ORE.get()).input(MSItems.RAW_CRUXITE).and().input(MSBlocks.PINK_STONE.get()).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(MSBlocks.STONE_URANIUM_ORE.get()).input(MSItems.RAW_URANIUM).and().input(Items.STONE).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(MSBlocks.NETHERRACK_URANIUM_ORE.get()).input(MSItems.RAW_URANIUM).and().input(Items.NETHERRACK).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(MSBlocks.COBBLESTONE_URANIUM_ORE.get()).input(MSItems.RAW_URANIUM).and().input(Items.COBBLESTONE).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(MSBlocks.SANDSTONE_URANIUM_ORE.get()).input(MSItems.RAW_URANIUM).and().input(Items.SANDSTONE).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(MSBlocks.RED_SANDSTONE_URANIUM_ORE.get()).input(MSItems.RAW_URANIUM).and().input(Items.RED_SANDSTONE).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(MSBlocks.END_STONE_URANIUM_ORE.get()).input(MSItems.RAW_URANIUM).and().input(Items.END_STONE).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(MSBlocks.SHADE_STONE_URANIUM_ORE.get()).input(MSItems.RAW_URANIUM).and().input(MSBlocks.SHADE_STONE.get()).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(MSBlocks.PINK_STONE_URANIUM_ORE.get()).input(MSItems.RAW_URANIUM).and().input(MSBlocks.PINK_STONE.get()).buildFor(consumer, Minestuck.MOD_ID);
		...
		CombinationRecipeBuilder.of(MSItems.PROSPIT_CIRCLET).namedInput(Items.GOLDEN_HELMET).and().input(MSBlocks.WHITE_CROWN_STAINED_GLASS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.PROSPIT_SHIRT).namedInput(Items.LEATHER_CHESTPLATE).and().input(MSBlocks.WHITE_CROWN_STAINED_GLASS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.PROSPIT_PANTS).namedInput(Items.LEATHER_LEGGINGS).and().input(MSBlocks.WHITE_CROWN_STAINED_GLASS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.PROSPIT_SHOES).namedInput(Items.LEATHER_BOOTS).and().input(MSBlocks.WHITE_CROWN_STAINED_GLASS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.DERSE_CIRCLET).namedInput(Items.GOLDEN_HELMET).or().input(MSBlocks.BLACK_CROWN_STAINED_GLASS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.DERSE_SHIRT).namedInput(Items.LEATHER_CHESTPLATE).or().input(MSBlocks.BLACK_CROWN_STAINED_GLASS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.DERSE_PANTS).namedInput(Items.LEATHER_LEGGINGS).or().input(MSBlocks.BLACK_CROWN_STAINED_GLASS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.DERSE_SHOES).namedInput(Items.LEATHER_BOOTS).or().input(MSBlocks.BLACK_CROWN_STAINED_GLASS.get()).build(consumer);
