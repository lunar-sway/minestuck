...
public final class MinestuckCombinationsProvider
{
	public static void buildRecipes(Consumer<FinishedRecipe> consumer)
	{
		...
		CombinationRecipeBuilder.of(Items.ANCIENT_DEBRIS).input(MSItems.STEEL_BEAM.get()).and().input(MSItems.RAW_URANIUM.get()).buildFor(consumer, Minestuck.MOD_ID);
		//food
		...
		CombinationRecipeBuilder.of(MSItems.PILLOW_TALK.get()).input(MSItems.UNBREAKABLE_KATANA.get()).and().input(Items.BAMBOO).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.THORN_IN_YOUR_SIDE.get()).input(Items.IRON_SWORD).and().input(Items.ROSE_BUSH).build(consumer);
		CombinationRecipeBuilder.of(MSItems.ROSE_PROTOCOL.get()).input(MSItems.THORN_IN_YOUR_SIDE.get()).and().input(MSItems.COMPUTER_PARTS.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.BASILISK_BREATH_DRAGONSLAYER.get()).input(MSItems.PIGLINS_PRIDE.get()).and().input(Items.DRAGON_BREATH).build(consumer);
		CombinationRecipeBuilder.of(MSItems.HALLOWED_SKEWER.get()).input(MSItems.DIAMOND_DAGGER.get()).or().input(Items.TOTEM_OF_UNDYING).build(consumer);
		CombinationRecipeBuilder.of(MSItems.GENESIS_GODSTABBER.get()).input(MSItems.HALLOWED_SKEWER.get()).and().input(MSItems.FROG.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.THOUSAND_DEGREE_KNIFE.get()).input(MSItems.LIGHT_OF_MY_KNIFE.get()).and().input(Items.LAVA_BUCKET).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.KEY_TO_THE_CITY.get()).input(MSItems.DEMOCRATIC_DEMOLITIONER.get()).or().input(MSItems.KEY_TO_THE_MACHINE.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.CRIMSON_LEAP.get()).input(MSItems.FROG.get()).and().input(MSItems.KEYBLADE.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.ALLWEDDOL.get()).input(MSItems.YALDABAOTHS_KEYTON.get()).and().input(MSItems.CUEBALL.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.BARBERS_MAGIC_TOUCH.get()).input(MSItems.BARBASOL.get()).and().input(MSItems.WIZARD_STAFF.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.TELESCOPIC_BEATDOWN_BRUISER.get()).input(MSItems.BO_STAFF.get()).or().input(Items.SPYGLASS).build(consumer);
		CombinationRecipeBuilder.of(MSItems.ION_DESTABILIZER.get()).input(MSItems.IRON_LASS_CHESTPLATE.get()).or().input(MSItems.BO_STAFF.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.MARASCHINO_CHERRY_SCYTHE.get()).input(MSItems.SCYTHE.get()).and().input(MSItems.CANDY_CORN.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.HELLBRINGERS_HOE_INACTIVE.get()).input(Items.NETHERITE_HOE).or().input(MSItems.CRYPTID_PHOTO.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.TOFFEE_CLUB.get()).input(MSItems.METAL_BAT.get()).and().input(MSItems.CANDY_CORN.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.BOOMBOX_BEATER.get()).input(MSItems.CASSETTE_PLAYER.get()).or().input(MSItems.SLEDGE_HAMMER.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.THRONGLER.get()).input(MSItems.NOSFERATU_SPOON.get()).and().input(MSItems.SBAHJ_POSTER.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.WET_MEAT_SHIT_THRONGLER.get()).input(MSItems.THRONGLER.get()).and().input(MSItems.MEATFORK.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.SKAIAN_CROCKER_ROCKER.get()).input(MSItems.SKAIA_FORK.get()).or().input(MSItems.CROCKER_FORK.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.MEATFORK.get()).input(Items.TRIDENT).and().input(Items.BEEF).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.LION_LACERATORS_DRAWN.get()).input(MSItems.TEARS_OF_THE_ENDERLICH_DRAWN.get()).or().input(MSItems.CANDY_CORN.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.HAND_CRANKED_VAMPIRE_ERASER.get()).input(MSItems.POINTY_STICK.get()).or().input(MSItems.LIPSTICK_CHAINSAW.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.DEVILS_DELIGHT.get()).input(MSItems.OBSIDIATOR.get()).and().input(MSItems.CRYPTID_PHOTO.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.DEMONBANE_RAGRIPPER.get()).input(MSItems.DEVILS_DELIGHT.get()).and().input(MSItems.CANDY_CORN.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.CHAINSAW_KATANA.get()).input(MSItems.LIPSTICK_CHAINSAW.get()).and().input(MSItems.KATANA.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.FIDUSPAWN_LANCE.get()).input(MSItems.DRAGON_LANCE.get()).or().input(MSItems.URANIUM_GUMMY_BEAR.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.REGILANCE.get()).input(MSItems.JOUSTING_LANCE.get()).or().input(MSItems.CHESSBOARD.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.CIGARETTE_LANCE.get()).input(MSItems.REGILANCE.get()).and().input(MSItems.EIGHTBALL.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.CANDY_FAN.get()).input(MSItems.FAN.get()).and().input(MSItems.CANDY_CORN.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.SPINES_OF_FLUTHLU.get()).input(MSItems.FAN.get()).and().input(MSItems.GRIMOIRE.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.RAZOR_FAN.get()).input(MSItems.FAN.get()).and().input(MSItems.RAZOR_BLADE.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.MOTOR_FAN.get()).input(MSItems.RAZOR_FAN.get()).and().input(MSItems.BATTERY.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.ATOMIC_VAPORIZER.get()).input(MSItems.MOTOR_FAN.get()).or().input(MSItems.QUANTUM_SABRE.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.SHAVING_FAN.get()).input(MSItems.RAZOR_FAN.get()).and().input(MSItems.BARBASOL.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.FIRESTARTER.get()).input(MSItems.RAZOR_FAN.get()).or().input(MSItems.BLAZING_GLORY.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.STAR_RAY.get()).input(MSItems.FIRESTARTER.get()).or().input(MSItems.SUNRAY_HARVESTER.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.WAND.get()).input(MSItems.MINI_WIZARD_STATUE.get()).or().input(Items.STICK).build(consumer);
		...
		CombinationRecipeBuilder.of(MSBlocks.HORSE_CLOCK.getMainBlock()).input(Items.SADDLE).or().input(MSBlocks.REDSTONE_CLOCK.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(SkaiaBlocks.BLACK_CHESS_DIRT.get()).input(Items.DIRT).and().input(Items.BLACK_DYE).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.DARK_GRAY_CHESS_DIRT).input(Items.DIRT).and().input(Items.GRAY_DYE).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.LIGHT_GRAY_CHESS_DIRT).input(Items.DIRT).and().input(Items.LIGHT_GRAY_DYE).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.WHITE_CHESS_DIRT).input(Items.DIRT).and().input(Items.WHITE_DYE).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.BLACK_CHESS_BRICKS).input(Items.STONE_BRICKS).or().input(SkaiaBlocks.BLACK_CHESS_DIRT.get()).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.DARK_GRAY_CHESS_BRICKS).input(Items.STONE_BRICKS).or().input(SkaiaBlocks.DARK_GRAY_CHESS_DIRT.get()).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.LIGHT_GRAY_CHESS_BRICKS).input(Items.STONE_BRICKS).or().input(SkaiaBlocks.LIGHT_GRAY_CHESS_DIRT.get()).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.WHITE_CHESS_BRICKS).input(Items.STONE_BRICKS).or().input(SkaiaBlocks.WHITE_CHESS_DIRT.get()).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.BLACK_CHESS_BRICK_SMOOTH).input(Items.STONE).or().input(SkaiaBlocks.BLACK_CHESS_BRICKS.get()).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.DARK_GRAY_CHESS_BRICK_SMOOTH).input(Items.STONE).or().input(SkaiaBlocks.DARK_GRAY_CHESS_BRICKS.get()).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.LIGHT_GRAY_CHESS_BRICK_SMOOTH).input(Items.STONE).or().input(SkaiaBlocks.LIGHT_GRAY_CHESS_BRICKS.get()).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.WHITE_CHESS_BRICK_SMOOTH).input(Items.STONE).or().input(SkaiaBlocks.WHITE_CHESS_BRICKS.get()).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.BLACK_CHESS_BRICK_TRIM).input(Items.YELLOW_WOOL).and().input(SkaiaBlocks.BLACK_CHESS_BRICKS.get()).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.DARK_GRAY_CHESS_BRICK_TRIM).input(Items.YELLOW_WOOL).and().input(SkaiaBlocks.DARK_GRAY_CHESS_BRICKS.get()).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.LIGHT_GRAY_CHESS_BRICK_TRIM).input(Items.YELLOW_WOOL).and().input(SkaiaBlocks.LIGHT_GRAY_CHESS_BRICKS.get()).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.WHITE_CHESS_BRICK_TRIM).input(Items.YELLOW_WOOL).and().input(SkaiaBlocks.WHITE_CHESS_BRICKS.get()).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.CHECKERED_STAINED_GLASS).input(Items.BLUE_STAINED_GLASS).and().input(MSBlocks.CHESSBOARD.get()).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.BLACK_PAWN_STAINED_GLASS).input(Items.BLACK_STAINED_GLASS).and().input(MSBlocks.CHESSBOARD.get()).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.WHITE_PAWN_STAINED_GLASS).input(Items.WHITE_STAINED_GLASS).and().input(MSBlocks.CHESSBOARD.get()).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.BLACK_CROWN_STAINED_GLASS).input(SkaiaBlocks.BLACK_PAWN_STAINED_GLASS.get()).and().input(MSItems.PRIM_AND_PROPER_WALKING_POLE.get()).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.WHITE_CROWN_STAINED_GLASS).input(SkaiaBlocks.WHITE_PAWN_STAINED_GLASS.get()).and().input(MSItems.PRIM_AND_PROPER_WALKING_POLE.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSBlocks.MIRROR.get()).input(Items.PAINTING).or().input(Items.WATER_BUCKET).build(consumer);
		CombinationRecipeBuilder.of(MSItems.PARTICLE_ACCELERATOR.get()).input(Items.REPEATER).or().input(MSItems.ENERGY_CORE.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.IRON_LASS_GLASSES.get()).namedInput(Items.IRON_HELMET).and().input(MSItems.PARTICLE_ACCELERATOR.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.PROSPIT_CIRCLET.get()).namedInput(Items.GOLDEN_HELMET).and().input(SkaiaBlocks.WHITE_CROWN_STAINED_GLASS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.PROSPIT_SHIRT.get()).namedInput(Items.LEATHER_CHESTPLATE).and().input(SkaiaBlocks.WHITE_CROWN_STAINED_GLASS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.PROSPIT_PANTS.get()).namedInput(Items.LEATHER_LEGGINGS).and().input(SkaiaBlocks.WHITE_CROWN_STAINED_GLASS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.PROSPIT_SHOES.get()).namedInput(Items.LEATHER_BOOTS).and().input(SkaiaBlocks.WHITE_CROWN_STAINED_GLASS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.DERSE_CIRCLET.get()).namedInput(Items.GOLDEN_HELMET).or().input(SkaiaBlocks.BLACK_CROWN_STAINED_GLASS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.DERSE_SHIRT.get()).namedInput(Items.LEATHER_CHESTPLATE).or().input(SkaiaBlocks.BLACK_CROWN_STAINED_GLASS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.DERSE_PANTS.get()).namedInput(Items.LEATHER_LEGGINGS).or().input(SkaiaBlocks.BLACK_CROWN_STAINED_GLASS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.DERSE_SHOES.get()).namedInput(Items.LEATHER_BOOTS).or().input(SkaiaBlocks.BLACK_CROWN_STAINED_GLASS.get()).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.SCALEMATE_APPLESCAB.get()).input(Items.RED_WOOL).and().input(Items.DRAGON_BREATH).build(consumer);
		CombinationRecipeBuilder.of(MSItems.SCALEMATE_BERRYBREATH.get()).input(Items.BLUE_WOOL).and().input(Items.DRAGON_BREATH).build(consumer);
		CombinationRecipeBuilder.of(MSItems.SCALEMATE_CINNAMONWHIFF.get()).input(Items.BROWN_WOOL).and().input(Items.DRAGON_BREATH).build(consumer);
		CombinationRecipeBuilder.of(MSItems.SCALEMATE_HONEYTONGUE.get()).input(Items.YELLOW_WOOL).and().input(Items.DRAGON_BREATH).build(consumer);
		CombinationRecipeBuilder.of(MSItems.SCALEMATE_LEMONSNOUT.get()).input(Items.LIME_WOOL).and().input(Items.DRAGON_BREATH).build(consumer);
		CombinationRecipeBuilder.of(MSItems.SCALEMATE_PINESNORT.get()).input(Items.LIGHT_BLUE_WOOL).and().input(Items.DRAGON_BREATH).build(consumer);
		CombinationRecipeBuilder.of(MSItems.SCALEMATE_PUCEFOOT.get()).input(Items.PINK_WOOL).and().input(Items.DRAGON_BREATH).build(consumer);
		CombinationRecipeBuilder.of(MSItems.SCALEMATE_PUMPKINSNUFFLE.get()).input(Items.ORANGE_WOOL).and().input(Items.DRAGON_BREATH).build(consumer);
		CombinationRecipeBuilder.of(MSItems.SCALEMATE_PYRALSPITE.get()).input(Items.WHITE_WOOL).and().input(Items.DRAGON_BREATH).build(consumer);
		CombinationRecipeBuilder.of(MSItems.SCALEMATE_WITNESS.get()).input(Items.GREEN_WOOL).and().input(Items.DRAGON_BREATH).build(consumer);
		
		CombinationRecipeBuilder.of(MSItems.PLUSH_SALAMANDER.get()).input(Items.YELLOW_WOOL).and().input(Items.AXOLOTL_BUCKET).build(consumer);
		CombinationRecipeBuilder.of(MSItems.PLUSH_NAKAGATOR.get()).input(Items.RED_WOOL).and().input(MSItems.NAKAGATOR_STATUE.get()).build(consumer);
		CombinationRecipeBuilder.of(MSItems.PLUSH_TURTLE.get()).input(Items.PINK_WOOL).and().input(Items.SCUTE).build(consumer);
		CombinationRecipeBuilder.of(MSItems.PLUSH_IGUANA.get()).input(Items.BLUE_WOOL).and().input(Items.MANGROVE_ROOTS).build(consumer);
