...
public class MinestuckCombinationsProvider extends RecipeProvider
{
	...
	protected void buildShapelessRecipes(Consumer<IFinishedRecipe> consumer)
	{
		...
		CombinationRecipeBuilder.of(MSBlocks.BLACK_CHESS_BRICKS).input(Items.STONE_BRICKS).or().input(MSBlocks.BLACK_CHESS_DIRT).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.DARK_GRAY_CHESS_BRICKS).input(Items.STONE_BRICKS).or().input(MSBlocks.DARK_GRAY_CHESS_DIRT).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.LIGHT_GRAY_CHESS_BRICKS).input(Items.STONE_BRICKS).or().input(MSBlocks.LIGHT_GRAY_CHESS_DIRT).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.WHITE_CHESS_BRICKS).input(Items.STONE_BRICKS).or().input(MSBlocks.WHITE_CHESS_DIRT).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.BLACK_CHESS_BRICK_SMOOTH).input(Items.STONE).or().input(MSBlocks.BLACK_CHESS_BRICKS).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.DARK_GRAY_CHESS_BRICK_SMOOTH).input(Items.STONE).or().input(MSBlocks.DARK_GRAY_CHESS_BRICKS).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.LIGHT_GRAY_CHESS_BRICK_SMOOTH).input(Items.STONE).or().input(MSBlocks.LIGHT_GRAY_CHESS_BRICKS).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.WHITE_CHESS_BRICK_SMOOTH).input(Items.STONE).or().input(MSBlocks.WHITE_CHESS_BRICKS).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.BLACK_CHESS_BRICK_TRIM).input(Items.YELLOW_WOOL).and().input(MSBlocks.BLACK_CHESS_BRICKS).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.DARK_GRAY_CHESS_BRICK_TRIM).input(Items.YELLOW_WOOL).and().input(MSBlocks.DARK_GRAY_CHESS_BRICKS).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.LIGHT_GRAY_CHESS_BRICK_TRIM).input(Items.YELLOW_WOOL).and().input(MSBlocks.LIGHT_GRAY_CHESS_BRICKS).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.WHITE_CHESS_BRICK_TRIM).input(Items.YELLOW_WOOL).and().input(MSBlocks.WHITE_CHESS_BRICKS).build(consumer);
