...
public class MinestuckCombinationsProvider extends RecipeProvider
{
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer)
	{
		...
		CombinationRecipeBuilder.of(Items.RAW_IRON).input(Items.RAW_COPPER).and().namedInput(Items.CLOCK).buildFor(consumer, Minestuck.MOD_ID);
		...
		CombinationRecipeBuilder.of(Items.AMETHYST_CLUSTER).input(Items.GRASS_BLOCK).and().input(Items.AMETHYST_SHARD).buildFor(consumer, Minestuck.MOD_ID);
		...
		CombinationRecipeBuilder.of(Items.SMALL_AMETHYST_BUD).input(Items.SPYGLASS).or().input(Items.MEDIUM_AMETHYST_BUD).buildFor(consumer, Minestuck.MOD_ID);
		...
		CombinationRecipeBuilder.of(Items.POINTED_DRIPSTONE).input(Items.CHAINMAIL_BOOTS).and().input(Items.ARROW).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(Items.POINTED_DRIPSTONE).input(Items.DIAMOND_BOOTS).or().input(Items.ARROW).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(Items.POINTED_DRIPSTONE).input(Items.IRON_BOOTS).and().input(Items.ARROW).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(Items.POINTED_DRIPSTONE).input(Items.NETHERITE_BOOTS).or().input(Items.ARROW).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(Items.POINTED_DRIPSTONE).input(Items.LEATHER_BOOTS).and().input(Items.ARROW).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(Items.POINTED_DRIPSTONE).input(Items.GOLDEN_BOOTS).or().input(Items.ARROW).buildFor(consumer, Minestuck.MOD_ID);
		...
		CombinationRecipeBuilder.of(Blocks.POWDER_SNOW).input(Items.WHITE_CONCRETE_POWDER).and().input(Items.ICE).buildFor(consumer, Minestuck.MOD_ID);
		...
		CombinationRecipeBuilder.of(Items.SMOOTH_BASALT).input(Items.INK_SAC).or().input(Items.STONE).buildFor(consumer, Minestuck.MOD_ID);
		...
		CombinationRecipeBuilder.of(Items.COBBLED_DEEPSLATE_SLAB).input(Items.INK_SAC).and().input(Items.COBBLESTONE_STAIRS).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(Items.COBBLED_DEEPSLATE_STAIRS).input(Items.INK_SAC).or().input(Items.COBBLESTONE_WALL).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(Items.COBBLED_DEEPSLATE_WALL).input(Items.INK_SAC).or().input(Items.COBBLESTONE_SLAB).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(Items.CHISELED_DEEPSLATE).input(Items.CHARCOAL).or().input(Items.CHISELED_SANDSTONE).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(Items.POLISHED_DEEPSLATE).input(Items.HONEYCOMB).and().input(Items.DEEPSLATE).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(Items.POLISHED_DEEPSLATE_WALL).input(Items.HONEYCOMB).and().input(Items.DEEPSLATE_TILE_WALL).buildFor(consumer, Minestuck.MOD_ID);
		...
		CombinationRecipeBuilder.of(Items.POLISHED_DEEPSLATE_STAIRS).input(Items.HONEYCOMB).and().input(Items.DEEPSLATE_TILE_STAIRS).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(Items.DEEPSLATE_BRICKS).input(Items.CHARCOAL).and().input(Items.BRICKS).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(Items.DEEPSLATE_BRICK_SLAB).input(Items.CHARCOAL).or().input(Items.BRICK_SLAB).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(Items.DEEPSLATE_BRICK_STAIRS).input(Items.CHARCOAL).and().input(Items.BRICK_STAIRS).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(Items.DEEPSLATE_BRICK_WALL).input(Items.CHARCOAL).or().input(Items.BRICK_WALL).buildFor(consumer, Minestuck.MOD_ID);
		...
		CombinationRecipeBuilder.of(Items.DEEPSLATE_TILE_SLAB).input(Items.INK_SAC).and().input(Items.STONE_SLAB).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(Items.DEEPSLATE_TILE_STAIRS).input(Items.INK_SAC).or().input(Items.STONE_STAIRS).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(Items.DEEPSLATE_TILE_WALL).input(Items.INK_SAC).and().input(Items.ANDESITE_WALL).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(Items.CRACKED_DEEPSLATE_TILES).input(Items.TNT).and().input(Items.SMOOTH_SANDSTONE).buildFor(consumer, Minestuck.MOD_ID);
		CombinationRecipeBuilder.of(Items.GLOW_ITEM_FRAME).input(Items.NETHER_WART).or().input(Items.ITEM_FRAME).buildFor(consumer, Minestuck.MOD_ID);
		//miscellaneous
		...
		CombinationRecipeBuilder.of(Items.AZALEA).input(Items.SPYGLASS).or().input(Items.OAK_SAPLING).buildFor(consumer, Minestuck.MOD_ID);
		...
		CombinationRecipeBuilder.of(Items.INFESTED_DEEPSLATE).input(Items.STONE).and().input(Items.TURTLE_EGG).buildFor(consumer, Minestuck.MOD_ID);
