...
public final class MinestuckCombinationsProvider
{
	public static void buildRecipes(Consumer<FinishedRecipe> consumer)
	{
		...
		CombinationRecipeBuilder.of(SkaiaBlocks.BLACK_CHESS_DIRT).input(Items.DIRT).and().input(Items.BLACK_DYE).build(consumer);
		...
		CombinationRecipeBuilder.of(SkaiaBlocks.BLACK_CHESS_BRICKS).input(Items.STONE_BRICKS).or().input(SkaiaBlocks.BLACK_CHESS_DIRT).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.DARK_GRAY_CHESS_BRICKS).input(Items.STONE_BRICKS).or().input(SkaiaBlocks.DARK_GRAY_CHESS_DIRT).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.LIGHT_GRAY_CHESS_BRICKS).input(Items.STONE_BRICKS).or().input(SkaiaBlocks.LIGHT_GRAY_CHESS_DIRT).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.WHITE_CHESS_BRICKS).input(Items.STONE_BRICKS).or().input(SkaiaBlocks.WHITE_CHESS_DIRT).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.BLACK_CHESS_BRICK_SMOOTH).input(Items.STONE).or().input(SkaiaBlocks.BLACK_CHESS_BRICKS).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.DARK_GRAY_CHESS_BRICK_SMOOTH).input(Items.STONE).or().input(SkaiaBlocks.DARK_GRAY_CHESS_BRICKS).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.LIGHT_GRAY_CHESS_BRICK_SMOOTH).input(Items.STONE).or().input(SkaiaBlocks.LIGHT_GRAY_CHESS_BRICKS).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.WHITE_CHESS_BRICK_SMOOTH).input(Items.STONE).or().input(SkaiaBlocks.WHITE_CHESS_BRICKS).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.BLACK_CHESS_BRICK_TRIM).input(Items.YELLOW_WOOL).and().input(SkaiaBlocks.BLACK_CHESS_BRICKS).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.DARK_GRAY_CHESS_BRICK_TRIM).input(Items.YELLOW_WOOL).and().input(SkaiaBlocks.DARK_GRAY_CHESS_BRICKS).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.LIGHT_GRAY_CHESS_BRICK_TRIM).input(Items.YELLOW_WOOL).and().input(SkaiaBlocks.LIGHT_GRAY_CHESS_BRICKS).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.WHITE_CHESS_BRICK_TRIM).input(Items.YELLOW_WOOL).and().input(SkaiaBlocks.WHITE_CHESS_BRICKS).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.CHECKERED_STAINED_GLASS).input(Items.BLUE_STAINED_GLASS).and().input(MSBlocks.CHESSBOARD).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.BLACK_PAWN_STAINED_GLASS).input(Items.BLACK_STAINED_GLASS).and().input(MSBlocks.CHESSBOARD).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.WHITE_PAWN_STAINED_GLASS).input(Items.WHITE_STAINED_GLASS).and().input(MSBlocks.CHESSBOARD).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.BLACK_CROWN_STAINED_GLASS).input(SkaiaBlocks.BLACK_PAWN_STAINED_GLASS).and().input(MSItems.PRIM_AND_PROPER_WALKING_POLE).build(consumer);
		CombinationRecipeBuilder.of(SkaiaBlocks.WHITE_CROWN_STAINED_GLASS).input(SkaiaBlocks.WHITE_PAWN_STAINED_GLASS).and().input(MSItems.PRIM_AND_PROPER_WALKING_POLE).build(consumer);
