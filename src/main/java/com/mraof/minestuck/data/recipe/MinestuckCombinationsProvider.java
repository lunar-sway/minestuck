...
public class MinestuckCombinationsProvider extends RecipeProvider
{
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> consumer)
	{
		...
		CombinationRecipeBuilder.of(MSItems.DOGG_MACHETE).namedInput(Items.ICE).or().input(Items.IRON_SWORD).build(consumer);
		CombinationRecipeBuilder.of(MSItems.DOGG_MACHETE).namedInput(Items.PACKED_ICE).or().input(Items.IRON_SWORD).build(consumer);
		CombinationRecipeBuilder.of(MSItems.DOGG_MACHETE).namedInput(Items.BLUE_ICE).or().input(Items.IRON_SWORD).build(consumer);
		CombinationRecipeBuilder.of(MSItems.DOGG_MACHETE).namedInput(Items.GRASS_BLOCK).and().input(MSItems.CALEDSCRATCH).build(consumer); //haha get it?? because snoop dogg does weed, which is called grass???? im hilarious.
		CombinationRecipeBuilder.of(MSItems.DOGG_MACHETE).namedInput(Items.GRASS).and().input(MSItems.CALEDSCRATCH).build(consumer);
		...
		CombinationRecipeBuilder.of(MSItems.CALEDFWLCH).namedInput(MSItems.ROYAL_DERINGER).or().input(MSItems.CUEBALL).build(consumer);
