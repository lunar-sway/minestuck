...
public class MinestuckRecipeProvider extends RecipeProvider
{
	...
	protected void buildShapelessRecipes(Consumer<IFinishedRecipe> recipeBuilder)
	{
		...
		//CookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.CHALK_BRICKS), MSBlocks.MOSSY_CHALK_BRICKS, 0.1f, 200).unlockedBy("has_chalk_bricks", has(MSBlocks.CHALK_BRICKS)).save(recipeBuilder);
