...
public class MinestuckRecipeProvider extends RecipeProvider
{
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> recipeBuilder)
	{
		...
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BLACK_CASTLE_BRICKS), MSBlocks.BLACK_CASTLE_BRICK_STAIRS).unlockedBy("has_black_chess_bricks", has(MSBlocks.BLACK_CASTLE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "black_chess_brick_stairs_from_black_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.DARK_GRAY_CASTLE_BRICKS), MSBlocks.DARK_GRAY_CASTLE_BRICK_STAIRS).unlockedBy("has_dark_gray_chess_bricks", has(MSBlocks.DARK_GRAY_CASTLE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "dark_gray_chess_brick_stairs_from_dark_gray_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS), MSBlocks.LIGHT_GRAY_CASTLE_BRICK_STAIRS).unlockedBy("has_light_gray_chess_bricks", has(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "light_gray_chess_brick_stairs_from_light_gray_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.WHITE_CASTLE_BRICKS), MSBlocks.WHITE_CASTLE_BRICK_STAIRS).unlockedBy("has_white_chess_bricks", has(MSBlocks.WHITE_CASTLE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "white_chess_brick_stairs_from_white_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BLACK_CASTLE_BRICKS), MSBlocks.BLACK_CASTLE_BRICK_SLAB, 2).unlockedBy("has_black_chess_bricks", has(MSBlocks.BLACK_CASTLE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "black_chess_brick_slab_from_black_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.DARK_GRAY_CASTLE_BRICKS), MSBlocks.DARK_GRAY_CASTLE_BRICK_SLAB, 2).unlockedBy("has_dark_gray_chess_bricks", has(MSBlocks.DARK_GRAY_CASTLE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "dark_gray_chess_brick_slab_from_dark_gray_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS), MSBlocks.LIGHT_GRAY_CASTLE_BRICK_SLAB, 2).unlockedBy("has_light_gray_chess_bricks", has(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "light_gray_chess_brick_slab_from_light_gray_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.WHITE_CASTLE_BRICKS), MSBlocks.WHITE_CASTLE_BRICK_SLAB, 2).unlockedBy("has_white_chess_bricks", has(MSBlocks.WHITE_CASTLE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "white_chess_brick_slab_from_white_chess_bricks_stonecutting"));
