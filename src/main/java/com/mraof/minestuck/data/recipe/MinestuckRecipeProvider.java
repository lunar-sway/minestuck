...
public class MinestuckRecipeProvider extends RecipeProvider
{
	...
	protected void buildShapelessRecipes(Consumer<IFinishedRecipe> recipeBuilder)
	{
		...
		ShapedRecipeBuilder.shaped(MSBlocks.GREEN_STONE_COLUMN, 3).define('#', MSBlocks.POLISHED_GREEN_STONE).pattern("#").pattern("#").pattern("#").unlockedBy("has_polished_green_stone", has(MSBlocks.POLISHED_GREEN_STONE)).save(recipeBuilder);
		...
		ShapedRecipeBuilder.shaped(MSBlocks.BLACK_CASTLE_BRICK_STAIRS, 4).define('#', MSBlocks.BLACK_CASTLE_BRICKS).pattern("#  ").pattern("## ").pattern("###").unlockedBy("has_black_castle_bricks", has(MSBlocks.BLACK_CASTLE_BRICKS)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.DARK_GRAY_CASTLE_BRICK_STAIRS, 4).define('#', MSBlocks.DARK_GRAY_CASTLE_BRICKS).pattern("#  ").pattern("## ").pattern("###").unlockedBy("has_dark_gray_castle_bricks", has(MSBlocks.DARK_GRAY_CASTLE_BRICKS)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.LIGHT_GRAY_CASTLE_BRICK_STAIRS, 4).define('#', MSBlocks.LIGHT_GRAY_CASTLE_BRICKS).pattern("#  ").pattern("## ").pattern("###").unlockedBy("has_light_gray_castle_bricks", has(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.WHITE_CASTLE_BRICK_STAIRS, 4).define('#', MSBlocks.WHITE_CASTLE_BRICKS).pattern("#  ").pattern("## ").pattern("###").unlockedBy("has_white_castle_bricks", has(MSBlocks.WHITE_CASTLE_BRICKS)).save(recipeBuilder);
		...
		ShapedRecipeBuilder.shaped(MSBlocks.BLACK_CASTLE_BRICK_SLAB, 6).define('#', MSBlocks.BLACK_CASTLE_BRICKS).pattern("###").unlockedBy("has_black_castle_bricks", has(MSBlocks.BLACK_CASTLE_BRICKS)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.DARK_GRAY_CASTLE_BRICK_SLAB, 6).define('#', MSBlocks.DARK_GRAY_CASTLE_BRICKS).pattern("###").unlockedBy("has_dark_gray_castle_bricks", has(MSBlocks.DARK_GRAY_CASTLE_BRICKS)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.LIGHT_GRAY_CASTLE_BRICK_SLAB, 6).define('#', MSBlocks.LIGHT_GRAY_CASTLE_BRICKS).pattern("###").unlockedBy("has_light_gray_castle_bricks", has(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.WHITE_CASTLE_BRICK_SLAB, 6).define('#', MSBlocks.WHITE_CASTLE_BRICKS).pattern("###").unlockedBy("has_white_castle_bricks", has(MSBlocks.WHITE_CASTLE_BRICKS)).save(recipeBuilder);
		...
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BLACK_CASTLE_BRICKS), MSBlocks.BLACK_CASTLE_BRICK_STAIRS).unlocks("has_black_castle_bricks", has(MSBlocks.BLACK_CASTLE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "black_castle_brick_stairs_from_black_castle_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.DARK_GRAY_CASTLE_BRICKS), MSBlocks.DARK_GRAY_CASTLE_BRICK_STAIRS).unlocks("has_dark_gray_castle_bricks", has(MSBlocks.DARK_GRAY_CASTLE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "dark_gray_castle_brick_stairs_from_dark_gray_castle_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS), MSBlocks.LIGHT_GRAY_CASTLE_BRICK_STAIRS).unlocks("has_light_gray_castle_bricks", has(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "light_gray_castle_brick_stairs_from_light_gray_castle_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.WHITE_CASTLE_BRICKS), MSBlocks.WHITE_CASTLE_BRICK_STAIRS).unlocks("has_white_castle_bricks", has(MSBlocks.WHITE_CASTLE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "white_castle_brick_stairs_from_white_castle_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BLACK_CASTLE_BRICKS), MSBlocks.BLACK_CASTLE_BRICK_SLAB, 2).unlocks("has_black_castle_bricks", has(MSBlocks.BLACK_CASTLE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "black_castle_brick_slab_from_black_castle_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.DARK_GRAY_CASTLE_BRICKS), MSBlocks.DARK_GRAY_CASTLE_BRICK_SLAB, 2).unlocks("has_dark_gray_castle_bricks", has(MSBlocks.DARK_GRAY_CASTLE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "dark_gray_castle_brick_slab_from_dark_gray_castle_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS), MSBlocks.LIGHT_GRAY_CASTLE_BRICK_SLAB, 2).unlocks("has_light_gray_castle_bricks", has(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "light_gray_castle_brick_slab_from_light_gray_castle_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.WHITE_CASTLE_BRICKS), MSBlocks.WHITE_CASTLE_BRICK_SLAB, 2).unlocks("has_white_castle_bricks", has(MSBlocks.WHITE_CASTLE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "white_castle_brick_slab_from_white_castle_bricks_stonecutting"));
		...
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.GREEN_STONE), MSBlocks.GREEN_STONE_BRICKS).unlocks("has_green_stone", has(MSBlocks.GREEN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "green_stone_bricks_from_green_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.GREEN_STONE), MSBlocks.GREEN_STONE_BRICK_STAIRS).unlocks("has_green_stone", has(MSBlocks.GREEN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "green_stone_brick_stairs_from_green_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.GREEN_STONE), MSBlocks.GREEN_STONE_BRICK_SLAB, 2).unlocks("has_green_stone", has(MSBlocks.GREEN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "green_stone_brick_slab_from_green_stone_stonecutting"));
		...
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.POLISHED_GREEN_STONE), MSBlocks.GREEN_STONE_BRICK_STAIRS).unlocks("has_polished_green_stone", has(MSBlocks.POLISHED_GREEN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "green_stone_brick_stairs_from_polished_green_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.POLISHED_GREEN_STONE), MSBlocks.GREEN_STONE_BRICK_SLAB, 2).unlocks("has_polished_green_stone", has(MSBlocks.POLISHED_GREEN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "green_stone_brick_slab_from_polished_green_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.POLISHED_GREEN_STONE), MSBlocks.HORIZONTAL_GREEN_STONE_BRICKS, 1).unlocks("has_polished_green_stone", has(MSBlocks.POLISHED_GREEN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "horizontal_green_stone_bricks_from_polished_green_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.POLISHED_GREEN_STONE), MSBlocks.VERTICAL_GREEN_STONE_BRICKS, 1).unlocks("has_polished_green_stone", has(MSBlocks.POLISHED_GREEN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "vertical_green_stone_bricks_from_polished_green_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.POLISHED_GREEN_STONE), MSBlocks.CHISELED_GREEN_STONE_BRICKS, 1).unlocks("has_polished_green_stone", has(MSBlocks.POLISHED_GREEN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chiseled_green_stone_bricks_from_polished_green_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.POLISHED_GREEN_STONE), MSBlocks.GREEN_STONE_COLUMN, 1).unlocks("has_polished_green_stone", has(MSBlocks.POLISHED_GREEN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "green_stone_column_from_polished_green_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.GREEN_STONE_BRICKS), MSBlocks.GREEN_STONE_BRICK_TRIM, 1).unlocks("has_green_stone_bricks", has(MSBlocks.GREEN_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "green_stone_brick_trim_from_green_stone_bricks_stonecutting"));
