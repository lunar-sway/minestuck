...
public class MinestuckRecipeProvider extends RecipeProvider
{
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> recipeBuilder)
	{
		...
		ShapelessRecipeBuilder.shapeless(MSBlocks.MOSSY_COARSE_STONE_BRICKS).requires(MSBlocks.COARSE_STONE_BRICKS).requires(Items.VINE).unlockedBy("has_coarse_stone_bricks", has( MSBlocks.COARSE_STONE_BRICKS)).save(recipeBuilder);
		...
		ShapelessRecipeBuilder.shapeless(MSBlocks.MOSSY_PINK_STONE_BRICKS).requires(MSBlocks.PINK_STONE_BRICKS).requires(Items.VINE).unlockedBy("has_vine", has(Items.VINE)).save(recipeBuilder);
		...
		ShapelessRecipeBuilder.shapeless(MSBlocks.MOSSY_DECREPIT_STONE_BRICKS).requires(MSBlocks.DECREPIT_STONE_BRICKS).requires(Items.VINE).unlockedBy("has_vine", has(Items.VINE)).save(recipeBuilder);
		...
		ShapedRecipeBuilder.shaped(MSBlocks.BLACK_CHESS_BRICK_STAIRS, 4).define('#', MSBlocks.BLACK_CHESS_BRICKS).pattern("#  ").pattern("## ").pattern("###").unlockedBy("has_black_chess_bricks", has(MSBlocks.BLACK_CHESS_BRICKS)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.DARK_GRAY_CHESS_BRICK_STAIRS, 4).define('#', MSBlocks.DARK_GRAY_CHESS_BRICKS).pattern("#  ").pattern("## ").pattern("###").unlockedBy("has_dark_gray_chess_bricks", has(MSBlocks.DARK_GRAY_CHESS_BRICKS)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.LIGHT_GRAY_CHESS_BRICK_STAIRS, 4).define('#', MSBlocks.LIGHT_GRAY_CHESS_BRICKS).pattern("#  ").pattern("## ").pattern("###").unlockedBy("has_light_gray_chess_bricks", has(MSBlocks.LIGHT_GRAY_CHESS_BRICKS)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.WHITE_CHESS_BRICK_STAIRS, 4).define('#', MSBlocks.WHITE_CHESS_BRICKS).pattern("#  ").pattern("## ").pattern("###").unlockedBy("has_white_chess_bricks", has(MSBlocks.WHITE_CHESS_BRICKS)).save(recipeBuilder);
		...
		ShapedRecipeBuilder.shaped(MSBlocks.BLACK_CHESS_BRICK_SLAB, 6).define('#', MSBlocks.BLACK_CHESS_BRICKS).pattern("###").unlockedBy("has_black_chess_bricks", has(MSBlocks.BLACK_CHESS_BRICKS)).save(recipeBuilder);
		...
		ShapedRecipeBuilder.shaped(MSBlocks.SANDSTONE_COLUMN, 3).define('#', Items.SANDSTONE).pattern("#").pattern("#").pattern("#").unlockedBy("has_sandstone", has(Items.SANDSTONE)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.CHISELED_SANDSTONE_COLUMN, 3).define('#', Items.CHISELED_SANDSTONE).pattern("#").pattern("#").pattern("#").unlockedBy("has_chiseled_sandstone", has(Items.CHISELED_SANDSTONE)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.RED_SANDSTONE_COLUMN, 3).define('#', Items.RED_SANDSTONE).pattern("#").pattern("#").pattern("#").unlockedBy("has_red_sandstone", has(Items.RED_SANDSTONE)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.CHISELED_RED_SANDSTONE_COLUMN, 3).define('#', Items.CHISELED_RED_SANDSTONE).pattern("#").pattern("#").pattern("#").unlockedBy("has_chiseled_red_sandstone", has(Items.CHISELED_RED_SANDSTONE)).save(recipeBuilder);
		...
		ShapelessRecipeBuilder.shapeless(Items.OAK_PLANKS).requires(MSBlocks.TREATED_PLANKS).requires(Items.WATER_BUCKET).group("planks").unlockedBy("has_log", has(MSBlocks.TREATED_PLANKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "oak_planks_from_treated_planks"));
		...
		ShapedRecipeBuilder.shaped(MSBlocks.URANIUM_COOKER).define('e', MSItems.ENERGY_CORE).define('i', Tags.Items.INGOTS_IRON).define('F', Items.FURNACE).pattern("iii").pattern("iFi").pattern("iei").unlockedBy("has_energy_core", has(MSItems.ENERGY_CORE)).save(recipeBuilder);
		
		ShapelessRecipeBuilder.shapeless(Items.SPRUCE_PLANKS).requires(MSBlocks.WOODEN_CACTUS).group("planks").unlockedBy("has_cactus", has(MSBlocks.WOODEN_CACTUS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "spruce_planks_from_wooden_cactus"));
		...
		ShapedRecipeBuilder.shaped(MSBlocks.WIRELESS_REDSTONE_TRANSMITTER).define('e', MSItems.PLUTONIUM_CORE).define('i', Items.IRON_INGOT).define('c', Items.COMPARATOR).define('q', MSItems.COMPUTER_PARTS).pattern("cqc").pattern("iei").pattern("iii").unlockedBy("has_plutonium_core", has(MSItems.PLUTONIUM_CORE)).save(recipeBuilder);
		...
		ShapedRecipeBuilder.shaped(MSBlocks.ROTATOR).define('p', Items.PISTON).define('i', Items.IRON_INGOT).define('r', Items.REDSTONE).pattern("ipi").pattern("rir").pattern("iri").unlockedBy("has_piston", has(Items.PISTON)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.TOGGLER).define('t', Items.REPEATER).define('i', Items.IRON_INGOT).define('r', Items.REDSTONE).pattern("iti").pattern("rir").pattern("iri").unlockedBy("has_piston", has(Items.PISTON)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.REMOTE_COMPARATOR).define('e', MSItems.PLUTONIUM_CORE).define('o', Items.OBSERVER).define('i', Items.IRON_INGOT).define('c', Items.COMPARATOR).pattern("ici").pattern("oeo").pattern("iii").unlockedBy("has_plutonium_core", has(MSItems.PLUTONIUM_CORE)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.BLOCK_PRESSURE_PLATE).define('p', Items.STONE_PRESSURE_PLATE).define('s', Items.STONE).define('i', Items.IRON_INGOT).define('r', Items.REDSTONE).pattern("sps").pattern("sis").pattern("srs").unlockedBy("has_stone_pressure_plate", has(Items.STONE_PRESSURE_PLATE)).save(recipeBuilder);
		
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.COARSE_STONE_BRICKS), MSBlocks.CRACKED_COARSE_STONE_BRICKS, 0.1f, 200).unlockedBy("has_coarse_stone_bricks", has(MSBlocks.COARSE_STONE_BRICKS)).save(recipeBuilder);
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.SHADE_STONE), MSBlocks.SMOOTH_SHADE_STONE, 0.1f, 200).unlockedBy("has_shade_stone", has(MSBlocks.SHADE_STONE)).save(recipeBuilder);
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.SHADE_BRICKS), MSBlocks.CRACKED_SHADE_BRICKS, 0.1f, 200).unlockedBy("has_shade_bricks", has(MSBlocks.SHADE_BRICKS)).save(recipeBuilder);
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.FROST_BRICKS), MSBlocks.CRACKED_FROST_BRICKS, 0.1f, 100).unlockedBy("has_frost_bricks", has(MSBlocks.FROST_BRICKS)).save(recipeBuilder);
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.MYCELIUM_COBBLESTONE), MSBlocks.MYCELIUM_STONE, 0.1f, 200).unlockedBy("has_mycelium_cobblestone", has(MSBlocks.MYCELIUM_COBBLESTONE)).save(recipeBuilder);
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.MYCELIUM_STONE), MSBlocks.POLISHED_MYCELIUM_STONE, 0.1f, 200).unlockedBy("has_mycelium_stone", has(MSBlocks.MYCELIUM_STONE)).save(recipeBuilder);
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.MYCELIUM_BRICKS), MSBlocks.CRACKED_MYCELIUM_BRICKS, 0.1f, 200).unlockedBy("has_mycelium_bricks", has(MSBlocks.MYCELIUM_BRICKS)).save(recipeBuilder);
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.BLACK_COBBLESTONE), MSBlocks.BLACK_STONE, 0.1f, 200).unlockedBy("has_black_cobblestone", has(MSBlocks.BLACK_COBBLESTONE)).save(recipeBuilder);
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.BLACK_STONE), MSBlocks.POLISHED_BLACK_STONE, 0.1f, 200).unlockedBy("has_black_stone", has(MSBlocks.BLACK_STONE)).save(recipeBuilder);
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.BLACK_STONE_BRICKS), MSBlocks.CRACKED_BLACK_STONE_BRICKS, 0.1f, 200).unlockedBy("has_black_stone_bricks", has(MSBlocks.BLACK_STONE_BRICKS)).save(recipeBuilder);
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.PINK_STONE), MSBlocks.POLISHED_PINK_STONE, 0.1F, 200).unlockedBy("has_pink_stone", has(MSBlocks.PINK_STONE)).save(recipeBuilder);
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.PINK_STONE_BRICKS), MSBlocks.CRACKED_PINK_STONE_BRICKS, 0.1F, 200).unlockedBy("has_pink_stone_bricks", has(MSBlocks.PINK_STONE_BRICKS)).save(recipeBuilder);
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.BROWN_STONE), MSBlocks.POLISHED_BROWN_STONE, 0.1f, 200).unlockedBy("has_brown_stone", has(MSBlocks.BROWN_STONE)).save(recipeBuilder);
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.BROWN_STONE_BRICKS), MSBlocks.CRACKED_BROWN_STONE_BRICKS, 0.1F, 200).unlockedBy("has_brown_stone_bricks", has(MSBlocks.BROWN_STONE_BRICKS)).save(recipeBuilder);
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSItems.CAKE_MIX), Items.CAKE, 0.0F, 200).unlockedBy("has_cake_mix", has(MSItems.CAKE_MIX)).save(recipeBuilder, new ResourceLocation (Minestuck.MOD_ID, "cake_from_mix"));
		
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSTags.Items.CRUXITE_ORES), MSItems.RAW_CRUXITE, 0.2F, 200).unlockedBy("has_cruxite_ore", has(MSTags.Items.CRUXITE_ORES)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "raw_cruxite_from_smelting"));
		SimpleCookingRecipeBuilder.blasting(Ingredient.of(MSTags.Items.CRUXITE_ORES), MSItems.RAW_CRUXITE, 0.2F, 100).unlockedBy("has_cruxite_ore", has(MSTags.Items.CRUXITE_ORES)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "raw_cruxite_from_blasting"));
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSTags.Items.URANIUM_ORES), MSItems.RAW_URANIUM, 0.2F, 200).unlockedBy("has_uranium_ore", has(MSTags.Items.URANIUM_ORES)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "raw_uranium_from_smelting"));
		SimpleCookingRecipeBuilder.blasting(Ingredient.of(MSTags.Items.URANIUM_ORES), MSItems.RAW_URANIUM, 0.2F, 100).unlockedBy("has_uranium_ore", has(MSTags.Items.URANIUM_ORES)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "raw_uranium_from_blasting"));
		...
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.CRUXITE_DOWEL), MSItems.RAW_CRUXITE, 0.0F, 200).unlockedBy("has_cruxite_dowel", has(MSBlocks.CRUXITE_DOWEL)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "raw_cruxite_from_dowel"));
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.GOLD_SEEDS), Items.GOLD_NUGGET, 0.1F, 200).unlockedBy("has_gold_seeds", has(MSBlocks.GOLD_SEEDS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "gold_nugget_from_seeds"));
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.WOODEN_CACTUS), Items.CHARCOAL, 0.15F, 200).unlockedBy("has_wooden_cactus", has(MSBlocks.WOODEN_CACTUS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "charcoal_from_wooden_cactus"));
		...
		SimpleCookingRecipeBuilder.cooking(Ingredient.of(Items.BEEF), MSItems.IRRADIATED_STEAK, 0.2F, 20, MSRecipeTypes.IRRADIATING).unlockedBy("has_beef", has(Items.BEEF)).save(skipAdvancement(recipeBuilder));
		SimpleCookingRecipeBuilder.cooking(Ingredient.of(MSItems.BEEF_SWORD), MSItems.IRRADIATED_STEAK_SWORD, 0.35F, 20, MSRecipeTypes.IRRADIATING).unlockedBy("has_beef_sword", has(MSItems.BEEF_SWORD)).save(skipAdvancement(recipeBuilder));
		SimpleCookingRecipeBuilder.cooking(Ingredient.of(Items.STICK), MSItems.URANIUM_POWERED_STICK, 0.1F, 100, MSRecipeTypes.IRRADIATING).unlockedBy("has_stick", has(Items.STICK)).save(skipAdvancement(recipeBuilder));
		...
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BLACK_CHESS_BRICKS), MSBlocks.BLACK_CHESS_BRICK_STAIRS).unlockedBy("has_black_chess_bricks", has(MSBlocks.BLACK_CHESS_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "black_chess_brick_stairs_from_black_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.DARK_GRAY_CHESS_BRICKS), MSBlocks.DARK_GRAY_CHESS_BRICK_STAIRS).unlockedBy("has_dark_gray_chess_bricks", has(MSBlocks.DARK_GRAY_CHESS_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "dark_gray_chess_brick_stairs_from_dark_gray_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.LIGHT_GRAY_CHESS_BRICKS), MSBlocks.LIGHT_GRAY_CHESS_BRICK_STAIRS).unlockedBy("has_light_gray_chess_bricks", has(MSBlocks.LIGHT_GRAY_CHESS_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "light_gray_chess_brick_stairs_from_light_gray_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.WHITE_CHESS_BRICKS), MSBlocks.WHITE_CHESS_BRICK_STAIRS).unlockedBy("has_white_chess_bricks", has(MSBlocks.WHITE_CHESS_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "white_chess_brick_stairs_from_white_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BLACK_CHESS_BRICKS), MSBlocks.BLACK_CHESS_BRICK_SLAB, 2).unlockedBy("has_black_chess_bricks", has(MSBlocks.BLACK_CHESS_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "black_chess_brick_slab_from_black_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.DARK_GRAY_CHESS_BRICKS), MSBlocks.DARK_GRAY_CHESS_BRICK_SLAB, 2).unlockedBy("has_dark_gray_chess_bricks", has(MSBlocks.DARK_GRAY_CHESS_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "dark_gray_chess_brick_slab_from_dark_gray_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.LIGHT_GRAY_CHESS_BRICKS), MSBlocks.LIGHT_GRAY_CHESS_BRICK_SLAB, 2).unlockedBy("has_light_gray_chess_bricks", has(MSBlocks.LIGHT_GRAY_CHESS_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "light_gray_chess_brick_slab_from_light_gray_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.WHITE_CHESS_BRICKS), MSBlocks.WHITE_CHESS_BRICK_SLAB, 2).unlockedBy("has_white_chess_bricks", has(MSBlocks.WHITE_CHESS_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "white_chess_brick_slab_from_white_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.COARSE_STONE), MSBlocks.CHISELED_COARSE_STONE).unlockedBy("has_coarse_stone", has(MSBlocks.COARSE_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chiseled_coarse_stone_from_coarse_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.COARSE_STONE), MSBlocks.COARSE_STONE_BRICKS).unlockedBy("has_coarse_stone", has(MSBlocks.COARSE_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "coarse_stone_bricks_from_coarse_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.COARSE_STONE_BRICKS), MSBlocks.CHISELED_COARSE_STONE_BRICKS).unlockedBy("has_coarse_stone_bricks", has(MSBlocks.COARSE_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chiseled_coarse_stone_bricks_from_coarse_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.COARSE_STONE_BRICKS), MSBlocks.COARSE_STONE_COLUMN).unlockedBy("has_coarse_stone_bricks", has(MSBlocks.COARSE_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "coarse_stone_column_from_coarse_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.COARSE_STONE), MSBlocks.COARSE_STONE_STAIRS).unlockedBy("has_coarse_stone", has(MSBlocks.COARSE_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "coarse_stone_stairs_from_coarse_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.COARSE_STONE), MSBlocks.COARSE_STONE_SLAB, 2).unlockedBy("has_coarse_stone", has(MSBlocks.COARSE_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "coarse_stone_slab_from_coarse_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.COARSE_STONE_BRICKS), MSBlocks.COARSE_STONE_BRICK_STAIRS).unlockedBy("has_coarse_stone_bricks", has(MSBlocks.COARSE_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "coarse_stone_brick_stairs_from_coarse_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.COARSE_STONE_BRICKS), MSBlocks.COARSE_STONE_BRICK_SLAB, 2).unlockedBy("has_coarse_stone_bricks", has(MSBlocks.COARSE_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "coarse_stone_brick_slab_from_coarse_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.SHADE_STONE), MSBlocks.SHADE_BRICKS).unlockedBy("has_shade_stone", has(MSBlocks.SHADE_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "shade_bricks_from_shade_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.SHADE_STONE), MSBlocks.SHADE_STAIRS).unlockedBy("has_shade_stone", has(MSBlocks.SHADE_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "shade_stairs_from_shade_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.SHADE_STONE), MSBlocks.SHADE_SLAB, 2).unlockedBy("has_shade_stone", has(MSBlocks.SHADE_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "shade_slab_from_shade_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.SHADE_BRICKS), MSBlocks.SHADE_BRICK_STAIRS).unlockedBy("has_shade_bricks", has(MSBlocks.SHADE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "shade_brick_stairs_from_shade_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.SHADE_BRICKS), MSBlocks.SHADE_BRICK_SLAB, 2).unlockedBy("has_shade_bricks", has(MSBlocks.SHADE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "shade_brick_slab_from_shade_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.SHADE_BRICKS), MSBlocks.CHISELED_SHADE_BRICKS).unlockedBy("has_shade_bricks", has(MSBlocks.SHADE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chiseled_shade_bricks_from_shade_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.SHADE_BRICKS), MSBlocks.SHADE_COLUMN).unlockedBy("has_shade_bricks", has(MSBlocks.SHADE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "shade_column_from_shade_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.FROST_TILE), MSBlocks.CHISELED_FROST_TILE).unlockedBy("has_frost_tile", has(MSBlocks.FROST_TILE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chiseled_frost_tile_from_frost_tile_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.FROST_TILE), MSBlocks.FROST_BRICKS).unlockedBy("has_frost_tile", has(MSBlocks.FROST_TILE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "frost_bricks_from_frost_tile_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.FROST_BRICKS), MSBlocks.CHISELED_FROST_BRICKS).unlockedBy("has_frost_bricks", has(MSBlocks.FROST_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chiseled_frost_bricks_from_frost_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.FROST_BRICKS), MSBlocks.FROST_COLUMN).unlockedBy("has_frost_bricks", has(MSBlocks.FROST_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "frost_column_from_frost_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.FROST_TILE), MSBlocks.FROST_TILE_STAIRS).unlockedBy("has_frost_tile", has(MSBlocks.FROST_TILE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "frost_tile_stairs_from_frost_tile_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.FROST_TILE), MSBlocks.FROST_TILE_SLAB, 2).unlockedBy("has_frost_tile", has(MSBlocks.FROST_TILE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "frost_tile_slab_from_frost_tile_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.FROST_BRICKS), MSBlocks.FROST_BRICK_STAIRS).unlockedBy("has_frost_bricks", has(MSBlocks.FROST_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "frost_brick_stairs_from_frost_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.FROST_BRICKS), MSBlocks.FROST_BRICK_SLAB, 2).unlockedBy("has_frost_bricks", has(MSBlocks.FROST_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "frost_brick_slab_from_frost_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.CAST_IRON), MSBlocks.CAST_IRON_STAIRS).unlockedBy("has_cast_iron", has(MSBlocks.CAST_IRON)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "cast_iron_stairs_from_cast_iron_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.CAST_IRON), MSBlocks.CHISELED_CAST_IRON).unlockedBy("has_cast_iron", has(MSBlocks.CAST_IRON)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chiseled_cast_iron_from_cast_iron_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.MYCELIUM_STONE), MSBlocks.MYCELIUM_BRICKS).unlockedBy("has_mycelium_stone", has(MSBlocks.MYCELIUM_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "mycelium_bricks_from_mycelium_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.MYCELIUM_BRICKS), MSBlocks.CHISELED_MYCELIUM_BRICKS).unlockedBy("has_mycelium_bricks", has(MSBlocks.MYCELIUM_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chiseled_mycelium_bricks_from_mycelium_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.MYCELIUM_BRICKS), MSBlocks.MYCELIUM_COLUMN).unlockedBy("has_mycelium_bricks", has(MSBlocks.MYCELIUM_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "mycelium_column_from_mycelium_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.MYCELIUM_STONE), MSBlocks.MYCELIUM_STAIRS).unlockedBy("has_mycelium_stone", has(MSBlocks.MYCELIUM_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "mycelium_stairs_from_mycelium_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.MYCELIUM_BRICKS), MSBlocks.MYCELIUM_BRICK_STAIRS).unlockedBy("has_mycelium_bricks", has(MSBlocks.MYCELIUM_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "mycelium_brick_stairs_from_mycelium_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.MYCELIUM_STONE), MSBlocks.MYCELIUM_SLAB, 2).unlockedBy("has_mycelium_stone", has(MSBlocks.MYCELIUM_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "mycelium_slab_from_mycelium_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.MYCELIUM_BRICKS), MSBlocks.MYCELIUM_BRICK_SLAB, 2).unlockedBy("has_mycelium_bricks", has(MSBlocks.MYCELIUM_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "mycelium_brick_slab_from_mycelium_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BLACK_STONE), MSBlocks.BLACK_STONE_BRICKS).unlockedBy("has_black_stone", has(MSBlocks.BLACK_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "black_stone_bricks_from_black_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BLACK_STONE_BRICKS), MSBlocks.CHISELED_BLACK_STONE_BRICKS).unlockedBy("has_black_stone_bricks", has(MSBlocks.BLACK_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chiseled_black_stone_bricks_from_black_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BLACK_STONE_BRICKS), MSBlocks.BLACK_STONE_COLUMN).unlockedBy("has_black_stone_bricks", has(MSBlocks.BLACK_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "black_stone_column_from_black_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BLACK_STONE), MSBlocks.BLACK_STONE_STAIRS).unlockedBy("has_black_stone", has(MSBlocks.BLACK_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "black_stone_stairs_from_black_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BLACK_STONE_BRICKS), MSBlocks.BLACK_STONE_BRICK_STAIRS).unlockedBy("has_black_stone_bricks", has(MSBlocks.BLACK_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "black_stone_brick_stairs_from_black_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BLACK_STONE), MSBlocks.BLACK_STONE_SLAB, 2).unlockedBy("has_black_stone", has(MSBlocks.BLACK_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "black_stone_slab_from_black_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BLACK_STONE_BRICKS), MSBlocks.BLACK_STONE_BRICK_SLAB, 2).unlockedBy("has_black_stone_bricks", has(MSBlocks.BLACK_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "black_stone_brick_slab_from_black_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.CHALK), MSBlocks.CHALK_STAIRS).unlockedBy("has_chalk", has(MSBlocks.CHALK)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chalk_stairs_from_chalk_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.CHALK), MSBlocks.CHALK_SLAB, 2).unlockedBy("has_chalk", has(MSBlocks.CHALK)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chalk_slab_from_chalk_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.CHALK), MSBlocks.POLISHED_CHALK).unlockedBy("has_chalk", has(MSBlocks.CHALK)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "polished_chalk_from_chalk_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.CHALK), MSBlocks.CHALK_BRICKS).unlockedBy("has_chalk", has(MSBlocks.CHALK)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chalk_bricks_from_chalk_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.POLISHED_CHALK), MSBlocks.CHALK_BRICKS).unlockedBy("has_polished_chalk", has(MSBlocks.POLISHED_CHALK)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chalk_bricks_from_polished_chalk_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.CHALK_BRICKS), MSBlocks.CHISELED_CHALK_BRICKS).unlockedBy("has_chalk_bricks", has(MSBlocks.CHALK_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chiseled_chalk_bricks_from_chalk_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.CHALK_BRICKS), MSBlocks.CHALK_COLUMN).unlockedBy("has_chalk_bricks", has(MSBlocks.CHALK_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chalk_column_from_chalk_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.CHALK_BRICKS), MSBlocks.CHALK_BRICK_STAIRS).unlockedBy("has_chalk_bricks", has(MSBlocks.CHALK_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chalk_brick_stairs_from_chalk_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.CHALK_BRICKS), MSBlocks.CHALK_BRICK_SLAB, 2).unlockedBy("has_chalk_bricks", has(MSBlocks.CHALK_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chalk_brick_slab_from_chalk_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.PINK_STONE), MSBlocks.PINK_STONE_BRICKS).unlockedBy("has_pink_stone", has(MSBlocks.PINK_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "pink_stone_bricks_from_pink_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.PINK_STONE_BRICKS), MSBlocks.CHISELED_PINK_STONE_BRICKS).unlockedBy("has_pink_stone_bricks", has(MSBlocks.PINK_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chiseled_pink_stone_bricks_from_pink_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.PINK_STONE_BRICKS), MSBlocks.PINK_STONE_COLUMN).unlockedBy("has_pink_stone_bricks", has(MSBlocks.PINK_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "pink_stone_column_from_pink_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.PINK_STONE), MSBlocks.PINK_STONE_STAIRS).unlockedBy("has_pink_stone", has(MSBlocks.PINK_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "pink_stone_stairs_from_pink_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.PINK_STONE), MSBlocks.PINK_STONE_SLAB, 2).unlockedBy("has_pink_stone", has(MSBlocks.PINK_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "pink_stone_slab_from_pink_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.PINK_STONE_BRICKS), MSBlocks.PINK_STONE_BRICK_STAIRS).unlockedBy("has_pink_stone_bricks", has(MSBlocks.PINK_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "pink_stone_brick_stairs_from_pink_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.PINK_STONE_BRICKS), MSBlocks.PINK_STONE_BRICK_SLAB, 2).unlockedBy("has_pink_stone_bricks", has(MSBlocks.PINK_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "pink_stone_brick_slab_from_pink_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BROWN_STONE), MSBlocks.BROWN_STONE_BRICKS).unlockedBy("has_brown_stone", has(MSBlocks.BROWN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "brown_stone_bricks_from_brown_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.POLISHED_BROWN_STONE), MSBlocks.BROWN_STONE_BRICKS).unlockedBy("has_polished_brown_stone", has(MSBlocks.POLISHED_BROWN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "brown_stone_bricks_from_polished_brown_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BROWN_STONE_BRICKS), MSBlocks.BROWN_STONE_COLUMN).unlockedBy("has_brown_stone_bricks", has(MSBlocks.BROWN_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "brown_stone_column_from_brown_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BROWN_STONE), MSBlocks.BROWN_STONE_STAIRS).unlockedBy("has_brown_stone", has(MSBlocks.BROWN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "brown_stone_stairs_from_brown_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BROWN_STONE), MSBlocks.BROWN_STONE_SLAB, 2).unlockedBy("has_brown_stone", has(MSBlocks.BROWN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "brown_stone_slab_from_brown_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BROWN_STONE_BRICKS), MSBlocks.BROWN_STONE_BRICK_STAIRS).unlockedBy("has_brown_stone_bricks", has(MSBlocks.BROWN_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "brown_stone_brick_stairs_from_brown_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BROWN_STONE_BRICKS), MSBlocks.BROWN_STONE_BRICK_SLAB, 2).unlockedBy("has_brown_stone_bricks", has(MSBlocks.BROWN_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "brown_stone_brick_slab_from_brown_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.GREEN_STONE), MSBlocks.POLISHED_GREEN_STONE).unlockedBy("has_green_stone", has(MSBlocks.GREEN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "polished_green_stone_from_green_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.POLISHED_GREEN_STONE), MSBlocks.GREEN_STONE_BRICKS).unlockedBy("has_polished_green_stone", has(MSBlocks.POLISHED_GREEN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "green_stone_bricks_from_polished_green_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.POLISHED_GREEN_STONE), MSBlocks.HORIZONTAL_GREEN_STONE_BRICKS).unlockedBy("has_polished_green_stone", has(MSBlocks.POLISHED_GREEN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "horizontal_green_stone_bricks_from_polished_green_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.POLISHED_GREEN_STONE), MSBlocks.VERTICAL_GREEN_STONE_BRICKS).unlockedBy("has_polished_green_stone", has(MSBlocks.POLISHED_GREEN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "vertical_green_stone_bricks_from_polished_green_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.POLISHED_GREEN_STONE), MSBlocks.CHISELED_GREEN_STONE_BRICKS).unlockedBy("has_polished_green_stone", has(MSBlocks.POLISHED_GREEN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chiseled_green_stone_bricks_from_polished_green_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.GREEN_STONE_BRICKS), MSBlocks.GREEN_STONE_COLUMN).unlockedBy("has_green_stone_bricks", has(MSBlocks.GREEN_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "green_stone_column_from_green_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.GREEN_STONE_BRICKS), MSBlocks.GREEN_STONE_BRICK_TRIM).unlockedBy("has_green_stone_bricks", has(MSBlocks.GREEN_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "green_stone_brick_trim_from_green_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.GREEN_STONE), MSBlocks.GREEN_STONE_STAIRS).unlockedBy("has_green_stone", has(MSBlocks.GREEN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "green_stone_stairs_from_green_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.GREEN_STONE), MSBlocks.GREEN_STONE_SLAB, 2).unlockedBy("has_green_stone", has(MSBlocks.GREEN_STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "green_stone_slab_from_green_stone_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.GREEN_STONE_BRICKS), MSBlocks.GREEN_STONE_BRICK_STAIRS).unlockedBy("has_green_stone_bricks", has(MSBlocks.GREEN_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "green_stone_brick_stairs_from_green_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.GREEN_STONE_BRICKS), MSBlocks.GREEN_STONE_BRICK_SLAB, 2).unlockedBy("has_green_stone_bricks", has(MSBlocks.GREEN_STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "green_stone_brick_slab_from_green_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(Items.STONE_BRICKS), MSBlocks.DECREPIT_STONE_BRICKS).unlockedBy("has_stone_bricks", has(Items.STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "decrepit_stone_bricks_from_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(Items.STONE_BRICKS), MSBlocks.PUSHABLE_BLOCK).unlockedBy("has_stone_bricks", has(Items.STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "pushable_block_from_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(Items.STONE), MSBlocks.FRAGILE_STONE).unlockedBy("has_stone", has(Items.STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "fragile_stone_from_stone_stonecutting"));
	}
