...
public class MinestuckRecipeProvider extends RecipeProvider
{
	...
	protected void buildShapelessRecipes(Consumer<IFinishedRecipe> recipeBuilder)
	{
		...
		ShapedRecipeBuilder.shaped(MSBlocks.PINK_STONE_COLUMN, 3).define('#', MSBlocks.POLISHED_PINK_STONE).pattern("#").pattern("#").pattern("#").unlockedBy("has_polished_pink_stone", has(MSBlocks.POLISHED_PINK_STONE)).save(recipeBuilder);
		...
		CookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.MYCELIUM_BRICKS), MSBlocks.CRACKED_CHALK_BRICKS, 0.1f, 200).unlockedBy("has_chalk_bricks", has(MSBlocks.CHALK_BRICKS)).save(recipeBuilder);
