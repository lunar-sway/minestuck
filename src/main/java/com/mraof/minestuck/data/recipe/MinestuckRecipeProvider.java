...
public class MinestuckRecipeProvider extends RecipeProvider
{
	...
	protected void buildShapelessRecipes(Consumer<IFinishedRecipe> recipeBuilder)
	{
		...
		ShapedRecipeBuilder.shaped(MSBlocks.BLACK_CASTLE_BRICK_STAIRS, 4).key('#', MSBlocks.BLACK_CASTLE_BRICKS).patternLine("#  ").patternLine("## ").patternLine("###").addCriterion("has_black_castle_bricks", hasItem(MSBlocks.BLACK_CASTLE_BRICKS)).build(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.DARK_GRAY_CASTLE_BRICK_STAIRS, 4).key('#', MSBlocks.DARK_GRAY_CASTLE_BRICKS).patternLine("#  ").patternLine("## ").patternLine("###").addCriterion("has_dark_gray_castle_bricks", hasItem(MSBlocks.DARK_GRAY_CASTLE_BRICKS)).build(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.LIGHT_GRAY_CASTLE_BRICK_STAIRS, 4).key('#', MSBlocks.LIGHT_GRAY_CASTLE_BRICKS).patternLine("#  ").patternLine("## ").patternLine("###").addCriterion("has_light_gray_castle_bricks", hasItem(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS)).build(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.WHITE_CASTLE_BRICK_STAIRS, 4).key('#', MSBlocks.WHITE_CASTLE_BRICKS).patternLine("#  ").patternLine("## ").patternLine("###").addCriterion("has_white_castle_bricks", hasItem(MSBlocks.WHITE_CASTLE_BRICKS)).build(recipeBuilder);
		...
		ShapedRecipeBuilder.shaped(MSBlocks.BLACK_CASTLE_BRICK_SLAB, 6).key('#', MSBlocks.BLACK_CASTLE_BRICKS).patternLine("###").addCriterion("has_black_castle_bricks", hasItem(MSBlocks.BLACK_CASTLE_BRICKS)).build(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.DARK_GRAY_CASTLE_BRICK_SLAB, 6).key('#', MSBlocks.DARK_GRAY_CASTLE_BRICKS).patternLine("###").addCriterion("has_dark_gray_castle_bricks", hasItem(MSBlocks.DARK_GRAY_CASTLE_BRICKS)).build(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.LIGHT_GRAY_CASTLE_BRICK_SLAB, 6).key('#', MSBlocks.LIGHT_GRAY_CASTLE_BRICKS).patternLine("###").addCriterion("has_light_gray_castle_bricks", hasItem(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS)).build(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.WHITE_CASTLE_BRICK_SLAB, 6).key('#', MSBlocks.WHITE_CASTLE_BRICKS).patternLine("###").addCriterion("has_white_castle_bricks", hasItem(MSBlocks.WHITE_CASTLE_BRICKS)).build(recipeBuilder);
		...
		SingleItemRecipeBuilder.stonecutting(Ingredient.fromItems(MSBlocks.BLACK_CASTLE_BRICKS), MSBlocks.BLACK_CASTLE_BRICK_STAIRS).addCriterion("has_black_castle_bricks", hasItem(MSBlocks.BLACK_CASTLE_BRICKS)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "black_castle_brick_stairs_from_black_castle_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.fromItems(MSBlocks.DARK_GRAY_CASTLE_BRICKS), MSBlocks.DARK_GRAY_CASTLE_BRICK_STAIRS).addCriterion("has_dark_gray_castle_bricks", hasItem(MSBlocks.DARK_GRAY_CASTLE_BRICKS)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "dark_gray_castle_brick_stairs_from_dark_gray_castle_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.fromItems(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS), MSBlocks.LIGHT_GRAY_CASTLE_BRICK_STAIRS).addCriterion("has_light_gray_castle_bricks", hasItem(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "light_gray_castle_brick_stairs_from_light_gray_castle_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.fromItems(MSBlocks.WHITE_CASTLE_BRICKS), MSBlocks.WHITE_CASTLE_BRICK_STAIRS).addCriterion("has_white_castle_bricks", hasItem(MSBlocks.WHITE_CASTLE_BRICKS)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "white_castle_brick_stairs_from_white_castle_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.fromItems(MSBlocks.BLACK_CASTLE_BRICKS), MSBlocks.BLACK_CASTLE_BRICK_SLAB, 2).addCriterion("has_black_castle_bricks", hasItem(MSBlocks.BLACK_CASTLE_BRICKS)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "black_castle_brick_slab_from_black_castle_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.fromItems(MSBlocks.DARK_GRAY_CASTLE_BRICKS), MSBlocks.DARK_GRAY_CASTLE_BRICK_SLAB, 2).addCriterion("has_dark_gray_castle_bricks", hasItem(MSBlocks.DARK_GRAY_CASTLE_BRICKS)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "dark_gray_castle_brick_slab_from_dark_gray_castle_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.fromItems(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS), MSBlocks.LIGHT_GRAY_CASTLE_BRICK_SLAB, 2).addCriterion("has_light_gray_castle_bricks", hasItem(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "light_gray_castle_brick_slab_from_light_gray_castle_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.fromItems(MSBlocks.WHITE_CASTLE_BRICKS), MSBlocks.WHITE_CASTLE_BRICK_SLAB, 2).addCriterion("has_white_castle_bricks", hasItem(MSBlocks.WHITE_CASTLE_BRICKS)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "white_castle_brick_slab_from_white_castle_bricks_stonecutting"));
