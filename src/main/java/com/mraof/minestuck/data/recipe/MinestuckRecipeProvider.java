...
public class MinestuckRecipeProvider extends RecipeProvider
{
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> recipeBuilder)
	{
		...
		ShapedRecipeBuilder.shapedRecipe(MSItems.LIP_BALM).key('n', Items.IRON_NUGGET).key('w', Items.HONEYCOMB).patternLine("   ").patternLine("nwn").patternLine(" n ").addCriterion("has_honeycomb", hasItem(Items.HONEYCOMB)).addCriterion("has_iron_nugget", hasItem(Items.IRON_NUGGET)).build(recipeBuilder);
