...
public class MinestuckRecipeProvider extends RecipeProvider
{
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> recipeBuilder)
	{
		...
		ShapelessRecipeBuilder.shapelessRecipe(MSBlocks.COMPUTER).addIngredient(MSItems.ENERGY_CORE).addCriterion("has_energy_core", hasItem(MSItems.ENERGY_CORE)).addIngredient(MSItems.COMPUTER_PARTS).addCriterion("has_computer_parts", hasItem(MSItems.COMPUTER_PARTS)).addIngredient(Items.QUARTZ).addCriterion("has_quartz", hasItem(Items.QUARTZ)).addIngredient(Items.REDSTONE).addCriterion("has_redstone", hasItem(Items.REDSTONE)).addIngredient(MSItems.RAW_CRUXITE).addCriterion("has_raw_cruxite", hasItem(MSItems.RAW_CRUXITE)).build(recipeBuilder);
