...
public class MinestuckRecipeProvider extends RecipeProvider
{
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> recipeBuilder)
	{
		...
		ShapedRecipeBuilder.shapedRecipe(MSItems.fancyGlove).key('#', Items.WHITE_WOOL).key('B', Items.BONE_MEAL).key('L', Items.LEATHER).patternLine(" ##").patternLine("BL#").patternLine(" B ").addCriterion("has_leather", hasItem(Items.LEATHER)).build(recipeBuilder);
