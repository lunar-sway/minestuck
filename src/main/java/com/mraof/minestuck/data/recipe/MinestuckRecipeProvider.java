...
public class MinestuckRecipeProvider extends RecipeProvider
{
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> recipeBuilder)
	{
		...
		SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(MSBlocks.GLOWING_GOLD_BRICKS), MSBlocks.GLOWING_GOLD_BRICK_STAIRS).addCriterion("has_gold_bricks", hasItem(MSBlocks.GLOWING_GOLD_BRICKS)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "gold_brick_stairs_from_gold_bricks_stonecutting"));
	}
