...
public class MinestuckRecipeProvider extends RecipeProvider
{
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> recipeBuilder)
	{
		...
		ShapedRecipeBuilder.shapedRecipe(MSItems.FLINTLOCK_PISTOL, 1).key('i', Items.IRON_INGOT).key('f', Items.FLINT_AND_STEEL).key('g', Items.GOLD_INGOT).key('w', ItemTags.PLANKS).patternLine("iif").patternLine(" gi").patternLine(" iw").addCriterion("has_iron_ingot", hasItem(Items.IRON_INGOT)).build(recipeBuilder);
		ShapedRecipeBuilder.shapedRecipe(MSItems.BULLET, 16).key('i', Items.IRON_INGOT).key('n', Items.IRON_NUGGET).key('g', Items.GUNPOWDER).patternLine(" n ").patternLine("ngn").patternLine("nin").addCriterion("has_gunpowder", hasItem(Items.GUNPOWDER)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "bullet_iron_cast"));
		//ShapedRecipeBuilder.shapedRecipe(MSItems.BULLET, 16).key('i', ExtraForgeTags.Items.COPPER_INGOTS).key('n', Items.IRON_NUGGET).key('g', Items.GUNPOWDER).patternLine(" n ").patternLine("ngn").patternLine("nin").addCriterion("has_gunpowder", hasItem(Items.GUNPOWDER)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "bullet_copper_cast"));
		ShapelessRecipeBuilder.shapelessRecipe(MSItems.HIGH_CALIBER_BULLET).addIngredient(MSItems.BULLET).addIngredient(Items.GUNPOWDER).addCriterion("has_bullet", hasItem(MSItems.BULLET)).build(recipeBuilder);
		ShapelessRecipeBuilder.shapelessRecipe(MSItems.LOW_DRAG_BULLET, 4).addIngredient(MSItems.BULLET, 4).addIngredient(Items.IRON_INGOT).addCriterion("has_bullet", hasItem(MSItems.BULLET)).build(recipeBuilder, "low_drag_bullet_iron");
		//ShapelessRecipeBuilder.shapelessRecipe(MSItems.LOW_DRAG_BULLET, 4).addIngredient(MSItems.BULLET, 4).addIngredient(ExtraForgeTags.Items.COPPER_INGOTS).addCriterion("has_bullet", hasItem(MSItems.BULLET)).build(recipeBuilder, "low_drag_bullet_copper");
