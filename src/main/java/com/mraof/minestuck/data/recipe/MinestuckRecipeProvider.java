...
public class MinestuckRecipeProvider extends RecipeProvider
{
	...
	{
		ShapelessRecipeBuilder.shapeless(MSItems.RAW_CRUXITE9j, 9).requires(MSBlocks.CRUXITE_BLOCK.get()).unlockedBy("has_raw_cruxite", has(MSItems.RAW_CRUXITE9j)).unlockedBy("has_cruxite_block", has(MSBlocks.CRUXITE_BLOCK.get())).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "raw_cruxite_from_block"));
		ShapedRecipeBuilder.shaped(MSBlocks.CRUXITE_BLOCK.get()).define('#', MSItems.RAW_CRUXITE9j).pattern("###").pattern("###").pattern("###").unlockedBy("has_raw_cruxite", has(MSItems.RAW_CRUXITE9j)).save(recipeBuilder);
		ShapelessRecipeBuilder.shapeless(MSItems.RAW_URANIUM9j, 9).requires(MSBlocks.URANIUM_BLOCK.get()).unlockedBy("has__raw_uranium", has(MSItems.RAW_URANIUM9j)).unlockedBy("has_uranium_block", has(MSBlocks.URANIUM_BLOCK.get())).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "raw_uranium_from_block"));
		ShapedRecipeBuilder.shaped(MSBlocks.URANIUM_BLOCK.get()).define('#', MSItems.RAW_URANIUM9j).pattern("###").pattern("###").pattern("###").unlockedBy("has_raw_uranium", has(MSItems.RAW_URANIUM9j)).save(recipeBuilder);
		...
		ShapelessRecipeBuilder.shapeless(MSItems.STRAWBERRY_CHUNK9j, 4).requires(MSBlocks.STRAWBERRY.get()).unlockedBy("has_strawberry_chunks", has( MSItems.STRAWBERRY_CHUNK9j)).unlockedBy("has_strawberry_block", has(MSBlocks.STRAWBERRY.get())).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.STRAWBERRY.get()).define('#', MSItems.STRAWBERRY_CHUNK9j).pattern("##").pattern("##").unlockedBy("has_strawberry_chunks", has(MSItems.STRAWBERRY_CHUNK9j)).save(recipeBuilder);
		...
		ShapelessRecipeBuilder.shapeless(MSBlocks.COMPUTER.get()).requires(MSItems.ENERGY_CORE9j).requires(MSItems.COMPUTER_PARTS9j).unlockedBy("has_computer_parts", has(MSItems.COMPUTER_PARTS9j)).requires(Items.QUARTZ).requires(Items.REDSTONE).requires(MSItems.RAW_CRUXITE9j).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.URANIUM_COOKER.get()).define('e', MSItems.ENERGY_CORE9j).define('i', Tags.Items.INGOTS_IRON).define('F', Items.FURNACE).pattern("iii").pattern("iFi").pattern("iei").unlockedBy("has_energy_core", has(MSItems.ENERGY_CORE9j)).save(recipeBuilder);
		...
		ShapedRecipeBuilder.shaped(MSItems.CLOTHES_IRON9j).define('s', Tags.Items.STONE).define('i', Tags.Items.INGOTS_IRON).define('r', Tags.Items.RODS_WOODEN).pattern(" rr").pattern("sss").pattern("iii").unlockedBy("has_stick", has(Tags.Items.RODS_WOODEN)).unlockedBy("has_iron_ingot", has(Tags.Items.INGOTS_IRON)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.HORN9j).define('w', Items.WHITE_WOOL).define('i', Tags.Items.INGOTS_IRON).define('r', Tags.Items.RODS_WOODEN).pattern("  i").pattern(" r ").pattern("w  ").unlockedBy("has_stick", has(Tags.Items.RODS_WOODEN)).unlockedBy("has_iron_ingot", has(Tags.Items.INGOTS_IRON)).unlockedBy("has_white_wool", has(Items.WHITE_WOOL)).save(recipeBuilder);
		ShapelessRecipeBuilder.shapeless(MSItems.BI_DYE9j, 2).requires(Items.BLUE_DYE).unlockedBy("has_blue_dye", has(Items.BLUE_DYE)).requires(Items.PINK_DYE).unlockedBy("has_pink_dye", has(Items.PINK_DYE)).requires(Items.PURPLE_DYE).unlockedBy("has_purple_dye", has(Items.PURPLE_DYE)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.LIP_BALM9j).define('n', Items.IRON_NUGGET).define('w', Items.HONEYCOMB).pattern("nwn").pattern(" n ").unlockedBy("has_honeycomb", has(Items.HONEYCOMB)).unlockedBy("has_iron_nugget", has(Items.IRON_NUGGET)).save(recipeBuilder);
		
		ShapedRecipeBuilder.shaped(MSItems.CLAW_HAMMER9j).define('i', Tags.Items.INGOTS_IRON).define('s', Tags.Items.RODS_WOODEN).pattern(" ii").pattern("is ").pattern(" s ").unlockedBy("has_iron_ingot", has(Tags.Items.INGOTS_IRON)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.SLEDGE_HAMMER9j).define('i', Tags.Items.INGOTS_IRON).define('s', Tags.Items.RODS_WOODEN).define('S', Tags.Items.STONE).pattern("iSi").pattern(" s ").pattern(" s ").unlockedBy("has_iron_ingot", has(Tags.Items.INGOTS_IRON)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.KATANA9j).define('i', Tags.Items.INGOTS_IRON).define('s', Tags.Items.RODS_WOODEN).pattern("  i").pattern(" i ").pattern("s  ").unlockedBy("has_iron_ingot", has(Tags.Items.INGOTS_IRON)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.DAGGER9j).define('i', Tags.Items.INGOTS_IRON).define('s', Tags.Items.RODS_WOODEN).pattern("s").pattern("i").pattern("i").unlockedBy("has_iron_ingot", has(Tags.Items.INGOTS_IRON)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.MACUAHUITL9j).define('P', ItemTags.PLANKS).define('s', Tags.Items.RODS_WOODEN).define('O', Items.OBSIDIAN).pattern("OPO").pattern("OPO").pattern(" s ").unlockedBy("has_stick", has(Tags.Items.RODS_WOODEN)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.OBSIDIAN_AXE_KNIFE9j).define('s', Tags.Items.RODS_WOODEN).define('O', Items.OBSIDIAN).pattern("  O").pattern(" Os").pattern("Os ").unlockedBy("has_stick", has(Tags.Items.RODS_WOODEN)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.SICKLE9j).define('i', Tags.Items.INGOTS_IRON).define('s', Tags.Items.RODS_WOODEN).pattern("ii ").pattern("  i").pattern(" s ").unlockedBy("has_iron_ingot", has(Tags.Items.INGOTS_IRON)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.DEUCE_CLUB9j).define('P', ItemTags.PLANKS).define('s', Tags.Items.RODS_WOODEN).pattern("  P").pattern(" s ").pattern("s  ").unlockedBy("has_stick", has(Tags.Items.RODS_WOODEN)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.CANE9j).define('s', Tags.Items.RODS_WOODEN).pattern("  s").pattern(" s ").pattern("s  ").unlockedBy("has_stick", has(Tags.Items.RODS_WOODEN)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.BEAR_POKING_STICK9j).define('s', Tags.Items.RODS_WOODEN).define('l', Tags.Items.LEATHER).pattern("  s").pattern(" s ").pattern("l  ").unlockedBy("has_stick", has(Tags.Items.RODS_WOODEN)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.UMBRELLA9j).define('s', Tags.Items.RODS_WOODEN).define('w', Items.BLACK_WOOL).pattern(" w ").pattern("wsw").pattern(" s ").unlockedBy("has_stick", has(Tags.Items.RODS_WOODEN)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.FAN9j).define('s', Tags.Items.RODS_WOODEN).define('p', Items.PAPER).pattern("  p").pattern(" pp").pattern("pps").unlockedBy("has_stick", has(Tags.Items.RODS_WOODEN)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.IRON_CANE9j).define('i', Tags.Items.INGOTS_IRON).define('c', MSItems.CANE9j).pattern("  i").pattern(" c ").pattern("i  ").unlockedBy("has_iron_ingot", has(Tags.Items.INGOTS_IRON)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.WOODEN_SPOON9j).define('s', Tags.Items.RODS_WOODEN).define('b', Items.BOWL).pattern("b").pattern("s").pattern("s").unlockedBy("has_stick", has(Tags.Items.RODS_WOODEN)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.FORK9j).define('S', Tags.Items.STONE).pattern("S S").pattern(" S ").pattern(" S ").unlockedBy("has_stone", has(Tags.Items.STONE)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.POINTY_STICK9j, 1).define('s', Tags.Items.RODS_WOODEN).pattern("s").pattern("s").pattern("s").unlockedBy("has_stick", has(Tags.Items.RODS_WOODEN)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.KNITTING_NEEDLE9j, 2).define('i', Items.IRON_INGOT).define('n', Items.IRON_NUGGET).pattern("  n").pattern(" i ").pattern("i  ").unlockedBy("has_iron_ingot", has(Items.IRON_INGOT)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.SHURIKEN9j, 2).define('i', Items.IRON_INGOT).define('n', Items.IRON_NUGGET).pattern(" i ").pattern("ini").pattern(" i ").unlockedBy("has_iron_ingot", has(Items.IRON_INGOT)).save(recipeBuilder);
		
		ShapedRecipeBuilder.shaped(MSItems.ENERGY_CORE9j).define('u', ExtraForgeTags.Items.URANIUM_CHUNKS).define('c', MSItems.RAW_CRUXITE9j).pattern("cuc").pattern("ucu").pattern("cuc").unlockedBy("has_raw_uranium", has(MSItems.RAW_URANIUM9j)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.PLUTONIUM_CORE9j).define('e', MSItems.ENERGY_CORE9j).define('i', Items.IRON_INGOT).define('n', Items.IRON_NUGGET).define('p', Items.ENDER_PEARL).pattern("nin").pattern("pep").pattern("nin").unlockedBy("has_energy_core", has(MSItems.ENERGY_CORE9j)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.TEMPLE_SCANNER9j).define('e', MSItems.ENERGY_CORE9j).define('c', MSItems.RAW_CRUXITE9j).define('i', Items.IRON_INGOT).define('r', Items.REDSTONE).define('g', Items.GLASS_PANE).pattern("igi").pattern("iei").pattern("crc").unlockedBy("has_energy_core", has(MSItems.ENERGY_CORE9j)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.SERVER_DISK9j).define('d', MSItems.BLANK_DISK9j).define('c', MSItems.SBURB_CODE9j).pattern(" c ").pattern("cdc").pattern(" c ").unlockedBy("has_sburb_code", has(MSItems.SBURB_CODE9j)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.CLIENT_DISK9j).define('d', MSItems.BLANK_DISK9j).define('c', MSItems.SBURB_CODE9j).pattern("c c").pattern(" d ").pattern("c c").unlockedBy("has_sburb_code", has(MSItems.SBURB_CODE9j)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.MAILBOX9j).define('c', Ingredient.of(Tags.Items.CHESTS)).define('r', Ingredient.of(Tags.Items.RODS)).define('i', Items.IRON_INGOT).pattern("ici").pattern(" r ").pattern(" r ").unlockedBy("has_chest", has(Tags.Items.CHESTS)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.CAPTCHA_CARD9j).define('p', Items.PAPER).define('c', MSItems.RAW_CRUXITE9j).pattern("ppp").pattern("pcp").pattern("ppp").unlockedBy("has_raw_cruxite", has(MSItems.RAW_CRUXITE9j)).save(recipeBuilder);
		//TODO custom ingredient type to disallow punched cards or cards with items to be used here
		NonMirroredRecipeBuilder.nonMirroredRecipe(MSItems.STACK_MODUS_CARD9j).define('a', Ingredient.of(MSItems.CAPTCHA_CARD9j)).define('c', MSItems.RAW_CRUXITE9j).define('C', MSBlocks.CRUXITE_BLOCK.get()).pattern("Cac").unlockedBy("has_card", has(MSItems.CAPTCHA_CARD9j)).save(recipeBuilder);
		NonMirroredRecipeBuilder.nonMirroredRecipe(MSItems.QUEUE_MODUS_CARD9j).define('a', Ingredient.of(MSItems.CAPTCHA_CARD9j)).define('c', MSItems.RAW_CRUXITE9j).define('C', MSBlocks.CRUXITE_BLOCK.get()).pattern("caC").unlockedBy("has_card", has(MSItems.CAPTCHA_CARD9j)).save(recipeBuilder);
		
		ShapelessRecipeBuilder.shapeless(MSItems.BUG_ON_A_STICK9j, 3).requires(Ingredient.of(Tags.Items.RODS_WOODEN), 3).requires(MSItems.JAR_OF_BUGS9j).unlockedBy("has_jag_of_bugs", has(MSItems.JAR_OF_BUGS9j)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSItems.GRUB_SAUCE9j,3).define('p', Items.PAPER).define('b', MSTags.Items.BUGS).pattern("bbb").pattern("p p").pattern(" p ").unlockedBy("has_bugs", has(MSTags.Items.BUGS)).save(recipeBuilder);
		ShapelessRecipeBuilder.shapeless(MSItems.BUG_MAC9j, 2).requires(Items.BREAD, 1).requires(MSTags.Items.BUGS).requires(MSTags.Items.BUGS).requires(MSItems.FRENCH_FRY9j, 4).requires(MSItems.GRUB_SAUCE9j, 1).unlockedBy("has_grub_sauce", has(MSItems.GRUB_SAUCE9j)).save(recipeBuilder);
		ShapelessRecipeBuilder.shapeless(MSItems.SALAD9j).requires(Items.BOWL).requires(ItemTags.LEAVES).unlockedBy("has_bowl", has(Items.BOWL)).save(recipeBuilder);
		...
		ShapedRecipeBuilder.shaped(MSBlocks.WIRELESS_REDSTONE_TRANSMITTER.get()).define('e', MSItems.PLUTONIUM_CORE9j).define('i', Items.IRON_INGOT).define('c', Items.COMPARATOR).define('q', MSItems.COMPUTER_PARTS9j).pattern("cqc").pattern("iei").pattern("iii").unlockedBy("has_plutonium_core", has(MSItems.PLUTONIUM_CORE9j)).save(recipeBuilder);
		...
		ShapedRecipeBuilder.shaped(MSBlocks.ITEM_MAGNET.get()).define('e', MSItems.PLUTONIUM_CORE9j).define('i', Items.IRON_INGOT).define('r', Items.REDSTONE).define('g', Items.GLASS_PANE).pattern("iri").pattern("geg").pattern("iri").unlockedBy("has_plutonium_core", has(MSItems.PLUTONIUM_CORE9j)).save(recipeBuilder);
		...
		ShapedRecipeBuilder.shaped(MSBlocks.REMOTE_COMPARATOR.get()).define('e', MSItems.PLUTONIUM_CORE9j).define('o', Items.OBSERVER).define('i', Items.IRON_INGOT).define('c', Items.COMPARATOR).pattern("ici").pattern("oeo").pattern("iii").unlockedBy("has_plutonium_core", has(MSItems.PLUTONIUM_CORE9j)).save(recipeBuilder);
		...
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSItems.CAKE_MIX9j), Items.CAKE, 0.0F, 200).unlockedBy("has_cake_mix", has(MSItems.CAKE_MIX9j)).save(recipeBuilder, new ResourceLocation (Minestuck.MOD_ID, "cake_from_mix"));
		
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSTags.Items.CRUXITE_ORES), MSItems.RAW_CRUXITE9j, 0.2F, 200).unlockedBy("has_cruxite_ore", has(MSTags.Items.CRUXITE_ORES)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "raw_cruxite_from_smelting"));
		SimpleCookingRecipeBuilder.blasting(Ingredient.of(MSTags.Items.CRUXITE_ORES), MSItems.RAW_CRUXITE9j, 0.2F, 100).unlockedBy("has_cruxite_ore", has(MSTags.Items.CRUXITE_ORES)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "raw_cruxite_from_blasting"));
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSTags.Items.URANIUM_ORES), MSItems.RAW_URANIUM9j, 0.2F, 200).unlockedBy("has_uranium_ore", has(MSTags.Items.URANIUM_ORES)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "raw_uranium_from_smelting"));
		SimpleCookingRecipeBuilder.blasting(Ingredient.of(MSTags.Items.URANIUM_ORES), MSItems.RAW_URANIUM9j, 0.2F, 100).unlockedBy("has_uranium_ore", has(MSTags.Items.URANIUM_ORES)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "raw_uranium_from_blasting"));
		...
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.CRUXITE_DOWEL.get()), MSItems.RAW_CRUXITE9j, 0.0F, 200).unlockedBy("has_cruxite_dowel", has(MSBlocks.CRUXITE_DOWEL.get())).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "raw_cruxite_from_dowel"));
		...
		cookingRecipesFor(recipeBuilder, Ingredient.of(MSItems.BEEF_SWORD9j), MSItems.STEAK_SWORD9j, 0.5F, "has_beef_sword", has(MSItems.BEEF_SWORD9j));
		
		SimpleCookingRecipeBuilder.cooking(Ingredient.of(Items.BEEF), MSItems.IRRADIATED_STEAK9j, 0.2F, 20, MSRecipeTypes.IRRADIATING).unlockedBy("has_beef", has(Items.BEEF)).save(skipAdvancement(recipeBuilder));
		SimpleCookingRecipeBuilder.cooking(Ingredient.of(MSItems.BEEF_SWORD9j), MSItems.IRRADIATED_STEAK_SWORD9j, 0.35F, 20, MSRecipeTypes.IRRADIATING).unlockedBy("has_beef_sword", has(MSItems.BEEF_SWORD9j)).save(skipAdvancement(recipeBuilder));
		SimpleCookingRecipeBuilder.cooking(Ingredient.of(Items.STICK), MSItems.URANIUM_POWERED_STICK9j, 0.1F, 100, MSRecipeTypes.IRRADIATING).unlockedBy("has_stick", has(Items.STICK)).save(skipAdvancement(recipeBuilder));
