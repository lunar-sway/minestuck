...
public class MinestuckRecipeProvider extends RecipeProvider
{
	...
	protected void buildShapelessRecipes(Consumer<IFinishedRecipe> recipeBuilder)
	{
		...
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(Items.STONE_BRICKS), MSBlocks.PUSHABLE_BLOCK).unlocks("has_stone_bricks", has(Items.STONE_BRICKS)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "pushable_block_from_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(Items.STONE), MSBlocks.FRAGILE_STONE).unlocks("has_stone", has(Items.STONE)).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "fragile_stone_from_stone_stonecutting"));
	}
