...
public class MinestuckRecipeProvider extends RecipeProvider
{
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> recipeBuilder)
	{
		...
		ShapedRecipeBuilder.shapedRecipe(MSBlocks.STAT_STORER).key('t', Items.REDSTONE_TORCH).key('i', Items.IRON_INGOT).key('o', MSBlocks.REMOTE_OBSERVER).key('c', Items.COMPARATOR).key('r', Items.REDSTONE).patternLine("iri").patternLine("coc").patternLine("iti").addCriterion("has_plutonium_core", hasItem(MSItems.PLUTONIUM_CORE)).build(recipeBuilder);
		ShapedRecipeBuilder.shapedRecipe(MSBlocks.REMOTE_OBSERVER).key('e', MSItems.PLUTONIUM_CORE).key('i', Items.IRON_INGOT).key('o', Blocks.OBSERVER).key('r', Items.REDSTONE).patternLine("iri").patternLine("iei").patternLine("ioi").addCriterion("has_plutonium_core", hasItem(MSItems.PLUTONIUM_CORE)).build(recipeBuilder);
		ShapedRecipeBuilder.shapedRecipe(MSBlocks.WIRELESS_REDSTONE_TRANSMITTER, 2).key('e', MSItems.PLUTONIUM_CORE).key('i', Items.IRON_INGOT).key('r', Items.REDSTONE).key('q', Items.QUARTZ).patternLine("rqr").patternLine("iei").patternLine("iii").addCriterion("has_plutonium_core", hasItem(MSItems.PLUTONIUM_CORE)).build(recipeBuilder);
		ShapedRecipeBuilder.shapedRecipe(MSBlocks.WIRELESS_REDSTONE_RECEIVER, 2).key('c', Items.COMPARATOR).key('i', Items.IRON_INGOT).key('r', Items.REDSTONE).key('q', Items.QUARTZ).key('s', Tags.Items.STONE).patternLine("rqr").patternLine("scs").patternLine("ici").addCriterion("has_plutonium_core", hasItem(MSItems.PLUTONIUM_CORE)).build(recipeBuilder);
		...
		//ShapedRecipeBuilder.shapedRecipe(MSBlocks.AND_GATE_BLOCK).key('t', Items.REDSTONE_TORCH).key('s', Items.STONE).key('c', Items.COMPARATOR).key('r', Items.REDSTONE).patternLine("srs").patternLine("tct").patternLine("srs").addCriterion("has_redstone_torch", hasItem(Items.REDSTONE_TORCH)).build(recipeBuilder);
		//ShapedRecipeBuilder.shapedRecipe(MSBlocks.OR_GATE_BLOCK).key('t', Items.REDSTONE_TORCH).key('s', Items.STONE).key('r', Items.REDSTONE).patternLine("srs").patternLine("t t").patternLine("srs").addCriterion("has_redstone_torch", hasItem(Items.REDSTONE_TORCH)).build(recipeBuilder);
		//ShapedRecipeBuilder.shapedRecipe(MSBlocks.XOR_GATE_BLOCK).key('t', Items.REDSTONE_TORCH).key('s', Items.STONE).key('c', Items.COMPARATOR).key('r', Items.REDSTONE).patternLine("scs").patternLine("ttt").patternLine("srs").addCriterion("has_redstone_torch", hasItem(Items.REDSTONE_TORCH)).build(recipeBuilder);
		//ShapedRecipeBuilder.shapedRecipe(MSBlocks.NAND_GATE_BLOCK).key('s', Items.STONE).key('i', MSBlocks.INVERTER).key('r', Items.REDSTONE).patternLine("srs").patternLine("rir").patternLine("srs").addCriterion("has_redstone_torch", hasItem(Items.REDSTONE_TORCH)).build(recipeBuilder);
		//ShapedRecipeBuilder.shapedRecipe(MSBlocks.NOR_GATE_BLOCK).key('t', Items.REDSTONE_TORCH).key('s', Items.STONE).key('i', MSBlocks.INVERTER).key('r', Items.REDSTONE).patternLine("srs").patternLine("tit").patternLine("srs").addCriterion("has_redstone_torch", hasItem(Items.REDSTONE_TORCH)).build(recipeBuilder);
		//ShapedRecipeBuilder.shapedRecipe(MSBlocks.XNOR_GATE_BLOCK).key('c', Items.COMPARATOR).key('s', Items.STONE).key('i', MSBlocks.INVERTER).key('r', Items.REDSTONE).patternLine("srs").patternLine("cic").patternLine("srs").addCriterion("has_redstone_torch", hasItem(Items.REDSTONE_TORCH)).build(recipeBuilder);
