...
public class MinestuckRecipeProvider extends RecipeProvider
{
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> recipeBuilder)
	{
		...
		//ShapedRecipeBuilder.shapedRecipe(MSBlocks.NAND_GATE_BLOCK).key('s', Items.STONE).key('i', MSBlocks.INVERTER).key('r', Items.REDSTONE).patternLine("srs").patternLine("rir").patternLine("srs").addCriterion("has_inverter", hasItem(MSBlocks.INVERTER)).build(recipeBuilder);
		//ShapedRecipeBuilder.shapedRecipe(MSBlocks.NOR_GATE_BLOCK).key('t', Items.REDSTONE_TORCH).key('s', Items.STONE).key('i', MSBlocks.INVERTER).key('r', Items.REDSTONE).patternLine("srs").patternLine("tit").patternLine("srs").addCriterion("has_inverter", hasItem(MSBlocks.INVERTER)).build(recipeBuilder);
		//ShapedRecipeBuilder.shapedRecipe(MSBlocks.XNOR_GATE_BLOCK).key('c', Items.COMPARATOR).key('s', Items.STONE).key('i', MSBlocks.INVERTER).key('r', Items.REDSTONE).patternLine("srs").patternLine("cic").patternLine("srs").addCriterion("has_inverter", hasItem(MSBlocks.INVERTER)).build(recipeBuilder);
