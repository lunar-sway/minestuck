...
public class MinestuckRecipeProvider extends RecipeProvider
{
	...
	{
		ShapelessRecipeBuilder.shapeless(MSItems.RAW_CRUXITE, 9).requires(MSBlocks.CRUXITE_BLOCK.get()).unlockedBy("has_raw_cruxite", has(MSItems.RAW_CRUXITE)).unlockedBy("has_cruxite_block", has(MSBlocks.CRUXITE_BLOCK.get())).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "raw_cruxite_from_block"));
		ShapedRecipeBuilder.shaped(MSBlocks.CRUXITE_BLOCK.get()).define('#', MSItems.RAW_CRUXITE).pattern("###").pattern("###").pattern("###").unlockedBy("has_raw_cruxite", has(MSItems.RAW_CRUXITE)).save(recipeBuilder);
		ShapelessRecipeBuilder.shapeless(MSItems.RAW_URANIUM, 9).requires(MSBlocks.URANIUM_BLOCK.get()).unlockedBy("has__raw_uranium", has(MSItems.RAW_URANIUM)).unlockedBy("has_uranium_block", has(MSBlocks.URANIUM_BLOCK.get())).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "raw_uranium_from_block"));
		ShapedRecipeBuilder.shaped(MSBlocks.URANIUM_BLOCK.get()).define('#', MSItems.RAW_URANIUM).pattern("###").pattern("###").pattern("###").unlockedBy("has_raw_uranium", has(MSItems.RAW_URANIUM)).save(recipeBuilder);
		...
		ShapelessRecipeBuilder.shapeless(MSItems.STRAWBERRY_CHUNK, 4).requires(MSBlocks.STRAWBERRY.get()).unlockedBy("has_strawberry_chunks", has( MSItems.STRAWBERRY_CHUNK)).unlockedBy("has_strawberry_block", has(MSBlocks.STRAWBERRY.get())).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.STRAWBERRY.get()).define('#', MSItems.STRAWBERRY_CHUNK).pattern("##").pattern("##").unlockedBy("has_strawberry_chunks", has(MSItems.STRAWBERRY_CHUNK)).save(recipeBuilder);
		...
		ShapelessRecipeBuilder.shapeless(MSBlocks.MOSSY_COARSE_STONE.get()).requires(MSBlocks.COARSE_STONE_BRICKS.get()).requires(Items.VINE).unlockedBy("has_coarse_stone_bricks", has( MSBlocks.COARSE_STONE_BRICKS.get())).save(recipeBuilder);
		...
		ShapedRecipeBuilder.shaped(MSBlocks.BLACK_CASTLE_BRICK_STAIRS.get(), 4).define('#', MSBlocks.BLACK_CASTLE_BRICKS.get()).pattern("#  ").pattern("## ").pattern("###").unlockedBy("has_black_chess_bricks", has(MSBlocks.BLACK_CASTLE_BRICKS.get())).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.DARK_GRAY_CASTLE_BRICK_STAIRS.get(), 4).define('#', MSBlocks.DARK_GRAY_CASTLE_BRICKS.get()).pattern("#  ").pattern("## ").pattern("###").unlockedBy("has_dark_gray_chess_bricks", has(MSBlocks.DARK_GRAY_CASTLE_BRICKS.get())).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.LIGHT_GRAY_CASTLE_BRICK_STAIRS.get(), 4).define('#', MSBlocks.LIGHT_GRAY_CASTLE_BRICKS.get()).pattern("#  ").pattern("## ").pattern("###").unlockedBy("has_light_gray_chess_bricks", has(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS.get())).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.WHITE_CASTLE_BRICK_STAIRS.get(), 4).define('#', MSBlocks.WHITE_CASTLE_BRICKS.get()).pattern("#  ").pattern("## ").pattern("###").unlockedBy("has_white_chess_bricks", has(MSBlocks.WHITE_CASTLE_BRICKS.get())).save(recipeBuilder);
		...
		ShapedRecipeBuilder.shaped(MSBlocks.BLACK_CASTLE_BRICK_SLAB.get(), 6).define('#', MSBlocks.BLACK_CASTLE_BRICKS.get()).pattern("###").unlockedBy("has_black_chess_bricks", has(MSBlocks.BLACK_CASTLE_BRICKS.get())).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.DARK_GRAY_CASTLE_BRICK_SLAB.get(), 6).define('#', MSBlocks.DARK_GRAY_CASTLE_BRICKS.get()).pattern("###").unlockedBy("has_dark_gray_chess_bricks", has(MSBlocks.DARK_GRAY_CASTLE_BRICKS.get())).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.LIGHT_GRAY_CASTLE_BRICK_SLAB.get(), 6).define('#', MSBlocks.LIGHT_GRAY_CASTLE_BRICKS.get()).pattern("###").unlockedBy("has_light_gray_chess_bricks", has(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS.get())).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.WHITE_CASTLE_BRICK_SLAB.get(), 6).define('#', MSBlocks.WHITE_CASTLE_BRICKS.get()).pattern("###").unlockedBy("has_white_chess_bricks", has(MSBlocks.WHITE_CASTLE_BRICKS.get())).save(recipeBuilder);
		...
		ShapelessRecipeBuilder.shapeless(MSBlocks.COMPUTER.get()).requires(MSItems.ENERGY_CORE).requires(MSItems.COMPUTER_PARTS).unlockedBy("has_computer_parts", has(MSItems.COMPUTER_PARTS)).requires(Items.QUARTZ).requires(Items.REDSTONE).requires(MSItems.RAW_CRUXITE).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.URANIUM_COOKER.get()).define('e', MSItems.ENERGY_CORE).define('i', Tags.Items.INGOTS_IRON).define('F', Items.FURNACE).pattern("iii").pattern("iFi").pattern("iei").unlockedBy("has_energy_core", has(MSItems.ENERGY_CORE)).save(recipeBuilder);
		...
		NonMirroredRecipeBuilder.nonMirroredRecipe(MSItems.STACK_MODUS_CARD).define('a', Ingredient.of(MSItems.CAPTCHA_CARD)).define('c', MSItems.RAW_CRUXITE).define('C', MSBlocks.CRUXITE_BLOCK.get()).pattern("Cac").unlockedBy("has_card", has(MSItems.CAPTCHA_CARD)).save(recipeBuilder);
		NonMirroredRecipeBuilder.nonMirroredRecipe(MSItems.QUEUE_MODUS_CARD).define('a', Ingredient.of(MSItems.CAPTCHA_CARD)).define('c', MSItems.RAW_CRUXITE).define('C', MSBlocks.CRUXITE_BLOCK.get()).pattern("caC").unlockedBy("has_card", has(MSItems.CAPTCHA_CARD)).save(recipeBuilder);
		...
		ShapedRecipeBuilder.shaped(MSBlocks.WIRELESS_REDSTONE_TRANSMITTER.get()).define('e', MSItems.PLUTONIUM_CORE).define('i', Items.IRON_INGOT).define('c', Items.COMPARATOR).define('q', MSItems.COMPUTER_PARTS).pattern("cqc").pattern("iei").pattern("iii").unlockedBy("has_plutonium_core", has(MSItems.PLUTONIUM_CORE)).save(recipeBuilder);
		ShapedRecipeBuilder.shaped(MSBlocks.WIRELESS_REDSTONE_RECEIVER.get()).define('c', Items.COMPARATOR).define('i', Items.IRON_INGOT).define('r', Items.REDSTONE).define('q', Items.QUARTZ).define('s', Tags.Items.STONE).pattern("rqr").pattern("scs").pattern("ici").unlockedBy("has_plutonium_core", has(MSItems.PLUTONIUM_CORE)).save(recipeBuilder);
		...
		ShapedRecipeBuilder.shaped(MSBlocks.ITEM_MAGNET.get()).define('e', MSItems.PLUTONIUM_CORE).define('i', Items.IRON_INGOT).define('r', Items.REDSTONE).define('g', Items.GLASS_PANE).pattern("iri").pattern("geg").pattern("iri").unlockedBy("has_plutonium_core", has(MSItems.PLUTONIUM_CORE)).save(recipeBuilder);
		...
		ShapedRecipeBuilder.shaped(MSBlocks.REMOTE_COMPARATOR.get()).define('e', MSItems.PLUTONIUM_CORE).define('o', Items.OBSERVER).define('i', Items.IRON_INGOT).define('c', Items.COMPARATOR).pattern("ici").pattern("oeo").pattern("iii").unlockedBy("has_plutonium_core", has(MSItems.PLUTONIUM_CORE)).save(recipeBuilder);
		...
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MSBlocks.CRUXITE_DOWEL.get()), MSItems.RAW_CRUXITE, 0.0F, 200).unlockedBy("has_cruxite_dowel", has(MSBlocks.CRUXITE_DOWEL.get())).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "raw_cruxite_from_dowel"));
		...
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BLACK_CASTLE_BRICKS.get()), MSBlocks.BLACK_CASTLE_BRICK_STAIRS.get()).unlockedBy("has_black_chess_bricks", has(MSBlocks.BLACK_CASTLE_BRICKS.get())).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "black_chess_brick_stairs_from_black_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.DARK_GRAY_CASTLE_BRICKS.get()), MSBlocks.DARK_GRAY_CASTLE_BRICK_STAIRS.get()).unlockedBy("has_dark_gray_chess_bricks", has(MSBlocks.DARK_GRAY_CASTLE_BRICKS.get())).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "dark_gray_chess_brick_stairs_from_dark_gray_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS.get()), MSBlocks.LIGHT_GRAY_CASTLE_BRICK_STAIRS.get()).unlockedBy("has_light_gray_chess_bricks", has(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS.get())).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "light_gray_chess_brick_stairs_from_light_gray_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.WHITE_CASTLE_BRICKS.get()), MSBlocks.WHITE_CASTLE_BRICK_STAIRS.get()).unlockedBy("has_white_chess_bricks", has(MSBlocks.WHITE_CASTLE_BRICKS.get())).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "white_chess_brick_stairs_from_white_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.BLACK_CASTLE_BRICKS.get()), MSBlocks.BLACK_CASTLE_BRICK_SLAB.get(), 2).unlockedBy("has_black_chess_bricks", has(MSBlocks.BLACK_CASTLE_BRICKS.get())).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "black_chess_brick_slab_from_black_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.DARK_GRAY_CASTLE_BRICKS.get()), MSBlocks.DARK_GRAY_CASTLE_BRICK_SLAB.get(), 2).unlockedBy("has_dark_gray_chess_bricks", has(MSBlocks.DARK_GRAY_CASTLE_BRICKS.get())).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "dark_gray_chess_brick_slab_from_dark_gray_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS.get()), MSBlocks.LIGHT_GRAY_CASTLE_BRICK_SLAB.get(), 2).unlockedBy("has_light_gray_chess_bricks", has(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS.get())).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "light_gray_chess_brick_slab_from_light_gray_chess_bricks_stonecutting"));
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(MSBlocks.WHITE_CASTLE_BRICKS.get()), MSBlocks.WHITE_CASTLE_BRICK_SLAB.get(), 2).unlockedBy("has_white_chess_bricks", has(MSBlocks.WHITE_CASTLE_BRICKS.get())).save(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "white_chess_brick_slab_from_white_chess_bricks_stonecutting"));
