...
public class MinestuckRecipeProvider extends RecipeProvider
{
	...
	protected void buildShapelessRecipes(Consumer<IFinishedRecipe> recipeBuilder)
	{
		...
		ShapedRecipeBuilder.shapedRecipe(MSBlocks.SPIKES).key('#', Items.IRON_INGOT).key('n', Items.IRON_NUGGET).patternLine("n n").patternLine("# #").patternLine("###").addCriterion("has_iron_ingot", hasItem(Items.IRON_INGOT)).build(recipeBuilder);
		...
		ShapedRecipeBuilder.shapedRecipe(MSItems.DAGGER).key('i', Tags.Items.INGOTS_IRON).key('s', Tags.Items.RODS_WOODEN).patternLine("s").patternLine("i").patternLine("i").addCriterion("has_iron_ingot", hasItem(Tags.Items.INGOTS_IRON)).build(recipeBuilder);
		...
		ShapedRecipeBuilder.shapedRecipe(MSItems.PLUTONIUM_CORE).key('e', MSItems.ENERGY_CORE).key('i', Items.IRON_INGOT).key('n', Items.IRON_NUGGET).key('p', Items.ENDER_PEARL).patternLine("nin").patternLine("pep").patternLine("nin").addCriterion("has_energy_core", hasItem(MSItems.ENERGY_CORE)).build(recipeBuilder);
		...
		ShapedRecipeBuilder.shapedRecipe(MSBlocks.WIRELESS_REDSTONE_TRANSMITTER).key('e', MSItems.PLUTONIUM_CORE).key('i', Items.IRON_INGOT).key('c', Items.COMPARATOR).key('q', Items.QUARTZ).patternLine("cqc").patternLine("iei").patternLine("iii").addCriterion("has_plutonium_core", hasItem(MSItems.PLUTONIUM_CORE)).build(recipeBuilder);
		ShapedRecipeBuilder.shapedRecipe(MSBlocks.WIRELESS_REDSTONE_RECEIVER).key('c', Items.COMPARATOR).key('i', Items.IRON_INGOT).key('r', Items.REDSTONE).key('q', Items.QUARTZ).key('s', Tags.Items.STONE).patternLine("rqr").patternLine("scs").patternLine("ici").addCriterion("has_plutonium_core", hasItem(MSItems.PLUTONIUM_CORE)).build(recipeBuilder);
		ShapedRecipeBuilder.shapedRecipe(MSBlocks.SOLID_SWITCH, 2).key('g', Items.GLOWSTONE).key('i', Items.IRON_INGOT).key('r', Items.REDSTONE).patternLine("iri").patternLine("rgr").patternLine("iri").addCriterion("has_glowstone", hasItem(Items.GLOWSTONE)).build(recipeBuilder);
		ShapelessRecipeBuilder.shapelessRecipe(MSBlocks.VARIABLE_SOLID_SWITCH).addIngredient(MSBlocks.SOLID_SWITCH).addIngredient(Items.COMPARATOR).addCriterion("has_solid_switch", hasItem(MSBlocks.SOLID_SWITCH)).build(recipeBuilder);
		ShapelessRecipeBuilder.shapelessRecipe(MSBlocks.ONE_SECOND_INTERVAL_TIMED_SOLID_SWITCH).addIngredient(MSBlocks.SOLID_SWITCH).addIngredient(Items.CLOCK).addIngredient(Items.REPEATER).addCriterion("has_solid_switch", hasItem(MSBlocks.SOLID_SWITCH)).build(recipeBuilder);
		ShapelessRecipeBuilder.shapelessRecipe(MSBlocks.TWO_SECOND_INTERVAL_TIMED_SOLID_SWITCH).addIngredient(MSBlocks.SOLID_SWITCH).addIngredient(Items.CLOCK).addIngredient(Items.REPEATER).addIngredient(Items.REPEATER).addCriterion("has_solid_switch", hasItem(MSBlocks.SOLID_SWITCH)).build(recipeBuilder);
		ShapedRecipeBuilder.shapedRecipe(MSBlocks.ITEM_MAGNET).key('e', MSItems.PLUTONIUM_CORE).key('i', Items.IRON_INGOT).key('r', Items.REDSTONE).patternLine("iri").patternLine("iei").patternLine("iri").addCriterion("has_plutonium_core", hasItem(MSItems.PLUTONIUM_CORE)).build(recipeBuilder);
		ShapedRecipeBuilder.shapedRecipe(MSBlocks.REDSTONE_CLOCK).key('c', Items.CLOCK).key('i', Items.IRON_INGOT).key('r', Items.REPEATER).key('q', Items.QUARTZ).key('P', ItemTags.PLANKS).patternLine("PiP").patternLine("rcr").patternLine("PqP").addCriterion("has_clock", hasItem(Items.CLOCK)).build(recipeBuilder);
