...
public class MinestuckRecipeProvider extends RecipeProvider
{
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> recipeBuilder)
	{
		...
		ShapedRecipeBuilder.shapedRecipe(MSBlocks.WIRELESS_REDSTONE_TRANSMITTER).key('e', MSItems.PLUTONIUM_CORE).key('i', Items.IRON_INGOT).key('r', Items.REDSTONE).key('q', Items.QUARTZ).patternLine("rqr").patternLine("iei").patternLine("iii").addCriterion("has_plutonium_core", hasItem(MSItems.PLUTONIUM_CORE)).build(recipeBuilder);
		...
		ShapedRecipeBuilder.shapedRecipe(MSBlocks.SOLID_SWITCH).key('g', Items.GLOWSTONE).key('i', Items.IRON_INGOT).key('r', Items.REDSTONE).patternLine("iri").patternLine("rgr").patternLine("iri").addCriterion("has_glowstone", hasItem(Items.GLOWSTONE)).build(recipeBuilder);
