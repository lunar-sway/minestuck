...
public final class ConsortDialogueProvider extends DialogueProvider
{
	...
	private void consortDialogues()
	{
		...
		addRandomlySelectable("immortality_herb", defaultWeight(all(isInTerrain(FLORA), Condition.FirstTimeGenerating.INSTANCE)).withKeepOnReset(), new ChainBuilder().withFolders()
