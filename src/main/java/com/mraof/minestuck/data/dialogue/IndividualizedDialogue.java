		...
		provider.getLookupProvider().thenCompose(providerIt ->
		{
			provider.add("kernelsprite", new FolderedDialogue(builder -> {
				...
				var blank = builder.add("blank", new NodeSelectorBuilder()
						.node(isNearBlock(MSBlocks.CRUXTRUDER.TUBE.get(), 22, 1), kernelspriteNode(l,
				...
				var helpEntering7 = builder.add("help_entering.7", new NodeSelectorBuilder()
						.node(playerHasItemTag(MSTags.Items.CRUXITE_ARTIFACTS, 1), kernelspriteNode(l,
								...
								.addResponse(new ResponseBuilder(l.subMsg("thanks_for_help", "Thank you for helping me"))
										.addTrigger(new GoToBlock(BlockPredicate.Builder.block().of(MSBlocks.CRUXTRUDER.TUBE.get()).build(), 22, 1, 240, 1, 6, true))
										.setNextAsEntrypoint()
										.nextDialogue(blank)
								)
				...
				var helpEntering6 = builder.add("help_entering.6", kernelspriteNode(l,
						...
						.addResponse(new ResponseBuilder(l.subMsg("next", "What's next?"))
								...
								.addTrigger(new GoToBlock(BlockPredicate.Builder.block().of(MSBlocks.ALCHEMITER.CENTER.get()).build(), 22, 1, 240, 1, 6, true))
				...
				var helpEntering5 = builder.add("help_entering.5", new NodeSelectorBuilder()
						.node(isNearBlock(MSBlocks.ALCHEMITER.TOTEM_PAD.get(), 22, 1), kernelspriteNode(l,
				...
				var helpEntering4 = builder.add("help_entering.4", kernelspriteNode(l,
						...
						.addResponse(new ResponseBuilder(l.subMsg("next", "What's next?"))
								.addPlayerMessage(l.subMsg("next_player", "What's next?"))
								.addTrigger(new GoToBlock(BlockPredicate.Builder.block().of(MSBlocks.ALCHEMITER.TOTEM_PAD.get()).build(), 22, 1, 240, 1, 6, true))
				...
				var helpEntering3 = builder.add("help_entering.3", kernelspriteNode(l,
						...
						.addResponse(new ResponseBuilder(l.subMsg("next", "What's next?"))
								.addPlayerMessage(l.subMsg("next_player", "What's next?"))
								.addTrigger(new GoToBlock(BlockPredicate.Builder.block().of(MSBlocks.TOTEM_LATHE.TOP.get()).build(), 22, 1, 240, 1, 6, true))
				...
				var helpEntering2 = builder.add("help_entering.2", new NodeSelectorBuilder()
						.node(isNearBlock(MSBlocks.TOTEM_LATHE.WHEEL.get(), 22, 1), kernelspriteNode(l,
								...
								.addResponse(new ResponseBuilder(l.subMsg("next", "What's next?"))
										.addPlayerMessage(l.subMsg("next_player", "What's next?"))
										.addTrigger(new GoToBlock(BlockPredicate.Builder.block().of(MSBlocks.TOTEM_LATHE.TOP_CORNER.get()).build(), 22, 1, 240, 1, 6, true))
				...
				var helpEntering = builder.add("help_entering.1", kernelspriteNode(l,
						...
						.addResponse(new ResponseBuilder(l.subMsg("next", "What's next?"))
								.addPlayerMessage(l.subMsg("next_player", "What's next?"))
								.addTrigger(new GoToBlock(BlockPredicate.Builder.block().of(MSBlocks.TOTEM_LATHE.WHEEL.get()).build(), 22, 1, 240, 1, 6, true))
				...
				var whatSay = builder.add("what_say", new NodeSelectorBuilder()
						.node(isNearBlock(MSBlocks.CRUXTRUDER.TUBE.get(), 22, 1), kernelspriteNode(l, "near_block",
