	...
	private static void dialogues(DialogueProvider provider, DialogueLangHelper l)
	{
		provider.getLookupProvider().thenCompose(providerIt ->
		{
			provider.add("kernelsprite", new FolderedDialogue(builder -> {
				...
				var thanks = builder.add("thanks", kernelspriteNode(l,
				...
				var helpEntering7 = builder.add("help_entering.7", new NodeSelectorBuilder()
						.node(playerHasItemTag(MSTags.Items.CRUXITE_ARTIFACTS, 1), kernelspriteNode(l,
								...
								.addResponse(new ResponseBuilder(l.subMsg("thanks_for_help", "Thank you for helping me")).nextDialogue(thanks))
								.addResponse(returnDialogue))
				...
				var helpEntering6 = builder.add("help_entering.6", kernelspriteNode(l,
						...
						.addResponse(new ResponseBuilder(l.subMsg("next", "What's next?"))
								...
								.addTrigger(new GoToBlock(BlockPredicate.Builder.block().of(MSBlocks.ALCHEMITER.CENTER.get()).build(), 24, 1, 240, 1, 6, false))
				...
				var helpEntering5 = builder.add("help_entering.5", new NodeSelectorBuilder()
						.node(isNearBlock(MSBlocks.ALCHEMITER.TOTEM_PAD.get(), 24, 1), kernelspriteNode(l,
								...
								.addResponse(new ResponseBuilder(l.subMsg("next", "What's next?"))
										.addPlayerMessage(l.subMsg("next_player", "What's next?"))
										.addTrigger(new GoToBlock(BlockPredicate.Builder.block().of(MSBlocks.ALCHEMITER.TOTEM_PAD.get()).build(), 24, 1, 240, 1, 6, false))
				...
				var helpEntering4 = builder.add("help_entering.4", kernelspriteNode(l,
						...
						.addResponse(new ResponseBuilder(l.subMsg("next", "What's next?"))
								.addPlayerMessage(l.subMsg("next_player", "What's next?"))
								.addTrigger(new GoToBlock(BlockPredicate.Builder.block().of(MSBlocks.TOTEM_LATHE.TOP.get()).build(), 24, 1, 240, 1, 6, false))
				...
				var helpEntering3 = builder.add("help_entering.3", kernelspriteNode(l,
						...
						.addResponse(new ResponseBuilder(l.subMsg("next", "What's next?"))
								.addPlayerMessage(l.subMsg("next_player", "What's next?"))
								.addTrigger(new GoToBlock(BlockPredicate.Builder.block().of(MSBlocks.TOTEM_LATHE.CARD_SLOT.get()).build(), 24, 1, 240, 1, 6, false))
				...
				var helpEntering2 = builder.add("help_entering.2", new NodeSelectorBuilder()
						.node(isNearBlock(MSBlocks.TOTEM_LATHE.TOP.get(), 24, 1), kernelspriteNode(l,
				...
				var whatSay = builder.add("what_say", new NodeSelectorBuilder()
						.node(isNearBlock(MSBlocks.CRUXTRUDER.TUBE.get(), 24, 1), kernelspriteNode(l, "near_block",
								...
								.addResponse(new ResponseBuilder(l.subMsg("help_entering", "Can you help me use that machine?"))
										...
										.addTrigger(new GoToBlock(BlockPredicate.Builder.block().of(MSBlocks.CRUXTRUDER.TUBE.get()).build(), 24, 1, 240, 1, 6, false))
				...
				builder.addStart(
						...
						.defaultNode(kernelspriteNode(l, "default",
								"Kernelsprite initialized. Please input command.", "It sounds like static, but it sounds like it is talking.")
								.addResponse(new ResponseBuilder(l.subMsg("what_kernel", "What are you?")).nextDialogue(whatKernel))
								.addResponse(new ResponseBuilder(l.subMsg("go_home", "Can you please go somewhere else?"))
										...
										.addTrigger(new GoToBlock(BlockPredicate.Builder.block().of(MSBlocks.CRUXTRUDER.TUBE.get()).build(), 24, 0.5, 360, 1, 4, true)))
								.addResponse(new ResponseBuilder(l.subMsg("go_free", "You don't have to hang out near the Cruxtruder"))
