...
public class MinestuckFrFrLanguageProvider extends MinestuckLanguageProvider
{
	...
	{
		add(MSBlocks.BLACK_CHESS_DIRT, "Carreau d'échecs noir");
		add(MSBlocks.WHITE_CHESS_DIRT, "Carreau d'échecs blanche");
		add(MSBlocks.DARK_GRAY_CHESS_DIRT, "Carreau d'échecs gris foncé");
		add(MSBlocks.LIGHT_GRAY_CHESS_DIRT, "Carreau d'échecs gris clair");
		...
		add(MSBlocks.CHISELED_COARSE_STONE, "Roche grossière taillé");
		add(MSBlocks.SHADE_BRICKS, "Pierre d'ombre taillée");
		add(MSBlocks.SMOOTH_SHADE_STONE, "Roche d'ombre");
		...
		add(MSBlocks.CHISELED_CAST_IRON, "Fonte taillé");
		add(MSBlocks.MYCELIUM_BRICKS, "Briques de Mycélium");
		...
		add(MSBlocks.TREATED_PLANKS, "Planches traité");
		...
		addExtra(MSItems.CASSETTE_DANCE_STAB, "desc", "C418 - Catboss - Dance-Stab-Dance");
		add(MSItems.CASSETTE_EMISSARY, "Cassette");
		addExtra(MSItems.CASSETTE_EMISSARY, "desc", "C418 - Catboss - Emissary of Dance");
