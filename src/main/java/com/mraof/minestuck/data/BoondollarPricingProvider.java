...
public class BoondollarPricingProvider implements DataProvider
{
	...
	protected void registerPricings()
	{
		...
		add(MSBlocks.GLOWING_MUSHROOM.get(), 10, 15);
		add(MSBlocks.COLD_CAKE.get(), 400);
		add(MSBlocks.BLUE_CAKE.get(), 400);
		add(MSBlocks.HOT_CAKE.get(), 400);
		add(MSBlocks.RED_CAKE.get(), 400);
		add(MSBlocks.FUCHSIA_CAKE.get(), 1500);
		...
		add(MSBlocks.GOLD_SEEDS.get(), 300, 400);
		add(MSBlocks.APPLE_CAKE.get(), 100, 140);
		...
		add(MSBlocks.MINI_FROG_STATUE.get(), 200, 250);
		add(MSBlocks.MINI_WIZARD_STATUE.get(), 200, 250);
		add(MSBlocks.MINI_TYPHEUS_STATUE.get(), 10000, 12000);
		...
		add(MSBlocks.GLOWYSTONE_DUST.get(), 20, 40);
		add(IRON_CANE.get(), 300, 400);
		add(MSBlocks.GLOWING_LOG.get(), 20, 32);
		add(MSBlocks.GLOWING_PLANKS.get(), 5, 8);
		add(MSBlocks.COARSE_STONE.get(), 5, 8);
		add(MSBlocks.CHISELED_COARSE_STONE.get(), 8, 15);
		add(MSBlocks.SHADE_BRICKS.get(), 5, 8);
		add(MSBlocks.SMOOTH_SHADE_STONE.get(), 5, 8);
		add(MSBlocks.FROST_BRICKS.get(), 5, 8);
		add(MSBlocks.FROST_TILE.get(), 5, 8);
		add(MSBlocks.CAST_IRON.get(), 5, 8);
		add(MSBlocks.CHISELED_CAST_IRON.get(), 8, 15);
		add(MSBlocks.VINE_LOG.get(), 20, 32);
		add(MSBlocks.FLOWERY_VINE_LOG.get(), 25, 40);
		add(MSBlocks.FROST_LOG.get(), 20, 32);
		add(MSBlocks.WOODEN_CACTUS.get(), 50, 60);
		add(MSBlocks.SUGAR_CUBE.get(), 200, 240);
