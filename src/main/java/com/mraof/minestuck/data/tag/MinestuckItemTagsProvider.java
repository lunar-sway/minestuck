...
public class MinestuckItemTagsProvider extends ItemTagsProvider
{
	...
	protected void addTags(HolderLookup.Provider provider)
	{
		...
		tag(WEAPONS).addTag(KIND_SWORD).addTag(KIND_HALF_SWORD).addTag(KIND_BOW).addTag(KIND_HAMMER).addTag(KIND_CANE).addTag(KIND_CLUB).addTag(KIND_SICKLE).addTag(KIND_SAW).addTag(KIND_PICKAXE).addTag(KIND_AXE).addTag(KIND_HOE).addTag(KIND_SHOVEL);
		...
		tag(KIND_SAW).add(LIPSTICK_CHAINSAW.get(), CAKESAW.get(), MAGENTA_MAULER.get(), THISTLEBLOWER.get(), HAND_CRANKED_VAMPIRE_ERASER.get(), EMERALD_IMMOLATOR.get(), OBSIDIATOR.get(), DEVILS_DELIGHT.get(), DEMONBANE_RAGRIPPER.get(), FROSTTOOTH.get());
