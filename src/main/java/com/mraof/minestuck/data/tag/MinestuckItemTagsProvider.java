...
public class MinestuckItemTagsProvider extends ItemTagsProvider
{
	...
	protected void addTags(HolderLookup.Provider provider)
	{
		...
		tag(HEAD_ARMOR).add(PRISMARINE_HELMET.get(), IRON_LASS_GLASSES.get(), PROSPIT_CIRCLET.get(), DERSE_CIRCLET.get(), AMPHIBEANIE.get(), NOSTRILDAMUS.get(), PONYTAIL.get(), ANOMALOCARIS_HAT.get());
