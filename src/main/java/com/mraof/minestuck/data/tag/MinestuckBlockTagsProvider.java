...
public final class MinestuckBlockTagsProvider extends BlockTagsProvider
{
	...
	protected void addTags(HolderLookup.Provider provider)
	{
		...
		tag(MINEABLE_WITH_AXE).add(RAINBOW_LOG.get(), RAINBOW_WOOD.get(), RAINBOW_PLANKS.get(), RAINBOW_BUTTON.get(), RAINBOW_FENCE.get(), RAINBOW_FENCE_GATE.get(), RAINBOW_PRESSURE_PLATE.get(), RAINBOW_SLAB.get(), RAINBOW_STAIRS.get());
		tag(MINEABLE_WITH_AXE).add(END_LOG.get(), END_WOOD.get(), END_PLANKS.get(), END_BUTTON.get(), END_FENCE.get(), END_FENCE_GATE.get(), END_PRESSURE_PLATE.get(), END_SLAB.get(), END_STAIRS.get());
		tag(MINEABLE_WITH_AXE).add(VINE_LOG.get(), VINE_WOOD.get());
		tag(MINEABLE_WITH_AXE).add(FLOWERY_VINE_LOG.get(), FLOWERY_VINE_WOOD.get());
		tag(MINEABLE_WITH_AXE).add(DEAD_LOG.get(), DEAD_WOOD.get(), DEAD_PLANKS.get(), DEAD_BUTTON.get(), DEAD_FENCE.get(), DEAD_FENCE_GATE.get(), DEAD_PRESSURE_PLATE.get(), DEAD_SLAB.get(), DEAD_STAIRS.get());
		tag(MINEABLE_WITH_AXE).add(PETRIFIED_LOG.get(), PETRIFIED_WOOD.get());
		tag(MINEABLE_WITH_AXE).add(TREATED_PLANKS.get(), TREATED_BUTTON.get(), TREATED_FENCE.get(), TREATED_FENCE_GATE.get(), TREATED_PRESSURE_PLATE.get(), TREATED_SLAB.get(), TREATED_STAIRS.get());
