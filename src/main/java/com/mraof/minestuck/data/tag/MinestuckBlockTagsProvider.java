...
public final class MinestuckBlockTagsProvider extends BlockTagsProvider
{
	...
	protected void addTags(HolderLookup.Provider provider)
	{
		...
		needsWoodPickaxe(CRUXITE_BLOCK.get(), CRUXITE_STAIRS.get(), CRUXITE_SLAB.get(), CRUXITE_WALL.get(), CRUXITE_BUTTON.get(), CRUXITE_PRESSURE_PLATE.get(),
				POLISHED_CRUXITE_BLOCK.get(), POLISHED_CRUXITE_STAIRS.get(), POLISHED_CRUXITE_SLAB.get(), POLISHED_CRUXITE_WALL.get(), CRUXITE_BRICKS.get(), CRUXITE_BRICK_STAIRS.get(), CRUXITE_BRICK_SLAB.get(), CRUXITE_BRICK_WALL.get(),
				SMOOTH_CRUXITE_BLOCK.get(), CHISELED_CRUXITE_BLOCK.get(), CRUXITE_PILLAR.get());
		tag(MINEABLE_WITH_PICKAXE).add(CRUXITE_LAMP.get());
		needsWoodPickaxe(URANIUM_BLOCK.get(), URANIUM_STAIRS.get(), URANIUM_SLAB.get(), URANIUM_WALL.get(), URANIUM_BUTTON.get(), URANIUM_PRESSURE_PLATE.get());
		tag(MINEABLE_WITH_PICKAXE).add(GENERIC_OBJECT.get(), PERFECTLY_GENERIC_STAIRS.get(), PERFECTLY_GENERIC_SLAB.get(), PERFECTLY_GENERIC_WALL.get(), PERFECTLY_GENERIC_FENCE.get(), PERFECTLY_GENERIC_FENCE_GATE.get(), PERFECTLY_GENERIC_BUTTON.get(),
				PERFECTLY_GENERIC_PRESSURE_PLATE.get(), PERFECTLY_GENERIC_SIGN.get(), PERFECTLY_GENERIC_WALL_SIGN.get(), PERFECTLY_GENERIC_HANGING_SIGN.get(), PERFECTLY_GENERIC_WALL_HANGING_SIGN.get());
		
		needsWoodPickaxe(METEORIC_STONE.get());
		...
		needsWoodPickaxe(BLACK_STONE.get(), POLISHED_BLACK_STONE.get(), BLACK_COBBLESTONE.get(), BLACK_STONE_BRICKS.get(), BLACK_STONE_COLUMN.get(), CRACKED_BLACK_STONE_BRICKS.get(),
				MAGMATIC_BLACK_STONE_BRICKS.get(), MAGMATIC_BLACK_STONE_BRICK_SLAB.get(), MAGMATIC_BLACK_STONE_BRICK_STAIRS.get(), CHISELED_BLACK_STONE_BRICKS.get(), BLACK_COBBLESTONE_SLAB.get(), BLACK_COBBLESTONE_STAIRS.get(), BLACK_COBBLESTONE_WALL.get(),
				BLACK_STONE_BRICK_WALL.get(), BLACK_STONE_STAIRS.get(), BLACK_STONE_SLAB.get(), BLACK_STONE_BUTTON.get(), BLACK_STONE_PRESSURE_PLATE.get(), BLACK_STONE_WALL.get(), BLACK_STONE_BRICK_STAIRS.get(), BLACK_STONE_BRICK_SLAB.get(), POLISHED_BLACK_STONE_SLAB.get(), POLISHED_BLACK_STONE_STAIRS.get(), POLISHED_BLACK_STONE_WALL.get());
		tag(MINEABLE_WITH_SHOVEL).add(BLACK_SAND.get());
		needsWoodPickaxe(DECREPIT_STONE_BRICKS.get(), FLOWERY_MOSSY_COBBLESTONE.get(), MOSSY_DECREPIT_STONE_BRICKS.get(), FLOWERY_MOSSY_STONE_BRICKS.get(), FLOWERY_MOSSY_STONE_BRICK_STAIRS.get(), FLOWERY_MOSSY_STONE_BRICK_WALL.get());
		...
		needsWoodPickaxe(IGNEOUS_STONE.get(), IGNEOUS_STONE_SLAB.get(), IGNEOUS_STONE_STAIRS.get(), POLISHED_IGNEOUS_STONE.get(), POLISHED_IGNEOUS_BRICKS.get(), POLISHED_IGNEOUS_PILLAR.get(), POLISHED_IGNEOUS_SLAB.get(), POLISHED_IGNEOUS_STAIRS.get(), CRACKED_POLISHED_IGNEOUS_BRICKS.get(),
				MAGMATIC_POLISHED_IGNEOUS_BRICKS.get(), CHISELED_IGNEOUS_STONE.get(), POLISHED_IGNEOUS_BRICK_WALL.get(), MAGMATIC_POLISHED_IGNEOUS_BRICK_WALL.get(), POLISHED_IGNEOUS_BRICK_SLAB.get(), MAGMATIC_POLISHED_IGNEOUS_BRICK_SLAB.get(), POLISHED_IGNEOUS_BRICK_STAIRS.get(), MAGMATIC_POLISHED_IGNEOUS_BRICK_STAIRS.get(), IGNEOUS_STONE_BUTTON.get(),
		...
		tag(MINEABLE_WITH_PICKAXE).add(POWER_HUB.get());
