...
public class MinestuckBlockTagsProvider extends BlockTagsProvider
{
	...
	{
		tag(PLANKS).add(GLOWING_PLANKS.get(), FROST_PLANKS.get(), RAINBOW_PLANKS.get(), END_PLANKS.get(), DEAD_PLANKS.get(), TREATED_PLANKS.get(), SHADEWOOD_PLANKS.get()).addTag(ASPECT_PLANKS);
		...
		tag(MINEABLE_WITH_AXE).add(SHADEWOOD_LOG.get(), SCARRED_SHADEWOOD_LOG.get(), ROTTED_SHADEWOOD_LOG.get(), SHADEWOOD_PLANKS.get());
		...
		tag(SHADEWOOD_LOGS).add(SHADEWOOD_LOG.get(), SCARRED_SHADEWOOD_LOG.get(),ROTTED_SHADEWOOD_LOG.get());
