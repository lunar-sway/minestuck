...
public final class MinestuckBlockTagsProvider extends BlockTagsProvider
{
	...
	protected void addTags(HolderLookup.Provider provider)
	{
		...
		tag(WOODEN_STAIRS).add(RAINBOW_PLANKS_STAIRS.get(), END_PLANKS_STAIRS.get(), DEAD_PLANKS_STAIRS.get(), CARVED_STAIRS.get(),  TREATED_PLANKS_STAIRS.get(), LACQUERED_STAIRS.get());
		tag(WOODEN_SLABS).add(RAINBOW_PLANKS_SLAB.get(), END_PLANKS_SLAB.get(), DEAD_PLANKS_SLAB.get(), CARVED_SLAB.get(), TREATED_PLANKS_SLAB.get(), LACQUERED_SLAB.get());
		...
		tag(MINEABLE_WITH_AXE).add(UNCARVED_WOOD_IRON_ORE.get(), UNCARVED_WOOD_REDSTONE_ORE.get(), UNCARVED_WOOD_EMERALD_ORE.get());
		tag(NEEDS_STONE_TOOL).add(UNCARVED_WOOD_IRON_ORE.get());
