...
public final class MinestuckBlockTagsProvider extends BlockTagsProvider
{
	...
	protected void addTags(HolderLookup.Provider provider)
	{
		...
		tag(MINEABLE_WITH_SHOVEL).add(BLACK_CHESS_DIRT.get(), WHITE_CHESS_DIRT.get(), DARK_GRAY_CHESS_DIRT.get(), LIGHT_GRAY_CHESS_DIRT.get(), BLUE_DIRT.get(), THOUGHT_DIRT.get());
		...
		tag(WALLS).add(BLACK_CHESS_BRICK_SMOOTH_WALL.get(), BLACK_CHESS_BRICK_WALL.get(), DARK_GRAY_CHESS_BRICK_SMOOTH_WALL.get(), DARK_GRAY_CHESS_BRICK_WALL.get(), LIGHT_GRAY_CHESS_BRICK_SMOOTH_WALL.get(), LIGHT_GRAY_CHESS_BRICK_WALL.get(), WHITE_CHESS_BRICK_SMOOTH_WALL.get(), WHITE_CHESS_BRICK_WALL.get(),
				BLACK_COBBLESTONE_WALL.get(), BLACK_STONE_BRICK_WALL.get(), BLACK_STONE_WALL.get(), POLISHED_BLACK_STONE_WALL.get(),
