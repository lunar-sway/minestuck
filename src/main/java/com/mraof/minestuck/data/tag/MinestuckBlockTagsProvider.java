...
public final class MinestuckBlockTagsProvider extends BlockTagsProvider
{
	...
	protected void addTags(HolderLookup.Provider provider)
	{
		...
		tag(STAIRS).add(BLACK_CHESS_BRICK_STAIRS.get(), DARK_GRAY_CHESS_BRICK_STAIRS.get(), LIGHT_GRAY_CHESS_BRICK_STAIRS.get(), WHITE_CHESS_BRICK_STAIRS.get(), COARSE_STONE_STAIRS.get(), COARSE_STONE_BRICK_STAIRS.get(), SHADE_STAIRS.get(), SHADE_BRICK_STAIRS.get(), FROST_TILE_STAIRS.get(), FROST_BRICK_STAIRS.get(), CAST_IRON_STAIRS.get(), BLACK_STONE_STAIRS.get(), BLACK_STONE_BRICK_STAIRS.get(), MAGMATIC_BLACK_STONE_BRICK_STAIRS.get(), IGNEOUS_STONE_STAIRS.get(), POLISHED_IGNEOUS_STAIRS.get(), POLISHED_IGNEOUS_BRICK_STAIRS.get(), MAGMATIC_POLISHED_IGNEOUS_BRICK_STAIRS.get(), MYCELIUM_STAIRS.get(), MYCELIUM_BRICK_STAIRS.get(), CHALK_STAIRS.get(), CHALK_BRICK_STAIRS.get(), PINK_STONE_BRICK_STAIRS.get(), BROWN_STONE_BRICK_STAIRS.get(), GREEN_STONE_BRICK_STAIRS.get(), FLOWERY_MOSSY_STONE_BRICK_STAIRS.get());
		tag(SLABS).add(COARSE_STONE_SLAB.get(), COARSE_STONE_BRICK_SLAB.get(), BLACK_CHESS_BRICK_SLAB.get(), DARK_GRAY_CHESS_BRICK_SLAB.get(), LIGHT_GRAY_CHESS_BRICK_SLAB.get(), WHITE_CHESS_BRICK_SLAB.get(), CHALK_SLAB.get(), CHALK_BRICK_SLAB.get(), PINK_STONE_BRICK_SLAB.get(), BROWN_STONE_BRICK_SLAB.get(), GREEN_STONE_BRICK_SLAB.get(), BLACK_STONE_SLAB.get(), BLACK_STONE_BRICK_SLAB.get(), MAGMATIC_BLACK_STONE_BRICK_SLAB.get(), IGNEOUS_STONE_SLAB.get(), POLISHED_IGNEOUS_SLAB.get(), POLISHED_IGNEOUS_BRICK_SLAB.get(), MAGMATIC_POLISHED_IGNEOUS_BRICK_SLAB.get(), MYCELIUM_SLAB.get(), MYCELIUM_BRICK_SLAB.get(), FLOWERY_MOSSY_STONE_BRICK_SLAB.get(), FROST_TILE_SLAB.get(), FROST_BRICK_SLAB.get(), SHADE_SLAB.get(), SHADE_BRICK_SLAB.get());
		...
		needsWoodPickaxe(CAST_IRON.get(), CHISELED_CAST_IRON.get(), CAST_IRON_BUTTON.get(), CAST_IRON_PRESSURE_PLATE.get(), CAST_IRON_STAIRS.get(), CAST_IRON_SLAB.get(), CAST_IRON_WALL.get(), CAST_IRON_FRAME.get(), CAST_IRON_TILE.get(), CAST_IRON_TILE_STAIRS.get(), CAST_IRON_TILE_SLAB.get(), CAST_IRON_SHEET.get(), CAST_IRON_SHEET_STAIRS.get(), CAST_IRON_SHEET_SLAB.get());
		...
		needsWoodPickaxe(BLACK_STONE.get(), POLISHED_BLACK_STONE.get(), BLACK_COBBLESTONE.get(), BLACK_STONE_BRICKS.get(), BLACK_STONE_COLUMN.get(), CRACKED_BLACK_STONE_BRICKS.get(), MAGMATIC_BLACK_STONE_BRICKS.get(), CHISELED_BLACK_STONE_BRICKS.get(), BLACK_COBBLESTONE_SLAB.get(), BLACK_COBBLESTONE_STAIRS.get(), BLACK_COBBLESTONE_WALL.get(), BLACK_STONE_BRICK_WALL.get(), BLACK_STONE_BUTTON.get(), BLACK_STONE_PRESSURE_PLATE.get(), BLACK_STONE_WALL.get(), POLISHED_BLACK_STONE_SLAB.get(), POLISHED_BLACK_STONE_STAIRS.get(), POLISHED_BLACK_STONE_WALL.get());
		...
		needsWoodPickaxe(IGNEOUS_STONE.get(), POLISHED_IGNEOUS_STONE.get(), POLISHED_IGNEOUS_BRICKS.get(), POLISHED_IGNEOUS_PILLAR.get(), CRACKED_POLISHED_IGNEOUS_BRICKS.get(), MAGMATIC_POLISHED_IGNEOUS_BRICKS.get(), CHISELED_IGNEOUS_STONE.get(), POLISHED_IGNEOUS_BRICK_WALL.get(), MAGMATIC_POLISHED_IGNEOUS_BRICK_WALL.get(), IGNEOUS_STONE_BUTTON.get(), IGNEOUS_STONE_PRESSURE_PLATE.get(), IGNEOUS_STONE_WALL.get(), PUMICE_STONE.get(), PUMICE_STONE_STAIRS.get(), PUMICE_STONE_SLAB.get(), PUMICE_STONE_WALL.get(), PUMICE_STONE_BUTTON.get(), PUMICE_STONE_PRESSURE_PLATE.get(), PUMICE_BRICKS.get(), PUMICE_BRICK_STAIRS.get(), PUMICE_BRICK_SLAB.get(), PUMICE_BRICK_WALL.get(), PUMICE_TILES.get(), PUMICE_TILE_STAIRS.get(), PUMICE_TILE_SLAB.get(), PUMICE_TILE_WALL.get());
