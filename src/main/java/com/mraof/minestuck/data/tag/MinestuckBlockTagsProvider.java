...
public final class MinestuckBlockTagsProvider extends BlockTagsProvider
{
	...
	protected void addTags(HolderLookup.Provider provider)
	{
		...
		tag(PLANKS).add(GLOWING_PLANKS.get(), SHADEWOOD_PLANKS.get(), FROST_PLANKS.get(), RAINBOW_PLANKS.get(), END_PLANKS.get(), DEAD_PLANKS.get(), TREATED_PLANKS.get());
		...
		tag(LOGS).addTags(GLOWING_LOGS, FROST_LOGS, RAINBOW_LOGS, END_LOGS, VINE_LOGS, FLOWERY_VINE_LOGS, DEAD_LOGS, PETRIFIED_LOGS, SHADEWOOD_LOGS);
		tag(ENDERMAN_HOLDABLE).add(THOUGHT_DIRT.get());
		tag(STAIRS).add(BLACK_CHESS_BRICK_STAIRS.asBlock(), DARK_GRAY_CHESS_BRICK_STAIRS.asBlock(), LIGHT_GRAY_CHESS_BRICK_STAIRS.asBlock(), WHITE_CHESS_BRICK_STAIRS.asBlock(), COARSE_STONE_STAIRS.get(), COARSE_STONE_BRICK_STAIRS.get(), SHADE_STAIRS.get(), SHADE_BRICK_STAIRS.get(), FROST_TILE_STAIRS.get(), FROST_BRICK_STAIRS.get(), CAST_IRON_STAIRS.get(), BLACK_STONE_STAIRS.get(), BLACK_STONE_BRICK_STAIRS.get(), MYCELIUM_STAIRS.get(), MYCELIUM_BRICK_STAIRS.get(), CHALK_STAIRS.get(), CHALK_BRICK_STAIRS.get(), PINK_STONE_BRICK_STAIRS.get(), BROWN_STONE_BRICK_STAIRS.get(), GREEN_STONE_BRICK_STAIRS.get(), FLOWERY_MOSSY_STONE_BRICK_STAIRS.get());
		tag(SLABS).add(COARSE_STONE_SLAB.get(), COARSE_STONE_BRICK_SLAB.get(), BLACK_CHESS_BRICK_SLAB.asBlock(), DARK_GRAY_CHESS_BRICK_SLAB.asBlock(), LIGHT_GRAY_CHESS_BRICK_SLAB.asBlock(), WHITE_CHESS_BRICK_SLAB.asBlock(), CHALK_SLAB.get(), CHALK_BRICK_SLAB.get(), PINK_STONE_BRICK_SLAB.get(), BROWN_STONE_BRICK_SLAB.get(), GREEN_STONE_BRICK_SLAB.get(), BLACK_STONE_SLAB.get(), BLACK_STONE_BRICK_SLAB.get(), MYCELIUM_SLAB.get(), MYCELIUM_BRICK_SLAB.get(), FLOWERY_MOSSY_STONE_BRICK_SLAB.get(), FROST_TILE_SLAB.get(), FROST_BRICK_SLAB.get(), SHADE_SLAB.get(), SHADE_BRICK_SLAB.get());
		...
		tag(IMPERMEABLE).add(PLATFORM_BLOCK.get(), CHECKERED_STAINED_GLASS.asBlock(), BLACK_CROWN_STAINED_GLASS.asBlock(), BLACK_PAWN_STAINED_GLASS.asBlock(), WHITE_CROWN_STAINED_GLASS.asBlock(), WHITE_PAWN_STAINED_GLASS.asBlock());
		tag(SAND).add(BLACK_SAND.get());
		tag(BEE_GROWABLES).add(BLOOMING_CACTUS.get(), GLOWFLOWER.get());
		tag(PORTALS).add(SKAIA_PORTAL.asBlock(), GATE.get(), GATE_MAIN.get(), RETURN_NODE.get(), RETURN_NODE_MAIN.get());
		...
		tag(Tags.Blocks.STAINED_GLASS).add(CHECKERED_STAINED_GLASS.asBlock(), BLACK_CROWN_STAINED_GLASS.asBlock(), BLACK_PAWN_STAINED_GLASS.asBlock(), WHITE_CROWN_STAINED_GLASS.asBlock(), WHITE_PAWN_STAINED_GLASS.asBlock());
		...
		tag(MINEABLE_WITH_SHOVEL).add(BLACK_CHESS_DIRT.asBlock(), WHITE_CHESS_DIRT.asBlock(), DARK_GRAY_CHESS_DIRT.asBlock(), LIGHT_GRAY_CHESS_DIRT.asBlock());
		
		needsWoodPickaxe(BLACK_CHESS_BRICKS.asBlock(), DARK_GRAY_CHESS_BRICKS.asBlock(), LIGHT_GRAY_CHESS_BRICKS.asBlock(), WHITE_CHESS_BRICKS.asBlock(), BLACK_CHESS_BRICK_SMOOTH_BUTTON.asBlock(), BLACK_CHESS_BRICK_WALL.asBlock(), DARK_GRAY_CHESS_BRICK_WALL.asBlock(), LIGHT_GRAY_CHESS_BRICK_WALL.asBlock(), WHITE_CHESS_BRICK_WALL.asBlock());
		needsWoodPickaxe(BLACK_CHESS_BRICK_SMOOTH.asBlock(), DARK_GRAY_CHESS_BRICK_SMOOTH.asBlock(), LIGHT_GRAY_CHESS_BRICK_SMOOTH.asBlock(), WHITE_CHESS_BRICK_SMOOTH.asBlock(), BLACK_CHESS_BRICK_SMOOTH_BUTTON.asBlock(), BLACK_CHESS_BRICK_SMOOTH_PRESSURE_PLATE.asBlock(), BLACK_CHESS_BRICK_SMOOTH_SLAB.asBlock(), BLACK_CHESS_BRICK_SMOOTH_STAIRS.asBlock(), BLACK_CHESS_BRICK_SMOOTH_WALL.asBlock(), BLACK_CHESS_BRICK_SMOOTH_BUTTON.asBlock(), BLACK_CHESS_BRICK_SMOOTH_PRESSURE_PLATE.asBlock(), BLACK_CHESS_BRICK_SMOOTH_SLAB.asBlock(), BLACK_CHESS_BRICK_SMOOTH_STAIRS.asBlock(), BLACK_CHESS_BRICK_SMOOTH_WALL.asBlock(), DARK_GRAY_CHESS_BRICK_SMOOTH_BUTTON.asBlock(), DARK_GRAY_CHESS_BRICK_SMOOTH_PRESSURE_PLATE.asBlock(), DARK_GRAY_CHESS_BRICK_SMOOTH_SLAB.asBlock(), DARK_GRAY_CHESS_BRICK_SMOOTH_STAIRS.asBlock(), DARK_GRAY_CHESS_BRICK_SMOOTH_WALL.asBlock(), LIGHT_GRAY_CHESS_BRICK_SMOOTH_BUTTON.asBlock(), LIGHT_GRAY_CHESS_BRICK_SMOOTH_PRESSURE_PLATE.asBlock(), LIGHT_GRAY_CHESS_BRICK_SMOOTH_SLAB.asBlock(), LIGHT_GRAY_CHESS_BRICK_SMOOTH_STAIRS.asBlock(), LIGHT_GRAY_CHESS_BRICK_SMOOTH_WALL.asBlock(), SMOOTH_SHADE_STONE_SLAB.get(), SMOOTH_SHADE_STONE_STAIRS.get(), SMOOTH_SHADE_STONE_WALL.get(), WHITE_CHESS_BRICK_SMOOTH_BUTTON.asBlock(), WHITE_CHESS_BRICK_SMOOTH_PRESSURE_PLATE.asBlock(), WHITE_CHESS_BRICK_SMOOTH_SLAB.asBlock(), WHITE_CHESS_BRICK_SMOOTH_STAIRS.asBlock(), WHITE_CHESS_BRICK_SMOOTH_WALL.asBlock());
		needsWoodPickaxe(BLACK_CHESS_BRICK_TRIM.asBlock(), DARK_GRAY_CHESS_BRICK_TRIM.asBlock(), LIGHT_GRAY_CHESS_BRICK_TRIM.asBlock(), WHITE_CHESS_BRICK_TRIM.asBlock());
		...
		needsWoodPickaxe(BLACK_CHESS_BRICK_STAIRS.asBlock(), DARK_GRAY_CHESS_BRICK_STAIRS.asBlock(), LIGHT_GRAY_CHESS_BRICK_STAIRS.asBlock(), WHITE_CHESS_BRICK_STAIRS.asBlock());
		...
		needsWoodPickaxe(BLACK_CHESS_BRICK_SLAB.asBlock(), DARK_GRAY_CHESS_BRICK_SLAB.asBlock(), LIGHT_GRAY_CHESS_BRICK_SLAB.asBlock(), WHITE_CHESS_BRICK_SLAB.asBlock());
