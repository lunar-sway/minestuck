...
public final class MinestuckBlockTagsProvider extends BlockTagsProvider
{
	...
	protected void addTags(HolderLookup.Provider provider)
	{
		...
		tag(MINEABLE_WITH_AXE).add(UNCARVED_WOOD.get(), CHIPBOARD.get(), CARVED_HEAVY_PLANKS.get(), CARVED_PLANKS.get(), CARVED_KNOTTED_WOOD.get(), POLISHED_UNCARVED_WOOD.get(), POLISHED_UNCARVED_SLAB.get(), POLISHED_UNCARVED_STAIRS.get(), CHIPBOARD_BUTTON.get(), CHIPBOARD_FENCE.get(), CHIPBOARD_FENCE_GATE.get(), CHIPBOARD_PRESSURE_PLATE.get(), CHIPBOARD_SLAB.get(), CHIPBOARD_STAIRS.get(),UNCARVED_WOOD_BUTTON.get(), UNCARVED_WOOD_FENCE.get(), UNCARVED_WOOD_FENCE_GATE.get(), UNCARVED_WOOD_PRESSURE_PLATE.get(), UNCARVED_WOOD_SLAB.get(), UNCARVED_WOOD_STAIRS.get(), CARVED_BUTTON.get(), CARVED_FENCE.get(), CARVED_FENCE_GATE.get(), CARVED_HEAVY_PLANK_SLAB.get(), CARVED_HEAVY_PLANK_STAIRS.get(), CARVED_PRESSURE_PLATE.get(), CARVED_SLAB.get(), CARVED_STAIRS.get());
		tag(NEEDS_STONE_TOOL).add(UNCARVED_WOOD.get(), CHIPBOARD.get(), CARVED_HEAVY_PLANKS.get(), CARVED_PLANKS.get(), CARVED_KNOTTED_WOOD.get(), POLISHED_UNCARVED_WOOD.get(), POLISHED_UNCARVED_SLAB.get(), POLISHED_UNCARVED_STAIRS.get(), CHIPBOARD_BUTTON.get(), CHIPBOARD_FENCE.get(), CHIPBOARD_FENCE_GATE.get(), CHIPBOARD_PRESSURE_PLATE.get(), CHIPBOARD_SLAB.get(), CHIPBOARD_STAIRS.get(),UNCARVED_WOOD_BUTTON.get(), UNCARVED_WOOD_FENCE.get(), UNCARVED_WOOD_FENCE_GATE.get(), UNCARVED_WOOD_PRESSURE_PLATE.get(), UNCARVED_WOOD_SLAB.get(), UNCARVED_WOOD_STAIRS.get(), CARVED_BUTTON.get(), CARVED_FENCE.get(), CARVED_FENCE_GATE.get(), CARVED_HEAVY_PLANK_SLAB.get(), CARVED_HEAVY_PLANK_STAIRS.get(), CARVED_PRESSURE_PLATE.get(), CARVED_SLAB.get(), CARVED_STAIRS.get());
		...
		tag(MINEABLE_WITH_AXE).add(AspectTreeBlocks.BLOOD_ASPECT_LOG.get(), AspectTreeBlocks.BREATH_ASPECT_LOG.get(), AspectTreeBlocks.DOOM_ASPECT_LOG.get(), AspectTreeBlocks.HEART_ASPECT_LOG.get(), AspectTreeBlocks.HOPE_ASPECT_LOG.get(), AspectTreeBlocks.LIFE_ASPECT_LOG.get(),
				AspectTreeBlocks.LIGHT_ASPECT_LOG.get(), AspectTreeBlocks.MIND_ASPECT_LOG.get(), AspectTreeBlocks.RAGE_ASPECT_LOG.get(), AspectTreeBlocks.SPACE_ASPECT_LOG.get(), AspectTreeBlocks.TIME_ASPECT_LOG.get(), AspectTreeBlocks.VOID_ASPECT_LOG.get());
		tag(MINEABLE_WITH_AXE).add(AspectTreeBlocks.BLOOD_ASPECT_PLANKS.get(), AspectTreeBlocks.BREATH_ASPECT_PLANKS.get(), AspectTreeBlocks.DOOM_ASPECT_PLANKS.get(), AspectTreeBlocks.HEART_ASPECT_PLANKS.get(), AspectTreeBlocks.HOPE_ASPECT_PLANKS.get(), AspectTreeBlocks.LIFE_ASPECT_PLANKS.get(),
				AspectTreeBlocks.LIGHT_ASPECT_PLANKS.get(), AspectTreeBlocks.MIND_ASPECT_PLANKS.get(), AspectTreeBlocks.RAGE_ASPECT_PLANKS.get(), AspectTreeBlocks.SPACE_ASPECT_PLANKS.get(), AspectTreeBlocks.TIME_ASPECT_PLANKS.get(), AspectTreeBlocks.VOID_ASPECT_PLANKS.get());
		tag(MINEABLE_WITH_AXE).add(AspectTreeBlocks.BLOOD_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.BREATH_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.DOOM_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.HEART_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.HOPE_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.LIFE_ASPECT_BOOKSHELF.get(),
				AspectTreeBlocks.LIGHT_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.MIND_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.RAGE_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.SPACE_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.TIME_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.VOID_ASPECT_BOOKSHELF.get());
		tag(MINEABLE_WITH_AXE).add(AspectTreeBlocks.BLOOD_ASPECT_LADDER.get(), AspectTreeBlocks.BREATH_ASPECT_LADDER.get(), AspectTreeBlocks.DOOM_ASPECT_LADDER.get(), AspectTreeBlocks.HEART_ASPECT_LADDER.get(), AspectTreeBlocks.HOPE_ASPECT_LADDER.get(), AspectTreeBlocks.LIFE_ASPECT_LADDER.get(),
				AspectTreeBlocks.LIGHT_ASPECT_LADDER.get(), AspectTreeBlocks.MIND_ASPECT_LADDER.get(), AspectTreeBlocks.RAGE_ASPECT_LADDER.get(), AspectTreeBlocks.SPACE_ASPECT_LADDER.get(), AspectTreeBlocks.TIME_ASPECT_LADDER.get(), AspectTreeBlocks.VOID_ASPECT_LADDER.get());
		tag(MINEABLE_WITH_AXE).add(AspectTreeBlocks.BLOOD_ASPECT_STAIRS.get(), AspectTreeBlocks.BREATH_ASPECT_STAIRS.get(), AspectTreeBlocks.DOOM_ASPECT_STAIRS.get(), AspectTreeBlocks.HEART_ASPECT_STAIRS.get(), AspectTreeBlocks.HOPE_ASPECT_STAIRS.get(), AspectTreeBlocks.LIFE_ASPECT_STAIRS.get(), AspectTreeBlocks.LIGHT_ASPECT_STAIRS.get(), AspectTreeBlocks.MIND_ASPECT_STAIRS.get(), AspectTreeBlocks.RAGE_ASPECT_STAIRS.get(), AspectTreeBlocks.SPACE_ASPECT_STAIRS.get(), AspectTreeBlocks.TIME_ASPECT_STAIRS.get(), AspectTreeBlocks.VOID_ASPECT_STAIRS.get());
		tag(MINEABLE_WITH_AXE).add(AspectTreeBlocks.BLOOD_ASPECT_SLAB.get(), AspectTreeBlocks.BREATH_ASPECT_SLAB.get(), AspectTreeBlocks.DOOM_ASPECT_SLAB.get(), AspectTreeBlocks.HEART_ASPECT_SLAB.get(), AspectTreeBlocks.HOPE_ASPECT_SLAB.get(), AspectTreeBlocks.LIFE_ASPECT_SLAB.get(), AspectTreeBlocks.LIGHT_ASPECT_SLAB.get(), AspectTreeBlocks.MIND_ASPECT_SLAB.get(), AspectTreeBlocks.RAGE_ASPECT_SLAB.get(), AspectTreeBlocks.SPACE_ASPECT_SLAB.get(), AspectTreeBlocks.TIME_ASPECT_SLAB.get(), AspectTreeBlocks.VOID_ASPECT_SLAB.get());
		tag(MINEABLE_WITH_AXE).add(AspectTreeBlocks.BLOOD_ASPECT_FENCE.get(), AspectTreeBlocks.BREATH_ASPECT_FENCE.get(), AspectTreeBlocks.DOOM_ASPECT_FENCE.get(), AspectTreeBlocks.HEART_ASPECT_FENCE.get(), AspectTreeBlocks.HOPE_ASPECT_FENCE.get(), AspectTreeBlocks.LIFE_ASPECT_FENCE.get(), AspectTreeBlocks.LIGHT_ASPECT_FENCE.get(), AspectTreeBlocks.MIND_ASPECT_FENCE.get(), AspectTreeBlocks.RAGE_ASPECT_FENCE.get(), AspectTreeBlocks.SPACE_ASPECT_FENCE.get(), AspectTreeBlocks.TIME_ASPECT_FENCE.get(), AspectTreeBlocks.VOID_ASPECT_FENCE.get());
		tag(MINEABLE_WITH_AXE).add(AspectTreeBlocks.BLOOD_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.BREATH_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.DOOM_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.HEART_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.HOPE_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.LIFE_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.LIGHT_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.MIND_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.RAGE_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.SPACE_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.TIME_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.VOID_ASPECT_FENCE_GATE.get());
		tag(MINEABLE_WITH_AXE).add(AspectTreeBlocks.BLOOD_ASPECT_BUTTON.get(), AspectTreeBlocks.BREATH_ASPECT_BUTTON.get(), AspectTreeBlocks.DOOM_ASPECT_BUTTON.get(), AspectTreeBlocks.HEART_ASPECT_BUTTON.get(), AspectTreeBlocks.HOPE_ASPECT_BUTTON.get(), AspectTreeBlocks.LIFE_ASPECT_BUTTON.get(), AspectTreeBlocks.LIGHT_ASPECT_BUTTON.get(), AspectTreeBlocks.MIND_ASPECT_BUTTON.get(), AspectTreeBlocks.RAGE_ASPECT_BUTTON.get(), AspectTreeBlocks.SPACE_ASPECT_BUTTON.get(), AspectTreeBlocks.TIME_ASPECT_BUTTON.get(), AspectTreeBlocks.VOID_ASPECT_BUTTON.get());
		tag(MINEABLE_WITH_AXE).add(AspectTreeBlocks.BLOOD_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.BREATH_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.DOOM_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.HEART_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.HOPE_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.LIFE_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.LIGHT_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.MIND_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.RAGE_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.SPACE_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.TIME_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.VOID_ASPECT_PRESSURE_PLATE.get());
		...
		tag(ASPECT_LOGS).add(AspectTreeBlocks.BLOOD_ASPECT_LOG.get(), AspectTreeBlocks.BREATH_ASPECT_LOG.get(), AspectTreeBlocks.DOOM_ASPECT_LOG.get(), AspectTreeBlocks.HEART_ASPECT_LOG.get(), AspectTreeBlocks.HOPE_ASPECT_LOG.get(), AspectTreeBlocks.LIFE_ASPECT_LOG.get(), AspectTreeBlocks.LIGHT_ASPECT_LOG.get(), AspectTreeBlocks.MIND_ASPECT_LOG.get(), AspectTreeBlocks.RAGE_ASPECT_LOG.get(), AspectTreeBlocks.SPACE_ASPECT_LOG.get(), AspectTreeBlocks.TIME_ASPECT_LOG.get(), AspectTreeBlocks.VOID_ASPECT_LOG.get());
		tag(ASPECT_PLANKS).add(AspectTreeBlocks.BLOOD_ASPECT_PLANKS.get(), AspectTreeBlocks.BREATH_ASPECT_PLANKS.get(), AspectTreeBlocks.DOOM_ASPECT_PLANKS.get(), AspectTreeBlocks.HEART_ASPECT_PLANKS.get(), AspectTreeBlocks.HOPE_ASPECT_PLANKS.get(), AspectTreeBlocks.LIFE_ASPECT_PLANKS.get(), AspectTreeBlocks.LIGHT_ASPECT_PLANKS.get(), AspectTreeBlocks.MIND_ASPECT_PLANKS.get(), AspectTreeBlocks.RAGE_ASPECT_PLANKS.get(), AspectTreeBlocks.SPACE_ASPECT_PLANKS.get(), AspectTreeBlocks.TIME_ASPECT_PLANKS.get(), AspectTreeBlocks.VOID_ASPECT_PLANKS.get());
		tag(ASPECT_LEAVES).add(AspectTreeBlocks.BLOOD_ASPECT_LEAVES.get(), AspectTreeBlocks.BREATH_ASPECT_LEAVES.get(), AspectTreeBlocks.DOOM_ASPECT_LEAVES.get(), AspectTreeBlocks.HEART_ASPECT_LEAVES.get(), AspectTreeBlocks.HOPE_ASPECT_LEAVES.get(), AspectTreeBlocks.LIFE_ASPECT_LEAVES.get(), AspectTreeBlocks.LIGHT_ASPECT_LEAVES.get(), AspectTreeBlocks.MIND_ASPECT_LEAVES.get(), AspectTreeBlocks.RAGE_ASPECT_LEAVES.get(), AspectTreeBlocks.SPACE_ASPECT_LEAVES.get(), AspectTreeBlocks.TIME_ASPECT_LEAVES.get(), AspectTreeBlocks.VOID_ASPECT_LEAVES.get());
		tag(ASPECT_SAPLINGS).add(AspectTreeBlocks.BLOOD_ASPECT_SAPLING.get(), AspectTreeBlocks.BREATH_ASPECT_SAPLING.get(), AspectTreeBlocks.DOOM_ASPECT_SAPLING.get(), AspectTreeBlocks.HEART_ASPECT_SAPLING.get(), AspectTreeBlocks.HOPE_ASPECT_SAPLING.get(), AspectTreeBlocks.LIFE_ASPECT_SAPLING.get(), AspectTreeBlocks.LIGHT_ASPECT_SAPLING.get(), AspectTreeBlocks.MIND_ASPECT_SAPLING.get(), AspectTreeBlocks.RAGE_ASPECT_SAPLING.get(), AspectTreeBlocks.SPACE_ASPECT_SAPLING.get(), AspectTreeBlocks.TIME_ASPECT_SAPLING.get(), AspectTreeBlocks.VOID_ASPECT_SAPLING.get());
		tag(ASPECT_BOOKSHELVES).add(AspectTreeBlocks.BLOOD_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.BREATH_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.DOOM_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.HEART_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.HOPE_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.LIFE_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.LIGHT_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.MIND_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.RAGE_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.SPACE_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.TIME_ASPECT_BOOKSHELF.get(), AspectTreeBlocks.VOID_ASPECT_BOOKSHELF.get());
		tag(ASPECT_LADDERS).add(AspectTreeBlocks.BLOOD_ASPECT_LADDER.get(), AspectTreeBlocks.BREATH_ASPECT_LADDER.get(), AspectTreeBlocks.DOOM_ASPECT_LADDER.get(), AspectTreeBlocks.HEART_ASPECT_LADDER.get(), AspectTreeBlocks.HOPE_ASPECT_LADDER.get(), AspectTreeBlocks.LIFE_ASPECT_LADDER.get(), AspectTreeBlocks.LIGHT_ASPECT_LADDER.get(), AspectTreeBlocks.MIND_ASPECT_LADDER.get(), AspectTreeBlocks.RAGE_ASPECT_LADDER.get(), AspectTreeBlocks.SPACE_ASPECT_LADDER.get(), AspectTreeBlocks.TIME_ASPECT_LADDER.get(), AspectTreeBlocks.VOID_ASPECT_LADDER.get());
		...
		tag(FENCES).add(PERFECTLY_GENERIC_FENCE.get(), GLOWING_FENCE.get(), UNCARVED_WOOD_FENCE.get(), CHIPBOARD_FENCE.get(), CARVED_FENCE.get(), FROST_FENCE.get(), RAINBOW_FENCE.get(), END_FENCE.get(), DEAD_FENCE.get(), SHADEWOOD_FENCE.get(), TREATED_FENCE.get(), AspectTreeBlocks.BLOOD_ASPECT_FENCE.get(), AspectTreeBlocks.BREATH_ASPECT_FENCE.get(), AspectTreeBlocks.DOOM_ASPECT_FENCE.get(), AspectTreeBlocks.HEART_ASPECT_FENCE.get(), AspectTreeBlocks.HOPE_ASPECT_FENCE.get(), AspectTreeBlocks.LIFE_ASPECT_FENCE.get(), AspectTreeBlocks.LIGHT_ASPECT_FENCE.get(), AspectTreeBlocks.MIND_ASPECT_FENCE.get(), AspectTreeBlocks.RAGE_ASPECT_FENCE.get(), AspectTreeBlocks.SPACE_ASPECT_FENCE.get(), AspectTreeBlocks.TIME_ASPECT_FENCE.get(), AspectTreeBlocks.VOID_ASPECT_FENCE.get());
		tag(FENCE_GATES).add(PERFECTLY_GENERIC_FENCE_GATE.get(), GLOWING_FENCE_GATE.get(), UNCARVED_WOOD_FENCE_GATE.get(), CHIPBOARD_FENCE_GATE.get(), CARVED_FENCE_GATE.get(), FROST_FENCE_GATE.get(), RAINBOW_FENCE_GATE.get(), END_FENCE_GATE.get(), DEAD_FENCE_GATE.get(), SHADEWOOD_FENCE_GATE.get(), TREATED_FENCE_GATE.get(), AspectTreeBlocks.BLOOD_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.BREATH_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.DOOM_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.HEART_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.HOPE_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.LIFE_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.LIGHT_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.MIND_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.RAGE_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.SPACE_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.TIME_ASPECT_FENCE_GATE.get(), AspectTreeBlocks.VOID_ASPECT_FENCE_GATE.get());
		tag(PRESSURE_PLATES).add(PERFECTLY_GENERIC_PRESSURE_PLATE.get(), GLOWING_PRESSURE_PLATE.get(), UNCARVED_WOOD_PRESSURE_PLATE.get(), CHIPBOARD_PRESSURE_PLATE.get(), CARVED_PRESSURE_PLATE.get(), FROST_PRESSURE_PLATE.get(), RAINBOW_PRESSURE_PLATE.get(), END_PRESSURE_PLATE.get(), DEAD_PRESSURE_PLATE.get(), SHADEWOOD_PRESSURE_PLATE.get(), TREATED_PRESSURE_PLATE.get(), AspectTreeBlocks.BLOOD_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.BREATH_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.DOOM_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.HEART_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.HOPE_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.LIFE_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.LIGHT_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.MIND_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.RAGE_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.SPACE_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.TIME_ASPECT_PRESSURE_PLATE.get(), AspectTreeBlocks.VOID_ASPECT_PRESSURE_PLATE.get());
