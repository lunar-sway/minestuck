...
public final class MinestuckBlockTagsProvider extends BlockTagsProvider
{
	...
	protected void addTags(HolderLookup.Provider provider)
	{
		...
		tag(WOODEN_SLABS).add(RAINBOW_SLAB.get(), END_SLAB.get(), DEAD_SLAB.get(), CARVED_SLAB.get(), TREATED_PLANKS_SLAB.get(), LACQUERED_SLAB.get(), CINDERED_SLAB.get());
		...
		tag(MINEABLE_WITH_AXE).add(UNCARVED_WOOD.get(), UNCARVED_WOOD_BUTTON.get(), UNCARVED_WOOD_FENCE.get(), UNCARVED_WOOD_FENCE_GATE.get(), UNCARVED_WOOD_PRESSURE_PLATE.get(), UNCARVED_WOOD_SLAB.get(),
				...
				CARVED_HEAVY_PLANKS.get(), CARVED_HEAVY_PLANK_SLAB.get(), CARVED_HEAVY_PLANK_STAIRS.get(), CARVED_PLANKS.get(), CARVED_BUTTON.get(), CARVED_FENCE.get(), CARVED_FENCE_GATE.get(), CARVED_PRESSURE_PLATE.get(),
				CARVED_SLAB.get(), CARVED_STAIRS.get(), CARVED_KNOTTED_WOOD.get(), POLISHED_UNCARVED_WOOD.get(), POLISHED_UNCARVED_SLAB.get(), POLISHED_UNCARVED_STAIRS.get(), WOODEN_GRASS.get(), TREATED_UNCARVED_WOOD.get(),
				TREATED_UNCARVED_WOOD_BUTTON.get(), TREATED_UNCARVED_WOOD_FENCE.get(), TREATED_UNCARVED_WOOD_FENCE_GATE.get(), TREATED_UNCARVED_WOOD_PRESSURE_PLATE.get(), TREATED_UNCARVED_WOOD_SLAB.get(),
				TREATED_UNCARVED_WOOD_STAIRS.get(), TREATED_CHIPBOARD.get(), TREATED_CHIPBOARD_BUTTON.get(), TREATED_CHIPBOARD_FENCE.get(), TREATED_CHIPBOARD_FENCE_GATE.get(), TREATED_CHIPBOARD_PRESSURE_PLATE.get(),
				TREATED_CHIPBOARD_SLAB.get(), TREATED_CHIPBOARD_STAIRS.get(), TREATED_HEAVY_PLANKS.get(), TREATED_HEAVY_PLANK_SLAB.get(), TREATED_HEAVY_PLANK_STAIRS.get(), TREATED_PLANKS.get(), TREATED_BUTTON.get(),
				TREATED_FENCE.get(), TREATED_FENCE_GATE.get(), TREATED_PRESSURE_PLATE.get(), TREATED_PLANKS_SLAB.get(), TREATED_PLANKS_STAIRS.get(), TREATED_CARVED_KNOTTED_WOOD.get(), POLISHED_TREATED_UNCARVED_WOOD.get(),
				POLISHED_TREATED_UNCARVED_SLAB.get(), POLISHED_TREATED_UNCARVED_STAIRS.get(), TREATED_WOODEN_GRASS.get(), LACQUERED_UNCARVED_WOOD.get(), LACQUERED_UNCARVED_WOOD_BUTTON.get(), LACQUERED_UNCARVED_WOOD_FENCE.get(),
				LACQUERED_UNCARVED_WOOD_FENCE_GATE.get(), LACQUERED_UNCARVED_WOOD_PRESSURE_PLATE.get(), LACQUERED_UNCARVED_WOOD_SLAB.get(), LACQUERED_UNCARVED_WOOD_STAIRS.get(), LACQUERED_CHIPBOARD.get(), LACQUERED_CHIPBOARD_BUTTON.get(),
				LACQUERED_CHIPBOARD_FENCE.get(), LACQUERED_CHIPBOARD_FENCE_GATE.get(), LACQUERED_CHIPBOARD_PRESSURE_PLATE.get(), LACQUERED_CHIPBOARD_SLAB.get(), LACQUERED_CHIPBOARD_STAIRS.get(), LACQUERED_HEAVY_PLANKS.get(),
				LACQUERED_HEAVY_PLANK_SLAB.get(), LACQUERED_HEAVY_PLANK_STAIRS.get(), LACQUERED_PLANKS.get(), LACQUERED_BUTTON.get(), LACQUERED_FENCE.get(), LACQUERED_FENCE_GATE.get(), LACQUERED_PRESSURE_PLATE.get(),
				LACQUERED_SLAB.get(), LACQUERED_STAIRS.get(), LACQUERED_CARVED_KNOTTED_WOOD.get(), POLISHED_LACQUERED_UNCARVED_WOOD.get(), POLISHED_LACQUERED_UNCARVED_SLAB.get(), POLISHED_LACQUERED_UNCARVED_STAIRS.get(), LACQUERED_WOODEN_MUSHROOM.get(), WOODEN_LAMP.get());
		tag(NEEDS_STONE_TOOL).add(UNCARVED_WOOD.get(), UNCARVED_WOOD_BUTTON.get(), UNCARVED_WOOD_FENCE.get(), UNCARVED_WOOD_FENCE_GATE.get(), UNCARVED_WOOD_PRESSURE_PLATE.get(), UNCARVED_WOOD_SLAB.get(),
				UNCARVED_WOOD_STAIRS.get(), CHIPBOARD.get(), CHIPBOARD_BUTTON.get(), CHIPBOARD_FENCE.get(), CHIPBOARD_FENCE_GATE.get(), CHIPBOARD_PRESSURE_PLATE.get(), CHIPBOARD_SLAB.get(), CHIPBOARD_STAIRS.get(),
		...
		tag(GLOWING_LOGS).add(GLOWING_LOG.get(), GLOWING_WOOD.get(), STRIPPED_GLOWING_LOG.get(), STRIPPED_GLOWING_LOG.get());
		...
		tag(DEAD_LOGS).add(DEAD_LOG.get(), DEAD_WOOD.get(), STRIPPED_DEAD_LOG.get(), STRIPPED_END_WOOD.get());
