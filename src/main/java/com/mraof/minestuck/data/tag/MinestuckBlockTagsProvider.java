...
public final class MinestuckBlockTagsProvider extends BlockTagsProvider
{
	...
	protected void addTags(HolderLookup.Provider provider)
	{
		...
		tag(PLANKS).add(GLOWING_PLANKS.get(), SHADEWOOD_PLANKS.get(), FROST_PLANKS.get(), RAINBOW_PLANKS.get(), END_PLANKS.get(), DEAD_PLANKS.get(), CARVED_PLANKS.get(), TREATED_PLANKS.get(), LACQUERED_PLANKS.get()).addTag(ASPECT_PLANKS);
		...
		tag(MINEABLE_WITH_AXE).add(UNCARVED_WOOD.get(), CHIPBOARD.get(), CARVED_HEAVY_PLANKS.get(), CARVED_PLANKS.get(), CARVED_KNOTTED_WOOD.get(), POLISHED_UNCARVED_WOOD.get(), POLISHED_UNCARVED_SLAB.get(), POLISHED_UNCARVED_STAIRS.get(), CHIPBOARD_BUTTON.get(), CHIPBOARD_FENCE.get(), CHIPBOARD_FENCE_GATE.get(), CHIPBOARD_PRESSURE_PLATE.get(), CHIPBOARD_SLAB.get(), CHIPBOARD_STAIRS.get(),UNCARVED_WOOD_BUTTON.get(), UNCARVED_WOOD_FENCE.get(), UNCARVED_WOOD_FENCE_GATE.get(), UNCARVED_WOOD_PRESSURE_PLATE.get(), UNCARVED_WOOD_SLAB.get(), UNCARVED_WOOD_STAIRS.get(), CARVED_BUTTON.get(), CARVED_FENCE.get(), CARVED_FENCE_GATE.get(), CARVED_HEAVY_PLANK_SLAB.get(), CARVED_HEAVY_PLANK_STAIRS.get(), CARVED_PRESSURE_PLATE.get(), CARVED_SLAB.get(), CARVED_STAIRS.get(), WOODEN_GRASS.get(), TREATED_UNCARVED_WOOD.get(), TREATED_CHIPBOARD.get(), TREATED_HEAVY_PLANKS.get(), TREATED_PLANKS.get(), TREATED_BUTTON.get(), TREATED_FENCE.get(), TREATED_FENCE_GATE.get(), TREATED_PRESSURE_PLATE.get(), TREATED_CARVED_KNOTTED_WOOD.get(), POLISHED_TREATED_UNCARVED_WOOD.get(), TREATED_WOODEN_GRASS.get(), LACQUERED_UNCARVED_WOOD.get(), LACQUERED_CHIPBOARD.get(), LACQUERED_HEAVY_PLANKS.get(), LACQUERED_PLANKS.get(), LACQUERED_CARVED_KNOTTED_WOOD.get(), POLISHED_LACQUERED_UNCARVED_WOOD.get(), LACQUERED_WOODEN_MUSHROOM.get(), WOODEN_LAMP.get());
		tag(NEEDS_STONE_TOOL).add(UNCARVED_WOOD.get(), CHIPBOARD.get(), CARVED_HEAVY_PLANKS.get(), CARVED_KNOTTED_WOOD.get(), POLISHED_UNCARVED_WOOD.get(), POLISHED_UNCARVED_SLAB.get(), POLISHED_UNCARVED_STAIRS.get(), CHIPBOARD_BUTTON.get(), CHIPBOARD_FENCE.get(), CHIPBOARD_FENCE_GATE.get(), CHIPBOARD_PRESSURE_PLATE.get(), CHIPBOARD_SLAB.get(), CHIPBOARD_STAIRS.get(),UNCARVED_WOOD_BUTTON.get(), UNCARVED_WOOD_FENCE.get(), UNCARVED_WOOD_FENCE_GATE.get(), UNCARVED_WOOD_PRESSURE_PLATE.get(), UNCARVED_WOOD_SLAB.get(), UNCARVED_WOOD_STAIRS.get(), CARVED_HEAVY_PLANK_SLAB.get(), CARVED_HEAVY_PLANK_STAIRS.get(), TREATED_UNCARVED_WOOD.get(), TREATED_CHIPBOARD.get(), TREATED_HEAVY_PLANKS.get(), TREATED_CARVED_KNOTTED_WOOD.get(), POLISHED_TREATED_UNCARVED_WOOD.get(), LACQUERED_UNCARVED_WOOD.get(), LACQUERED_CHIPBOARD.get(), LACQUERED_HEAVY_PLANKS.get(), LACQUERED_CARVED_KNOTTED_WOOD.get(), POLISHED_LACQUERED_UNCARVED_WOOD.get());
		...
		tag(MINEABLE_WITH_AXE).add(BLOOD_ASPECT_STAIRS.get(), BREATH_ASPECT_STAIRS.get(), DOOM_ASPECT_STAIRS.get(), HEART_ASPECT_STAIRS.get(), HOPE_ASPECT_STAIRS.get(), LIFE_ASPECT_STAIRS.get(), LIGHT_ASPECT_STAIRS.get(), MIND_ASPECT_STAIRS.get(), RAGE_ASPECT_STAIRS.get(), SPACE_ASPECT_STAIRS.get(), TIME_ASPECT_STAIRS.get(), VOID_ASPECT_STAIRS.get());
		tag(MINEABLE_WITH_AXE).add(BLOOD_ASPECT_SLAB.get(), BREATH_ASPECT_SLAB.get(), DOOM_ASPECT_SLAB.get(), HEART_ASPECT_SLAB.get(), HOPE_ASPECT_SLAB.get(), LIFE_ASPECT_SLAB.get(), LIGHT_ASPECT_SLAB.get(), MIND_ASPECT_SLAB.get(), RAGE_ASPECT_SLAB.get(), SPACE_ASPECT_SLAB.get(), TIME_ASPECT_SLAB.get(), VOID_ASPECT_SLAB.get());
		tag(MINEABLE_WITH_AXE).add(BLOOD_ASPECT_FENCE.get(), BREATH_ASPECT_FENCE.get(), DOOM_ASPECT_FENCE.get(), HEART_ASPECT_FENCE.get(), HOPE_ASPECT_FENCE.get(), LIFE_ASPECT_FENCE.get(), LIGHT_ASPECT_FENCE.get(), MIND_ASPECT_FENCE.get(), RAGE_ASPECT_FENCE.get(), SPACE_ASPECT_FENCE.get(), TIME_ASPECT_FENCE.get(), VOID_ASPECT_FENCE.get());
		tag(MINEABLE_WITH_AXE).add(BLOOD_ASPECT_FENCE_GATE.get(), BREATH_ASPECT_FENCE_GATE.get(), DOOM_ASPECT_FENCE_GATE.get(), HEART_ASPECT_FENCE_GATE.get(), HOPE_ASPECT_FENCE_GATE.get(), LIFE_ASPECT_FENCE_GATE.get(), LIGHT_ASPECT_FENCE_GATE.get(), MIND_ASPECT_FENCE_GATE.get(), RAGE_ASPECT_FENCE_GATE.get(), SPACE_ASPECT_FENCE_GATE.get(), TIME_ASPECT_FENCE_GATE.get(), VOID_ASPECT_FENCE_GATE.get());
		tag(MINEABLE_WITH_AXE).add(BLOOD_ASPECT_BUTTON.get(), BREATH_ASPECT_BUTTON.get(), DOOM_ASPECT_BUTTON.get(), HEART_ASPECT_BUTTON.get(), HOPE_ASPECT_BUTTON.get(), LIFE_ASPECT_BUTTON.get(), LIGHT_ASPECT_BUTTON.get(), MIND_ASPECT_BUTTON.get(), RAGE_ASPECT_BUTTON.get(), SPACE_ASPECT_BUTTON.get(), TIME_ASPECT_BUTTON.get(), VOID_ASPECT_BUTTON.get());
		tag(MINEABLE_WITH_AXE).add(BLOOD_ASPECT_PRESSURE_PLATE.get(), BREATH_ASPECT_PRESSURE_PLATE.get(), DOOM_ASPECT_PRESSURE_PLATE.get(), HEART_ASPECT_PRESSURE_PLATE.get(), HOPE_ASPECT_PRESSURE_PLATE.get(), LIFE_ASPECT_PRESSURE_PLATE.get(), LIGHT_ASPECT_PRESSURE_PLATE.get(), MIND_ASPECT_PRESSURE_PLATE.get(), RAGE_ASPECT_PRESSURE_PLATE.get(), SPACE_ASPECT_PRESSURE_PLATE.get(), TIME_ASPECT_PRESSURE_PLATE.get(), VOID_ASPECT_PRESSURE_PLATE.get());
		...
		tag(FENCES).add(PERFECTLY_GENERIC_FENCE.get(), GLOWING_FENCE.get(), UNCARVED_WOOD_FENCE.get(), CHIPBOARD_FENCE.get(), CARVED_FENCE.get(), FROST_FENCE.get(), RAINBOW_FENCE.get(), END_FENCE.get(), DEAD_FENCE.get(), SHADEWOOD_FENCE.get(), TREATED_FENCE.get(), BLOOD_ASPECT_FENCE.get(), BREATH_ASPECT_FENCE.get(), DOOM_ASPECT_FENCE.get(), HEART_ASPECT_FENCE.get(), HOPE_ASPECT_FENCE.get(), LIFE_ASPECT_FENCE.get(), LIGHT_ASPECT_FENCE.get(), MIND_ASPECT_FENCE.get(), RAGE_ASPECT_FENCE.get(), SPACE_ASPECT_FENCE.get(), TIME_ASPECT_FENCE.get(), VOID_ASPECT_FENCE.get());
		tag(FENCE_GATES).add(PERFECTLY_GENERIC_FENCE_GATE.get(), GLOWING_FENCE_GATE.get(), UNCARVED_WOOD_FENCE_GATE.get(), CHIPBOARD_FENCE_GATE.get(), CARVED_FENCE_GATE.get(), FROST_FENCE_GATE.get(), RAINBOW_FENCE_GATE.get(), END_FENCE_GATE.get(), DEAD_FENCE_GATE.get(), SHADEWOOD_FENCE_GATE.get(), TREATED_FENCE_GATE.get(), BLOOD_ASPECT_FENCE_GATE.get(), BREATH_ASPECT_FENCE_GATE.get(), DOOM_ASPECT_FENCE_GATE.get(), HEART_ASPECT_FENCE_GATE.get(), HOPE_ASPECT_FENCE_GATE.get(), LIFE_ASPECT_FENCE_GATE.get(), LIGHT_ASPECT_FENCE_GATE.get(), MIND_ASPECT_FENCE_GATE.get(), RAGE_ASPECT_FENCE_GATE.get(), SPACE_ASPECT_FENCE_GATE.get(), TIME_ASPECT_FENCE_GATE.get(), VOID_ASPECT_FENCE_GATE.get());
		tag(PRESSURE_PLATES).add(PERFECTLY_GENERIC_PRESSURE_PLATE.get(), GLOWING_PRESSURE_PLATE.get(), UNCARVED_WOOD_PRESSURE_PLATE.get(), CHIPBOARD_PRESSURE_PLATE.get(), CARVED_PRESSURE_PLATE.get(), FROST_PRESSURE_PLATE.get(), RAINBOW_PRESSURE_PLATE.get(), END_PRESSURE_PLATE.get(), DEAD_PRESSURE_PLATE.get(), SHADEWOOD_PRESSURE_PLATE.get(), TREATED_PRESSURE_PLATE.get(), BLOOD_ASPECT_PRESSURE_PLATE.get(), BREATH_ASPECT_PRESSURE_PLATE.get(), DOOM_ASPECT_PRESSURE_PLATE.get(), HEART_ASPECT_PRESSURE_PLATE.get(), HOPE_ASPECT_PRESSURE_PLATE.get(), LIFE_ASPECT_PRESSURE_PLATE.get(), LIGHT_ASPECT_PRESSURE_PLATE.get(), MIND_ASPECT_PRESSURE_PLATE.get(), RAGE_ASPECT_PRESSURE_PLATE.get(), SPACE_ASPECT_PRESSURE_PLATE.get(), TIME_ASPECT_PRESSURE_PLATE.get(), VOID_ASPECT_PRESSURE_PLATE.get());
