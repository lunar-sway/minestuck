...
public class MinestuckBlockTagsProvider extends BlockTagsProvider
{
	...
	protected void addTags()
	{
		...
		tag(SLABS).add(BLACK_CHESS_BRICK_SLAB, DARK_GRAY_CHESS_BRICK_SLAB, LIGHT_GRAY_CHESS_BRICK_SLAB, WHITE_CHESS_BRICK_SLAB, CHALK_SLAB, CHALK_BRICK_SLAB, PINK_STONE_BRICK_SLAB, BROWN_STONE_BRICK_SLAB, GREEN_STONE_BRICK_SLAB, MYCELIUM_BRICK_SLAB, FLOWERY_MOSSY_STONE_BRICK_SLAB, FROST_BRICK_SLAB, SHADE_BRICK_SLAB, COARSE_STONE_SLAB);
