...
public class MinestuckBlockTagsProvider extends BlockTagsProvider
{
	...
	protected void registerTags()
	{
		...
		getBuilder(STAIRS).add(COARSE_STONE_STAIRS, SHADE_BRICK_STAIRS, FROST_BRICK_STAIRS, CAST_IRON_STAIRS, MYCELIUM_BRICK_STAIRS, CHALK_STAIRS, CHALK_BRICK_STAIRS, PINK_STONE_BRICK_STAIRS, GOLD_BRICK_STAIRS, PURPLE_BRICK_STAIRS);
		getBuilder(SLABS).add(CHALK_SLAB, CHALK_BRICK_SLAB, PINK_STONE_BRICK_SLAB, BROWN_DUNGEON_TILE_SLAB, GOLD_BRICK_SLAB, PURPLE_BRICK_SLAB);
