...
public class MinestuckBlockTagsProvider extends BlockTagsProvider
{
	...
	protected void registerTags()
	{
		...
		getBuilder(STAIRS).add(BLACK_CASTLE_BRICK_STAIRS, DARK_GRAY_CASTLE_BRICK_STAIRS, LIGHT_GRAY_CASTLE_BRICK_STAIRS, WHITE_CASTLE_BRICK_STAIRS, COARSE_STONE_STAIRS, SHADE_BRICK_STAIRS, FROST_BRICK_STAIRS, CAST_IRON_STAIRS, MYCELIUM_BRICK_STAIRS, CHALK_STAIRS, CHALK_BRICK_STAIRS, PINK_STONE_BRICK_STAIRS, BROWN_STONE_BRICK_STAIRS, GREEN_STONE_BRICK_STAIRS);
		getBuilder(SLABS).add(BLACK_CASTLE_BRICK_SLAB, DARK_GRAY_CASTLE_BRICK_SLAB, LIGHT_GRAY_CASTLE_BRICK_SLAB, WHITE_CASTLE_BRICK_SLAB, CHALK_SLAB, CHALK_BRICK_SLAB, PINK_STONE_BRICK_SLAB, BROWN_STONE_BRICK_SLAB, GREEN_STONE_BRICK_SLAB);
