...
public class MinestuckBlockTagsProvider extends BlockTagsProvider
{
	...
	protected void addTags()
	{
		...
		tag(STAIRS).add(BLACK_CASTLE_BRICK_STAIRS.get(), DARK_GRAY_CASTLE_BRICK_STAIRS.get(), LIGHT_GRAY_CASTLE_BRICK_STAIRS.get(), WHITE_CASTLE_BRICK_STAIRS.get(), COARSE_STONE_STAIRS.get(), COARSE_STONE_BRICK_STAIRS.get(), SHADE_STAIRS.get(), SHADE_BRICK_STAIRS.get(), FROST_TILE_STAIRS.get(), FROST_BRICK_STAIRS.get(), CAST_IRON_STAIRS.get(), BLACK_STONE_STAIRS.get(), BLACK_STONE_BRICK_STAIRS.get(), MYCELIUM_STAIRS.get(), MYCELIUM_BRICK_STAIRS.get(), CHALK_STAIRS.get(), CHALK_BRICK_STAIRS.get(), PINK_STONE_BRICK_STAIRS.get(), BROWN_STONE_BRICK_STAIRS.get(), GREEN_STONE_BRICK_STAIRS.get(), FLOWERY_MOSSY_STONE_BRICK_STAIRS.get());
		tag(SLABS).add(COARSE_STONE_SLAB.get(), COARSE_STONE_BRICK_SLAB.get(), BLACK_CASTLE_BRICK_SLAB.get(), DARK_GRAY_CASTLE_BRICK_SLAB.get(), LIGHT_GRAY_CASTLE_BRICK_SLAB.get(), WHITE_CASTLE_BRICK_SLAB.get(), CHALK_SLAB.get(), CHALK_BRICK_SLAB.get(), PINK_STONE_BRICK_SLAB.get(), BROWN_STONE_BRICK_SLAB.get(), GREEN_STONE_BRICK_SLAB.get(), BLACK_STONE_SLAB.get(), BLACK_STONE_BRICK_SLAB.get(), MYCELIUM_SLAB.get(), MYCELIUM_BRICK_SLAB.get(), FLOWERY_MOSSY_STONE_BRICK_SLAB.get(), FROST_TILE_SLAB.get(), FROST_BRICK_SLAB.get(), SHADE_SLAB.get(), SHADE_BRICK_SLAB.get());
		...
		needsWoodPickaxe(BLACK_CASTLE_BRICKS.get(), DARK_GRAY_CASTLE_BRICKS.get(), LIGHT_GRAY_CASTLE_BRICKS.get(), WHITE_CASTLE_BRICKS.get());
		needsWoodPickaxe(BLACK_CASTLE_BRICK_SMOOTH.get(), DARK_GRAY_CASTLE_BRICK_SMOOTH.get(), LIGHT_GRAY_CASTLE_BRICK_SMOOTH.get(), WHITE_CASTLE_BRICK_SMOOTH.get());
		needsWoodPickaxe(BLACK_CASTLE_BRICK_TRIM.get(), DARK_GRAY_CASTLE_BRICK_TRIM.get(), LIGHT_GRAY_CASTLE_BRICK_TRIM.get(), WHITE_CASTLE_BRICK_TRIM.get());
		...
		needsWoodPickaxe(COARSE_STONE.get(), CHISELED_COARSE_STONE.get(), COARSE_STONE_BRICKS.get(), COARSE_STONE_COLUMN.get(), CHISELED_COARSE_STONE_BRICKS.get(), CRACKED_COARSE_STONE_BRICKS.get(), MOSSY_COARSE_STONE);
		...
		needsStonePickaxe(HORIZONTAL_GREEN_STONE_BRICKS.get(), VERTICAL_GREEN_STONE_BRICKS.get(), GREEN_STONE_BRICK_TRIM.get());
		...
		needsWoodPickaxe(BLACK_CASTLE_BRICK_STAIRS.get(), DARK_GRAY_CASTLE_BRICK_STAIRS.get(), LIGHT_GRAY_CASTLE_BRICK_STAIRS.get(), WHITE_CASTLE_BRICK_STAIRS.get());
		...
		needsWoodPickaxe(BLACK_CASTLE_BRICK_SLAB.get(), DARK_GRAY_CASTLE_BRICK_SLAB.get(), LIGHT_GRAY_CASTLE_BRICK_SLAB.get(), WHITE_CASTLE_BRICK_SLAB.get());
		...
		tag(MSTags.Blocks.GOLD_ORES).add(SANDSTONE_GOLD_ORE.get(), RED_SANDSTONE_GOLD_ORE.get(), SHADE_STONE_GOLD_ORE.get(), PINK_STONE_GOLD_ORE);
