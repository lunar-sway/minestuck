...
public class MinestuckBlockTagsProvider extends BlockTagsProvider
{
	...
	protected void addTags()
	{
		...
		tag(STAIRS).add(BLACK_CASTLE_BRICK_STAIRS, DARK_GRAY_CASTLE_BRICK_STAIRS, LIGHT_GRAY_CASTLE_BRICK_STAIRS, WHITE_CASTLE_BRICK_STAIRS, COARSE_STONE_STAIRS, SHADE_STAIRS, SHADE_BRICK_STAIRS, FROST_STAIRS, FROST_BRICK_STAIRS, CAST_IRON_STAIRS, BLACK_STONE_STAIRS, BLACK_STONE_BRICK_STAIRS, MYCELIUM_STAIRS, MYCELIUM_BRICK_STAIRS, CHALK_STAIRS, CHALK_BRICK_STAIRS, PINK_STONE_BRICK_STAIRS, BROWN_STONE_BRICK_STAIRS, GREEN_STONE_BRICK_STAIRS, FLOWERY_MOSSY_STONE_STAIRS, FLOWERY_MOSSY_STONE_BRICK_STAIRS);
		tag(SLABS).add(COARSE_STONE_SLAB, BLACK_CASTLE_BRICK_SLAB, DARK_GRAY_CASTLE_BRICK_SLAB, LIGHT_GRAY_CASTLE_BRICK_SLAB, WHITE_CASTLE_BRICK_SLAB, CHALK_SLAB, CHALK_BRICK_SLAB, PINK_STONE_BRICK_SLAB, BROWN_STONE_BRICK_SLAB, GREEN_STONE_BRICK_SLAB, BLACK_STONE_SLAB, BLACK_STONE_BRICK_SLAB, MYCELIUM_SLAB, MYCELIUM_BRICK_SLAB, FLOWERY_MOSSY_STONE_SLAB, FLOWERY_MOSSY_STONE_BRICK_SLAB, FROST_SLAB, FROST_BRICK_SLAB, SHADE_SLAB, SHADE_BRICK_SLAB);
		...
		tag(Tags.Blocks.STONE).add(COARSE_STONE, SHADE_STONE, FLOWERY_MOSSY_STONE, MYCELIUM_STONE, BLACK_STONE, COARSE_END_STONE, PINK_STONE, BROWN_STONE, GREEN_STONE);
