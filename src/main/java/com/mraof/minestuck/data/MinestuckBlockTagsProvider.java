...
public class MinestuckBlockTagsProvider extends BlockTagsProvider
{
	...
	protected void addTags()
	{
		...
		tag(GREEN_HIEROGLYPHS).add(GREEN_STONE_BRICK_FROG, GREEN_STONE_BRICK_LOTUS, GREEN_STONE_BRICK_IGUANA_LEFT, GREEN_STONE_BRICK_IGUANA_RIGHT, GREEN_STONE_BRICK_NAK_LEFT, GREEN_STONE_BRICK_NAK_RIGHT, GREEN_STONE_BRICK_SALAMANDER_LEFT, GREEN_STONE_BRICK_SALAMANDER_RIGHT, GREEN_STONE_BRICK_SKAIA, GREEN_STONE_BRICK_TURTLE);
