...
public final class AspectTreeBlocksData
{
	...
	public static void addToBlockTags(MinestuckBlockTagsProvider provider)
	{
		provider.tag(BlockTags.MINEABLE_WITH_AXE).add(BLOOD_ASPECT_LOG.asBlock(), BLOOD_ASPECT_WOOD.asBlock(),
				...
				BLOOD_ASPECT_SIGN.get(), BLOOD_ASPECT_HANGING_SIGN.get(),
				BLOOD_ASPECT_WALL_SIGN.get(), BLOOD_ASPECT_WALL_HANGING_SIGN.get());
		provider.tag(BlockTags.MINEABLE_WITH_AXE).add(BREATH_ASPECT_LOG.asBlock(), BREATH_ASPECT_WOOD.asBlock(),
				...
				BREATH_ASPECT_SIGN.get(), BREATH_ASPECT_HANGING_SIGN.get(),
				BREATH_ASPECT_WALL_SIGN.get(), BREATH_ASPECT_WALL_HANGING_SIGN.get());
		provider.tag(BlockTags.MINEABLE_WITH_AXE).add(DOOM_ASPECT_LOG.asBlock(), DOOM_ASPECT_WOOD.asBlock(),
				...
				DOOM_ASPECT_SIGN.get(), DOOM_ASPECT_HANGING_SIGN.get(),
				DOOM_ASPECT_WALL_SIGN.get(), DOOM_ASPECT_WALL_HANGING_SIGN.get());
		provider.tag(BlockTags.MINEABLE_WITH_AXE).add(HEART_ASPECT_LOG.asBlock(), HEART_ASPECT_WOOD.asBlock(),
				...
				HEART_ASPECT_SIGN.get(), HEART_ASPECT_HANGING_SIGN.get(),
				HEART_ASPECT_WALL_SIGN.get(), HEART_ASPECT_WALL_HANGING_SIGN.get());
		provider.tag(BlockTags.MINEABLE_WITH_AXE).add(HOPE_ASPECT_LOG.asBlock(), HOPE_ASPECT_WOOD.asBlock(),
				...
				HOPE_ASPECT_SIGN.get(), HOPE_ASPECT_HANGING_SIGN.get(),
				HOPE_ASPECT_WALL_SIGN.get(), HOPE_ASPECT_WALL_HANGING_SIGN.get());
		provider.tag(BlockTags.MINEABLE_WITH_AXE).add(LIFE_ASPECT_LOG.asBlock(), LIFE_ASPECT_WOOD.asBlock(),
				...
				LIFE_ASPECT_SIGN.get(), LIFE_ASPECT_HANGING_SIGN.get(),
				LIFE_ASPECT_WALL_SIGN.get(), LIFE_ASPECT_WALL_HANGING_SIGN.get());
		provider.tag(BlockTags.MINEABLE_WITH_AXE).add(LIGHT_ASPECT_LOG.asBlock(), LIGHT_ASPECT_WOOD.asBlock(),
				...
				LIGHT_ASPECT_SIGN.get(), LIGHT_ASPECT_HANGING_SIGN.get(),
				LIGHT_ASPECT_WALL_SIGN.get(), LIGHT_ASPECT_WALL_HANGING_SIGN.get());
		provider.tag(BlockTags.MINEABLE_WITH_AXE).add(MIND_ASPECT_LOG.asBlock(), MIND_ASPECT_WOOD.asBlock(),
				...
				MIND_ASPECT_SIGN.get(), MIND_ASPECT_HANGING_SIGN.get(),
				MIND_ASPECT_WALL_SIGN.get(), MIND_ASPECT_WALL_HANGING_SIGN.get());
		provider.tag(BlockTags.MINEABLE_WITH_AXE).add(RAGE_ASPECT_LOG.asBlock(), RAGE_ASPECT_WOOD.asBlock(),
				...
				RAGE_ASPECT_SIGN.get(), RAGE_ASPECT_HANGING_SIGN.get(),
				RAGE_ASPECT_WALL_SIGN.get(), RAGE_ASPECT_WALL_HANGING_SIGN.get());
		provider.tag(BlockTags.MINEABLE_WITH_AXE).add(SPACE_ASPECT_LOG.asBlock(), SPACE_ASPECT_WOOD.asBlock(),
				...
				SPACE_ASPECT_SIGN.get(), SPACE_ASPECT_HANGING_SIGN.get(),
				SPACE_ASPECT_WALL_SIGN.get(), SPACE_ASPECT_WALL_HANGING_SIGN.get());
		provider.tag(BlockTags.MINEABLE_WITH_AXE).add(TIME_ASPECT_LOG.asBlock(), TIME_ASPECT_WOOD.asBlock(),
				...
				TIME_ASPECT_SIGN.get(), TIME_ASPECT_HANGING_SIGN.get(),
				TIME_ASPECT_WALL_SIGN.get(), TIME_ASPECT_WALL_HANGING_SIGN.get());
		provider.tag(BlockTags.MINEABLE_WITH_AXE).add(VOID_ASPECT_LOG.asBlock(), VOID_ASPECT_WOOD.asBlock(),
				...
				VOID_ASPECT_SIGN.get(), VOID_ASPECT_HANGING_SIGN.get(),
				VOID_ASPECT_WALL_SIGN.get(), VOID_ASPECT_WALL_HANGING_SIGN.get());
