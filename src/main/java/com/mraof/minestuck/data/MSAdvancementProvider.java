...
public class MSAdvancementProvider implements DataProvider
{
	...
	{
		Advancement root = Advancement.Builder.advancement().display(MSItems.RAW_CRUXITE9j, new TranslatableComponent(title(ROOT)), new TranslatableComponent(desc(ROOT)), new ResourceLocation("minestuck:textures/gui/advancement_bg.png"), FrameType.TASK, false, false, false).addCriterion("raw_cruxite", InventoryChangeTrigger.TriggerInstance.hasItems(MSItems.RAW_CRUXITE9j)).save(advancementSaver, Minestuck.MOD_ID+":minestuck/root");
		Advancement searching = Advancement.Builder.advancement().parent(root).display(Items.COMPASS, new TranslatableComponent(title(SEARCHING)), new TranslatableComponent(desc(SEARCHING)), null, FrameType.TASK, true, true, false).addCriterion("possess_scanner", InventoryChangeTrigger.TriggerInstance.hasItems(MSItems.TEMPLE_SCANNER9j)).save(advancementSaver, Minestuck.MOD_ID+":minestuck/searching");
		Advancement longTimeComing = Advancement.Builder.advancement().parent(root).display(MSItems.SBURB_CODE9j, new TranslatableComponent(title(LONG_TIME_COMING)), new TranslatableComponent(desc(LONG_TIME_COMING)), null, FrameType.TASK, true, true, false).addCriterion("possess_code", InventoryChangeTrigger.TriggerInstance.hasItems(MSItems.SBURB_CODE9j)).save(advancementSaver, Minestuck.MOD_ID+":minestuck/long_time_coming");
		Advancement connect = Advancement.Builder.advancement().parent(root).display(MSItems.CLIENT_DISK9j, new TranslatableComponent(title(CONNECT)), new TranslatableComponent(desc(CONNECT)), null, FrameType.TASK, true, true, false).addCriterion("connection", EventTrigger.Instance.sburbConnection()).save(advancementSaver, Minestuck.MOD_ID+":minestuck/connect");
		Advancement entry = Advancement.Builder.advancement().parent(connect).display(ColorHandler.setDefaultColor(new ItemStack(MSItems.CRUXITE_APPLE9j)), new TranslatableComponent(title(ENTRY)), new TranslatableComponent(desc(ENTRY)), null, FrameType.TASK, true, true, false).addCriterion("use_artifact", EventTrigger.Instance.cruxiteArtifact()).save(advancementSaver, Minestuck.MOD_ID+":minestuck/entry");
		Advancement alchemy = Advancement.Builder.advancement().parent(entry).display(MSItems.CAPTCHA_CARD9j, new TranslatableComponent(title(ALCHEMY)), new TranslatableComponent(desc(ALCHEMY)), null, FrameType.TASK, true, true, false).addCriterion("use_punch_designix", PunchDesignixTrigger.Instance.any()).save(advancementSaver, Minestuck.MOD_ID+":minestuck/alchemy");
		Advancement newModus = Advancement.Builder.advancement().parent(alchemy).display(MSItems.HASHMAP_MODUS_CARD9j, new TranslatableComponent(title(NEW_MODUS)), new TranslatableComponent(desc(NEW_MODUS)), null, FrameType.TASK, true, true, false).addCriterion("change_modus_type", ChangeModusTrigger.Instance.any()).save(advancementSaver, Minestuck.MOD_ID+":minestuck/new_modus");
		Advancement allModi = changeModusCriteria(Advancement.Builder.advancement().parent(newModus).display(MSItems.QUEUESTACK_MODUS_CARD9j, new TranslatableComponent(title(ALL_MODI)), new TranslatableComponent(desc(ALL_MODI)), null, FrameType.TASK, true, true, false).requirements(RequirementsStrategy.AND)).save(advancementSaver, Minestuck.MOD_ID+":minestuck/all_modi");
		...
		Advancement frenchFry = Advancement.Builder.advancement().parent(alchemy).display(MSItems.FRENCH_FRY9j, new TranslatableComponent(title(FRENCH_FRY)), new TranslatableComponent(desc(FRENCH_FRY)), null, FrameType.TASK, true, true, false).addCriterion("has_french_fry", ConsumeItemTrigger.TriggerInstance.usedItem(MSItems.FRENCH_FRY9j)).save(advancementSaver, Minestuck.MOD_ID+":minestuck/french_fry");
		Advancement melonOverload = Advancement.Builder.advancement().parent(alchemy).display(MSItems.MELONSBANE9j, new TranslatableComponent(title(MELON_OVERLOAD)), new TranslatableComponent(desc(MELON_OVERLOAD)), null, FrameType.TASK, true, true, true).addCriterion("melon_overload", EventTrigger.Instance.melonOverload()).save(advancementSaver, Minestuck.MOD_ID+":minestuck/melon_overload");
		Advancement treeModus = Advancement.Builder.advancement().parent(newModus).display(MSItems.TREE_MODUS_CARD9j, new TranslatableComponent(title(TREE_MODUS)), new TranslatableComponent(desc(TREE_MODUS)), null, FrameType.TASK, true, true, false).addCriterion("tree_root", TreeModusRootTrigger.Instance.count(MinMaxBounds.Ints.atLeast(16))).save(advancementSaver, Minestuck.MOD_ID+":minestuck/tree_modus");
		Advancement killOgre = Advancement.Builder.advancement().parent(entry).display(MSItems.POGO_HAMMER9j, new TranslatableComponent(title(KILL_OGRE)), new TranslatableComponent(desc(KILL_OGRE)), null, FrameType.TASK, true, true, false).addCriterion("kill_ogre", KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity().of(MSEntityTypes.OGRE))).save(advancementSaver, Minestuck.MOD_ID+":minestuck/kill_ogre");
		...
		Advancement commune = Advancement.Builder.advancement().parent(entry).display(MSItems.STONE_SLAB9j, new TranslatableComponent(title(COMMUNE)), new TranslatableComponent(desc(COMMUNE)), null, FrameType.TASK, true, true, false).requirements(RequirementsStrategy.AND).addCriterion("talk_to_consort", ConsortTalkTrigger.Instance.any()).addCriterion("visit_village", LocationTrigger.TriggerInstance.located(LocationPredicate.inFeature(Objects.requireNonNull(MSStructureFeatures.CONSORT_VILLAGE.getKey())))).save(advancementSaver, Minestuck.MOD_ID+":minestuck/commune");
		Advancement bugs = consumeBugCriteria(Advancement.Builder.advancement().parent(commune).display(MSItems.CHOCOLATE_BEETLE9j, new TranslatableComponent(title(BUGS)), new TranslatableComponent(desc(BUGS)), null, FrameType.TASK, true, true, false).requirements(RequirementsStrategy.OR)).save(advancementSaver, Minestuck.MOD_ID+":minestuck/bugs");
		Advancement shadyBuyer = Advancement.Builder.advancement().parent(commune).display(MSItems.ROCK_COOKIE9j, new TranslatableComponent(title(SHADY_BUYER)), new TranslatableComponent(desc(SHADY_BUYER)), null, FrameType.TASK, true, true, false).addCriterion("buy_item", ConsortItemTrigger.Instance.forType(EnumConsort.MerchantType.SHADY)).save(advancementSaver, Minestuck.MOD_ID+":minestuck/shady_buyer");
	}
	...
	{
		for(ItemLike item : Arrays.asList(MSItems.BUG_ON_A_STICK9j, MSItems.CHOCOLATE_BEETLE9j, MSItems.CONE_OF_FLIES9j, MSItems.GRASSHOPPER9j, MSItems.JAR_OF_BUGS9j))
		{
