...
public class MinestuckEnUsLanguageProvider extends MinestuckLanguageProvider
{
	...
	protected void addTranslations()
	{
		...
		add(MSItems.CLAW_HAMMER.get(), "Claw Hammer");
		addTooltip(MSItems.CLAW_HAMMER.get(), "An average hammer found in about any garage. It can also destroy blocks");
		add(MSItems.SLEDGE_HAMMER.get(), "Sledgehammer");
		addTooltip(MSItems.SLEDGE_HAMMER.get(), "A decently large, yet average, hammer. It can also destroy blocks");
		add(MSItems.MAILBOX.get(), "Mailbox");
		addTooltip(MSItems.MAILBOX.get(), "Literally just a mailbox");
		add(MSItems.BLACKSMITH_HAMMER.get(), "Blacksmith's Hammer");
		addTooltip(MSItems.BLACKSMITH_HAMMER.get(), "A strong hammer that would commonly be found in a blacksmiths. It can also break blocks");
		add(MSItems.POGO_HAMMER.get(), "Pogo Hammer");
		addTooltip(MSItems.POGO_HAMMER.get(), "A slimy hammer with the ability to bounce back your enemies. It can also break blocks");
		add(MSItems.WRINKLEFUCKER.get(), "Wrinklefucker");
		addTooltip(MSItems.WRINKLEFUCKER.get(), "Is there anything more iconic?");
		add(MSItems.TELESCOPIC_SASSACRUSHER.get(), "Telescopic Sassacrusher");
		addTooltip(MSItems.TELESCOPIC_SASSACRUSHER.get(), "OH ho! The perfect hammer for the dashing young gent who loves a pranksters gambit or a good grist horde!");
		add(MSItems.DEMOCRATIC_DEMOLITIONER.get(), "DEMOCRATIC DEMOLITIONER");
		add(MSItems.REGI_HAMMER.get(), "Regihammer");
		add(MSItems.FEAR_NO_ANVIL.get(), "Fear No Anvil");
		addTooltip(MSItems.FEAR_NO_ANVIL.get(), "Break blocks and stop clocks with the hammer of Hephaestus");
		add(MSItems.MELT_MASHER.get(), "Melt-Masher");
		addTooltip(MSItems.MELT_MASHER.get(), "This hot-commodity of a hammer looks like it came fresh out of the furnace! Leaves foes with third-degree burns.");
		add(MSItems.ESTROGEN_EMPOWERED_EVERYTHING_ERADICATOR.get(), "Estrogen-Empowered Everything Eradicator");
		addTooltip(MSItems.ESTROGEN_EMPOWERED_EVERYTHING_ERADICATOR.get(), "Eradicate everything with girl power!");
		add(MSItems.EEEEEEEEEEEE.get(), "the swEEt bro and hElla jEff EstrogEn EmpowErEd EvErything Eradicator");
		addTooltip(MSItems.EEEEEEEEEEEE.get(), "Eradicate everything with girl power?");
		add(MSItems.ZILLYHOO_HAMMER.get(), "Warhammer of Zillyhoo");
		addTooltip(MSItems.ZILLYHOO_HAMMER.get(), "HooHoo This zilly weapon is rumoured to be able to defeat the strongest enemies!");
		add(MSItems.POPAMATIC_VRILLYHOO.get(), "Pop-a-matic Vrillyhoo Hammer");
		addTooltip(MSItems.POPAMATIC_VRILLYHOO.get(), "Pop! Hit an enemy and let the dice fly for  damage bonus! It can Also Break blocks.");
		add(MSItems.SCARLET_ZILLYHOO.get(), "Scarlet Zillyhoo");
		addTooltip(MSItems.SCARLET_ZILLYHOO.get(), "A legendary weapon, forged from the most powerful of charmic destiny and..a red frog...");
		add(MSItems.MWRTHWL.get(), "Mwrthwl");
		add(MSItems.SORD.get(), "Sord.....");
		addTooltip(MSItems.SORD.get(), "A shitty sword. Not much more too it.");
		addExtra(MSItems.SORD.get(), OnHitEffect.SORD_DROP_MESSAGE, "The shittiness of the sord made it phase through your hand");
		add(MSItems.PAPER_SWORD.get(), "Paper Sword");
		addTooltip(MSItems.PAPER_SWORD.get(), "None shall be the wiser. It is the perfect crime.");
		add(MSItems.SWONGE.get(), "Swonge");
		addTooltip(MSItems.SWONGE.get(), "Schlorp.");
		add(MSItems.WET_SWONGE.get(), "Wet Swonge");
		addTooltip(MSItems.WET_SWONGE.get(), "Splorch.");
		add(MSItems.PUMORD.get(), "Pumord");
		addTooltip(MSItems.PUMORD.get(), "A sword made of pumice. Is it really much of a blade anymore?");
		add(MSItems.WET_PUMORD.get(), "Wet Pumord");
		addTooltip(MSItems.WET_PUMORD.get(), "Yeoch! Looks preddy hot.");
		add(MSItems.CACTACEAE_CUTLASS.get(), "Cactaceae Cutlass");
		addTooltip(MSItems.CACTACEAE_CUTLASS.get(), "A spiny sword made of cactus, you might hurt yourself more on the spines then the blade would your enemies");
		addStoreTooltip(MSItems.CACTACEAE_CUTLASS.get(), "It's not as quenchy, but if it comes down to it you can always drink the blood of your foes.");
		add(MSItems.STEAK_SWORD.get(), "Steak Sword");
		addTooltip(MSItems.STEAK_SWORD.get(), "This item has two purposes: a weapon for slicing your foes AND an expensive dinner!");
		addStoreTooltip(MSItems.STEAK_SWORD.get(), "A sword? Made of meat? That's like, double cool!");
		add(MSItems.BEEF_SWORD.get(), "Raw Beef Sword");
		add(MSItems.IRRADIATED_STEAK_SWORD.get(), "Irradiated Steak Sword");
		add(MSItems.MACUAHUITL.get(), "Macuahuitl");
		add(MSItems.FROSTY_MACUAHUITL.get(), "Frosty Macuahuitl");
		addTooltip(MSItems.FROSTY_MACUAHUITL.get(), "Now featuring real Ice Shards");
		add(MSItems.KATANA.get(), "Katana");
		addTooltip(MSItems.KATANA.get(), "A powerful Katana, once wielded by the most powerful of Otaku Masters");
		add(MSItems.UNBREAKABLE_KATANA.get(), "Unbreakable Katana");
		addTooltip(MSItems.UNBREAKABLE_KATANA.get(), "This Katana has been fused with bedrock to make it even more kawai- I mean powerful!");
		add(MSItems.ANGEL_APOCALYPSE.get(), "Angel Apocalypse");
		addTooltip(MSItems.ANGEL_APOCALYPSE.get(), "This sword either starts the end of the world or prevents the end from occurring. Hopefully the latter!");
		add(MSItems.FIRE_POKER.get(), "Fire Poker");
		addTooltip(MSItems.FIRE_POKER.get(), "A flaming blade! Or just that thing you find next to wood fire places.....either way it can burn you enemies");
		addStoreTooltip(MSItems.FIRE_POKER.get(), "Make sure you don't drop this like it's hot. Because it is hot.");
		add(MSItems.TOO_HOT_TO_HANDLE.get(), "Too Hot to Handle");
		addTooltip(MSItems.TOO_HOT_TO_HANDLE.get(), "This sick blade slices and burns through enemies like there is no tomorrow!");
		add(MSItems.CALEDSCRATCH.get(), "Caledscratch");
		addTooltip(MSItems.CALEDSCRATCH.get(), "The chosen weapon of Hephaestus, Guardian of the land of heat and clockwork. They say if you break this blade you incur their godly wrath.");
		add(MSItems.CALEDFWLCH.get(), "Caledfwlch");
		addTooltip(MSItems.CALEDFWLCH.get(), "Dumb Welsh Sword. Probably has some chamic destiny.");
		add(MSItems.ROYAL_DERINGER.get(), "Royal Deringer");
		add(MSItems.CLAYMORE.get(), "Claymore");
		addTooltip(MSItems.CLAYMORE.get(), "A featherweight amongst greatswords. It's still bloody heavy, though!");
		add(MSItems.CUTLASS_OF_ZILLYWAIR.get(), "Cutlass of Zillywair");
		addTooltip(MSItems.CUTLASS_OF_ZILLYWAIR.get(), "HooHoo! Another Zilly weapon imported straight from Zillywair! Enemies beware!");
		add(MSItems.REGISWORD.get(), "Regisword");
		addTooltip(MSItems.REGISWORD.get(), "A sword once wielded by the most wicked of ArchAgents......and the most devout mail lady");
		add(MSItems.CRUEL_FATE_CRUCIBLE.get(), "Cruel Fate Crucible");
		addTooltip(MSItems.CRUEL_FATE_CRUCIBLE.get(), "The aura of Nemesis enacts retribution on those who hurt it's wielder");
		add(MSItems.SCARLET_RIBBITAR.get(), "Scarlet Ribbitar");
		add(MSItems.DOGG_MACHETE.get(), "Snoop Dogg Snow Cone Machete");
		add(MSItems.COBALT_SABRE.get(), "Cobalt Cobeam Coblade");
		add(MSItems.QUANTUM_SABRE.get(), "Quantum Sabre");
		add(MSItems.SHATTER_BEACON.get(), "ShatterBeacon");
		add(MSItems.SHATTER_BACON.get(), "ShatterBacon");
		addTooltip(MSItems.SHATTER_BACON.get(), "This thing is so unspeakably greasy you are having a hard time even holding it.");
		addExtra(MSItems.SHATTER_BACON.get(), OnHitEffect.SORD_DROP_MESSAGE, "The grease caused the ShatterBacon to slip from your grasp!");
		add(MSItems.SUBTRACTSHUMIDIRE_ZOMORRODNEGATIVE.get(), "SUBTRACTSHUMIDIR-E ZOMORRODNEGATIVE");
		add(MSItems.DAGGER.get(), "Dagger");
		add(MSItems.NIFE.get(), "nife.");
		addExtra(MSItems.NIFE.get(), OnHitEffect.SORD_DROP_MESSAGE, "Whoopsies doopsies you dwopped the nife!!");
		add(MSItems.LIGHT_OF_MY_KNIFE.get(), "Light Of My Knife");
		add(MSItems.STARSHARD_TRI_BLADE.get(), "Starshard Tri-Blade");
		add(MSItems.TOOTHRIPPER.get(), "Toothripper");
		add(MSItems.BATLEACKS.get(), "batleacks!!");
		addTooltip(MSItems.BATLEACKS.get(), "A shitty axe. Not much more to it.");
		addExtra(MSItems.BATLEACKS.get(), OnHitEffect.SORD_DROP_MESSAGE, "The shittiness of the batleacks made it phase through your hand");
		add(MSItems.COPSE_CRUSHER.get(), "Coppice Crusher");
		addStoreTooltip(MSItems.COPSE_CRUSHER.get(), "Good for crushing trees and your enemies!");
		add(MSItems.QUENCH_CRUSHER.get(), "Quench Crusher");
		addTooltip(MSItems.QUENCH_CRUSHER.get(), "Quench Crusher... isn't that the opposite of what it does? Shouldn't it be Thirst Quencher? Drought Crusher? Whatever.");
		addStoreTooltip(MSItems.QUENCH_CRUSHER.get(), "This fruity-flavored axe has been passed down from generation to generation.");
		add(MSItems.MELONSBANE.get(), "Melonsbane");
		addTooltip(MSItems.MELONSBANE.get(), "It seems to be multipurpose; you can commit acts of violence against melons and foes.");
		addExtra(MSItems.MELONSBANE.get(), "message", "M- M- M- MELON OVERLOAD!!!!!!");
		add(MSItems.CROP_CHOP.get(), "Crop Chop");
		addTooltip(MSItems.CROP_CHOP.get(), "Double crop from a single chop. Excellent!");
		add(MSItems.THE_LAST_STRAW.get(), "The Last Straw");
		add(MSItems.BATTLEAXE.get(), "Battleaxe");
		addTooltip(MSItems.BATTLEAXE.get(), "Forget that sissy hatchet stuff, this is an axe made for the battlefield. Chop heads, not wood!");
		add(MSItems.CANDY_BATTLEAXE.get(), "Candy Battleaxe");
		addTooltip(MSItems.CANDY_BATTLEAXE.get(), "Oh, how glory and honor is sweet!");
		add(MSItems.CHOCO_LOCO_WOODSPLITTER.get(), "Choco Loco Woodsplitter");
		addTooltip(MSItems.CHOCO_LOCO_WOODSPLITTER.get(), "Now to match this, you'd just need armor engraved with 'I'm a chocoholic!'");
		add(MSItems.STEEL_EDGE_CANDYCUTTER.get(), "Choco Loco Steeled Cocoa Candycutter");
		addTooltip(MSItems.STEEL_EDGE_CANDYCUTTER.get(), "All the benefits of the Choco Loco Woodsplitter, now with more bloodshed! Perfect!");
		add(MSItems.BLACKSMITH_BANE.get(), "Blacksmith's Bane");
		add(MSItems.REGIAXE.get(), "Regiaxe");
		add(MSItems.GOTHY_AXE.get(), "Gothy Axe");
        add(MSItems.SURPRISE_AXE.get(), "Kundler Surprise Axe");
        addTooltip(MSItems.SURPRISE_AXE.get(), "Who knows what surprises this bad boy has in store!");
		addExtra(MSItems.SURPRISE_AXE.get(), "message", "WOW! NO WAY! You found a %s from your opponent!");
		add(MSItems.SHOCK_AXE.get(), "Kundler Shock Axe");
		addTooltip(MSItems.SHOCK_AXE.get(), "An electric surprise!");
		add(MSItems.SHOCK_AXE_UNPOWERED.get(), "Kundler Shock Axe");
		addTooltip(MSItems.SHOCK_AXE_UNPOWERED.get(), "An electric surprise!");
		add(MSItems.SCRAXE.get(), "Scraxe");
		add(MSItems.LORENTZ_DISTRANSFORMATIONER.get(), "Lorentz Distransformationer");
		addTooltip(MSItems.LORENTZ_DISTRANSFORMATIONER.get(), "In physics, the Lorentz transformations are a six-parameter family of linear transformations from a coordinate frame in spacetime to another frame that moves at a constant velocity relative to the former. The respective inverse transformation is then parametrized by the negative of this velocity.");
		add(MSItems.PISTON_POWERED_POGO_AXEHAMMER.get(), "Piston-Powered Pogo Pulverizer");
		add(MSItems.RUBY_CROAK.get(), "Ruby Croak");
		add(MSItems.HEPHAESTUS_LUMBERJACK.get(), "Hephaestus' Lumberjack");
		add(MSItems.FISSION_FOCUSED_FAULT_FELLER.get(), "Fission-Focused Fault Feller");
		add(MSItems.BISECTOR.get(), "Bisector");
		addTooltip(MSItems.BISECTOR.get(), "Cleave foes in twain... with pride :]");
		add(MSItems.FINE_CHINA_AXE.get(), "Fine China Axe");
		addTooltip(MSItems.FINE_CHINA_AXE.get(), "Physically I'm here but mentally I'm still thinking about that ceramic battle axe...");
		add(MSItems.DICE.get(), "Dice");
		addTooltip(MSItems.DICE.get(), "Dungeons and Dragons anybody?");
		add(MSItems.FLUORITE_OCTET.get(), "Fluorite Octet");
		addTooltip(MSItems.FLUORITE_OCTET.get(), "Magical Dice! Let 'em roll!");
		add(MSItems.CAT_CLAWS_DRAWN.get(), "Cat Claws");
		add(MSItems.CAT_CLAWS_SHEATHED.get(), "Cat Claws");
		add(MSItems.SKELETONIZER_DRAWN.get(), "Skeletonizer");
		addTooltip(MSItems.SKELETONIZER_DRAWN.get(), "Why don't skeletons get upset? Because nothing gets under their skin! This weapon sure might however.");
		add(MSItems.SKELETONIZER_SHEATHED.get(), "Skeletonizer");
		addTooltip(MSItems.SKELETONIZER_SHEATHED.get(), "Why don't skeletons get upset? Because nothing gets under their skin! This weapon sure might however.");
		add(MSItems.SKELETON_DISPLACER_DRAWN.get(), "Skeleton Displacer");
		addTooltip(MSItems.SKELETON_DISPLACER_DRAWN.get(), "Effective against skeletons!");
		add(MSItems.SKELETON_DISPLACER_SHEATHED.get(), "Skeleton Displacer");
		addTooltip(MSItems.SKELETON_DISPLACER_SHEATHED.get(), "Effective against skeletons!");
		add(MSItems.TEARS_OF_THE_ENDERLICH_DRAWN.get(), "Tears of the Enderlich");
		addTooltip(MSItems.TEARS_OF_THE_ENDERLICH_DRAWN.get(), "Effective against liches!");
		add(MSItems.TEARS_OF_THE_ENDERLICH_SHEATHED.get(), "Tears of the Enderlich");
		addTooltip(MSItems.TEARS_OF_THE_ENDERLICH_SHEATHED.get(), "Effective against liches!");
		add(MSItems.ACTION_CLAWS_DRAWN.get(), "Action Claws");
		add(MSItems.ACTION_CLAWS_SHEATHED.get(), "Action Claws");
		add(MSItems.LIPSTICK_CHAINSAW.get(), "Chainsaw");
		add(MSItems.LIPSTICK.get(), "Jade Lipstick");
		add(MSItems.THISTLEBLOWER.get(), "Thistleblower");
		add(MSItems.THISTLEBLOWER_LIPSTICK.get(), "Rosy Lipstick");
		add(MSItems.EMERALD_IMMOLATOR.get(), "Emerald Immolator");
		add(MSItems.EMERALD_IMMOLATOR_LIPSTICK.get(), "Lipodemic Lipstick");
		add(MSItems.FROSTTOOTH.get(), "Frosttooth");
		add(MSItems.FROSTTOOTH_LIPSTICK.get(), "Calcium Froststick");
		addTooltip(MSItems.FROSTTOOTH_LIPSTICK.get(), "Feels cold and sharp");
		add(MSItems.OBSIDIATOR.get(), "Obsidiator");
		add(MSItems.OBSIDIATOR_LIPSTICK.get(), "Fuschia Lipstick");
		add(MSItems.JOUSTING_LANCE.get(), "Jousting Lance");
		add(MSItems.CIGARETTE_LANCE.get(), "Cigarette Holder Lance");
		add(MSItems.LUCERNE_HAMMER.get(), "Lucerne Hammer");
		add(MSItems.LUCERNE_HAMMER_OF_UNDYING.get(), "Lucerne Hammer of Undying");
		addTooltip(MSItems.LUCERNE_HAMMER_OF_UNDYING.get(), "Delays down your imminent doom");
		add(MSItems.OBSIDIAN_AXE_KNIFE.get(), "Obsidian Axe Knife");
		add(MSItems.FAN.get(), "Fan");
		add(MSItems.TYPHONIC_TRIVIALIZER.get(), "Typhonic Trivializer");
		addTooltip(MSItems.TYPHONIC_TRIVIALIZER.get(), "It's easy being breezy, with this denizen's boon");
		add(MSItems.SICKLE.get(), "Sickle");
		add(MSItems.BISICKLE.get(), "Bisickle");
		add(MSItems.OW_THE_EDGE.get(), "oW THE EDGE");
		add(MSItems.THORNY_SUBJECT.get(), "A Thorny Subject");
		add(MSItems.HEMEOREAPER.get(), "Hemeoreaper");
		addTooltip(MSItems.HEMEOREAPER.get(), "You get the feeling you should hide this away, or maybe paint it a nice gray.");
		add(MSItems.HOMES_SMELL_YA_LATER.get(), "Homes Smell Ya Later");
		add(MSItems.FUDGESICKLE.get(), "Fudgesickle");
		addTooltip(MSItems.FUDGESICKLE.get(), "Whose idea was this?");
		add(MSItems.REGISICKLE.get(), "Regisickle");
		addTooltip(MSItems.REGISICKLE.get(), "A black sickle wielded by Dersites and Agents!");
		add(MSItems.HERETICUS_AURURM.get(), "Hereticus Aururm");
		addTooltip(MSItems.HERETICUS_AURURM.get(), "Did the Dersites get their Latin correct? I dunno, probably not. Go ask a Roman.");
		add(MSItems.CLAW_SICKLE.get(), "Clawsickle");
		addTooltip(MSItems.CLAW_SICKLE.get(), "This crabby blade can hook and pinch your enemies for you!");
		add(MSItems.CLAW_OF_NRUBYIGLITH.get(), "Claw of Nrub'yiglith");
		addTooltip(MSItems.CLAW_OF_NRUBYIGLITH.get(), "Even though it's no longer a part of what you presume to be a living being, it still feels... alive.");
		add(MSItems.CANDY_SICKLE.get(), "Candy Sickle");
		add(MSItems.SCYTHE.get(), "Scythe");
		add(MSItems.EIGHTBALL_SCYTHE.get(), "Eightball Scythe");
		add(MSItems.DEUCE_CLUB.get(), "Deuce Club");
		addTooltip(MSItems.DEUCE_CLUB.get(), "The weakest club in the world");
		add(MSItems.STALE_BAGUETTE.get(), "Stale Baguette");
		add(MSItems.GLUB_CLUB.get(), "Glub Club");
		addTooltip(MSItems.GLUB_CLUB.get(), "Ever been smacked with a raw fish?");
		add(MSItems.NIGHT_CLUB.get(), "Nightclub");
		addTooltip(MSItems.NIGHT_CLUB.get(), "Wanna go...clubbing?");
		add(MSItems.NIGHTSTICK.get(), "Nightstick");
		addTooltip(MSItems.NIGHTSTICK.get(), "NO CLUBBING MOVE ALONG.");
		add(MSItems.RED_EYES.get(), "Red Eyes");
		add(MSItems.PRISMARINE_BASHER.get(), "Prismarine Basher");
		addTooltip(MSItems.PRISMARINE_BASHER.get(), "Smells like sea salt, unsurprisingly.");
		add(MSItems.CLUB_ZERO.get(), "Club Zero");
		addTooltip(MSItems.CLUB_ZERO.get(), "This club is so cold, even just holding it makes your hand numb. But you endure it nonetheless.");
		add(MSItems.POGO_CLUB.get(), "Pogo Club");
		addTooltip(MSItems.POGO_CLUB.get(), "Boing! Bounce back your foes with this bouncy weapon!");
		addStoreTooltip(MSItems.POGO_CLUB.get(), "Strive to touch the sky, and smash a few skulls on the way up!");
		add(MSItems.BARBER_BASHER.get(), "Barber Basher");
		add(MSItems.METAL_BAT.get(), "Metal Bat");
		addTooltip(MSItems.METAL_BAT.get(), "Regular weapons not working for you? Try beating foes with an average bat!");
		add(MSItems.CLOWN_CLUB.get(), "Clown Club");
		addTooltip(MSItems.CLOWN_CLUB.get(), "Rage inducing. Why would you make this");
		add(MSItems.SPIKED_CLUB.get(), "Spiked Club");
		addTooltip(MSItems.SPIKED_CLUB.get(), "About what it sounds like");
		add(MSItems.MACE.get(), "Mace");
		add(MSItems.M_ACE.get(), "mACE");
		add(MSItems.DESOLATOR_MACE.get(), "Desolator Mace");
		addTooltip(MSItems.DESOLATOR_MACE.get(), "Void your enemies existence. Is the damage really that low?");
		add(MSItems.BLAZING_GLORY.get(), "Blazing Glory");
		add(MSItems.HORSE_HITCHER.get(), "Cast Iron Horse Hitcher");
		add(MSItems.ACE_OF_SPADES.get(), "Ace of Spades");
		addStore(MSItems.ACE_OF_SPADES.get(), "Shovel Sigil");
		addStoreTooltip(MSItems.ACE_OF_SPADES.get(), "Who knows, maybe this has digging magic?");
		add(MSItems.CLUB_OF_FELONY.get(), "Club of Felony");
		add(MSItems.ACE_OF_CLUBS.get(), "Ace of Clubs");
		addStore(MSItems.ACE_OF_CLUBS.get(), "Clover Sigil");
		addStoreTooltip(MSItems.ACE_OF_CLUBS.get(), "Perhaps this slip of paper has luck magic?");
		add(MSItems.CUESTICK.get(), "Ultra-Violence Cuestick");
		add(MSItems.ACE_OF_DIAMONDS.get(), "Ace of Diamonds");
		addStore(MSItems.ACE_OF_DIAMONDS.get(), "Star Sigil");
		addStoreTooltip(MSItems.ACE_OF_DIAMONDS.get(), "This star-shaped sigil probably has magical astral properties.");
		add(MSItems.ACE_OF_HEARTS.get(), "Ace of Hearts");
		addStore(MSItems.ACE_OF_HEARTS.get(), "Heart Sigil");
		addStoreTooltip(MSItems.ACE_OF_HEARTS.get(), "This thing MUST have magical love powers!");
		add(MSItems.WHITE_KINGS_SCEPTER.get(), "Kings Scepter");
		addTooltip(MSItems.WHITE_KINGS_SCEPTER.get(), "Starts the Reckoning in the capable hands of a carapacian. It would be hard to call YOU capable however...");
		add(MSItems.BLACK_KINGS_SCEPTER.get(), "Kings Scepter");
		addTooltip(MSItems.BLACK_KINGS_SCEPTER.get(), "Super sizes and prototypes a king, but useless to you. Good for whacking however!");
		add(MSItems.CANE.get(), "Cane");
		addTooltip(MSItems.CANE.get(), "An average walking cane, used by the blind and those with weak knees.");
		add(MSItems.VAUDEVILLE_HOOK.get(), "Vaudeville Hook");
		addTooltip(MSItems.VAUDEVILLE_HOOK.get(), "This is sure to get the audience laughing with the many japes you can pull with this bad boy!");
		add(MSItems.BEAR_POKING_STICK.get(), "Bear-Poking Stick");
		addTooltip(MSItems.BEAR_POKING_STICK.get(), "Do not-- and I repeat, DO NOT-- poke the bear!");
		add(MSItems.CROWBAR.get(), "Crowbar");
		add(MSItems.UMBRELLA.get(), "Umbrella");
		addTooltip(MSItems.UMBRELLA.get(), "Shit, let's be Mary Poppins.");
		add(MSItems.UPPER_CRUST_CRUST_CANE.get(), "Upper Crust Crust Cane");
		addTooltip(MSItems.UPPER_CRUST_CRUST_CANE.get(), "*Now* you're walking like an upper crust!");
		add(MSItems.IRON_CANE.get(), "Iron-Tipped Cane");
		addTooltip(MSItems.IRON_CANE.get(), "A regular cane, except that it is tipped with the power of metal!");
		addStoreTooltip(MSItems.IRON_CANE.get(), "This metal rod is perfect for attracting thunder!");
		add(MSItems.ZEPHYR_CANE.get(), "Zephyr Cane");
		addTooltip(MSItems.ZEPHYR_CANE.get(), "Catch your breath and relax with this casual weapon by your side.");
		add(MSItems.SPEAR_CANE.get(), "Spear Cane");
		addTooltip(MSItems.SPEAR_CANE.get(), "Replace with blind persons cane for hilarious results.");
		add(MSItems.PARADISES_PORTABELLO.get(), "Paradise's Portabello");
		addTooltip(MSItems.PARADISES_PORTABELLO.get(), "A mushroom which reaches the heavens. Good for whacking people.");
		addStoreTooltip(MSItems.PARADISES_PORTABELLO.get(), "This mushroom is very tall! We think Our Glorious Speaker blessed us with it as a gift!");
		add(MSItems.REGI_CANE.get(), "Regicane");
		addTooltip(MSItems.REGI_CANE.get(), "A black cane used only by the most elegant among Dersites.");
		add(MSItems.DRAGON_CANE.get(), "Dragon Cane");
		addTooltip(MSItems.DRAGON_CANE.get(), "The most Powerful and awe inspiring of canes!");
		add(MSItems.DRAGON_CANE_UNSHEATHED.get(), "Dragon Cane");
		addTooltip(MSItems.DRAGON_CANE_UNSHEATHED.get(), "The most Powerful and awe inspiring of canes!");
		add(MSItems.CHANCEWYRMS_EXTRA_FORTUNATE_STABBING_IMPLEMENT.get(), "Chancewyrm's Extra Fortunate Stabbing Implement");
		add(MSItems.CHANCEWYRMS_EXTRA_FORTUNATE_STABBING_IMPLEMENT_UNSHEATHED.get(), "Chancewyrm's Extra Fortunate Stabbing Implement");
		add(MSItems.POGO_CANE.get(), "Pogo Cane");
		addTooltip(MSItems.POGO_CANE.get(), "Now without leg or hand holds for even more danger!");
		add(MSItems.CANDY_CANE.get(), "Candy Cane");
		addTooltip(MSItems.CANDY_CANE.get(), "This striped treat never ceases to delight you, both with its flavor and its capacity for murder.");
		add(MSItems.SHARP_CANDY_CANE.get(), "Sharp Candy Cane");
		addTooltip(MSItems.SHARP_CANDY_CANE.get(), "You wouldn't dare put this bladed delight into your gob-hole, so instead you turn it towards your foes.");
		add(MSItems.PRIM_AND_PROPER_WALKING_POLE.get(), "Prim and Proper Walking Pole");
		addTooltip(MSItems.PRIM_AND_PROPER_WALKING_POLE.get(), "This cane SCREAMS propriety and 18th century heteronormativity.");
		add(MSItems.ROCKEFELLERS_WALKING_BLADECANE.get(), "Rockefeller's Walking Bladecane");
		addTooltip(MSItems.ROCKEFELLERS_WALKING_BLADECANE.get(), "Now you too can own an oil monopoly! Or at least walk like you do. Your confidence is all that matters in the end, anyway.");
		add(MSItems.ROCKEFELLERS_WALKING_BLADECANE_SHEATHED.get(), "Rockefeller's Walking Bladecane");
		addTooltip(MSItems.ROCKEFELLERS_WALKING_BLADECANE_SHEATHED.get(), "Now you too can own an oil monopoly! Or at least walk like you do. Your confidence is all that matters in the end, anyway.");
		add(MSItems.LESS_PROPER_WALKING_STICK.get(), "Slightly-Less Proper Stabbing Stick");
		addTooltip(MSItems.LESS_PROPER_WALKING_STICK.get(), "Fuck propriety, all that matters is that you can kill things!");
		add(MSItems.LESS_PROPER_WALKING_STICK_SHEATHED.get(), "Slightly-Less Proper Stabbing Stick");
		addTooltip(MSItems.LESS_PROPER_WALKING_STICK_SHEATHED.get(), "Fuck propriety, all that matters is that you can kill things!");
		add(MSItems.WOODEN_SPOON.get(), "Wooden Spoon");
		addTooltip(MSItems.WOODEN_SPOON.get(), "Like the kind you would eat your soup with");
		add(MSItems.SILVER_SPOON.get(), "Silver Spoon");
		addTooltip(MSItems.SILVER_SPOON.get(), "Could be the first silver object you've seen so far");
		add(MSItems.MELONBALLER.get(), "Melonballer");
		add(MSItems.SIGHTSEEKER.get(), "Sightseeker");
		add(MSItems.TERRAIN_FLATENATOR.get(), "Terrain Flatenator");
		addTooltip(MSItems.TERRAIN_FLATENATOR.get(), "Construction worker's pride and joy!");
		add(MSItems.NOSFERATU_SPOON.get(), "Nosferatu Spoon");
		addTooltip(MSItems.NOSFERATU_SPOON.get(), "The life-draining bloodlust of evil, in spoon form");
		add(MSItems.CROCKER_SPOON.get(), "Junior Battlemaster's Bowlbuster Stirring Solution 50000");
		addTooltip(MSItems.CROCKER_SPOON.get(), "Whip your foes into shape and bake a cake all at the same time!");
		add(MSItems.CROCKER_FORK.get(), "Junior Battlemaster's Bowlbuster Poking Solution 50000");
		addTooltip(MSItems.CROCKER_FORK.get(), "Did something change?");
		add(MSItems.SKAIA_FORK.get(), "Skaia War Fork");
		addTooltip(MSItems.SKAIA_FORK.get(), "The elegance and grace of Skaia, and the ability to poke things of a fork!");
		add(MSItems.FORK.get(), "Fork");
		add(MSItems.CANDY_FORK.get(), "Candy Fork");
		add(MSItems.TUNING_FORK.get(), "Tuning Fork");
		addTooltip(MSItems.TUNING_FORK.get(), "Does anyone hear a ringing?");
		add(MSItems.ELECTRIC_FORK.get(), "Electric Fork");
		add(MSItems.EATING_FORK_GEM.get(), "Eating Fork Gem");
		add(MSItems.DEVIL_FORK.get(), "Devil Fork");
		add(MSItems.SPORK.get(), "Spork");
		add(MSItems.GOLDEN_SPORK.get(), "Golden Spork");
		addTooltip(MSItems.GOLDEN_SPORK.get(), "A spoon and fork with all the awfulness of gold tools? Sign me up!");
		add(MSItems.BIDENT.get(), "Bident");
		addTooltip(MSItems.BIDENT.get(), "Double trouble for all your bubble scuffle needs");
		add(MSItems.EDISONS_FURY.get(), "Edison's Fury");
		add(MSItems.EDISONS_SERENITY.get(), "Edison's Serenity");
		add(MSItems.POINTY_STICK.get(), "Pointy Stick");
		add(MSItems.KNITTING_NEEDLE.get(), "Knitting Needle");
		add(MSItems.ARTIFUCKER.get(), "Artifucker");
		addTooltip(MSItems.ARTIFUCKER.get(), "What's the opposite of an aimbot?");
		add(MSItems.POINTER_WAND.get(), "Pointer Wand");
		addTooltip(MSItems.POINTER_WAND.get(), "Aimbot your way to victory!");
		add(MSItems.NEEDLE_WAND.get(), "Needle Wand");
		add(MSItems.POOL_CUE_WAND.get(), "Pool Cue Wand");
		add(MSItems.THORN_OF_OGLOGOTH.get(), "Thorn of Oglogoth");
		addTooltip(MSItems.THORN_OF_OGLOGOTH.get(), "Causer of woes, heart of darkness. Also useful for knitting");
		add(MSItems.THISTLE_OF_ZILLYWICH.get(), "Thistle of Zillywich");
		addTooltip(MSItems.THISTLE_OF_ZILLYWICH.get(), "Flippety dippety doo bup bup shrubber double floppy mumblescurry noodlescoop pizzabubble pizzabubble mip mip mip mip mip mip.");
		add(MSItems.QUILL_OF_ECHIDNA.get(), "Quill of Echidna");
		add(MSItems.SBAHJARANG.get(), "SBaHJarang");
		addTooltip(MSItems.SBAHJARANG.get(), "Worst throwing weapon money can't buy");
		add(MSItems.SHURIKEN.get(), "Shuriken");
		add(MSItems.CLUBS_SUITARANG.get(), "Clubs Suitarang");
		add(MSItems.DIAMONDS_SUITARANG.get(), "Diamonds Suitarang");
		add(MSItems.HEARTS_SUITARANG.get(), "Hearts Suitarang");
		add(MSItems.SPADES_SUITARANG.get(), "Spades Suitarang");
		add(MSItems.CHAKRAM.get(), "Magic Chakram");
		addTooltip(MSItems.CHAKRAM.get(), "Some power makes this weapon turn the exact opposite direction any time it hits something!");
		add(MSItems.UMBRAL_INFILTRATOR.get(), "Umbral Infiltrator");
		addTooltip(MSItems.UMBRAL_INFILTRATOR.get(), "Phases through blocks like the shadowy abyss of the denizen Nyx");
		add(MSItems.SORCERERS_PINBALL.get(), "Sorcerer's Pinball");
		addTooltip(MSItems.SORCERERS_PINBALL.get(), "Enchanted with real bouncy majyyk");
		add(MSItems.EMERALD_SWORD.get(), "Emerald Sword");
		add(MSItems.EMERALD_AXE.get(), "Emerald Axe");
		add(MSItems.EMERALD_PICKAXE.get(), "Emerald Pickaxe");
		add(MSItems.EMERALD_SHOVEL.get(), "Emerald Shovel");
		add(MSItems.EMERALD_HOE.get(), "Emerald Hoe");
		add(MSItems.MINE_AND_GRIST.get(), "Mine and Grist");
		add(MSItems.PRISMARINE_HELMET.get(), "Prismarine Helmet");
		add(MSItems.PRISMARINE_CHESTPLATE.get(), "Prismarine Chestplate");
		add(MSItems.PRISMARINE_LEGGINGS.get(), "Prismarine Leggings");
		add(MSItems.PRISMARINE_BOOTS.get(), "Prismarine Boots");
		add(MSItems.IRON_LASS_GLASSES.get(), "Iron Lass Glasses");
		add(MSItems.IRON_LASS_CHESTPLATE.get(), "Iron Lass Chestplate");
		add(MSItems.IRON_LASS_SKIRT.get(), "Iron Lass Skirt");
		add(MSItems.IRON_LASS_SHOES.get(), "Iron Lass Boots");
		add(MSItems.PROSPIT_CIRCLET.get(), "Prospit Circlet");
		add(MSItems.PROSPIT_SHIRT.get(), "Prospit Shirt");
		add(MSItems.PROSPIT_PANTS.get(), "Prospit Pants");
		add(MSItems.PROSPIT_SHOES.get(), "Prospit Shoes");
		add(MSItems.DERSE_CIRCLET.get(), "Derse Circlet");
		add(MSItems.DERSE_SHIRT.get(), "Derse Shirt");
		add(MSItems.DERSE_PANTS.get(), "Derse Pants");
		add(MSItems.DERSE_SHOES.get(), "Derse Shoes");
		add(MSItems.BOONDOLLARS.get(), "Boondollars");
		addExtra(MSItems.BOONDOLLARS.get(), "amount", "Amount: %s");
		add(MSItems.RAW_CRUXITE.get(), "Raw Cruxite");
		add(MSItems.RAW_URANIUM.get(), "Uranium Lump");
		addTooltip(MSItems.RAW_URANIUM.get(), "Is this even safe to be around?");
		add(MSItems.ENERGY_CORE.get(), "Energy Core");
		addTooltip(MSItems.ENERGY_CORE.get(), "The power of radiation in a neat little packet.");
		add(MSItems.PLUTONIUM_CORE.get(), "Plutonium Spatial Core");
		addTooltip(MSItems.PLUTONIUM_CORE.get(), "It seems to pulse gently, moving its immediate surroundings slightly each time.");
		add(MSItems.TEMPLE_SCANNER.get(), "Temple Scanner");
		addExtra(MSItems.TEMPLE_SCANNER.get(), "successMessage", "Closest detected temple around %s blocks away");
		addExtra(MSItems.TEMPLE_SCANNER.get(), "failMessage", "No temple detected nearby");
		addExtra(MSItems.TEMPLE_SCANNER.get(), "noFuelMessage", "This device requires uranium to run");
		add(MSItems.CRUXITE_APPLE.get(), "Cruxite Artifact");
		add(MSItems.CRUXITE_POTION.get(), "Cruxite Artifact");
		add(MSItems.SBURB_CODE.get(), "SBURB Code");
		addTooltip(MSItems.SBURB_CODE.get(), "It seems temple hieroglyphs can be translated into computer game code using a Book and Quill.");
		add(MSItems.COMPUTER_PARTS.get(), "Computer Parts");
		addTooltip(MSItems.COMPUTER_PARTS.get(), "Looks like it needs some additional components to get working.");
		add(MSItems.BLANK_DISK.get(), "Blank Disk");
		addTooltip(MSItems.BLANK_DISK.get(), "Can be put into a computer once there is a program on it to run.");
		add(MSItems.CLIENT_DISK.get(), "SBURB Client Disk");
		add(MSItems.SERVER_DISK.get(), "SBURB Server Disk");
		add(MSItems.CAPTCHA_CARD.get(), "Captchalogue Card");
		addExtra(MSItems.CAPTCHA_CARD.get(), "empty", "Empty");
		addExtra(MSItems.CAPTCHA_CARD.get(), "invalid", "Invalid Data");
		addExtra(MSItems.CAPTCHA_CARD.get(), "punched", "Punched");
		addExtra(MSItems.CAPTCHA_CARD.get(), "ghost", "Ghost");
		add(MSItems.STACK_MODUS_CARD.get(), "Stack Modus");
		add(MSItems.QUEUE_MODUS_CARD.get(), "Queue Modus");
		add(MSItems.QUEUESTACK_MODUS_CARD.get(), "Queue-Stack Modus");
		add(MSItems.TREE_MODUS_CARD.get(), "Tree Modus");
		add(MSItems.HASHMAP_MODUS_CARD.get(), "Hashmap Modus");
		add(MSItems.SET_MODUS_CARD.get(), "Set Modus");
		addTooltip(MSItems.SET_MODUS_CARD.get(), "This modus is quite similar to the array modus. Surely this is what you were looking for?");
		add(MSItems.SHUNT.get(), "Punch Card Shunt");
		addExtra(MSItems.SHUNT.get(), "invalid", "Invalid Item");
		addExtra(MSItems.SHUNT.get(), "empty", "Empty");
		add(MSItems.PHLEGM_GUSHERS.get(), "Hellacious Blue Phlegm Aneurysm Gushers");
		addTooltip(MSItems.PHLEGM_GUSHERS.get(), "These should be convenient, if somewhat unappetizing.");
		add(MSItems.SORROW_GUSHERS.get(), "Bodacious Black Liquid Sorrow Gushers");
		addTooltip(MSItems.SORROW_GUSHERS.get(), "These are pure poison.");
		add(MSItems.BUG_ON_A_STICK.get(), "Bug On a Stick");
		addStoreTooltip(MSItems.BUG_ON_A_STICK.get(), "Who doesn't like bugs? Someone who haven't had a bug on a stick. That's who.");
		add(MSItems.CHOCOLATE_BEETLE.get(), "Chocolate Covered Beetle");
		addStoreTooltip(MSItems.CHOCOLATE_BEETLE.get(), "The wonders of cocoa beans has given us this delicacy. Try now!");
		add(MSItems.CONE_OF_FLIES.get(), "Cone Of Flies");
		addStoreTooltip(MSItems.CONE_OF_FLIES.get(), "Want a cone of flies? They're quite popular with the kids. Everyone else too, honestly.");
		add(MSItems.GRASSHOPPER.get(), "Grasshopper");
		addStoreTooltip(MSItems.GRASSHOPPER.get(), "This extra-large grasshopper makes a perfect dinner.");
		add(MSItems.CICADA.get(), "Cicada");
		addTooltip(MSItems.CICADA.get(), "Why this looks like a member of the Magicicada genus! Known for popping out the ground in large numbers every 13 or 17 years to- hey are you still listening?");
		add(MSItems.JAR_OF_BUGS.get(), "Jar Of Bugs");
		addStoreTooltip(MSItems.JAR_OF_BUGS.get(), "It's like a bug on a stick but in a jar! What's not to love about it?");
		add(MSItems.BUG_MAC.get(), "Bug Mac");
		addStoreTooltip(MSItems.BUG_MAC.get(), "Does this come with a toy?");
		addTooltip(MSItems.BUG_MAC.get(), "If you don't think about the ingredients, this delicious meal will fill you up.");
		add(MSItems.ONION.get(), "Onion");
		addTooltip(MSItems.ONION.get(), "This \"cool\" vegetable is actually just an onion.");
		addStore(MSItems.ONION.get(), "Cool Veggie");
		addStoreTooltip(MSItems.ONION.get(), "This cool vegetable is so good that it will make you cry!");
		add(MSItems.SALAD.get(), "Bowl of Leaves");
		addTooltip(MSItems.SALAD.get(), "It's literally just salad, Gordon Ramsay would not approve.");
		addStore(MSItems.SALAD.get(), "Handpicked Greens");
		addStoreTooltip(MSItems.SALAD.get(), "A bowl of our fine, handpicked greens. The perfect meal.");
		add(MSItems.DESERT_FRUIT.get(), "Desert Fruit");
		addStore(MSItems.DESERT_FRUIT.get(), "Quenchy Berry");
		addStoreTooltip(MSItems.DESERT_FRUIT.get(), "This berry helps beat the desert heat!");
		add(MSItems.ROCK_COOKIE.get(), "Rock Cookie");
		addTooltip(MSItems.ROCK_COOKIE.get(), "It's as edible as a rock");
		addStore(MSItems.ROCK_COOKIE.get(), "Grey-Colored Cookie");
		addStoreTooltip(MSItems.ROCK_COOKIE.get(), "This here is a true wonder-cookie! Totally! And they are even cheaper than regular cookies!");
		add(MSItems.WOODEN_CARROT.get(), "Wooden Carrot");
		addTooltip(MSItems.WOODEN_CARROT.get(), "It's as edible as a plank.");
		add(MSItems.COCOA_WART.get(), "Cocoa Wart");
		addTooltip(MSItems.COCOA_WART.get(), "It has a... unique smell.");
		add(MSItems.FUNGAL_SPORE.get(), "Fungal Spore");
		addTooltip(MSItems.FUNGAL_SPORE.get(), "You must live off the land, and in this land, it means eating this.");
		addStore(MSItems.FUNGAL_SPORE.get(), "Mushroom Skittles");
		addStoreTooltip(MSItems.FUNGAL_SPORE.get(), "We harvest the mushrooms for this candy, although it's not very sweet.");
		add(MSItems.SPOREO.get(), "Sporeo");
		addTooltip(MSItems.SPOREO.get(), "Huh. Who knew fungal spores could be so delicious?");
		addStore(MSItems.SPOREO.get(), "Skittle Cookie");
		addStoreTooltip(MSItems.SPOREO.get(), "We found this spore-filled cookie sandwich in nearby ruins!");
		add(MSItems.MOREL_MUSHROOM.get(), "Morel Mushroom");
		addTooltip(MSItems.MOREL_MUSHROOM.get(), "A delicacy amongst both humans and consorts.");
		addStore(MSItems.MOREL_MUSHROOM.get(), "THE Mushroom");
		addStoreTooltip(MSItems.MOREL_MUSHROOM.get(), "This is a very rare mushroom-- not many get to see it, much less taste it!");
		add(MSItems.SUSHROOM.get(), "Sushroom");
		addTooltip(MSItems.SUSHROOM.get(), "Afungus.");
		add(MSItems.FRENCH_FRY.get(), "French Fry");
		add(MSItems.STRAWBERRY_CHUNK.get(), "Strawberry Chunk");
		addTooltip(MSItems.STRAWBERRY_CHUNK.get(), "It tastes a lot better than it looks.");
		addStore(MSItems.STRAWBERRY_CHUNK.get(), "Fistfull o' Strawberry");
		addStoreTooltip(MSItems.STRAWBERRY_CHUNK.get(), "This sweet-and-sour fruit glob is sure to drip stuff everywhere!");
		add(MSItems.FOOD_CAN.get(), "Food Can");
		addTooltip(MSItems.FOOD_CAN.get(), "You could be at the forefront of carapacian fashion if you turned the label into a sash");
		add(MSItems.CANDY_CORN.get(), "Candy Corn");
		add(MSItems.TUIX_BAR.get(), "Tuix Bar");
		add(MSItems.BUILD_GUSHERS.get(), "Build Gushers");
		add(MSItems.AMBER_GUMMY_WORM.get(), "Amber Gummy Worm");
		add(MSItems.CAULK_PRETZEL.get(), "Caulk Pretzel");
		add(MSItems.CHALK_CANDY_CIGARETTE.get(), "Chalk Candy Cigarette");
		add(MSItems.IODINE_LICORICE.get(), "Iodine Licorice");
		add(MSItems.SHALE_PEEP.get(), "Shale Peep");
		add(MSItems.TAR_LICORICE.get(), "Tar Black Licorice");
		add(MSItems.COBALT_GUM.get(), "Cobalt Gum");
		add(MSItems.MARBLE_JAWBREAKER.get(), "Marble Jawbreaker");
		add(MSItems.MERCURY_SIXLETS.get(), "Mercury Sixlets");
		add(MSItems.QUARTZ_JELLY_BEAN.get(), "Quartz Jelly Bean");
		add(MSItems.SULFUR_CANDY_APPLE.get(), "Sulfur Candy Apple");
		add(MSItems.AMETHYST_HARD_CANDY.get(), "Amethyst Hard Candy");
		add(MSItems.GARNET_TWIX.get(), "Garnet Twix");
		add(MSItems.RUBY_LOLLIPOP.get(), "Ruby Lollipop");
		add(MSItems.RUST_GUMMY_EYE.get(), "Rust Gummy Eye");
		add(MSItems.DIAMOND_MINT.get(), "Diamond Mint");
		add(MSItems.GOLD_CANDY_RIBBON.get(), "Gold Candy Ribbon");
		add(MSItems.URANIUM_GUMMY_BEAR.get(), "Uranium Gummy Bear");
		add(MSItems.ARTIFACT_WARHEAD.get(), "Artifact War Head");
		add(MSItems.ZILLIUM_SKITTLES.get(), "Zillium Skittles");
		add(MSItems.APPLE_JUICE.get(), "Apple Juice");
		add(MSItems.TAB.get(), "Tab");
		addStore(MSItems.TAB.get(), "Sugary Drink");
		addStoreTooltip(MSItems.TAB.get(), "This drink is too sweet for this world. Have a taste!");
		add(MSItems.ORANGE_FAYGO.get(), "Orange Faygo");
		add(MSItems.CANDY_APPLE_FAYGO.get(), "Candy-Apple Faygo");
		add(MSItems.FAYGO_COLA.get(), "Faygo Cola");
		add(MSItems.COTTON_CANDY_FAYGO.get(), "Cotton Candy Faygo");
		add(MSItems.CREME_SODA_FAYGO.get(), "Creme Soda Faygo");
		add(MSItems.GRAPE_FAYGO.get(), "Grape Faygo");
		add(MSItems.MOON_MIST_FAYGO.get(), "Moonmist Faygo");
		add(MSItems.PEACH_FAYGO.get(), "Peach Faygo");
		add(MSItems.REDPOP_FAYGO.get(), "Redpop Faygo");
		add(MSItems.GRUB_SAUCE.get(), "Grub Sauce");
		add(MSItems.IRRADIATED_STEAK.get(), "Irradiated Steak");
		addTooltip(MSItems.IRRADIATED_STEAK.get(), "Steak (over)cooked using the power of uranium!");
		add(MSItems.SURPRISE_EMBRYO.get(), "Kundler Shelled Surprise Embryo");
		addTooltip(MSItems.SURPRISE_EMBRYO.get(), "Oh boy! You sure can't wait to find out what's contained inside the Surprise Embryo!");
		addExtra(MSItems.SURPRISE_EMBRYO.get(), "message", "WOW! NO WAY! You found a %s inside your Surprise Embryo!");
		add(MSItems.UNKNOWABLE_EGG.get(), "The Egg of Unknowable, Horrible Truths");
		addTooltip(MSItems.UNKNOWABLE_EGG.get(), "This egg somehow knows your name.");
		add(MSItems.BREADCRUMBS.get(), "Breadcrumbs");
		add(MSItems.GOLDEN_GRASSHOPPER.get(), "Golden Grasshopper");
		add(MSItems.BUG_NET.get(), "Net");
		addTooltip(MSItems.BUG_NET.get(), "Perfect for catching bugs and frogs!");
		add(MSItems.FROG.get(), "Frog");
		addExtra(MSItems.FROG.get(), "random", "Random Frog");
		addExtra(MSItems.FROG.get(), "type.0", "Frog");
		addExtra(MSItems.FROG.get(), "type.1", "Totally Normal Frog");
		addExtra(MSItems.FROG.get(), "type.2", "Ruby Contraband");
		addExtra(MSItems.FROG.get(), "type.3", "Tiny Genesis Frog");
		addExtra(MSItems.FROG.get(), "type.4", "Frog");
		addExtra(MSItems.FROG.get(), "type.5", "Golden Frog");
		addExtra(MSItems.FROG.get(), "type.6", "Frog");
		addExtra(MSItems.FROG.get(), "desc.4", "frog.null.name");
		addExtra(MSItems.FROG.get(), "desc.6", ChatFormatting.OBFUSCATED+"Susan");
		addExtra(MSItems.FROG.get(), "eyes.0", "Lighter Eyes");
		addExtra(MSItems.FROG.get(), "eyes.1", "Darker Eyes");
		addExtra(MSItems.FROG.get(), "eyes.2", "Blank Eyes");
		addExtra(MSItems.FROG.get(), "belly.1", "Solid-Colored Belly");
		addExtra(MSItems.FROG.get(), "belly.2", "Spotted Belly");
		addExtra(MSItems.FROG.get(), "belly.3", "Striped Belly");
		addExtra(MSItems.FROG.get(), "size.0", "Tiny");
		addExtra(MSItems.FROG.get(), "size.1", "Small");
		addExtra(MSItems.FROG.get(), "size.2", "Normal Sized");
		addExtra(MSItems.FROG.get(), "size.3", "Big");
		addExtra(MSItems.FROG.get(), "size.4", "Huge");
		add(MSItems.CARVING_TOOL.get(), "Carving Tool");
		addStoreTooltip(MSItems.CARVING_TOOL.get(), "You gotta BE the marble!");
		add(MSItems.CRUMPLY_HAT.get(), "Crumply Hat");
		add(MSItems.STONE_EYEBALLS.get(), "Stone Eyeballs");
		...
		add(MSItems.BRAIN_JUICE_BUCKET.get(), "Bucket of Brain Juice");
		add(MSItems.WATER_COLORS_BUCKET.get(), "Bucket of Paint");
		addTooltip(MSItems.WATER_COLORS_BUCKET.get(), "The colors just refuse to mix. It's kind of disturbing, actually.");
		add(MSItems.ENDER_BUCKET.get(), "Bucket of End Fluid");
		addTooltip(MSItems.ENDER_BUCKET.get(), "It seems to be liquified ender pearls.");
		add(MSItems.LIGHT_WATER_BUCKET.get(), "Bucket of Glimmering Water");
		addTooltip(MSItems.LIGHT_WATER_BUCKET.get(), "You're not convinced this is water. It's unnatural.");
		add(MSItems.OBSIDIAN_BUCKET.get(), "Obsidian Bucket");
		add(MSItems.CAPTCHAROID_CAMERA.get(), "Captcharoid Camera");
		add(MSItems.GRIMOIRE.get(), "Grimoire for Summoning the Zoologically Dubious");
		addExtra(MSItems.GRIMOIRE.get(), "message", "After flipping through some pages, you feel significantly more insignificant.");
		addTooltip(MSItems.GRIMOIRE.get(), "This book is absolutely indispensable for enthusiasts of your ilk. Of which there are very few.");
		addStore(MSItems.GRIMOIRE.get(), "Spooky Book");
		addStoreTooltip(MSItems.GRIMOIRE.get(), "Our best wizard cultists tried to decipher this ancient tome, but none of them can read.");
		add(MSItems.LONG_FORGOTTEN_WARHORN.get(), "The Long Forgotten Warhorn of the Acolytes");
		addTooltip(MSItems.LONG_FORGOTTEN_WARHORN.get(), "Some things are better left forgotten.");
		add(MSItems.BLACK_QUEENS_RING.get(), "Black Queen's Ring");
		addTooltip(MSItems.BLACK_QUEENS_RING.get(), "One of a pair. If the wrong carapacian got this, the session would Ascend into chaos!");
		add(MSItems.WHITE_QUEENS_RING.get(), "White Queen's Ring");
		addTooltip(MSItems.WHITE_QUEENS_RING.get(), "One of a pair. Cast it into the fire!");
		add(MSItems.RAZOR_BLADE.get(), "Razor Blade");
		addTooltip(MSItems.RAZOR_BLADE.get(), "Only a fool would try to pick this up.");
		add(MSItems.URANIUM_POWERED_STICK.get(), "Uranium-Powered Stick");
		addTooltip(MSItems.URANIUM_POWERED_STICK.get(), "Never runs out of uranium!");
		add(MSItems.SCALEMATE_APPLESCAB.get(), "Officer Applescab");
		add(MSItems.SCALEMATE_BERRYBREATH.get(), "Inspector Berrybreath");
		add(MSItems.SCALEMATE_CINNAMONWHIFF.get(), "Officer Cinnamonwhiff");
		add(MSItems.SCALEMATE_HONEYTONGUE.get(), "Doctor Honeytongue");
		add(MSItems.SCALEMATE_LEMONSNOUT.get(), "Senator Lemonsnout");
		add(MSItems.SCALEMATE_PINESNOUT.get(), "Duke Pinesnout");
		add(MSItems.SCALEMATE_PUCEFOOT.get(), "Professor Pucefoot");
		add(MSItems.SCALEMATE_PUMPKINSNUFFLE.get(), "Liason Pumpkinsnuffle");
		add(MSItems.SCALEMATE_PYRALSPITE.get(), "Pyralspite");
		add(MSItems.SCALEMATE_WITNESS.get(), "The Witness");
		add(MSItems.IRON_BOAT.get(), "Iron Boat");
		add(MSItems.GOLD_BOAT.get(), "Golden Boat");
		add(MSItems.FLARP_MANUAL.get(), "Flarp Manual");
		add(MSItems.SASSACRE_TEXT.get(), "Sassacre Text");
		add(MSItems.WISEGUY.get(), "Wise Guy");
		add(MSItems.TABLESTUCK_MANUAL.get(), "Tablestuck Manual");
		add(MSItems.TILLDEATH_HANDBOOK.get(), "~ATH Handbook");
		addTooltip(MSItems.TILLDEATH_HANDBOOK.get(), "A Handbook for the Imminently Deceased");
		add(MSItems.BINARY_CODE.get(), "Binary code");
		addTooltip(MSItems.BINARY_CODE.get(), "01101010 01110101 01110011 01110100 00100000 01100001 00100000 01100010 01110101 01101110 01100011 01101000 00100000 01101111 01100110 00100000 01101111 01101110 01100101 01110011 00100000 01100001 01101110 01100100 00100000 01111010 01100101 01110010 01101111 01110011");
		add(MSItems.NONBINARY_CODE.get(), "Nonbinary code");
		addTooltip(MSItems.NONBINARY_CODE.get(), "6e 6f 74 20 6a 75 73 74 20 61 20 62 75 6e 63 68 20 6f 66 20 6f 6e 65 73 20 61 6e 64 20 7a 65 72 6f 73");
		add(MSItems.THRESH_DVD.get(), "Thresh Prince DVD");
		add(MSItems.GAMEBRO_MAGAZINE.get(), "Game Bro Magazine");
		add(MSItems.GAMEGRL_MAGAZINE.get(), "Game Grl Magazine");
		add(MSItems.ICE_SHARD.get(), "Ice Shard");
		add(MSItems.HORN.get(), "Horn");
		addTooltip(MSItems.HORN.get(), ":o)");
		add(MSItems.CAKE_MIX.get(), "Cake Mix");
		add(MSItems.BARBASOL.get(), "Barbasol");
		add(MSItems.BARBASOL_BOMB.get(), "Betty Crocker Barbasol Bomb");
		add(MSItems.CLOTHES_IRON.get(), "Clothes Iron");
		add(MSItems.BATTERY.get(), "Battery");
		addStore(MSItems.BATTERY.get(), "Death Gusher");
		addStoreTooltip(MSItems.BATTERY.get(), "This one's tough to crunch into, and the effort's barely even worth it!");
		add(MSItems.BI_DYE.get(), "Bi Dye");
		addTooltip(MSItems.BI_DYE.get(), "Show off your pride to friends! Make gear to help vanquish your foes!");
		add(MSItems.LIP_BALM.get(), "Lip Balm");
		addTooltip(MSItems.LIP_BALM.get(), "I see you there with those dry lips. Aht aht don't lick them now.");
		addExtra(MSItems.LIP_BALM.get(), "message", "Your lips are slightly more moisturized, but is it enough?");
		add(MSItems.ELECTRIC_AUTOHARP.get(), "Electric Autoharp");
		add(MSItems.CARDBOARD_TUBE.get(), "Cardboard Tube");
		add(MSItems.INK_SQUID_PRO_QUO.get(), "Ink of Squid Pro Quo");
		addTooltip(MSItems.INK_SQUID_PRO_QUO.get(), "For the love of god, don't drink it.");
		add(MSItems.CUEBALL.get(), "Magic Cueball");
		add(MSItems.EIGHTBALL.get(), "Magic Eightball");
		add(MSItems.CREW_POSTER.get(), "Midnight Crew Poster");
		add(MSItems.SBAHJ_POSTER.get(), "Sweet Bro and Hella Jeff Poster");
		add(MSItems.MUSIC_DISC_EMISSARY_OF_DANCE.get(), "Music Disc");
		addExtra(MSItems.MUSIC_DISC_EMISSARY_OF_DANCE.get(), "desc", "Catboss - Emissary of Dance");
		add(MSItems.MUSIC_DISC_DANCE_STAB_DANCE.get(), "Music Disc");
		addExtra(MSItems.MUSIC_DISC_DANCE_STAB_DANCE.get(), "desc", "Catboss - Dance-Stab-Dance");
		add(MSItems.MUSIC_DISC_RETRO_BATTLE.get(), "Music Disc");
		addExtra(MSItems.MUSIC_DISC_RETRO_BATTLE.get(), "desc", "SinFrog - Retro Battle Theme");
		add(MSItems.CASSETTE_MELLOHI.get(), "Cassette");
		addExtra(MSItems.CASSETTE_MELLOHI.get(), "desc", "C418 - mellohi");
		add(MSItems.CASSETTE_13.get(), "Cassette");
		addExtra(MSItems.CASSETTE_13.get(), "desc", "C418 - 13");
		add(MSItems.CASSETTE_BLOCKS.get(), "Cassette");
		addExtra(MSItems.CASSETTE_BLOCKS.get(), "desc", "C418 - blocks");
		add(MSItems.CASSETTE_CAT.get(), "Cassette");
		addExtra(MSItems.CASSETTE_CAT.get(), "desc", "C418 - cat");
		add(MSItems.CASSETTE_CHIRP.get(), "Cassette");
		addExtra(MSItems.CASSETTE_CHIRP.get(), "desc", "C418 - chirp");
		add(MSItems.CASSETTE_FAR.get(), "Cassette");
		addExtra(MSItems.CASSETTE_FAR.get(), "desc", "C418 - far");
		add(MSItems.CASSETTE_MALL.get(), "Cassette");
		addExtra(MSItems.CASSETTE_MALL.get(), "desc", "C418 - mall");
		add(MSItems.CASSETTE_EMISSARY.get(), "Cassette");
		addExtra(MSItems.CASSETTE_EMISSARY.get(), "desc", "Catboss - Emissary of Dance");
		add(MSItems.CASSETTE_DANCE_STAB.get(), "Cassette");
		addExtra(MSItems.CASSETTE_DANCE_STAB.get(), "desc", "Catboss - Dance-Stab-Dance");
		add(MSItems.CASSETTE_RETRO_BATTLE.get(), "Cassette");
		addExtra(MSItems.CASSETTE_RETRO_BATTLE.get(), "desc", "SinFrog - Retro Battle Theme");
