...
public class MinestuckEnUsLanguageProvider extends MinestuckLanguageProvider
{
	...
	protected void addTranslations()
	{
		...
		add(MSBlocks.FROST, "Frost Block");
		...
		add(MSBlocks.FLOWERY_MOSSY_STONE, "Flowery Mossy Stone");
		add(MSBlocks.POLISHED_FLOWERY_MOSSY_STONE, "Polished Flowery Mossy Stone");
		add(MSBlocks.FLOWERY_MOSSY_STONE_BRICKS, "Flowery Mossy Stone Bricks");
		add(MSBlocks.FLOWERY_MOSSY_STONE_COLUMN, "Flowery Mossy Stone Column");
		add(MSBlocks.CHISELED_FLOWERY_MOSSY_STONE_BRICKS, "Chiseled Flowery Mossy Stone Bricks");
		add(MSBlocks.CRACKED_FLOWERY_MOSSY_STONE_BRICKS, "Cracked Flowery Mossy Stone Bricks");
		...
		add(MSBlocks.FROST_STAIRS, "Frost Stairs");
		...
		add(MSBlocks.FLOWERY_MOSSY_STONE_STAIRS, "Flowery Mossy Stone Stairs");
		...
		add(MSBlocks.FLOWERY_MOSSY_STONE_SLAB, "Flowery Mossy Stone Slab");
		add(MSBlocks.FLOWERY_MOSSY_STONE_BRICK_SLAB, "Flowery Mossy Stone Brick Slab");
		add(MSBlocks.FROST_SLAB, "Frost Slab");
