...
public class MinestuckEnUsLanguageProvider extends MinestuckLanguageProvider
{
	...
	protected void addTranslations()
	{
		...
		add(MSItems.FURRY_POSTER, "Furries poster");
		...
		add(MSItems.MUSIC_DISC_TAVROS_THEME, "Music Disc");
		addExtra(MSItems.MUSIC_DISC_TAVROS_THEME, "desc", "Toby \"Radiation\" Fox - dESPERADO ROCKET CHAIRS");
		add(MSItems.MUSIC_DISC_ERIDAN_THEME, "Music Disc");
		addExtra(MSItems.MUSIC_DISC_ERIDAN_THEME, "desc", "Toby \"Radiation\" Fox - Eridan's Theme");
		add(MSItems.MUSIC_DISC_FEFERI_THEME, "Music Disc");
		addExtra(MSItems.MUSIC_DISC_FEFERI_THEME, "desc", "Toby \"Radiation\" Fox - Love You (Feferi's Theme)");
		add(MSItems.MUSIC_DISC_EQUIUS_THEME, "Music Disc");
		addExtra(MSItems.MUSIC_DISC_EQUIUS_THEME, "desc", "Alexander Rosetti - Horschestra STRONG Version");
		add(MSItems.MUSIC_DISC_KANAYA_THEME, "Music Disc");
		addExtra(MSItems.MUSIC_DISC_KANAYA_THEME, "desc", "Toby \"Radiation\" Fox - Darling Kanaya");
		add(MSItems.MUSIC_DISC_KARKAT_THEME, "Music Disc");
		addExtra(MSItems.MUSIC_DISC_KARKAT_THEME, "desc", "Toby \"Radiation\" Fox - Karkat's Theme");
		add(MSItems.MUSIC_DISC_GAMZEE_THEME, "Music Disc");
		addExtra(MSItems.MUSIC_DISC_GAMZEE_THEME, "desc", "Toby \"Radiation\" Fox - mIrAcLeS");
		add(MSItems.MUSIC_DISC_NEPETA_THEME, "Music Disc");
		addExtra(MSItems.MUSIC_DISC_NEPETA_THEME, "desc", "Toby \"Radiation\" Fox - Nepeta's Theme");
		add(MSItems.MUSIC_DISC_ARADIA_THEME, "Music Disc");
		addExtra(MSItems.MUSIC_DISC_ARADIA_THEME, "desc", "Toby \"Radiation\" Fox - psych0ruins");
		add(MSItems.MUSIC_DISC_SOLLUX_THEME, "Music Disc");
		addExtra(MSItems.MUSIC_DISC_SOLLUX_THEME, "desc", "Toby \"Radiation\" Fox - The La2t Frontiier");
		add(MSItems.MUSIC_DISC_TEREZI_THEME, "Music Disc");
		addExtra(MSItems.MUSIC_DISC_TEREZI_THEME, "desc", "Toby \"Radiation\" Fox - Terezi's Theme");
		add(MSItems.MUSIC_DISC_VRISKA_THEME, "Music Disc");
		addExtra(MSItems.MUSIC_DISC_VRISKA_THEME, "desc", "Toby \"Radiation\" Fox - Vriska's Theme");
