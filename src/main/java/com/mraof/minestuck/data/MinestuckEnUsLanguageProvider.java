...
public class MinestuckEnUsLanguageProvider extends MinestuckLanguageProvider
{
	...
	protected void addTranslations()
	{
		...
		add(MSBlocks.GOLD_BRICK_CHISELED, "Chiseled Gold Bricks");
		add(MSBlocks.GOLD_COLUMN, "Gold Column");
		add(MSBlocks.GOLD_TILE_LIGHT, "Light Gold Tile");
		add(MSBlocks.GOLD_TILE_DARK, "Dark Gold Tile");
		add(MSBlocks.GOLD_TILE_COLORED, "Rose Gold Tile");
		add(MSBlocks.PURPLE_BRICKS, "Purple Bricks");
		add(MSBlocks.PURPLE_BRICK_STAIRS, "Purple Brick Stairs");
		add(MSBlocks.PURPLE_BRICK_SLAB, "Purple Brick Slab");
		add(MSBlocks.PURPLE_BRICK_CHISELED, "Chiseled Purple Bricks");
		add(MSBlocks.PURPLE_COLUMN, "Purple Column");
		add(MSBlocks.PURPLE_TILE_LIGHT, "Light Purple Tile");
		add(MSBlocks.PURPLE_TILE_DARK, "Dark Purple Tile");
		add(MSBlocks.PURPLE_TILE_COLORED, "Colored Purple Tile");
		...
		add(MSBlocks.IGUANA_STATUE, "Iguana Statue");
		add(MSBlocks.SALAMANDER_STATUE, "Salamander Statue");
		add(MSBlocks.TURTLE_STATUE, "Turtle Statue");
		add(MSBlocks.WOODEN_NAKAGATOR_STATUE, "Wooden Nakagator Statue");
		add(MSBlocks.WOODEN_IGUANA_STATUE, "Wooden Iguana Statue");
		...
		addTooltip(MSItems.SURPRISE_AXE, "Cleave foes in twain... with pride :]");
		...
		//add(MSItems.BI_SICKLE, "Bi-Sickle");
		//addTooltip(MSItems.BI_SICKLE, "Freddy Mercury would approve");
		...
		add(MSItems.KINGS_SCEPTER_WHITE, "Kings Scepter");
		...
		add(MSItems.QUEENS_RING_BLACK, "Black Queen's Ring");
		addTooltip(MSItems.QUEENS_RING_BLACK, "One of a pair. If the wrong carapacian got this, the session would Ascend into chaos!");
		add(MSItems.QUEENS_RING_WHITE, "White Queen's Ring");
		addTooltip(MSItems.QUEENS_RING_WHITE, "One of a pair. Cast it into the fire!");
