...
public class MinestuckEnUsLanguageProvider extends MinestuckLanguageProvider
{
	...
	protected void addTranslations()
	{
		...
		addExtra(MSItems.CASSETTE_STAL, "desc", "C418 - stal");
		add(MSItems.CASSETTE_STRAD, "Cassette");
		addExtra(MSItems.CASSETTE_STRAD, "desc", "C418 - strad");
		add(MSItems.CASSETTE_WAIT, "Cassette");
		addExtra(MSItems.CASSETTE_WAIT, "desc", "C418 - wait");
		add(MSItems.CASSETTE_WARD, "Cassette");
		addExtra(MSItems.CASSETTE_WARD, "desc", "C418 - ward");
