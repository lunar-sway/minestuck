...
public class MinestuckEnUsLanguageProvider extends MinestuckLanguageProvider
{
	...
	protected void addTranslations()
	{
		...
		add(MSBlocks.BLACK_CASTLE_BRICKS.get(), "Black Chess Bricks");
		add(MSBlocks.DARK_GRAY_CASTLE_BRICKS.get(), "Dark Gray Chess Bricks");
		add(MSBlocks.LIGHT_GRAY_CASTLE_BRICKS.get(), "Light Gray Chess Bricks");
		add(MSBlocks.WHITE_CASTLE_BRICKS.get(), "White Chess Bricks");
		add(MSBlocks.BLACK_CASTLE_BRICK_SMOOTH.get(), "Smooth Black Chess Brick");
		add(MSBlocks.DARK_GRAY_CASTLE_BRICK_SMOOTH.get(), "Smooth Dark Gray Chess Brick");
		add(MSBlocks.LIGHT_GRAY_CASTLE_BRICK_SMOOTH.get(), "Smooth Light Gray Black Chess Brick");
		add(MSBlocks.WHITE_CASTLE_BRICK_SMOOTH.get(), "Smooth White Chess Brick");
		add(MSBlocks.BLACK_CASTLE_BRICK_TRIM.get(), "Black Chess Brick Trim");
		add(MSBlocks.DARK_GRAY_CASTLE_BRICK_TRIM.get(), "Dark Gray Chess Brick Trim");
		add(MSBlocks.LIGHT_GRAY_CASTLE_BRICK_TRIM.get(), "Light Gray Chess Brick Trim");
		add(MSBlocks.WHITE_CASTLE_BRICK_TRIM.get(), "White Chess Brick Trim");
		...
		add(MSBlocks.MOSSY_COARSE_STONE.get(), "Mossy Coarse Stone Bricks");
		...
		add(MSBlocks.BLACK_CASTLE_BRICK_STAIRS.get(), "Black Chess Brick Stairs");
		add(MSBlocks.DARK_GRAY_CASTLE_BRICK_STAIRS.get(), "Dark Gray Chess Brick Stairs");
		add(MSBlocks.LIGHT_GRAY_CASTLE_BRICK_STAIRS.get(), "Light Gray Chess Brick Stairs");
		add(MSBlocks.WHITE_CASTLE_BRICK_STAIRS.get(), "White Chess Brick Stairs");
		...
		add(MSBlocks.BLACK_CASTLE_BRICK_SLAB.get(), "Black Chess Brick Slab");
		add(MSBlocks.DARK_GRAY_CASTLE_BRICK_SLAB.get(), "Dark Gray Chess Brick Slab");
		add(MSBlocks.LIGHT_GRAY_CASTLE_BRICK_SLAB.get(), "Light Gray Chess Brick Slab");
		add(MSBlocks.WHITE_CASTLE_BRICK_SLAB.get(), "White Chess Brick Slab");
