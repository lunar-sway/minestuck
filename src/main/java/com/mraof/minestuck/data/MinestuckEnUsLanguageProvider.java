...
public class MinestuckEnUsLanguageProvider extends MinestuckLanguageProvider
{
	...
	protected void addTranslations()
	{
		...
		*/
		...
		addEntitySubtitles(MSEntityTypes.NAKAGATOR.get(), "ambient", "Nakagator naks");
		addEntitySubtitles(MSEntityTypes.NAKAGATOR.get(), "hurt", "Nakagator hurts");
		addEntitySubtitles(MSEntityTypes.NAKAGATOR.get(), "death", "Nakagator dies");
		addEntitySubtitles(MSEntityTypes.IGUANA.get(), "ambient", "Iguana thips");
		addEntitySubtitles(MSEntityTypes.IGUANA.get(), "hurt", "Iguana hurts");
		addEntitySubtitles(MSEntityTypes.IGUANA.get(), "death", "Iguana dies");
		addEntitySubtitles(MSEntityTypes.SALAMANDER.get(), "ambient", "Salamander blubs");
		addEntitySubtitles(MSEntityTypes.SALAMANDER.get(), "hurt", "Salamander hurts");
		addEntitySubtitles(MSEntityTypes.SALAMANDER.get(), "death", "Salamander dies");
		addEntitySubtitles(MSEntityTypes.TURTLE.get(), "hurt", "Turtle hurts");
		addEntitySubtitles(MSEntityTypes.TURTLE.get(), "death", "Turtle dies");
		addEntitySubtitles(MSEntityTypes.FROG.get(), "ambient", "Frog croaks");
		addEntitySubtitles(MSEntityTypes.FROG.get(), "hurt", "Frog hurts");
		addEntitySubtitles(MSEntityTypes.FROG.get(), "death", "Frog dies");
		addEntitySubtitles(MSEntityTypes.IMP.get(), "ambient", "Imp screeches");
		addEntitySubtitles(MSEntityTypes.IMP.get(), "hurt", "Imp hurts");
		addEntitySubtitles(MSEntityTypes.IMP.get(), "death", "Imp dies");
		addEntitySubtitles(MSEntityTypes.OGRE.get(), "ambient", "Ogre grunts");
		addEntitySubtitles(MSEntityTypes.OGRE.get(), "hurt", "Ogre hurts");
		addEntitySubtitles(MSEntityTypes.OGRE.get(), "death", "Ogre dies");
		addEntitySubtitles(MSEntityTypes.BASILISK.get(), "ambient", "Basilisk hisses");
		addEntitySubtitles(MSEntityTypes.BASILISK.get(), "hurt", "Basilisk hurts");
		addEntitySubtitles(MSEntityTypes.BASILISK.get(), "death", "Basilisk dies");
		addEntitySubtitles(MSEntityTypes.LICH.get(), "ambient", "Lich wispers");
		addEntitySubtitles(MSEntityTypes.LICH.get(), "hurt", "Lich hurts");
		addEntitySubtitles(MSEntityTypes.LICH.get(), "death", "Lich dies");
		addEntitySubtitles(MSEntityTypes.GICLOPS.get(), "ambient", "Giclops wants to eat'cha");
		addEntitySubtitles(MSEntityTypes.GICLOPS.get(), "hurt", "Giclops hurts");
		addEntitySubtitles(MSEntityTypes.GICLOPS.get(), "death", "Giclops dies");
	}
}