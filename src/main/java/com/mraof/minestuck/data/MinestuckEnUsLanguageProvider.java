...
//		addStrife(KindAbstratusList.SPORK, "Sporkkind");
		...
		add(StrifeSpecibusScreen.CONFIRM_TITLE, "Choose Abstractus Kind");
		add(StrifeSpecibusScreen.CONFIRM_BODY, "Add %s to your abstratus? This cannot be undone!");
		add(StrifeSpecibusScreen.ABSTRATUS_PROMPT, "Choose Kind Abstratus (%s/4)");
		add(StrifeSpecibusScreen.ABSTRATUS_FULL, "Kind Abstratus");
