...
public class MinestuckEnUsLanguageProvider extends MinestuckLanguageProvider
{
	...
	protected void addTranslations()
	{
		...
		add(MSItems.BLACK_STAFF, "Black Staff");
		add(MSItems.GOLD_STAFF, "Gold Staff");
		...
		addExtra(MSItems.RIFLE, "values", "Accuracy modifier: %s \nDamage modifier: %s \nBase distance: %s \nReload speed: %s sec");
		add(MSItems.SHOTGUN, "Shotgun");
		addExtra(MSItems.SHOTGUN, "values", "Accuracy modifier: %s \nDamage modifier: %s \nBase distance: %s \nReload speed: %s sec");
		add(MSItems.SNIPER_RIFLE, "Sniper Rifle");
		addExtra(MSItems.SNIPER_RIFLE, "values", "Accuracy modifier: %s \nDamage modifier: %s \nBase distance: %s \nReload speed: %s sec");
		add(MSItems.GIRLS_BEST_FRIEND, "Girl's Best Friend");
		addExtra(MSItems.GIRLS_BEST_FRIEND, "values", "Accuracy modifier: %s \nDamage modifier: %s \nBase distance: %s \nReload speed: %s sec");
		add(MSItems.GREEN_SUN_STREETSWEEPER, "Green Sun Streetsweeper");
		addExtra(MSItems.GREEN_SUN_STREETSWEEPER, "values", "Accuracy modifier: %s \nDamage modifier: %s \nBase distance: %s \nReload speed: %s sec\nSpecial: Slight chance of wither");
		add(MSItems.BLACK_ASSAULT_RIFLE, "Black Assault Rifle");
		addExtra(MSItems.BLACK_ASSAULT_RIFLE, "values", "Accuracy modifier: %s \nDamage modifier: %s \nBase distance: %s \nReload speed: %s sec");
		add(MSItems.GOLD_ASSAULT_RIFLE, "Gold Assault Rifle");
		addExtra(MSItems.GOLD_ASSAULT_RIFLE, "values", "Accuracy modifier: %s \nDamage modifier: %s \nBase distance: %s \nReload speed: %s sec");
		add(MSItems.GOLD_BERETTA, "Gold Beretta");
		addExtra(MSItems.GOLD_BERETTA, "values", "Accuracy modifier: %s \nDamage modifier: %s \nBase distance: %s \nReload speed: %s sec");
		add(MSItems.AHABS_CROSSHAIRS, "Ahab's Crosshairs");
		addExtra(MSItems.AHABS_CROSSHAIRS, "values", "Accuracy modifier: %s \nDamage modifier: %s \nBase distance: %s \nReload speed: %s sec");
		add(MSItems.BULLET, "Bullet");
		addExtra(MSItems.BULLET, "values", "Accuracy modifier: %s \nDamage modifier: %s \nDistance modifier: %s");
		add(MSItems.HIGH_CALIBER_BULLET, "High Caliber Bullet");
		addTooltip(MSItems.HIGH_CALIBER_BULLET, "How does this fit in the same barrel as other bullets? Don't worry about it.");
		addExtra(MSItems.HIGH_CALIBER_BULLET, "values", "Accuracy modifier: %s \nDamage modifier: %s \nDistance modifier: %s \nPenetrating power: %s entities");
		add(MSItems.GEIGER_WRECKER, "Geiger Wrecker");
		addExtra(MSItems.GEIGER_WRECKER, "values", "Accuracy modifier: %s \nDamage modifier: %s \nDistance modifier: %s\nSpecial: High chance of wither");
		add(MSItems.LOW_DRAG_BULLET, "Low-Drag Bullet");
		addExtra(MSItems.LOW_DRAG_BULLET, "values", "Accuracy modifier: %s \nDamage modifier: %s \nDistance modifier: %s");
		add(MSItems.VEIL_PIERCER_SHOT, "Veil Piercer Shot");
		addExtra(MSItems.VEIL_PIERCER_SHOT, "values", "Accuracy modifier: %s \nDamage modifier: %s \nDistance modifier: %s \nPenetrating power: %s entities");
		add(MSItems.DRAGON_SHOT, "Dragon Shot");
		addExtra(MSItems.DRAGON_SHOT, "values", "Accuracy modifier: %s \nDamage modifier: %s \nDistance modifier: %s \nPenetrating power: %s entities \nSpecial: High chance of causing fire");
