...
public class MinestuckItemTagsProvider extends ItemTagsProvider
{
	...
	protected void registerTags()
	{
		...
		getBuilder(GUNS).add(FLINTLOCK_PISTOL, RIFLE, SHOTGUN, SNIPER_RIFLE, GIRLS_BEST_FRIEND, GREEN_SUN_STREETSWEEPER);
		getBuilder(BULLETS).add(BULLET, HIGH_CALIBER_BULLET, LOW_DRAG_BULLET, GEIGER_WRECKER);
	}
