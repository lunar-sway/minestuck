...
public class MinestuckItemTagsProvider extends ItemTagsProvider
{
	...
	protected void registerTags()
	{
		...
		getBuilder(ItemTags.MUSIC_DISCS).add(MUSIC_DISC_DANCE_STAB_DANCE, MUSIC_DISC_EMISSARY_OF_DANCE, MUSIC_DISC_RETRO_BATTLE, MUSIC_DISC_TAVROS_THEME, MUSIC_DISC_ERIDAN_THEME, MUSIC_DISC_FEFERI_THEME, MUSIC_DISC_EQUIUS_THEME, MUSIC_DISC_KANAYA_THEME, MUSIC_DISC_KARKAT_THEME, MUSIC_DISC_GAMZEE_THEME, MUSIC_DISC_NEPETA_THEME, MUSIC_DISC_ARADIA_THEME, MUSIC_DISC_SOLLUX_THEME, MUSIC_DISC_TEREZI_THEME, MUSIC_DISC_VRISKA_THEME);
		getBuilder(Tags.Items.MUSIC_DISCS).add(MUSIC_DISC_DANCE_STAB_DANCE, MUSIC_DISC_EMISSARY_OF_DANCE, MUSIC_DISC_RETRO_BATTLE, MUSIC_DISC_TAVROS_THEME, MUSIC_DISC_ERIDAN_THEME, MUSIC_DISC_FEFERI_THEME, MUSIC_DISC_EQUIUS_THEME, MUSIC_DISC_KANAYA_THEME, MUSIC_DISC_KARKAT_THEME, MUSIC_DISC_GAMZEE_THEME, MUSIC_DISC_NEPETA_THEME, MUSIC_DISC_ARADIA_THEME, MUSIC_DISC_SOLLUX_THEME, MUSIC_DISC_TEREZI_THEME, MUSIC_DISC_VRISKA_THEME);
