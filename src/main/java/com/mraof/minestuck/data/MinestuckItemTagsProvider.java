...
public class MinestuckItemTagsProvider extends ItemTagsProvider
{
	...
	protected void addTags()
	{
		...
		tag(CASSETTES).add(CASSETTE_13, CASSETTE_BLOCKS, CASSETTE_CAT, CASSETTE_CHIRP, CASSETTE_DANCE_STAB, CASSETTE_EMISSARY, CASSETTE_FAR, CASSETTE_MALL, CASSETTE_MELLOHI, CASSETTE_PIGSTEP, CASSETTE_RETRO_BATTLE, CASSETTE_STAL, CASSETTE_STRAD, CASSETTE_WAIT, CASSETTE_WARD);
