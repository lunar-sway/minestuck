...
public class MinestuckItemTagsProvider extends ItemTagsProvider
{
	...
	protected void registerTags()
	{
		...
		getBuilder(WANDS).add(ARTIFUCKER, POINTER_WAND, NEEDLE_WAND, POOL_CUE_WAND, THORN_OF_OGLOGOTH, THISTLE_OF_ZILLYWICH, QUILL_OF_ECHIDNA);
		getBuilder(GUNS).add(FLINTLOCK_PISTOL, RIFLE, SHOTGUN, SNIPER_RIFLE, GIRLS_BEST_FRIEND, GREEN_SUN_STREETSWEEPER, BLACK_ASSAULT_RIFLE, GOLD_ASSAULT_RIFLE, GOLD_BERETTA, AHABS_CROSSHAIRS);
		getBuilder(BULLETS).add(BULLET, HIGH_CALIBER_BULLET, LOW_DRAG_BULLET, GEIGER_WRECKER, VEIL_PIERCER_SHOT, DRAGON_SHOT);
	}
