...
//@Mod(MSGlobalLootModifiersTest.MODID)
public class MSGlobalLootModifier {
	...
	public static class EventHandlers {
		...
		public static void registerEnchantments(@Nonnull final RegistryEvent.Register<Enchantment> event) {
			if (ENABLE) {
				event.getRegistry().register(new SmelterEnchantment(Rarity.UNCOMMON, EnchantmentType.DIGGER, new EquipmentSlotType[] {EquipmentSlotType.MAINHAND}).setRegistryName(new ResourceLocation(Minestuck.MOD_ID,"smelt")));
			}
		}
		...
		public static void registerModifierSerializers(@Nonnull final RegistryEvent.Register<GlobalLootModifierSerializer<?>> event) {
			if (ENABLE) {
				event.getRegistry().register(
						new WheatSeedsConverterModifier.Serializer().setRegistryName(new ResourceLocation(Minestuck.MOD_ID,"wheat_harvest"))
				);
				event.getRegistry().register(new SmeltingEnchantmentModifier.Serializer().setRegistryName(new ResourceLocation(Minestuck.MOD_ID,"smelting")));
				event.getRegistry().register(new DungeonLootEnhancerModifier.Serializer().setRegistryName(new ResourceLocation(Minestuck.MOD_ID,"dungeon_loot")));
				event.getRegistry().register(new SilkTouchTestModifier.Serializer().setRegistryName(new ResourceLocation(Minestuck.MOD_ID,"silk_touch_bamboo")));
			}
		}
	}
