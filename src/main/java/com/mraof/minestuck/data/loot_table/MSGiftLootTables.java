	...
	public void accept(BiConsumer<ResourceLocation, LootTable.Builder> lootProcessor)
	{
		...
		lootProcessor.accept(MSLootTables.CONSORT_GENERAL_STOCK, LootTable.builder()
				.addLootPool(LootPool.builder().name(ITEM_POOL).rolls(ConstantRange.of(4))
						...
						.addEntry(ItemLootEntry.builder(MSBlocks.MINI_WIZARD_STATUE).weight(8).acceptFunction(SetCount.builder(RandomValueRange.of(1, 5))))
						...
						.addEntry(ItemLootEntry.builder(MSItems.CLUBS_SUITARANG).weight(2).acceptFunction(SetCount.builder(RandomValueRange.of(1, 5))))
						.addEntry(ItemLootEntry.builder(MSItems.DIAMONDS_SUITARANG).weight(2).acceptFunction(SetCount.builder(RandomValueRange.of(1, 5))))
						.addEntry(ItemLootEntry.builder(MSItems.HEARTS_SUITARANG).weight(2).acceptFunction(SetCount.builder(RandomValueRange.of(1, 5))))
						.addEntry(ItemLootEntry.builder(MSItems.SPADES_SUITARANG).weight(2).acceptFunction(SetCount.builder(RandomValueRange.of(1, 5))))
