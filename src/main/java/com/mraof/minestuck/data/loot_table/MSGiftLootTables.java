	...
	public void accept(BiConsumer<ResourceLocation, LootTable.Builder> lootProcessor)
	{
		...
		lootProcessor.accept(MSLootTables.CONSORT_GENERAL_STOCK, LootTable.lootTable()
				.withPool(LootPool.lootPool().name(ITEM_POOL).setRolls(ConstantValue.exactly(4))
						...
						.add(LootItem.lootTableItem(MSItems.CARVING_TOOL9j).setWeight(10).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 5))))
						...
						.add(LootItem.lootTableItem(MSItems.STONE_SLAB9j).setWeight(10).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 5))))
						.add(LootItem.lootTableItem(MSItems.THRESH_DVD9j).setWeight(5).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3))))
						.add(LootItem.lootTableItem(MSItems.CREW_POSTER9j).setWeight(5).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3))))
						.add(LootItem.lootTableItem(MSItems.SBAHJ_POSTER9j).setWeight(5).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3))))
						.add(LootItem.lootTableItem(MSItems.GAMEBRO_MAGAZINE9j).setWeight(5).when(ConsortLootCondition.builder(EnumConsort.SALAMANDER, EnumConsort.NAKAGATOR)))
						.add(LootItem.lootTableItem(MSItems.GAMEGRL_MAGAZINE9j).setWeight(5).when(ConsortLootCondition.builder(EnumConsort.TURTLE, EnumConsort.IGUANA)))
						.add(LootItem.lootTableItem(MSItems.ACE_OF_CLUBS9j).setWeight(2).when(ConsortLootCondition.builder(EnumConsort.SALAMANDER)))
						.add(LootItem.lootTableItem(MSItems.ACE_OF_SPADES9j).setWeight(2).when(ConsortLootCondition.builder(EnumConsort.NAKAGATOR)))
						.add(LootItem.lootTableItem(MSItems.ACE_OF_HEARTS9j).setWeight(2).when(ConsortLootCondition.builder(EnumConsort.TURTLE)))
						.add(LootItem.lootTableItem(MSItems.ACE_OF_DIAMONDS9j).setWeight(2).when(ConsortLootCondition.builder(EnumConsort.IGUANA)))
						.add(LootItem.lootTableItem(MSItems.CLUBS_SUITARANG9j).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 5))))
						.add(LootItem.lootTableItem(MSItems.DIAMONDS_SUITARANG9j).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 5))))
						.add(LootItem.lootTableItem(MSItems.HEARTS_SUITARANG9j).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 5))))
						.add(LootItem.lootTableItem(MSItems.SPADES_SUITARANG9j).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 5))))
						.add(LootItem.lootTableItem(MSItems.MUSIC_DISC_EMISSARY_OF_DANCE9j).setWeight(1))
						.add(LootItem.lootTableItem(MSItems.MUSIC_DISC_DANCE_STAB_DANCE9j).setWeight(1))
						.add(LootItem.lootTableItem(MSItems.ELECTRIC_AUTOHARP9j).setWeight(1))
						.add(LootItem.lootTableItem(MSItems.BATTERY9j).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1,4))))
						.add(LootItem.lootTableItem(MSItems.GRIMOIRE9j).setWeight(1).when(ConsortLootCondition.builder(EnumConsort.TURTLE)))
						.add(LootItem.lootTableItem(MSItems.CRUMPLY_HAT9j).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 5))).when(ConsortLootCondition.builder(EnumConsort.SALAMANDER))))
		...
		lootProcessor.accept(locationFor(LandTypes.FOREST, MSLootTables.CONSORT_GENERAL_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(ITEM_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.COPSE_CRUSHER9j).setWeight(3))
		...
		lootProcessor.accept(locationFor(LandTypes.FROST, MSLootTables.CONSORT_GENERAL_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(ITEM_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.KATANA9j).setWeight(3))
		...
		lootProcessor.accept(locationFor(LandTypes.HEAT, MSLootTables.CONSORT_GENERAL_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(ITEM_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.FIRE_POKER9j).setWeight(3))
		...
		lootProcessor.accept(locationFor(LandTypes.ROCK, MSLootTables.CONSORT_GENERAL_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(ITEM_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.METAL_BAT9j).setWeight(3))
		...
		lootProcessor.accept(locationFor(LandTypes.SAND, MSLootTables.CONSORT_GENERAL_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(ITEM_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.CACTACEAE_CUTLASS9j).setWeight(3))
		...
		lootProcessor.accept(locationFor(LandTypes.SHADE, MSLootTables.CONSORT_GENERAL_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(ITEM_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.POGO_CLUB9j).setWeight(3))
		...
		lootProcessor.accept(locationFor(LandTypes.FROGS, MSLootTables.CONSORT_GENERAL_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(ITEM_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.BUG_NET9j).setWeight(5)))
				.withPool(LootPool.lootPool().name(BLOCK_POOL).setRolls(ConstantValue.exactly(1))
		...
		lootProcessor.accept(locationFor(LandTypes.THUNDER, MSLootTables.CONSORT_GENERAL_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(ITEM_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.IRON_CANE9j).setWeight(3)))
				.withPool(LootPool.lootPool().name(BLOCK_POOL).setRolls(ConstantValue.exactly(1))));
		...
		lootProcessor.accept(MSLootTables.CONSORT_FOOD_STOCK, LootTable.lootTable()
				.withPool(LootPool.lootPool().name(MAIN_POOL).setRolls(ConstantValue.exactly(5))
						...
						.add(LootItem.lootTableItem(MSItems.GRASSHOPPER9j).setWeight(5).apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 10)))))
				.withPool(LootPool.lootPool().name(SPECIAL_POOL).setRolls(UniformGenerator.between(1, 2))
						...
						.add(LootItem.lootTableItem(MSItems.CANDY_CORN9j).setWeight(1).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4))))
		...
		lootProcessor.accept(locationFor(LandTypes.FOREST, MSLootTables.CONSORT_FOOD_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(MAIN_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.ONION9j).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 10))))
						.add(LootItem.lootTableItem(MSItems.CONE_OF_FLIES9j).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 10))))
						.add(LootItem.lootTableItem(Items.APPLE).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 10))))
						.add(LootItem.lootTableItem(MSItems.CHOCOLATE_BEETLE9j).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 10))))
		...
		lootProcessor.accept(locationFor(LandTypes.FLORA, MSLootTables.CONSORT_FOOD_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(MAIN_POOL).setRolls(ConstantValue.exactly(1))
						...
						.add(LootItem.lootTableItem(Items.WHEAT).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 10))))
						.add(LootItem.lootTableItem(Items.WHEAT_SEEDS).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 10))))
						.add(LootItem.lootTableItem(MSItems.STRAWBERRY_CHUNK9j).setWeight(5).apply(SetItemCountFunction.setCount(UniformGenerator.between(8, 12)))))
				.withPool(LootPool.lootPool().name(SPECIAL_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(Items.COOKIE).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3))))
						.add(LootItem.lootTableItem(MSBlocks.APPLE_CAKE.get()).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3))))));
		...
		lootProcessor.accept(locationFor(LandTypes.FUNGI, MSLootTables.CONSORT_FOOD_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(MAIN_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.JAR_OF_BUGS9j).setWeight(5).apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 10))))
						.add(LootItem.lootTableItem(MSItems.BUG_ON_A_STICK9j).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 10))))
						.add(LootItem.lootTableItem(MSItems.CONE_OF_FLIES9j).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 10))))
						...
						.add(LootItem.lootTableItem(MSItems.FUNGAL_SPORE9j).setWeight(10).apply(SetItemCountFunction.setCount(UniformGenerator.between(8, 12))))
						.add(LootItem.lootTableItem(MSItems.SPOREO9j).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 4)))))
				.withPool(LootPool.lootPool().name(SPECIAL_POOL).setRolls(ConstantValue.exactly(1))
		...
		lootProcessor.accept(locationFor(LandTypes.HEAT, MSLootTables.CONSORT_FOOD_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(MAIN_POOL).setRolls(ConstantValue.exactly(1))
						...
						.add(LootItem.lootTableItem(MSItems.STEAK_SWORD9j).setWeight(3))
				...
				.withPool(LootPool.lootPool().name(SPECIAL_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.TAB9j).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 6))))
						.add(LootItem.lootTableItem(MSItems.IRRADIATED_STEAK9j).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3))))));
		lootProcessor.accept(locationFor(LandTypes.ROCK, MSLootTables.CONSORT_FOOD_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(MAIN_POOL).setRolls(ConstantValue.exactly(1))
						...
						.add(LootItem.lootTableItem(MSItems.STEAK_SWORD9j).setWeight(3))
						.add(LootItem.lootTableItem(Items.BEETROOT).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 10))))
						.add(LootItem.lootTableItem(MSItems.ROCK_COOKIE9j).setWeight(5).apply(SetItemCountFunction.setCount(UniformGenerator.between(8, 12)))))
				.withPool(LootPool.lootPool().name(SPECIAL_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.TAB9j).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 6))))
						.add(LootItem.lootTableItem(MSItems.IRRADIATED_STEAK9j).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3))))));
		...
		lootProcessor.accept(locationFor(LandTypes.SAND, MSLootTables.CONSORT_FOOD_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(MAIN_POOL).setRolls(ConstantValue.exactly(1))
						...
						.add(LootItem.lootTableItem(MSItems.BUG_ON_A_STICK9j).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 10))))
						.add(LootItem.lootTableItem(Items.POTATO).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 10))))
						.add(LootItem.lootTableItem(MSItems.SALAD9j).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 10))))
						...
						.add(LootItem.lootTableItem(MSItems.DESERT_FRUIT9j).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(15, 20)))))
				.withPool(LootPool.lootPool().name(SPECIAL_POOL).setRolls(ConstantValue.exactly(1))
		...
		lootProcessor.accept(locationFor(LandTypes.WIND, MSLootTables.CONSORT_FOOD_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(MAIN_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.COTTON_CANDY_FAYGO9j).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3)))))
				.withPool(LootPool.lootPool().name(SPECIAL_POOL).setRolls(ConstantValue.exactly(1))));
		
		lootProcessor.accept(locationFor(LandTypes.LIGHT, MSLootTables.CONSORT_FOOD_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(MAIN_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.ORANGE_FAYGO9j).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3)))))
				.withPool(LootPool.lootPool().name(SPECIAL_POOL).setRolls(ConstantValue.exactly(1))));
		
		lootProcessor.accept(locationFor(LandTypes.CLOCKWORK, MSLootTables.CONSORT_FOOD_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(MAIN_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.CANDY_APPLE_FAYGO9j).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3)))))
				.withPool(LootPool.lootPool().name(SPECIAL_POOL).setRolls(ConstantValue.exactly(1))));
		
		lootProcessor.accept(locationFor(LandTypes.SILENCE, MSLootTables.CONSORT_FOOD_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(MAIN_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.FAYGO_COLA9j).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3)))))
				.withPool(LootPool.lootPool().name(SPECIAL_POOL).setRolls(ConstantValue.exactly(1))));
		
		lootProcessor.accept(locationFor(LandTypes.THUNDER, MSLootTables.CONSORT_FOOD_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(MAIN_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.PEACH_FAYGO9j).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3)))))
				.withPool(LootPool.lootPool().name(SPECIAL_POOL).setRolls(ConstantValue.exactly(1))));
		
		lootProcessor.accept(locationFor(LandTypes.PULSE, MSLootTables.CONSORT_FOOD_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(MAIN_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.BEEF_SWORD9j).setWeight(4)).when(ConsortLootCondition.builder(EnumConsort.NAKAGATOR))
						.add(LootItem.lootTableItem(MSItems.REDPOP_FAYGO9j).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3)))))
				.withPool(LootPool.lootPool().name(SPECIAL_POOL).setRolls(ConstantValue.exactly(1))));
		
		lootProcessor.accept(locationFor(LandTypes.THOUGHT, MSLootTables.CONSORT_FOOD_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(MAIN_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.MOON_MIST_FAYGO9j).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3)))))
				.withPool(LootPool.lootPool().name(SPECIAL_POOL).setRolls(ConstantValue.exactly(1))));
		...
		lootProcessor.accept(locationFor(LandTypes.MONSTERS, MSLootTables.CONSORT_FOOD_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(MAIN_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.GRAPE_FAYGO9j).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3)))))
				.withPool(LootPool.lootPool().name(SPECIAL_POOL).setRolls(ConstantValue.exactly(1))));
		...
		lootProcessor.accept(locationFor(LandTypes.TOWERS, MSLootTables.CONSORT_FOOD_STOCK), LootTable.lootTable()
				.withPool(LootPool.lootPool().name(MAIN_POOL).setRolls(ConstantValue.exactly(1))
						.add(LootItem.lootTableItem(MSItems.CREME_SODA_FAYGO9j).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3)))))
				.withPool(LootPool.lootPool().name(SPECIAL_POOL).setRolls(ConstantValue.exactly(1))));
		...
		lootProcessor.accept(MSLootTables.CONSORT_JUNK_REWARD, LootTable.lootTable()
				.withPool(LootPool.lootPool().name("main").setRolls(ConstantValue.exactly(1))
						...
						.add(LootItem.lootTableItem(MSItems.SORD9j).setWeight(10))
						.add(LootItem.lootTableItem(MSItems.CROWBAR9j).setWeight(3).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.05F, 0.7F))))
						...
						.add(LootItem.lootTableItem(MSItems.SBAHJ_POSTER9j).setWeight(10))
						.add(LootItem.lootTableItem(MSItems.CREW_POSTER9j).setWeight(10))
						.add(LootItem.lootTableItem(MSItems.THRESH_DVD9j).setWeight(10))
						.add(LootItem.lootTableItem(MSItems.ONION9j).setWeight(5).when(ConsortLootCondition.builder(EnumConsort.NAKAGATOR)))
						.add(LootItem.lootTableItem(MSItems.TAB9j).setWeight(5).when(ConsortLootCondition.builder(EnumConsort.SALAMANDER)))
						.add(LootItem.lootTableItem(MSItems.JAR_OF_BUGS9j).setWeight(5).when(ConsortLootCondition.builder(EnumConsort.TURTLE)))
						.add(LootItem.lootTableItem(MSItems.GRASSHOPPER9j).setWeight(5).when(ConsortLootCondition.builder(EnumConsort.IGUANA)))));
