...
public class MSBlockLootTables extends BlockLootTables
{
	...
	protected void addTables()
	{
		...
		dropSelf(FLOWERY_MOSSY_STONE);
		dropSelf(POLISHED_FLOWERY_MOSSY_STONE);
		dropSelf(FLOWERY_MOSSY_STONE_BRICKS);
		dropSelf(FLOWERY_MOSSY_STONE_COLUMN);
		dropSelf(CHISELED_FLOWERY_MOSSY_STONE_BRICKS);
		dropSelf(CRACKED_FLOWERY_MOSSY_STONE_BRICKS);
		...
		dropSelf(FLOWERY_MOSSY_STONE_STAIRS);
