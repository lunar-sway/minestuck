...
public class MSBlockLootTables extends BlockLoot
{
	...
	protected void addTables()
	{
		...
		dropSelf(BLACK_CASTLE_BRICKS.get());
		dropSelf(WHITE_CASTLE_BRICKS.get());
		dropSelf(LIGHT_GRAY_CASTLE_BRICKS.get());
		dropSelf(DARK_GRAY_CASTLE_BRICKS.get());
		dropSelf(BLACK_CASTLE_BRICK_SMOOTH.get());
		dropSelf(WHITE_CASTLE_BRICK_SMOOTH.get());
		dropSelf(LIGHT_GRAY_CASTLE_BRICK_SMOOTH.get());
		dropSelf(DARK_GRAY_CASTLE_BRICK_SMOOTH.get());
		dropSelf(BLACK_CASTLE_BRICK_TRIM.get());
		dropSelf(WHITE_CASTLE_BRICK_TRIM.get());
		dropSelf(LIGHT_GRAY_CASTLE_BRICK_TRIM.get());
		dropSelf(DARK_GRAY_CASTLE_BRICK_TRIM.get());
		...
		dropSelf(MOSSY_COARSE_STONE.get());
		...
		dropSelf(BLACK_CASTLE_BRICK_STAIRS.get());
		dropSelf(DARK_GRAY_CASTLE_BRICK_STAIRS.get());
		dropSelf(LIGHT_GRAY_CASTLE_BRICK_STAIRS.get());
		dropSelf(WHITE_CASTLE_BRICK_STAIRS.get());
		...
		dropSelf(BLACK_CASTLE_BRICK_SLAB.get());
		dropSelf(DARK_GRAY_CASTLE_BRICK_SLAB.get());
		dropSelf(LIGHT_GRAY_CASTLE_BRICK_SLAB.get());
		dropSelf(WHITE_CASTLE_BRICK_SLAB.get());
