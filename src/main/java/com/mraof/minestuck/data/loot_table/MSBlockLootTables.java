...
public class MSBlockLootTables extends BlockLoot
{
	...
	protected void addTables()
	{
		...
		dropSelf(BLACK_CHESS_BRICKS);
		dropSelf(WHITE_CHESS_BRICKS);
		dropSelf(LIGHT_GRAY_CHESS_BRICKS);
		dropSelf(DARK_GRAY_CHESS_BRICKS);
		dropSelf(BLACK_CHESS_BRICK_SMOOTH);
		dropSelf(WHITE_CHESS_BRICK_SMOOTH);
		dropSelf(LIGHT_GRAY_CHESS_BRICK_SMOOTH);
		dropSelf(DARK_GRAY_CHESS_BRICK_SMOOTH);
		dropSelf(BLACK_CHESS_BRICK_TRIM);
		dropSelf(WHITE_CHESS_BRICK_TRIM);
		dropSelf(LIGHT_GRAY_CHESS_BRICK_TRIM);
		dropSelf(DARK_GRAY_CHESS_BRICK_TRIM);
		...
		dropSelf(BLACK_CHESS_BRICK_STAIRS);
		dropSelf(DARK_GRAY_CHESS_BRICK_STAIRS);
		dropSelf(LIGHT_GRAY_CHESS_BRICK_STAIRS);
		dropSelf(WHITE_CHESS_BRICK_STAIRS);
		...
		dropSelf(DARK_GRAY_CHESS_BRICK_SLAB);
		dropSelf(LIGHT_GRAY_CHESS_BRICK_SLAB);
		dropSelf(WHITE_CHESS_BRICK_SLAB);
		dropSelf(CHALK_SLAB);
		...
		dropSelf(ROTATOR);
		dropSelf(TOGGLER);
		dropSelf(REMOTE_COMPARATOR);
		add(STRUCTURE_CORE, noDrop());
		dropSelf(FALL_PAD);
		dropSelf(FRAGILE_STONE);
		dropSelf(RETRACTABLE_SPIKES);
		dropSelf(BLOCK_PRESSURE_PLATE);
		dropSelf(PUSHABLE_BLOCK);
	...
	{
		return createLeavesDrops(block, END_SAPLING, SAPLING_CHANCES).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1)).when(NO_SILK_OR_SHEAR_CONDITION).add(applyExplosionCondition(block, LootItem.lootTableItem(Items.CHORUS_FRUIT)).when(BonusLevelTableCondition.bonusLevelFlatChance(Enchantments.BLOCK_FORTUNE, 0.005F, 0.0055555557F, 0.00625F, 0.008333334F, 0.025F))));
	}
