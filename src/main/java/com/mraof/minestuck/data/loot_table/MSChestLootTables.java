...
public class MSChestLootTables implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>>
{
	...
	public void accept(BiConsumer<ResourceLocation, LootTable.Builder> lootProcessor)
	{
		...
		lootProcessor.accept(MSLootTables.TIER_ONE_MEDIUM_CHEST, LootTable.builder()
				.addLootPool(LootPool.builder().name(WEAPONS_POOL).rolls(RandomValueRange.of(0, 1))
						...
						.addEntry(ItemLootEntry.builder(MSItems.SCYTHE).weight(4).quality(2).acceptFunction(SetDamage.func_215931_a(RandomValueRange.of(0.75F, 1.0F))))
						...
						.addEntry(ItemLootEntry.builder(MSItems.METAL_BAT).weight(6).quality(1).acceptFunction(SetDamage.func_215931_a(RandomValueRange.of(0.75F, 1.0F))))
						.addEntry(ItemLootEntry.builder(MSItems.MACE).weight(6).quality(1).acceptFunction(SetDamage.func_215931_a(RandomValueRange.of(0.75F, 1.0F))))
						.addEntry(ItemLootEntry.builder(MSItems.JOUSTING_LANCE).weight(6).quality(1).acceptFunction(SetDamage.func_215931_a(RandomValueRange.of(0.75F, 1.0F))))
						.addEntry(ItemLootEntry.builder(MSItems.LUCERNE_HAMMER).weight(4).quality(2).acceptFunction(SetDamage.func_215931_a(RandomValueRange.of(0.75F, 1.0F))))
				...
				.addLootPool(LootPool.builder().name(SUPPLIES_POOL).rolls(RandomValueRange.of(1, 3))
						...
						.addEntry(ItemLootEntry.builder(MSItems.GRUB_SAUCE).weight(5).quality(0).acceptFunction(SetCount.builder(RandomValueRange.of(1, 2))))
						.addEntry(ItemLootEntry.builder(MSItems.FRENCH_FRY).weight(5).quality(0).acceptFunction(SetCount.builder(RandomValueRange.of(1, 5))))
						.addEntry(ItemLootEntry.builder(MSItems.TUIX_BAR).weight(5).quality(0).acceptFunction(SetCount.builder(RandomValueRange.of(1, 2))))
				...
				.addLootPool(LootPool.builder().name(MISC_POOL).rolls(RandomValueRange.of(1, 2))
				...
				.addLootPool(LootPool.builder().name(RARE_POOL).rolls(RandomValueRange.of(0, 1))
						...
						.addEntry(ItemLootEntry.builder(Items.IRON_INGOT).weight(20).quality(1).acceptFunction(SetCount.builder(RandomValueRange.of(0, 6))))
						.addEntry(ItemLootEntry.builder(Items.GOLD_INGOT).weight(15).quality(1).acceptFunction(SetCount.builder(RandomValueRange.of(0, 5))))
						.addEntry(ItemLootEntry.builder(Items.DIAMOND).weight(15).quality(2).acceptFunction(SetCount.builder(RandomValueRange.of(0, 3))))
		...
		lootProcessor.accept(MSLootTables.BASIC_MEDIUM_CHEST, LootTable.builder()
				.addLootPool(LootPool.builder().name("main").rolls(ConstantRange.of(1))
						//.addEntry(LandTableLootEntry.builder(MSLootTables.BASIC_MEDIUM_CHEST))
						.addEntry(ItemLootEntry.builder(Items.BOW).weight(5).quality(1).acceptFunction(SetDamage.func_215931_a(RandomValueRange.of(0.75F, 1.0F))))
						.addEntry(ItemLootEntry.builder(Items.IRON_SWORD).weight(3).quality(1).acceptFunction(SetDamage.func_215931_a(RandomValueRange.of(0.75F, 1.0F))))
						.addEntry(ItemLootEntry.builder(MSItems.CLAW_HAMMER).weight(5).quality(-1).acceptFunction(SetDamage.func_215931_a(RandomValueRange.of(0.75F, 1.0F))))
						.addEntry(ItemLootEntry.builder(MSItems.SICKLE).weight(5).quality(-1).acceptFunction(SetDamage.func_215931_a(RandomValueRange.of(0.75F, 1.0F))))
						...
						.addEntry(ItemLootEntry.builder(Items.EXPERIENCE_BOTTLE).weight(5).quality(2).acceptFunction(SetCount.builder(RandomValueRange.of(1, 2))))
						.addEntry(ItemLootEntry.builder(Items.GOLDEN_APPLE).weight(3).quality(2))
						.addEntry(ItemLootEntry.builder(MSItems.SORROW_GUSHERS).weight(6).quality(-1).acceptFunction(SetCount.builder(RandomValueRange.of(3, 7))))
						...
						.addEntry(ItemLootEntry.builder(MSBlocks.GENERIC_OBJECT).weight(6).quality(-1))
						.addEntry(ItemLootEntry.builder(MSItems.RAW_CRUXITE).weight(8).quality(1).acceptFunction(SetCount.builder(RandomValueRange.of(1, 5))))
						.addEntry(ItemLootEntry.builder(MSItems.RAW_URANIUM).weight(4).quality(1).acceptFunction(SetCount.builder(RandomValueRange.of(1, 4))))
						.addEntry(ItemLootEntry.builder(Items.IRON_INGOT).weight(5).quality(1).acceptFunction(SetCount.builder(RandomValueRange.of(1, 5))))
						.addEntry(ItemLootEntry.builder(Items.GOLD_INGOT).weight(1).quality(1).acceptFunction(SetCount.builder(RandomValueRange.of(1, 4))))
						.addEntry(ItemLootEntry.builder(Items.DIAMOND).weight(1).quality(2).acceptFunction(SetCount.builder(RandomValueRange.of(1, 2))))
						.addEntry(ItemLootEntry.builder(MSItems.GRIMOIRE).weight(3).quality(1))
						.addEntry(ItemLootEntry.builder(MSBlocks.MINI_WIZARD_STATUE).weight(3).quality(1))
						.addEntry(ItemLootEntry.builder(MSBlocks.TRANSPORTALIZER).weight(1).quality(2))
						.addEntry(ItemLootEntry.builder(MSItems.DICE).weight(5).quality(0))
						.addEntry(ItemLootEntry.builder(MSBlocks.COMPUTER).weight(1).quality(0))
						.addEntry(ItemLootEntry.builder(MSBlocks.LAPTOP).weight(1).quality(0))
						.addEntry(ItemLootEntry.builder(MSBlocks.CHESSBOARD).weight(2).quality(0))
						.addEntry(ItemLootEntry.builder(MSItems.ENERGY_CORE).weight(2).quality(0))
						...
						.addEntry(ItemLootEntry.builder(MSItems.BOONDOLLARS).weight(20).quality(-1).acceptFunction(SetBoondollarCount.builder(RandomValueRange.of(5, 50))))
						.addEntry(ItemLootEntry.builder(MSItems.BOONDOLLARS).weight(10).quality(0).acceptFunction(SetBoondollarCount.builder(RandomValueRange.of(50, 250))))
						.addEntry(ItemLootEntry.builder(MSItems.BOONDOLLARS).weight(4).quality(1).acceptFunction(SetBoondollarCount.builder(RandomValueRange.of(250, 1000))))));
		...
		lootProcessor.accept(locationFor(LandTypes.FUNGI, MSLootTables.BASIC_MEDIUM_CHEST), LootTable.builder()
				.addLootPool(LootPool.builder().name("main").rolls(ConstantRange.of(1))
						...
						.addEntry(ItemLootEntry.builder(MSItems.FUNGAL_SPORE).weight(100).quality(0).acceptFunction(SetCount.builder(RandomValueRange.of(6, 11))))));
		...
		lootProcessor.accept(locationFor(LandTypes.RABBITS, MSLootTables.BASIC_MEDIUM_CHEST), LootTable.builder()
				.addLootPool(LootPool.builder().name("main").rolls(ConstantRange.of(1))
						.addEntry(ItemLootEntry.builder(Items.RABBIT).weight(100).quality(-1).acceptFunction(SetCount.builder(RandomValueRange.of(1, 2))))
