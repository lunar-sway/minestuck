	...
	public void accept(BiConsumer<ResourceLocation, LootTable.Builder> lootProcessor)
	{
		lootProcessor.accept(MSLootTables.BASIC_MEDIUM_CHEST, LootTable.builder()
				.addLootPool(LootPool.builder().name(WEAPONS_POOL).rolls(ConstantRange.of(1))
						...
						.addEntry(ItemLootEntry.builder(MSItems.FLINTLOCK_PISTOL).weight(1).quality(2).acceptFunction(SetDamage.func_215931_a(RandomValueRange.of(0.75F, 1.0F))))
						.addEntry(ItemLootEntry.builder(MSItems.RIFLE).weight(1).quality(3).acceptFunction(SetDamage.func_215931_a(RandomValueRange.of(0.75F, 1.0F))))
						.addEntry(ItemLootEntry.builder(MSItems.SHOTGUN).weight(1).quality(3).acceptFunction(SetDamage.func_215931_a(RandomValueRange.of(0.75F, 1.0F))))
				...
				.addLootPool(LootPool.builder().name(SUPPLIES_POOL).rolls(ConstantRange.of(3))
						...
						.addEntry(ItemLootEntry.builder(MSItems.BULLET).weight(5).quality(1).acceptFunction(SetCount.builder(RandomValueRange.of(1, 16))))
