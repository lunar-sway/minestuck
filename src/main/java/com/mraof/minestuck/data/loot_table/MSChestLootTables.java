	...
	public void accept(BiConsumer<ResourceLocation, LootTable.Builder> lootProcessor)
	{
		...
		lootProcessor.accept(MSLootTables.TIER_ONE_MEDIUM_CHEST, LootTable.builder()
				...
				.addLootPool(LootPool.builder().name(SUPPLIES_POOL).rolls(RandomValueRange.of(1, 3))
						...
						.addEntry(ItemLootEntry.builder(MSItems.GRUB_SAUCE).weight(3).quality(0).acceptFunction(SetCount.builder(RandomValueRange.of(1, 2))))
						.addEntry(ItemLootEntry.builder(MSItems.FRENCH_FRY).weight(3).quality(0).acceptFunction(SetCount.builder(RandomValueRange.of(1, 5))))
