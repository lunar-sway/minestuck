	...
	public void accept(BiConsumer<ResourceLocation, LootTable.Builder> lootProcessor)
	{
		lootProcessor.accept(MSLootTables.DUNGEON_LOOT_INJECT, LootTable.lootTable()
				.withPool(LootPool.lootPool().name("minestuck").setRolls(UniformGenerator.between(0, 1))
						.add(LootItem.lootTableItem(MSItems.BLANK_DISK).setWeight(1).setQuality(1).apply(SetItemCountFunction.setCount(UniformGenerator.between(0, 2))))));
		...
		lootProcessor.accept(MSLootTables.FROG_TEMPLE_CHEST, LootTable.lootTable()
				...
				.withPool(LootPool.lootPool().name(SUPPLIES_POOL).setRolls(UniformGenerator.between(2, 6))
						...
						.add(LootItem.lootTableItem(MSItems.BLANK_DISK).setWeight(5).setQuality(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 2))))
						.add(LootItem.lootTableItem(MSItems.RAW_CRUXITE).setWeight(4).setQuality(0).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 7))))
						.add(LootItem.lootTableItem(MSItems.RAW_URANIUM).setWeight(2).setQuality(1).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 5))))
						.add(LootItem.lootTableItem(MSItems.BUG_ON_A_STICK).setWeight(4).setQuality(-1).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 5))))
						.add(LootItem.lootTableItem(MSItems.CHOCOLATE_BEETLE).setWeight(4).setQuality(-1).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 5))))
						.add(LootItem.lootTableItem(MSItems.FOOD_CAN).setWeight(4).setQuality(-1).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 5))))
						.add(LootItem.lootTableItem(MSItems.GRASSHOPPER).setWeight(4).setQuality(-1).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 5))))
						.add(LootItem.lootTableItem(MSItems.CONE_OF_FLIES).setWeight(4).setQuality(-1).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 5))))
						.add(LootItem.lootTableItem(MSItems.GOLDEN_GRASSHOPPER).setWeight(1).setQuality(1).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 2))))
						.add(LootItem.lootTableItem(MSBlocks.MINI_FROG_STATUE).setWeight(1).setQuality(1).apply(SetItemCountFunction.setCount(UniformGenerator.between(0, 1))))
						.add(LootItem.lootTableItem(MSItems.CARVING_TOOL).setWeight(5).setQuality(0).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 2))))
						.add(LootItem.lootTableItem(MSItems.STONE_SLAB).setWeight(2).setQuality(0).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 2))))
						.add(LootItem.lootTableItem(MSItems.HASHMAP_MODUS_CARD).setWeight(1).setQuality(1).apply(SetItemCountFunction.setCount(UniformGenerator.between(0, 1))))
						.add(LootItem.lootTableItem(MSItems.QUEUE_MODUS_CARD).setWeight(1).setQuality(1).apply(SetItemCountFunction.setCount(UniformGenerator.between(0, 1))))
						.add(LootItem.lootTableItem(MSItems.QUEUESTACK_MODUS_CARD).setWeight(1).setQuality(1).apply(SetItemCountFunction.setCount(UniformGenerator.between(0, 1))))
						.add(LootItem.lootTableItem(MSItems.SET_MODUS_CARD).setWeight(1).setQuality(1).apply(SetItemCountFunction.setCount(UniformGenerator.between(0, 1))))
						.add(LootItem.lootTableItem(MSItems.STACK_MODUS_CARD).setWeight(1).setQuality(1).apply(SetItemCountFunction.setCount(UniformGenerator.between(0, 1))))
						.add(LootItem.lootTableItem(MSItems.TREE_MODUS_CARD).setWeight(1).setQuality(1).apply(SetItemCountFunction.setCount(UniformGenerator.between(0, 1))))));
