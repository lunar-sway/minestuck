...
public final class MSPlacedFeatureProvider
{
	public static void register(BootstapContext<PlacedFeature> context)
	{
		...
		context.register(TREE_STUMP, placed(features, MSCFeatures.TREE_STUMP,
				worldGenModifiers(RarityFilter.onAverageOnceEvery(12), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BlockPredicateFilter.forPredicate(BlockPredicate.matchesBlocks(Direction.DOWN.getNormal(), Blocks.DIRT, Blocks.GRASS_BLOCK, Blocks.PODZOL, Blocks.ROOTED_DIRT)))));
