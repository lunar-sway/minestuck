...
public class RabbitsLandType extends TitleLandType
{
	...
	public void addExtensions(HolderLookup.Provider provider, StructureBlockRegistry blocks)
	{
		...
		addFeatureExtension(features, GenerationStep.Decoration.TOP_LAYER_MODIFICATION, MSPlacedFeatures.RABBIT_PLACEMENT, LandBiomeType.NORMAL);
		addFeatureExtension(features, GenerationStep.Decoration.TOP_LAYER_MODIFICATION, MSPlacedFeatures.SMALL_RABBIT_PLACEMENT, LandBiomeType.ROUGH);
		addFeatureExtension(features, GenerationStep.Decoration.VEGETAL_DECORATION, MSPlacedFeatures.LIFE_TREE, LandBiomeType.anyExcept(LandBiomeType.OCEAN));
	}
