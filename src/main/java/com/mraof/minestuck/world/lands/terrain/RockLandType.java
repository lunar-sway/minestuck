...
public class RockLandType extends TerrainLandType
{
	...
	public void addExtensions(HolderLookup.Provider provider, StructureBlockRegistry blocks)
	{
		...
		{
			addFeatureExtension(features, GenerationStep.Decoration.VEGETAL_DECORATION, MSPlacedFeatures.SPARSE_PETRIFIED_TREE, LandBiomeType.ROUGH);
			addFeatureExtension(features, GenerationStep.Decoration.LOCAL_MODIFICATIONS, MSPlacedFeatures.RANDOM_ROCK_BLOCK_BLOB, LandBiomeType.NORMAL);
			addFeatureExtension(features, GenerationStep.Decoration.LOCAL_MODIFICATIONS, MSPlacedFeatures.LARGE_RANDOM_ROCK_BLOCK_BLOB, LandBiomeType.ROUGH);
			addFeatureExtension(features, GenerationStep.Decoration.VEGETAL_DECORATION, MSPlacedFeatures.SPARSE_PETRIFIED_GRASS_PATCH, LandBiomeType.NORMAL);
			addFeatureExtension(features, GenerationStep.Decoration.VEGETAL_DECORATION, MSPlacedFeatures.PETRIFIED_GRASS_PATCH, LandBiomeType.ROUGH);
			addFeatureExtension(features, GenerationStep.Decoration.LOCAL_MODIFICATIONS, MSPlacedFeatures.COBBLESTONE_SURFACE_DISK, LandBiomeType.NORMAL, LandBiomeType.ROUGH);
			addFeatureExtension(features, GenerationStep.Decoration.LOCAL_MODIFICATIONS, MSPlacedFeatures.STONE_SURFACE_DISK, LandBiomeType.NORMAL, LandBiomeType.ROUGH);
			addFeatureExtension(features, GenerationStep.Decoration.LOCAL_MODIFICATIONS, MSPlacedFeatures.STONE_MOUND, LandBiomeType.ROUGH);
		} else if(this.type == Variant.PETRIFICATION)
		{
			addFeatureExtension(features, GenerationStep.Decoration.VEGETAL_DECORATION, MSPlacedFeatures.SPARSE_PETRIFIED_TREE, LandBiomeType.NORMAL);
			addFeatureExtension(features, GenerationStep.Decoration.VEGETAL_DECORATION, MSPlacedFeatures.PETRIFIED_TREE, LandBiomeType.ROUGH);
			addFeatureExtension(features, GenerationStep.Decoration.LOCAL_MODIFICATIONS, MSPlacedFeatures.COBBLESTONE_BLOCK_BLOB, LandBiomeType.NORMAL, LandBiomeType.ROUGH);
			addFeatureExtension(features, GenerationStep.Decoration.VEGETAL_DECORATION, MSPlacedFeatures.PETRIFIED_GRASS_PATCH, LandBiomeType.NORMAL);
			addFeatureExtension(features, GenerationStep.Decoration.VEGETAL_DECORATION, MSPlacedFeatures.PETRIFIED_POPPY_PATCH, LandBiomeType.NORMAL);
			addFeatureExtension(features, GenerationStep.Decoration.VEGETAL_DECORATION, MSPlacedFeatures.SPARSE_PETRIFIED_GRASS_PATCH, LandBiomeType.ROUGH);
			addFeatureExtension(features, GenerationStep.Decoration.VEGETAL_DECORATION, MSPlacedFeatures.SPARSE_PETRIFIED_POPPY_PATCH, LandBiomeType.ROUGH);
		}
		
		addFeatureExtension(features, GenerationStep.Decoration.VEGETAL_DECORATION, CavePlacements.GLOW_LICHEN, LandBiomeType.any());
		addFeatureExtension(features, GenerationStep.Decoration.UNDERGROUND_STRUCTURES, MSPlacedFeatures.DRIPSTONE_CLUSTER, LandBiomeType.anyExcept(LandBiomeType.OCEAN));
		addFeatureExtension(features, GenerationStep.Decoration.UNDERGROUND_STRUCTURES, MSPlacedFeatures.OCEANIC_DRIPSTONE_CLUSTER, LandBiomeType.OCEAN);
		addFeatureExtension(features, GenerationStep.Decoration.UNDERGROUND_STRUCTURES, MSPlacedFeatures.LARGE_DRIPSTONE, LandBiomeType.any());
		addFeatureExtension(features, GenerationStep.Decoration.UNDERGROUND_STRUCTURES, MSPlacedFeatures.POINTED_DRIPSTONE, LandBiomeType.anyExcept(LandBiomeType.OCEAN));
		addFeatureExtension(features, GenerationStep.Decoration.UNDERGROUND_STRUCTURES, MSPlacedFeatures.OCEANIC_POINTED_DRIPSTONE, LandBiomeType.OCEAN);
		
		addFeatureExtension(features, GenerationStep.Decoration.UNDERGROUND_DECORATION, CavePlacements.AMETHYST_GEODE, LandBiomeType.any());
		...
		addFeatureExtension(features, GenerationStep.Decoration.UNDERGROUND_ORES, OrePlacements.ORE_GRANITE_UPPER, LandBiomeType.any());
		addFeatureExtension(features, GenerationStep.Decoration.UNDERGROUND_ORES, OrePlacements.ORE_GRANITE_LOWER, LandBiomeType.any());
		addFeatureExtension(features, GenerationStep.Decoration.UNDERGROUND_ORES, OrePlacements.ORE_DIORITE_UPPER, LandBiomeType.any());
		addFeatureExtension(features, GenerationStep.Decoration.UNDERGROUND_ORES, OrePlacements.ORE_DIORITE_LOWER, LandBiomeType.any());
		addFeatureExtension(features, GenerationStep.Decoration.UNDERGROUND_ORES, OrePlacements.ORE_ANDESITE_UPPER, LandBiomeType.any());
		addFeatureExtension(features, GenerationStep.Decoration.UNDERGROUND_ORES, OrePlacements.ORE_ANDESITE_LOWER, LandBiomeType.any());
		addFeatureExtension(features, GenerationStep.Decoration.UNDERGROUND_ORES, OrePlacements.ORE_TUFF, LandBiomeType.any());
