...
public class ForestLandType extends TerrainLandType
{
	...
	{
		return new ForestLandType(Variant.FOREST, new Builder(MSEntityTypes.IGUANA::get).group(GROUP_NAME).names(FORESTS, TREES)
	...
	{
		return new ForestLandType(Variant.TAIGA, new Builder(MSEntityTypes.IGUANA::get).group(GROUP_NAME).names(TAIGAS, BOREAL_FORESTS, COLD_FORESTS)
				.fogColor(0.0, 1.0, 0.6).skyColor(0.4, 0.7, 1.0)
