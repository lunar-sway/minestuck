...
public class LandInfo
{
	...
	public LandInfo(PlayerIdentifier identifier, ResourceKey<Level> dimensionType)
	{
		this.identifier = Objects.requireNonNull(identifier);
		dimension = Objects.requireNonNull(dimensionType);
	}
	
	private LandInfo(SkaianetHandler handler, PlayerIdentifier identifier, ResourceKey<Level> dimensionType)
	{
	...
	public static LandInfo read(CompoundTag nbt, SkaianetHandler handler, PlayerIdentifier identifier)
	{
		...
		LandInfo info = new LandInfo(handler, identifier, dimension);
