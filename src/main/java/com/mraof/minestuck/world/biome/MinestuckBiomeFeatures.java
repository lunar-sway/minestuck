...
public class MinestuckBiomeFeatures
{
	...
	public static final RandomPatchConfiguration STRAWBERRY_CONFIG = FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(MSBlocks.STRAWBERRY.get())), List.of(Blocks.GRASS_BLOCK), 64);
