...
{
	public final SurfaceBuilderConfig PROSPIT_CONFIG = new SurfaceBuilderConfig(MSBlocks.GOLD_TILE_LIGHT.getDefaultState(), MSBlocks.GOLD_TILE_LIGHT.getDefaultState(), MSBlocks.GOLD_TILE_LIGHT.getDefaultState());
