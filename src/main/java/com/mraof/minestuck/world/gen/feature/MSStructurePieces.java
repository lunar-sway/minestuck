...
import com.mraof.minestuck.world.gen.feature.structure.tiered.tier1.*;
...
public final class MSStructurePieces
{
	...
	public static IStructurePieceType TIER_ONE_DUNGEON_ENTRY, TIER_ONE_DUNGEON_END, TIER_ONE_DUNGEON_COMBAT_MODULE, TIER_ONE_DUNGEON_PUZZLE_MODULE, TIER_ONE_DUNGEON_RETURN_MODULE, TIER_ONE_DUNGEON_TREASURE_MODULE;
	...
	static void init()
	{
		...
		TIER_ONE_DUNGEON_RETURN_MODULE = register(TierOneDungeonReturnModulePiece::new, Minestuck.MOD_ID+":tier_one_dungeon_return_module");
		TIER_ONE_DUNGEON_TREASURE_MODULE = register(TierOneDungeonTreasureModulePiece::new, Minestuck.MOD_ID+":tier_one_dungeon_treasure_module");
