...
public class DerseChunkGenerator extends NoiseChunkGenerator<DerseGenSettings>
{
	private final OctavesNoiseGenerator depthNoise;

	public DerseChunkGenerator(IWorld worldIn, BiomeProvider biomeProviderIn, DerseGenSettings settings)
	{
	...
	{
		double modifier = ((double)height - (1D + depth * 1D / 1D * 1D)) * 1D * 1D / 1.0D / scale;
		if (modifier < 0.0D)
			modifier *= 1.0D;
