...
import com.mraof.minestuck.block.CustomModelBlock;
...
public class FrogTemplePiece extends ScatteredStructurePiece
{
	...
	private void buildStairsAndUnderneath(BlockState block, ISeedReader world, MutableBoundingBox boundingBox)
	{
		...
		for(int i = 0; i < 24; i++)
		{
			fillWithBlocksCheckWater(world, boundingBox, 17, pushUp, i, 24, pushUp, i, MSBlocks.STEEP_GREEN_STONE_BRICK_STAIRS_BASE.defaultBlockState().setValue(CustomModelBlock.FACING, this.getOrientation().getOpposite())); //stairs base
			fillWithBlocksCheckWater(world, boundingBox, 17, pushUp + 1, i, 24, pushUp + 1, i, MSBlocks.STEEP_GREEN_STONE_BRICK_STAIRS_TOP.defaultBlockState().setValue(CustomModelBlock.FACING, this.getOrientation().getOpposite())); //stairs top
		...
		fillWithBlocksCheckWater(world, boundingBox, 17, 48, 24, 24, 48, 24, MSBlocks.STEEP_GREEN_STONE_BRICK_STAIRS_BASE.defaultBlockState().setValue(CustomModelBlock.FACING, this.getOrientation().getOpposite())); //stairs base at top
