...
public class TierOneDungeonSecondaryPiece extends ImprovedStructurePiece
{
	...
	private void buildAspectThemedPuzzle(ISeedReader world, MutableBoundingBox boundingBox, Random rand, ChunkGenerator chunkGeneratorIn)
	{
		...
		} else if(worldAspect == EnumAspect.LIFE)
		{
			...
			//generateBox(world, boundingBox, pieceMinX + 6, pieceMaxY - 19, pieceMaxZ + 1, pieceMinX + 19, pieceMaxY - 10, pieceMaxZ + 11, MSBlocks.BLOOD.getDefaultState(), MSBlocks.BLOOD.getDefaultState(), false); //first side room liquid
			...
			generateBox(world, boundingBox, pieceMinX + 16, pieceMaxY - 9, pieceMaxZ - 2, pieceMinX + 16, pieceMaxY - 8, pieceMaxZ - 2, Blocks.STICKY_PISTON.getDefaultState().with(PistonBlock.FACING, Direction.NORTH), Blocks.STICKY_PISTON.getDefaultState(), false);
			generateBox(world, boundingBox, pieceMinX + 16, pieceMaxY - 9, pieceMaxZ - 4, pieceMinX + 16, pieceMaxY - 8, pieceMaxZ - 4, MSBlocks.DUNGEON_DOOR.getDefaultState(), MSBlocks.DUNGEON_DOOR.getDefaultState(), false);
			...
			//generateBox(world, boundingBox, pieceMinX + 9, pieceMinY + 11, pieceMinZ + 1, pieceMaxX - 9, pieceMinY + 11, pieceMinZ + 2, MSBlocks.BLOOD.getDefaultState(), MSBlocks.BLOOD.getDefaultState(), false); //side waterfall
			//generateBox(world, boundingBox, pieceMinX + 9, pieceMinY + 11, pieceMaxZ - 2, pieceMaxX - 9, pieceMinY + 11, pieceMaxZ - 1, MSBlocks.BLOOD.getDefaultState(), MSBlocks.BLOOD.getDefaultState(), false); //side waterfall
			...
			StructureBlockUtil.placeRemoteObserver(world, boundingBox, aspectSymbolPos.down(2).offset(getCoordBaseMode().rotateY(), 8), RemoteObserverTileEntity.ActiveType.IS_PLAYER_PRESENT); //checks for presence of player
			StructureBlockUtil.placeStatStorer(world, boundingBox, aspectSymbolPos.down(2), StatStorerTileEntity.ActiveType.DEATHS, 1); //counts how many deaths there have been(need 10 kills to activate all 5 pistons)
			//generateBox(world, boundingBox, aspectSymbolPos.getX(), aspectSymbolPos.down(2).getY(), aspectSymbolPos.offset(getCoordBaseMode().rotateYCCW()).getZ(), aspectSymbolPos.getX(), aspectSymbolPos.down(2).getY(), aspectSymbolPos.offset(getCoordBaseMode().rotateYCCW()).getZ());
			StructureBlockUtil.fillWithBlocksFromPos(world, boundingBox, Blocks.REDSTONE_WIRE.getDefaultState(), aspectSymbolPos.down(2).offset(getCoordBaseMode().rotateYCCW()), aspectSymbolPos.down(2).offset(getCoordBaseMode().rotateYCCW(), 10));
			StructureBlockUtil.fillWithBlocksFromPos(world, boundingBox, Blocks.REDSTONE_WIRE.getDefaultState(), aspectSymbolPos.down(2).offset(getCoordBaseMode().rotateY()), aspectSymbolPos.down(2).offset(getCoordBaseMode().rotateY(), 5));
			...
			//area effect block/how to complete puzzle
			generateBox(world, boundingBox, pieceMinX + 1, pieceMinY + 10, (pieceMinZ + pieceMaxZ) / 2 + 1, pieceMinX + 1, pieceMinY + 11, (pieceMinZ + pieceMaxZ) / 2 + 1, MSBlocks.COARSE_STONE_STAIRS.getDefaultState().with(StairsBlock.FACING, Direction.NORTH), MSBlocks.COARSE_STONE_STAIRS.getDefaultState(), false);
			generateBox(world, boundingBox, pieceMinX + 1, pieceMinY + 10, (pieceMinZ + pieceMaxZ) / 2 - 1, pieceMinX + 1, pieceMinY + 11, (pieceMinZ + pieceMaxZ) / 2 - 1, MSBlocks.COARSE_STONE_STAIRS.getDefaultState().with(StairsBlock.FACING, Direction.SOUTH), MSBlocks.COARSE_STONE_STAIRS.getDefaultState(), false);
