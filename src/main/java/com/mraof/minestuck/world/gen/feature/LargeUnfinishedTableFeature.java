...
public class LargeUnfinishedTableFeature extends Feature<NoneFeatureConfiguration>
{
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context)
	{
		...
		StructureTemplate template = level.getLevel().getStructureManager().getOrCreate(LARGE_UNFINISHED_TABLE);
