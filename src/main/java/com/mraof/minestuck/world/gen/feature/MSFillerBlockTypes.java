...
public class MSFillerBlockTypes
{
	...
	public static final OreFeatureConfig.FillerBlockType COARSE_END_STONE = OreFeatureConfig.FillerBlockType.create("minestuck_coarse_end_stone", "minestuck_coarse_end_stone", state -> state.getBlock() == MSBlocks.COARSE_END_STONE);
