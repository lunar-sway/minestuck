...
@OnlyIn(Dist.CLIENT)
public class MidRollParticle extends TextureSheetParticle
{
	
	protected MidRollParticle(ClientLevel level, double xCoord, double yCoord, double zCoord,
	...
	public static class Provider implements ParticleProvider<SimpleParticleType>
	{
		...
		{
			MidRollParticle particle = new MidRollParticle(level, x, y, z, this.sprites, dx, dy, dz);
