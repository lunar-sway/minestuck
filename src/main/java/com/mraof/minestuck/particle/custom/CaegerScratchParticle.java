...
@OnlyIn(Dist.CLIENT)
public class CaegerScratchParticle extends TextureSheetParticle
{
	
	protected CaegerScratchParticle(ClientLevel level, double xCoord, double yCoord, double zCoord,
	...
	public static class Provider implements ParticleProvider<SimpleParticleType>
	{
		...
		{
			CaegerScratchParticle particle = new CaegerScratchParticle(level, x, y, z, this.sprites, dx, dy, dz);
