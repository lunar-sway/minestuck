...
@OnlyIn(Dist.CLIENT)
public class LowRollParticle extends TextureSheetParticle
{
	
	protected LowRollParticle(ClientLevel level, double xCoord, double yCoord, double zCoord,
	...
	public static class Provider implements ParticleProvider<SimpleParticleType>
	{
		...
		{
			LowRollParticle particle = new LowRollParticle(level, x, y, z, this.sprites, dx, dy, dz);
