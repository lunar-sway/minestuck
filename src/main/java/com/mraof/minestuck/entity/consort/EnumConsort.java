...
{
	SALAMANDER(MSEntityTypes.SALAMANDER, "salamander", ChatFormatting.GOLD, MSSoundEvents.ENTITY_SALAMANDER_AMBIENT, MSSoundEvents.ENTITY_SALAMANDER_HURT, MSSoundEvents.ENTITY_SALAMANDER_DEATH),
	TURTLE(MSEntityTypes.TURTLE, "turtle", ChatFormatting.DARK_PURPLE, () -> null, MSSoundEvents.ENTITY_TURTLE_HURT, MSSoundEvents.ENTITY_TURTLE_DEATH),
	NAKAGATOR(MSEntityTypes.NAKAGATOR, "nakagator", ChatFormatting.DARK_RED, MSSoundEvents.ENTITY_NAKAGATOR_AMBIENT, MSSoundEvents.ENTITY_NAKAGATOR_HURT, MSSoundEvents.ENTITY_NAKAGATOR_DEATH),
	IGUANA(MSEntityTypes.IGUANA, "iguana", ChatFormatting.BLUE, MSSoundEvents.ENTITY_IGUANA_AMBIENT, MSSoundEvents.ENTITY_IGUANA_HURT, MSSoundEvents.ENTITY_IGUANA_DEATH);
