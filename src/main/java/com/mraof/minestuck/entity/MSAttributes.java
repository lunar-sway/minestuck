...
public final class MSAttributes
{
	...
	public static final Holder<Attribute> STRIFE_DECK_CAPACITY = REGISTER.register("player.strife_deck_capacity", () -> new RangedAttribute("attribute.name.player.strife_deck_capacity", 0, 0, Integer.MAX_VALUE).setSyncable(true).setSentiment(Attribute.Sentiment.POSITIVE));
