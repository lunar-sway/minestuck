...
public class GristEntity extends Entity implements IEntityAdditionalSpawnData
{
	...
	public void consumeGrist(PlayerIdentifier identifier, boolean sound)
	{
		...
		GristHelper.increaseAndNotify(level, identifier, new GristSet(gristType, gristValue), GristHelper.limitGristByPlayerRung(level, identifier, new GristSet(gristType, gristValue)), GristHelper.EnumSource.CLIENT);
		this.discard();
	}
