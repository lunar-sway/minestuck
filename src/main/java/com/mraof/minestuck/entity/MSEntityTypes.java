...
public final class MSEntityTypes
{
	...
	public static final RegistryObject<EntityType<ServerCursorEntity>> SERVER_CURSOR = REGISTER.register("server_cursor", () -> EntityType.Builder.of(ServerCursorEntity::new, MobCategory.MISC).sized(0.1F, 0.1F).setShouldReceiveVelocityUpdates(false).setTrackingRange(4).fireImmune().build(new ResourceLocation(Minestuck.MOD_ID, "server_cursor").toString()));
