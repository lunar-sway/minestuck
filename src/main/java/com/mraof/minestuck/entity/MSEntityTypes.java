...
public final class MSEntityTypes
{
	...
	public static final RegistryObject<EntityType<ImpEntity>> IMP = REGISTER.register("imp", () -> EntityType.Builder.of(ImpEntity::new, UNDERLING).sized(0.7F, 1.2F).build(new ResourceLocation(Minestuck.MOD_ID, "imp").toString())); //TODO adjust hitboxes for all underlings
