...
public final class MSEntityTypes
{
	...
	public static final RegistryObject<EntityType<BishopEntity>> DERSITE_BISHOP = REGISTER.register("dersite_bishop", () -> EntityType.Builder.of(BishopEntity::createDersite, MobCategory.MONSTER).sized(1.9F, 4.1F).build(new ResourceLocation(Minestuck.MOD_ID, "dersite_bishop").toString()));
	public static final RegistryObject<EntityType<BishopEntity>> PROSPITIAN_BISHOP = REGISTER.register("prospitian_bishop", () -> EntityType.Builder.of(BishopEntity::createProspitian, MobCategory.MONSTER).sized(1.9F, 4.1F).build(new ResourceLocation(Minestuck.MOD_ID, "prospitian_bishop").toString()));
	public static final RegistryObject<EntityType<RookEntity>> DERSITE_ROOK = REGISTER.register("dersite_rook", () -> EntityType.Builder.of(RookEntity::createDersite, MobCategory.MONSTER).sized(3.5F, 3.5F).build(new ResourceLocation(Minestuck.MOD_ID, "dersite_rook").toString()));
	public static final RegistryObject<EntityType<RookEntity>> PROSPITIAN_ROOK = REGISTER.register("prospitian_rook", () -> EntityType.Builder.of(RookEntity::createProspitian, MobCategory.MONSTER).sized(3.5F, 3.5F).build(new ResourceLocation(Minestuck.MOD_ID, "prospitian_rook").toString()));
	
	public static final RegistryObject<EntityType<GristEntity>> GRIST = REGISTER.register("grist", () -> EntityType.Builder.<GristEntity>of(GristEntity::new, MobCategory.MISC).sized(1 / 3F, 1 / 3F).setTrackingRange(4).setUpdateInterval(20).fireImmune().build(new ResourceLocation(Minestuck.MOD_ID, "grist").toString()));
	public static final RegistryObject<EntityType<VitalityGelEntity>> VITALITY_GEL = REGISTER.register("vitality_gel", () -> EntityType.Builder.<VitalityGelEntity>of(VitalityGelEntity::new, MobCategory.MISC).sized(1 / 4F, 1 / 4F).setTrackingRange(4).setUpdateInterval(20).fireImmune().build(new ResourceLocation(Minestuck.MOD_ID, "vitality_gel").toString()));
	...
	public static final RegistryObject<EntityType<BarbasolBombEntity>> BARBASOL_BOMB = REGISTER.register("barbasol_bomb", () -> EntityType.Builder.<BarbasolBombEntity>of(BarbasolBombEntity::new, MobCategory.MISC).sized(0.25F, 0.25F).setTrackingRange(4).setUpdateInterval(10).build(new ResourceLocation(Minestuck.MOD_ID, "barbasol_bomb").toString()));
	public static final RegistryObject<EntityType<CrewPosterEntity>> MIDNIGHT_CREW_POSTER = REGISTER.register("midnight_crew_poster", () -> EntityType.Builder.<CrewPosterEntity>of(CrewPosterEntity::new, MobCategory.MISC).sized(0.5F, 0.5F).setShouldReceiveVelocityUpdates(false).setTrackingRange(10).setUpdateInterval(Integer.MAX_VALUE).build(new ResourceLocation(Minestuck.MOD_ID, "midnight_crew_poster").toString()));
	public static final RegistryObject<EntityType<SbahjPosterEntity>> SBAHJ_POSTER = REGISTER.register("sbahj_poster", () -> EntityType.Builder.<SbahjPosterEntity>of(SbahjPosterEntity::new, MobCategory.MISC).sized(0.5F, 0.5F).setShouldReceiveVelocityUpdates(false).setTrackingRange(10).setUpdateInterval(Integer.MAX_VALUE).build(new ResourceLocation(Minestuck.MOD_ID, "sbahj_poster").toString()));
	public static final RegistryObject<EntityType<ShopPosterEntity>> SHOP_POSTER = REGISTER.register("shop_poster", () -> EntityType.Builder.<ShopPosterEntity>of(ShopPosterEntity::new, MobCategory.MISC).sized(0.5F, 0.5F).setShouldReceiveVelocityUpdates(false).setTrackingRange(10).setUpdateInterval(Integer.MAX_VALUE).build(new ResourceLocation(Minestuck.MOD_ID, "shop_poster").toString()));
	public static final RegistryObject<EntityType<HologramEntity>> HOLOGRAM = REGISTER.register("hologram", () -> EntityType.Builder.<HologramEntity>of(HologramEntity::new, MobCategory.MISC).sized(0.25F, 0.25F).setShouldReceiveVelocityUpdates(false).setTrackingRange(10).setUpdateInterval(Integer.MAX_VALUE).build(new ResourceLocation(Minestuck.MOD_ID, "hologram").toString()));
	public static final RegistryObject<EntityType<LotusFlowerEntity>> LOTUS_FLOWER = REGISTER.register("lotus_flower", () -> EntityType.Builder.<LotusFlowerEntity>of(LotusFlowerEntity::new, MobCategory.MISC).sized(2F, 2F).setShouldReceiveVelocityUpdates(false).setTrackingRange(10).build(new ResourceLocation(Minestuck.MOD_ID, "lotus_flower").toString()));
	
	public static final RegistryObject<EntityType<ConsumableProjectileEntity>> CONSUMABLE_PROJECTILE = REGISTER.register("consumable_projectile", () -> EntityType.Builder.<ConsumableProjectileEntity>of(ConsumableProjectileEntity::new, MobCategory.MISC).sized(0.25F, 0.25F).setTrackingRange(4).setUpdateInterval(10).build(new ResourceLocation(Minestuck.MOD_ID, "consumable_projectile").toString()));
	public static final RegistryObject<EntityType<ReturningProjectileEntity>> RETURNING_PROJECTILE = REGISTER.register("returning_projectile", () -> EntityType.Builder.<ReturningProjectileEntity>of(ReturningProjectileEntity::new, MobCategory.MISC).sized(0.25F, 0.25F).setTrackingRange(6).setUpdateInterval(2).build(new ResourceLocation(Minestuck.MOD_ID, "returning_projectile").toString())); //TODO smaller update interval value is temporary solution to improve client rendering
	public static final RegistryObject<EntityType<BouncingProjectileEntity>> BOUNCING_PROJECTILE = REGISTER.register("bouncing_projectile", () -> EntityType.Builder.<BouncingProjectileEntity>of(BouncingProjectileEntity::new, MobCategory.MISC).sized(0.25F, 0.25F).setTrackingRange(6).setUpdateInterval(2).build(new ResourceLocation(Minestuck.MOD_ID, "bouncing_projectile").toString()));
