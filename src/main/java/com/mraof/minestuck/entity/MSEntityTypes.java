...
public final class MSEntityTypes
{
	...
	public static void registerEntities(final RegistryEvent.Register<EntityType<?>> event)
	{
		...
		register(registry, EntityType.Builder.<LotusFlowerEntity>create(LotusFlowerEntity::new, EntityClassification.MISC).size(1F, 1F).setShouldReceiveVelocityUpdates(false).setTrackingRange(10), "lotus_flower");
