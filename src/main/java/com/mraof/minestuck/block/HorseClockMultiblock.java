...
public class HorseClockMultiblock extends MachineMultiblock
{
	...
	public final DeferredBlock<Block> CENTER = register("horse_clock_center", () -> new HorseClockBlock(Block.Properties.of().mapColor(MapColor.WOOD).ignitedByLava().instrument(NoteBlockInstrument.BASS).strength(0.5F).sound(SoundType.WOOD).noLootTable().noOcclusion()));
	public final DeferredBlock<Block> TOP = register("horse_clock_top", () -> new HorseClockBlock(Block.Properties.of().mapColor(MapColor.WOOD).ignitedByLava().instrument(NoteBlockInstrument.BASS).strength(0.5F).sound(SoundType.WOOD).noLootTable().noOcclusion()));
