...
public class MSBlockShapes
{
	...
	//Misc Machines
	public static CustomVoxelShape INTELLIBEAM_LAZERSTATION = new CustomVoxelShape(new double[]{2,0,12,9,7,17}, new double[]{0,0,6,10,8,12}, new double[]{10,0,4,19,8,12}, new double[]{-1,7,7,20,10,11}, new double[]{4,7,11,9,18,15}, new double[]{2,18,9,12,24,15}, new double[]{-3,18,8,2,25,16});
