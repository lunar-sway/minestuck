...
public class MSBlockShapes
{
	...
	//public static final CustomVoxelShape PIPE = new CustomVoxelShape(new double[]{0, 0, 0, 1, 16, 15}, new double[]{0, 0, 16, 15, 16, 15}, new double[]{16, 0, 16, 15, 16, 1}, new double[]{16, 0, 0, 1, 16, 1});
	//public static final CustomVoxelShape PIPE = new CustomVoxelShape(new double[]{0, 0, 0, 16, 1, 15}, new double[]{0, 0, 15, 16, 15, 16}, new double[]{0, 15, 16, 16, 16, 1}, new double[]{0, 16, 0, 16, 1, 1});
	...
	public static final CustomVoxelShape PARCEL_PYXIS = new CustomVoxelShape(new double[]{4, 0, 4, 12, 16, 12}, new double[]{3, 0, 3, 13, 3.5, 13});
	public static final CustomVoxelShape PYXIS_LID = new CustomVoxelShape(new double[]{4, 0, 4, 12, 2.5, 12});
