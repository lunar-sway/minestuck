...
public class MSProperties
{
	...
	public static final EnumProperty<EnumDowelType> DOWEL = EnumProperty.create("dowel", EnumDowelType.class, EnumDowelType.NONE, EnumDowelType.DOWEL, EnumDowelType.CARVED_DOWEL);
