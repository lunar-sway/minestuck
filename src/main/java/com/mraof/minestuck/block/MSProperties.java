...
public class MSProperties
{
	...
	public static final BooleanProperty UNTRIGGERABLE = BooleanProperty.create("untriggerable"); //for use in SummonerBlock, if used in other blocks then add those cases to StuctureCoreTileEntity
