...
public class TotemLatheMultiblock extends MachineMultiblock
{
	...
	public final RegistryObject<Block> WHEEL = register("totem_lathe_wheel", () -> new TotemLatheBlock.Rod(this, TOTEM_LATHE_MIDDLE_RIGHT, TOTEM_LATHE_MIDDLE_RIGHT_ACTIVE, new BlockPos(3, -1, 0), Block.Properties.of(Material.METAL).strength(3.0F, 4.5F).noLootTable()));
	public final RegistryObject<Block> ROD = register("totem_lathe_rod", () -> new TotemLatheBlock.Rod(this, TOTEM_LATHE_ROD_LEFT, TOTEM_LATHE_ROD_LEFT_ACTIVE, new BlockPos(1, -1, 0), Block.Properties.of(Material.METAL).strength(3.0F, 4.5F).noLootTable()));
