...
public class TotemLatheMultiblock extends MachineMultiblock
{
	...
	public final RegistryObject<Block> BOTTOM_CORNER = register("totem_lathe_bottom_corner", () -> new TotemLatheBlock(this, TOTEM_LATHE_BOTTOM_CORNER, new BlockPos(3, 0, 0), AbstractBlock.Properties.of(Material.METAL).strength(3.0F, 4.5F).noDrops()));
	...
	public final RegistryObject<Block> WHEEL = register("totem_lathe_wheel", () -> new TotemLatheBlock.Rod(this, TOTEM_LATHE_MIDDLE_RIGHT, TOTEM_LATHE_MIDDLE_RIGHT_ACTIVE, new BlockPos(3, -1, 0), AbstractBlock.Properties.of(Material.METAL).strength(3.0F, 4.5F).noDrops()));
	public final RegistryObject<Block> ROD = register("totem_lathe_rod", () -> new TotemLatheBlock.Rod(this, TOTEM_LATHE_ROD_LEFT, TOTEM_LATHE_ROD_LEFT_ACTIVE, new BlockPos(1, -1, 0), AbstractBlock.Properties.of(Material.METAL).strength(3.0F, 4.5F).noDrops()));
	public final RegistryObject<Block> DOWEL_ROD = register("totem_lathe_dowel_rod", () -> new TotemLatheBlock.DowelRod(this, TOTEM_LATHE_ROD_RIGHT, TOTEM_LATHE_ROD_RIGHT_CARVED, new BlockPos(2, -1, 0), AbstractBlock.Properties.of(Material.METAL).strength(3.0F, 4.5F).noDrops()));
	public final RegistryObject<Block> TOP_CORNER = register("totem_lathe_top_corner", () -> new TotemLatheBlock(this,TOTEM_LATHE_TOP_LEFT, new BlockPos(0, -2, 0), AbstractBlock.Properties.of(Material.METAL).strength(3.0F, 4.5F).noDrops()));
	public final RegistryObject<Block> TOP = register("totem_lathe_top", () -> new TotemLatheBlock(this, TOTEM_LATHE_TOP_MIDDLE, new BlockPos(1, -2, 0), AbstractBlock.Properties.of(Material.METAL).strength(3.0F, 4.5F).noDrops()));
	public final RegistryObject<Block> CARVER = register("totem_lathe_carver", () -> new TotemLatheBlock(this, TOTEM_LATHE_CARVER, new BlockPos(2, -2, 0), AbstractBlock.Properties.of(Material.METAL).strength(3.0F, 4.5F).noDrops()));
