...
public class TotemLatheMultiblock extends MachineMultiblock
{
	...
	public final RegistryObject<Block> DOWEL_ROD = register("totem_lathe_dowel_rod", () -> new TotemLatheBlock.DowelRod(this, TOTEM_LATHE_ROD, TOTEM_LATHE_ROD_ACTIVE, TOTEM_LATHE_ROD_ACTIVE, new BlockPos(1, -1, 0), AbstractBlock.Properties.of(Material.METAL).strength(3.0F, 4.5F).noDrops()));
