...
{
	NONE(() -> null, null),
	ELEVEN(() -> SoundEvents.MUSIC_DISC_11, () -> onHitEffect(new MobEffectInstance(MobEffects.WITHER, 80, 0),
			0.10F)),
	...
	@Nullable
	private final Supplier<EffectContainer> effectContainer;
	
	EnumCassetteType(Supplier<SoundEvent> soundEvent, Supplier<EffectContainer> effectContainer)
	{
	...
	{
		return Objects.requireNonNull(effectContainer).get();
	}
