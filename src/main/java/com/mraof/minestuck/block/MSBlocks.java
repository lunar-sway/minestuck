...
public class MSBlocks
{
	...
	public static void registerBlocks(final RegistryEvent.Register<Block> event)
	{
		...
		registry.register(new SpikeBlock(AbstractBlock.Properties.of(Material.METAL, MaterialColor.METAL).strength(2).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE).harvestLevel(0), MSBlockShapes.SPIKES).setRegistryName("spikes"));
		...
		registry.register(new TrajectoryBlock(AbstractBlock.Properties.of(Material.METAL).strength(3).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE)).setRegistryName("trajectory_block"));
		registry.register(new StatStorerBlock(AbstractBlock.Properties.of(Material.METAL).strength(3).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE)).setRegistryName("stat_storer"));
		registry.register(new RemoteObserverBlock(AbstractBlock.Properties.of(Material.METAL).strength(3).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE)).setRegistryName("remote_observer"));
		registry.register(new WirelessRedstoneTransmitterBlock(AbstractBlock.Properties.of(Material.METAL).strength(3).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE)).setRegistryName("wireless_redstone_transmitter"));
		registry.register(new WirelessRedstoneReceiverBlock(AbstractBlock.Properties.of(Material.METAL).strength(3).randomTicks().sound(SoundType.METAL).harvestTool(ToolType.PICKAXE)).setRegistryName("wireless_redstone_receiver"));
		registry.register(new SolidSwitchBlock(AbstractBlock.Properties.of(Material.METAL).strength(3).sound(SoundType.METAL).lightLevel(state -> state.getValue(SolidSwitchBlock.POWERED) ? 15 : 0).harvestTool(ToolType.PICKAXE)).setRegistryName("solid_switch"));
		registry.register(new VariableSolidSwitchBlock(AbstractBlock.Properties.of(Material.METAL).strength(3).sound(SoundType.METAL).lightLevel(state -> state.getValue(VariableSolidSwitchBlock.POWER)).harvestTool(ToolType.PICKAXE)).setRegistryName("variable_solid_switch"));
		registry.register(new TimedSolidSwitchBlock(AbstractBlock.Properties.of(Material.METAL).strength(3).sound(SoundType.METAL).lightLevel(state -> state.getValue(TimedSolidSwitchBlock.POWER)).harvestTool(ToolType.PICKAXE), 20).setRegistryName("one_second_interval_timed_solid_switch"));
		registry.register(new TimedSolidSwitchBlock(AbstractBlock.Properties.of(Material.METAL).strength(3).sound(SoundType.METAL).lightLevel(state -> state.getValue(TimedSolidSwitchBlock.POWER)).harvestTool(ToolType.PICKAXE), 40).setRegistryName("two_second_interval_timed_solid_switch"));
		registry.register(new SummonerBlock(AbstractBlock.Properties.of(Material.METAL).strength(3).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE)).setRegistryName("summoner"));
		registry.register(new AreaEffectBlock(AbstractBlock.Properties.of(Material.METAL).strength(6).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE)).setRegistryName("area_effect_block"));
		registry.register(new PlatformGeneratorBlock(AbstractBlock.Properties.of(Material.METAL).strength(6).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE)).setRegistryName("platform_generator"));
		registry.register(new PlatformBlock(AbstractBlock.Properties.of(Material.BARRIER).strength(0.2F).sound(SoundType.SCAFFOLDING).lightLevel(state -> 6).randomTicks().noOcclusion().isSuffocating(MSBlocks::never).isViewBlocking(MSBlocks::never)).setRegistryName("platform_block"));
		registry.register(new PlatformReceptacleBlock(AbstractBlock.Properties.of(Material.METAL).strength(3).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE)).setRegistryName("platform_receptacle"));
		registry.register(new ItemMagnetBlock(AbstractBlock.Properties.of(Material.METAL).strength(3).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE), new CustomVoxelShape(new double[]{0, 0, 0, 16, 1, 16}, new double[]{1, 1, 1, 15, 15, 15}, new double[]{0, 15, 0, 16, 16, 16})).setRegistryName("item_magnet"));
		registry.register(new RedstoneClockBlock(AbstractBlock.Properties.of(Material.METAL).strength(3).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE)).setRegistryName("redstone_clock"));
		registry.register(new RotatorBlock(AbstractBlock.Properties.of(Material.METAL).strength(3).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE)).setRegistryName("rotator"));
		registry.register(new TogglerBlock(AbstractBlock.Properties.of(Material.METAL).strength(3).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE)).setRegistryName("toggler"));
		registry.register(new RemoteComparatorBlock(AbstractBlock.Properties.of(Material.METAL).strength(3).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE)).setRegistryName("remote_comparator"));
		registry.register(new StructureCoreBlock(AbstractBlock.Properties.of(Material.METAL).strength(6).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE)).setRegistryName("structure_core"));
		...
		registry.register(new LogicGateBlock(AbstractBlock.Properties.of(Material.STONE).strength(1).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE), LogicGateBlock.State.NAND).setRegistryName("nand_gate_block"));
		registry.register(new LogicGateBlock(AbstractBlock.Properties.of(Material.STONE).strength(1).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE), LogicGateBlock.State.NOR).setRegistryName("nor_gate_block"));
		registry.register(new LogicGateBlock(AbstractBlock.Properties.of(Material.STONE).strength(1).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE), LogicGateBlock.State.XNOR).setRegistryName("xnor_gate_block"));
		...
		registry.register(new SendificatorBlock(AbstractBlock.Properties.of(Material.METAL).requiresCorrectToolForDrops().strength(3.0F).harvestTool(ToolType.PICKAXE).harvestLevel(0)).setRegistryName("sendificator"));
