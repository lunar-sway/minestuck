...
public class MSBlocks
{
	...
	public static final RegistryObject<Block> MIRROR = REGISTER.register("mirror", () -> new CustomShapeBlock(Block.Properties.of(Material.WOOD).strength(2.5F), MSBlockShapes.MIRROR));
