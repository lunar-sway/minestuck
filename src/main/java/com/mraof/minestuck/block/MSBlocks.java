...
public class MSBlocks
{
	...
	public static void registerBlocks(final RegistryEvent.Register<Block> event)
	{
		...
		registry.register(new SmallMachineBlock<>(MSBlockShapes.SENDIFICATOR.createRotatedShapes(), MSTileEntityTypes.SENDIFICATOR, AbstractBlock.Properties.of(Material.METAL).requiresCorrectToolForDrops().strength(3.0F).harvestTool(ToolType.PICKAXE).harvestLevel(0)).setRegistryName("sendificator"));
