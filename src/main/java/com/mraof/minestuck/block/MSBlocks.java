...
public class MSBlocks
{
	...
	//Dungeon Special
	public static final Block CALEDFWLCH_PEDESTAL_FULL = getNull(), CALEDFWLCH_PEDESTAL_EMPTY = getNull();
	public static final Block NAKIGATOR_STATUE = getNull();
	...
	public static void registerBlocks(final RegistryEvent.Register<Block> event)
	{
		...
		*/
		...
		registry.register(new DecorBlock(Block.Properties.create(Material.STONE).hardnessAndResistance(1.0F).sound(SoundType.STONE), MSBlockShapes.NAKIGATOR_STATUE).setRegistryName("nakigator_statue"));
