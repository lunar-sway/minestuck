 ...
 */
public class DirectionalCustomModelBlock extends MSDirectionalBlock implements IWaterLoggable
{
	public final ImmutableMap<Direction, VoxelShape> shape;
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;
	
	public DirectionalCustomModelBlock(Properties properties, CustomVoxelShape shape)
	{
		super(properties);
