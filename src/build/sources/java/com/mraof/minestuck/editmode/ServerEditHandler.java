...
//		
//		if(!event.entity.worldObj.isRemote && getData(event.entityPlayer.getCommandSenderName()) != null && event.action == PlayerInteractEvent.Action.RIGHT_CLICK_BLOCK) {
...
//			nbt.setString("contentID", GameRegistry.findUniqueIdentifierFor(Minestuck.cruxiteArtifact).name);
