...
public class StructureGeneratorOverworld implements IWorldGenerator
{
			...
			IChunkProvider chunkProvider) 
	{
		...
		{
			generateStructChunkAligned(frogTemple, world, random, chunkX, chunkZ, 150, BiomePlains.class);
			
		}
	}
	
	private void generateStructChunkAligned(WorldGenerator generator, World world, Random rand, int chunkX, int chunkZ, int chance, Class<?>... biomes)
	{		
