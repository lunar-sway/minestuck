...
public final class PlayerData
{
	...
	public List<StrifeSpecibus> getPortfolio()
	{
		return Collections.unmodifiableList(strifePortfolio);
	}
	
	public void addSpecibus(StrifeSpecibus specibus)
	{
		if(!strifePortfolio.contains(specibus))
		{
			strifePortfolio.add(specibus);
			markDirty();
			sendPortfolio(getPlayer());
		}
	}
	...
	private void sendPortfolio(ServerPlayerEntity player)
	{
		List<StrifeSpecibus> portfolio = getPortfolio();
		
		System.out.println(portfolio);
		
		CompoundNBT nbt = StrifePortfolioHandler.writeToNBT(portfolio);
		...
		*/
		SpecibusPacket packet = SpecibusPacket.sendPortfolioData(nbt);
		MSPacketHandler.sendToPlayer(packet, player);
	}
