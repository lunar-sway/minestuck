...
public class GuiTitleSelector extends GuiScreen
{
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks)
	{
		...
		String message = previous == null ? StatCollector.translateToLocal("gui.selectTitle") : StatCollector.translateToLocalFormatted("gui.selectTitle.used", previous.getTitleName());
		mc.fontRendererObj.drawString(message, (this.width / 2) - mc.fontRendererObj.getStringWidth(message) / 2, yOffset + 12, 0x404040);
		
		message = StatCollector.translateToLocalFormatted("title.format", "", "");
