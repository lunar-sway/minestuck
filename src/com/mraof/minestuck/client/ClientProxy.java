...
//		MinecraftForgeClient.registerItemRenderer(Minestuck.captchaCard, new RenderCard());
		...
		mc.getBlockColors().registerBlockColorHandler(new BlockColorCruxite(), MinestuckBlocks.alchemiter[0], MinestuckBlocks.totemlathe[1], MinestuckBlocks.cruxiteDowel);
	}
