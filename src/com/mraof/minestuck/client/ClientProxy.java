...
//		MinecraftForgeClient.registerItemRenderer(Minestuck.captchaCard, new CardRenderer());
	...
	public static void init()
	{
		...
		//customFont = new MinestuckFontRenderer(mc.gameSettings, new ResourceLocation(Minestuck.MOD_ID, "textures/font/lucida_console_small.png"), mc.renderEngine, true, 4, 8);
