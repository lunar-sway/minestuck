...
public class MinestuckConfig
{
	...
	static void loadConfigFile(File file, Side side)
	{
		...
		Minestuck.entityIdStart = config.get("IDs", "entityIdStart", 200).setMinValue(0).setMaxValue(243).setRequiresMcRestart(true).setLanguageKey("minestuck.config.entityIdStart").getInt();
