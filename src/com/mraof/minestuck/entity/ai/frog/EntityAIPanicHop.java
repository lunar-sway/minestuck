...
public class EntityAIPanicHop extends EntityAIBase
{
    ...
    public EntityAIPanicHop(EntityCreature creature, double speedIn)
    {
    ...
    {
        if (this.creature.getRNG().nextFloat() < 0.8F && shouldHop)
        {
