...
public final class ModEntityTypes
{
	...
	public static void registerEntities(final RegistryEvent.Register<EntityType<?>> event)
	{
		...
		registry.register(EntityType.Builder.create(BlackPawnEntity::new, EntityClassification.MISC).size(0.6F, 1.5F).build(Minestuck.MOD_ID+":dersite_pawn").setRegistryName("dersite_pawn"));
		registry.register(EntityType.Builder.create(WhitePawnEntity::new, EntityClassification.MISC).size(0.6F, 1.5F).build(Minestuck.MOD_ID+":prospitian_pawn").setRegistryName("prospitian_pawn"));
		registry.register(EntityType.Builder.create(BlackBishopEntity::new, EntityClassification.MISC).size(1.9F, 4.1F).build(Minestuck.MOD_ID+":dersite_bishop").setRegistryName("dersite_bishop"));
		registry.register(EntityType.Builder.create(WhiteBishopEntity::new, EntityClassification.MISC).size(1.9F, 4.1F).build(Minestuck.MOD_ID+":prospitian_bishop").setRegistryName("prospitian_bishop"));
		registry.register(EntityType.Builder.create(BlackRookEntity::new, EntityClassification.MISC).size(3.5F, 3.5F).build(Minestuck.MOD_ID+":dersite_rook").setRegistryName("dersite_rook"));
		registry.register(EntityType.Builder.create(WhiteRookEntity::new, EntityClassification.MISC).size(3.5F, 3.5F).build(Minestuck.MOD_ID+":prospitian_rook").setRegistryName("prospitian_rook"));
