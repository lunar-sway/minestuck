	...
	public static final CreativeTabs tabMinestuck = new CreativeTabs("tabMinestuck")
{
  ...
  public static Item irradiatedSteak = new ItemFood(4, 0.4F, true).setPotionEffect(new PotionEffect(MobEffects.WITHER, 100, 1), 0.9F).setRegistryName("irradiated_steak").setUnlocalizedName("irradiatedSteak").setCreativeTab(tabMinestuck);
	//Other
  ...
  public static Item rawUranium = new Item().setRegistryName("raw_uranium").setUnlocalizedName("rawUranium").setCreativeTab(tabMinestuck);
  public static Item energyCore = new Item().setRegistryName("energy_core").setUnlocalizedName("energyCore").setCreativeTab(tabMinestuck);
  ...
  public static Item fakeArms = new Item().setRegistryName("fake_arms").setUnlocalizedName("fakeArms").setCreativeTab(tabMinestuck);
	//Music disks
	...
	public static void registerItems(RegistryEvent.Register<Item> event)
	{
		...
		registerItemBlock(registry, new ItemBlock(rabbitSpawner));
