...
public class MinestuckItems
{
	...
	//axes
	public static Item copseCrusher = new ItemFarmine(400, 6.0D, -3.0D, 20, "copseCrusher", -1, 20).setTool("axe", 2, 7.0F).setRegistryName("copse_crusher");
	...
	public static Item qPHammerAxe = new ItemPogoFarmine(800, 8.0D, -3.0D, 30, "qPHammerAxe", -1, 50,0.6).setTool("axe", 2, 7.0F).setTool("pickaxe", 1, 2.0F).setRegistryName("piston_powered_pogo_axehammer");
	...
	public static Item qFHammerAxe = new ItemPogoFarmine(2048, 11.0D, -3.0D, 0, "qFHammerAxe", -1, 100, 0.7).setTool("axe", 3, 9.0F).setTool("pickaxe", 2, 4.0F).setRegistryName("fission_focused_fault_feller");
	//Dice
	...
	//Material tools
	public static Item emeraldSword = new ItemSword(toolEmerald).setRegistryName("emerald_sword").setUnlocalizedName("swordEmerald").setCreativeTab(TabMinestuck.instance);
	public static Item emeraldAxe = new ItemMinestuckAxe(toolEmerald, 9.0F, -3.0F).setRegistryName("emerald_axe").setUnlocalizedName("hatchetEmerald").setCreativeTab(TabMinestuck.instance);
	public static Item emeraldPickaxe = new ItemMinestuckPickaxe(toolEmerald).setRegistryName("emerald_pickaxe").setUnlocalizedName("pickaxeEmerald").setCreativeTab(TabMinestuck.instance);
	public static Item emeraldShovel = new ItemSpade(toolEmerald).setRegistryName("emerald_shovel").setUnlocalizedName("shovelEmerald").setCreativeTab(TabMinestuck.instance);
	public static Item emeraldHoe = new ItemHoe(toolEmerald).setRegistryName("emerald_hoe").setUnlocalizedName("hoeEmerald").setCreativeTab(TabMinestuck.instance);
	//Armor
	public static Item prismarineHelmet = new ItemArmor(armorPrismarine, 0, EntityEquipmentSlot.HEAD).setRegistryName("prismarine_helmet").setUnlocalizedName("helmetPrismarine").setCreativeTab(TabMinestuck.instance);
	public static Item prismarineChestplate = new ItemArmor(armorPrismarine, 0, EntityEquipmentSlot.CHEST).setRegistryName("prismarine_chestplate").setUnlocalizedName("chestplatePrismarine").setCreativeTab(TabMinestuck.instance);
	public static Item prismarineLeggings = new ItemArmor(armorPrismarine, 0, EntityEquipmentSlot.LEGS).setRegistryName("prismarine_leggings").setUnlocalizedName("leggingsPrismarine").setCreativeTab(TabMinestuck.instance);
	public static Item prismarineBoots = new ItemArmor(armorPrismarine, 0, EntityEquipmentSlot.FEET).setRegistryName("prismarine_boots").setUnlocalizedName("bootsPrismarine").setCreativeTab(TabMinestuck.instance);
	//Food
	...
	public static Item bugOnAStick = new ItemFood(1, 0.1F, false).setRegistryName("bug_on_stick").setUnlocalizedName("bugOnAStick").setCreativeTab(TabMinestuck.instance);
	public static Item chocolateBeetle = new ItemFood(3, 0.4F, false).setRegistryName("chocolate_beetle").setUnlocalizedName("chocolateBeetle").setCreativeTab(TabMinestuck.instance);
	public static Item coneOfFlies = new ItemFood(2, 0.1F, false).setRegistryName("cone_of_flies").setUnlocalizedName("coneOfFlies").setCreativeTab(TabMinestuck.instance);
	public static Item grasshopper = new ItemFood(4, 0.5F, false).setRegistryName("grasshopper").setUnlocalizedName("grasshopper").setCreativeTab(TabMinestuck.instance);
	public static Item jarOfBugs = new ItemFood(3, 0.2F, false).setRegistryName("jar_of_bugs").setUnlocalizedName("jarOfBugs").setCreativeTab(TabMinestuck.instance);
	...
	public static Item rawUranium = new Item().setRegistryName("raw_uranium").setUnlocalizedName("rawUranium").setCreativeTab(TabMinestuck.instance);
	public static Item energyCore = new Item().setRegistryName("energy_core").setUnlocalizedName("energyCore").setCreativeTab(TabMinestuck.instance);
	...
	public static Item chessboard = new Item().setRegistryName("chessboard").setUnlocalizedName("chessboard").setMaxStackSize(1).setCreativeTab(TabMinestuck.instance);
	...
	public static Item threshDvd = new Item().setRegistryName("thresh_dvd").setUnlocalizedName("threshDvd").setMaxStackSize(1).setCreativeTab(TabMinestuck.instance);
	...
	}.setRegistryName("crew_poster").setUnlocalizedName("crewPoster").setMaxStackSize(1).setCreativeTab(TabMinestuck.instance);
	...
	}.setRegistryName("sbahj_poster").setUnlocalizedName("sbahjPoster").setMaxStackSize(1).setCreativeTab(TabMinestuck.instance);
	public static Item carvingTool = new Item().setRegistryName("carving_tool").setUnlocalizedName("carvingTool").setMaxStackSize(1).setCreativeTab(TabMinestuck.instance);
	public static Item crumplyHat = new Item().setRegistryName("crumply_hat").setUnlocalizedName("crumplyHat").setMaxStackSize(1).setCreativeTab(TabMinestuck.instance);
	public static Item frogStatueReplica = new Item().setRegistryName("frog_statue_replica").setUnlocalizedName("frogStatueReplica").setCreativeTab(TabMinestuck.instance);
	public static Item stoneSlab = new Item().setRegistryName("stone_slab").setUnlocalizedName("stoneSlab").setCreativeTab(TabMinestuck.instance);
	public static Item glowystoneDust = new ItemGlowystoneDust().setRegistryName("glowystone_dust").setUnlocalizedName("glowystoneDust").setCreativeTab(TabMinestuck.instance);
	public static Item fakeArms = new Item().setRegistryName("fake_arms").setUnlocalizedName("fakeArms").setCreativeTab(null);
	//Music disks
