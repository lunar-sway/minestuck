...
public class MSItems
{
	...
	//Gauntlets
	public static Item fancyGlove;
	public static Item spikedGlove;
	public static Item cobbleBasher;
	public static Item fluoriteGauntlet;
	public static Item goldenGenesisGauntlet;
	public static Item pogoFist;
	//Bows
	public static Item natureBow;
	public static Item infernoShot;
	...
	public static Item hereticusAurum;
	//clubs
	...
	//Hats
	public static Item diverHelmet;
	...
	public static void registerItems(IForgeRegistry<Item> registry)
	{
		...
		//Gauntlets
		registry.register(fancyGlove = new WeaponItem(ItemTier.WOOD, 0, 0, 0.0F, MSItemTypes.GAUNTLET_TOOL, new Item.Properties().maxDamage(50).group(MSItemGroup.WEAPONS)).setRegistryName("fancy_glove"));
		registry.register(spikedGlove = new WeaponItem(ItemTier.STONE, 2, 0.25F, 0.5F, MSItemTypes.GAUNTLET_TOOL, new Item.Properties().maxDamage(95).group(MSItemGroup.WEAPONS)).setRegistryName("spiked_glove"));
		registry.register(cobbleBasher = new WeaponItem(ItemTier.IRON, 2, -1.8F, 1.2F, MSItemTypes.GAUNTLET_TOOL, new Item.Properties().maxDamage(175).group(MSItemGroup.WEAPONS)).setRegistryName("cobble_basher"));
		registry.register(fluoriteGauntlet = new RandomWeaponItem(ItemTier.DIAMOND, 5, -0.3F, 2.4F, MSItemTypes.GAUNTLET_TOOL, 3, new Item.Properties().maxDamage(980).group(MSItemGroup.WEAPONS)).setRegistryName("fluorite_gauntlet"));
		registry.register(goldenGenesisGauntlet = new WeaponItem(ItemTier.GOLD, 11, -0.25F, 3F, MSItemTypes.GAUNTLET_TOOL, new Item.Properties().maxDamage(1256).group(MSItemGroup.WEAPONS)).setRegistryName("golden_genesis_gauntlet"));
		registry.register(pogoFist = new PogoWeaponItem(MSItemTypes.POGO_TIER, 5, -0.3F, 1.4F, 0.55D, MSItemTypes.GAUNTLET_TOOL, new Item.Properties().maxDamage(700).group(MSItemGroup.WEAPONS)).setRegistryName("pogo_fist"));
		//Bows
		//registry.register(natureBow = new ItemRanged("natureBow", 2.0D, 530, 5000, Items.ARROW, ArrowEntity.class).setRegistryName("nature_bow"));
		//registry.register(infernoShot = new ItemRanged("infernoShot", 3.5D, 480, 7500, Items.ARROW, ArrowEntity.class).setBulletSpeed(1.1F).setRegistryName("inferno_shot"));
		//registry.register(energyBow = new ItemRanged("energyBow", 1.5, 235, 7000, ItemStack.EMPTY, EntityBullet.class).setBulletSpeed(1.2F).setRegistryName("energy_bow"));
		registry.register(natureBow = new Item(new Item.Properties()).setRegistryName("nature_bow"));
		registry.register(infernoShot = new Item(new Item.Properties()).setRegistryName("inferno_shot"));
		registry.register(energyBow = new Item(new Item.Properties()).setRegistryName("energy_bow"));
		...
		registry.register(hereticusAurum = new WeaponItem(ItemTier.GOLD, 6, -2.3F, 5.0F, MSItemTypes.SICKLE_TOOL, new Item.Properties().defaultMaxDamage(952).group(MSItemGroup.WEAPONS)).setRegistryName("hereticus_aurum"));
		...
		//Hats
		registry.register(diverHelmet = new ItemMinestuckArmor(MSItemTypes.materialDiverHelmet, EquipmentSlotType.HEAD, new ModelDiverHelmet(), new Item.Properties().group(MSItemGroup.WEAPONS)).setRegistryName("diver_helmet"));
		...
		registry.register(strifeCard = new ItemStrifeCard(new Item.Properties().maxStackSize(1).group(MSItemGroup.MAIN)).setRegistryName("strife_card"));
