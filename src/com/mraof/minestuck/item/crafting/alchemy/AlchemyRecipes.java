...
public class AlchemyRecipes
{
	...
	public static void registerMinestuckRecipes()
	{
		...
		GristRegistry.addGristConversion(new ItemStack(hereticusAurum), false, new GristSet(new GristType[] {GristType.Amethyst, GristType.Tar, GristType.Gold, GristType.Quartz}, new int[] {8, 64, 155, 2}));
		...
		*/
		...
		//CombinationRegistry.addCombination(new ItemStack(itemFrog, 1, 5), new ItemStack(regiSickle), MODE_OR, true, false, new ItemStack(hereticusAurum));
		...
		//gauntlets
		CombinationRegistry.addCombination(Blocks.IRON_BARS, fancyGlove, MODE_AND, new ItemStack(spikedGlove));
		CombinationRegistry.addCombination(Blocks.COBBLESTONE, fancyGlove, MODE_AND, new ItemStack(cobbleBasher));
		CombinationRegistry.addCombination(Items.SLIME_BALL, fancyGlove, MODE_OR, new ItemStack(pogoFist));
		CombinationRegistry.addCombination(FLUORITE_OCTET, cobbleBasher, MODE_OR, new ItemStack(fluoriteGauntlet));
		...
		//bows
		CombinationRegistry.addCombination(Items.BOW, Blocks.VINE, MODE_AND, new ItemStack(natureBow));
		CombinationRegistry.addCombination(Items.BOW, Items.BLAZE_POWDER, MODE_AND, new ItemStack(infernoShot));
		CombinationRegistry.addCombination(Items.BOW, ENERGY_CORE, MODE_AND, new ItemStack(energyBow));
		...
		CombinationRegistry.addCombination(Blocks.IRON_BARS, fancyGlove, MODE_OR, new ItemStack(CAT_CLAWS_SHEATHED));
