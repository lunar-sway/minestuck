...
public class MinestuckAdvancementProvider implements IDataProvider
{
	...
	protected void buildAdvancements(Consumer<Advancement> advancementSaver)
	{
		...
		Advancement entry = Advancement.Builder.builder().withParent(connect).withDisplay(ColorCollector.setDefaultColor(new ItemStack(MSItems.CRUXITE_APPLE)), new TranslationTextComponent("advancements.minestuck.entry.title"), new TranslationTextComponent("advancements.minestuck.entry.description"), null, FrameType.TASK, true, true, false).withCriterion("use_artifact", EventTrigger.Instance.cruxiteArtifact()).register(advancementSaver, Minestuck.MOD_ID+":minestuck/entry");
