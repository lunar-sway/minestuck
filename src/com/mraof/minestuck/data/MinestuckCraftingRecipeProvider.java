...
public class MinestuckCraftingRecipeProvider extends RecipeProvider
{
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> recipeBuilder)
	{
		...
		ShapelessRecipeBuilder.shapelessRecipe(MinestuckItems.RAW_URANIUM, 9).addIngredient(MinestuckBlocks.URANIUM_BLOCK).addCriterion("has_at_least_9_raw_uranium", hasItem(MinMaxBounds.IntBound.atLeast(9), MinestuckItems.RAW_URANIUM)).addCriterion("has_uranium_block", hasItem(MinestuckBlocks.URANIUM_BLOCK)).build(recipeBuilder);
		...
		ShapelessRecipeBuilder.shapelessRecipe(Blocks.OAK_PLANKS).addIngredient(MinestuckBlocks.TREATED_PLANKS).addIngredient(Items.WATER_BUCKET).setGroup("planks").addCriterion("has_log", hasItem(MinestuckTags.Items.DEAD_LOGS)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "treated_to_oak_planks"));
		...
		ShapelessRecipeBuilder.shapelessRecipe(Blocks.SPRUCE_PLANKS).addIngredient(MinestuckBlocks.WOODEN_CACTUS).setGroup("planks").addCriterion("has_cactus", hasItem(MinestuckBlocks.WOODEN_CACTUS)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "cactus_to_spruce_planks"));
		...
		ShapedRecipeBuilder.shapedRecipe(MinestuckItems.CAPTCHA_CARD).key('p', Items.PAPER).key('c', MinestuckItems.RAW_CRUXITE).patternLine("ppp").patternLine("pip").patternLine("ppp").addCriterion("has_raw_cruxite", hasItem(MinestuckItems.RAW_CRUXITE)).build(recipeBuilder);
		...
		CookingRecipeBuilder.smeltingRecipe(Ingredient.fromTag(MinestuckTags.Items.CRUXITE_ORES), MinestuckItems.RAW_CRUXITE, 0.2F, 200).addCriterion("has_cruxite_ore", hasItem(MinestuckTags.Items.CRUXITE_ORES)).build(recipeBuilder);
		CookingRecipeBuilder.blastingRecipe(Ingredient.fromTag(MinestuckTags.Items.CRUXITE_ORES), MinestuckItems.RAW_CRUXITE, 0.2F, 100).addCriterion("has_cruxite_ore", hasItem(MinestuckTags.Items.CRUXITE_ORES)).build(recipeBuilder);
		CookingRecipeBuilder.smeltingRecipe(Ingredient.fromTag(MinestuckTags.Items.URANIUM_ORES), MinestuckItems.RAW_URANIUM, 0.2F, 200).addCriterion("has_uranium_ore", hasItem(MinestuckTags.Items.URANIUM_ORES)).build(recipeBuilder);
		CookingRecipeBuilder.blastingRecipe(Ingredient.fromTag(MinestuckTags.Items.URANIUM_ORES), MinestuckItems.RAW_URANIUM, 0.2F, 100).addCriterion("has_uranium_ore", hasItem(MinestuckTags.Items.URANIUM_ORES)).build(recipeBuilder);
		CookingRecipeBuilder.smeltingRecipe(Ingredient.fromTag(MinestuckTags.Items.COAL_ORES), Items.COAL, 0.1F, 200).addCriterion("has_coal_ore", hasItem(MinestuckTags.Items.COAL_ORES)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "coal"));
		CookingRecipeBuilder.blastingRecipe(Ingredient.fromTag(MinestuckTags.Items.COAL_ORES), Items.COAL, 0.1F, 100).addCriterion("has_coal_ore", hasItem(MinestuckTags.Items.COAL_ORES)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "coal"));
		CookingRecipeBuilder.smeltingRecipe(Ingredient.fromTag(MinestuckTags.Items.IRON_ORES), Items.IRON_INGOT, 0.7F, 200).addCriterion("has_iron_ore", hasItem(MinestuckTags.Items.IRON_ORES)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "iron_ingot"));
		CookingRecipeBuilder.blastingRecipe(Ingredient.fromTag(MinestuckTags.Items.IRON_ORES), Items.IRON_INGOT, 0.7F, 100).addCriterion("has_iron_ore", hasItem(MinestuckTags.Items.IRON_ORES)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "iron_ingot"));
		CookingRecipeBuilder.smeltingRecipe(Ingredient.fromTag(MinestuckTags.Items.GOLD_ORES), Items.GOLD_INGOT, 1.0F, 200).addCriterion("has_gold_ore", hasItem(MinestuckTags.Items.GOLD_ORES)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "gold_ingot"));
		CookingRecipeBuilder.blastingRecipe(Ingredient.fromTag(MinestuckTags.Items.GOLD_ORES), Items.GOLD_INGOT, 1.0F, 100).addCriterion("has_gold_ore", hasItem(MinestuckTags.Items.GOLD_ORES)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "gold_ingot"));
		CookingRecipeBuilder.smeltingRecipe(Ingredient.fromTag(MinestuckTags.Items.REDSTONE_ORES), Items.REDSTONE, 0.7F, 200).addCriterion("has_redstone_ore", hasItem(MinestuckTags.Items.REDSTONE_ORES)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "redstone"));
		CookingRecipeBuilder.blastingRecipe(Ingredient.fromTag(MinestuckTags.Items.REDSTONE_ORES), Items.REDSTONE, 0.7F, 100).addCriterion("has_redstone_ore", hasItem(MinestuckTags.Items.REDSTONE_ORES)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "redstone"));
		CookingRecipeBuilder.smeltingRecipe(Ingredient.fromTag(MinestuckTags.Items.QUARTZ_ORES), Items.QUARTZ, 0.2F, 200).addCriterion("has_quartz_ore", hasItem(MinestuckTags.Items.QUARTZ_ORES)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "quartz"));
		CookingRecipeBuilder.blastingRecipe(Ingredient.fromTag(MinestuckTags.Items.QUARTZ_ORES), Items.QUARTZ, 0.2F, 100).addCriterion("has_quartz_ore", hasItem(MinestuckTags.Items.QUARTZ_ORES)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "quartz"));
		CookingRecipeBuilder.smeltingRecipe(Ingredient.fromTag(MinestuckTags.Items.LAPIS_ORES), Items.LAPIS_LAZULI, 0.2F, 200).addCriterion("has_lapis_ore", hasItem(MinestuckTags.Items.LAPIS_ORES)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "lapis_lazuli"));
		CookingRecipeBuilder.blastingRecipe(Ingredient.fromTag(MinestuckTags.Items.LAPIS_ORES), Items.LAPIS_LAZULI, 0.2F, 100).addCriterion("has_lapis_ore", hasItem(MinestuckTags.Items.LAPIS_ORES)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "lapis_lazuli"));
		CookingRecipeBuilder.smeltingRecipe(Ingredient.fromTag(MinestuckTags.Items.DIAMOND_ORES), Items.DIAMOND, 1.0F, 200).addCriterion("has_diamond_ore", hasItem(MinestuckTags.Items.DIAMOND_ORES)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "diamond"));
		CookingRecipeBuilder.blastingRecipe(Ingredient.fromTag(MinestuckTags.Items.DIAMOND_ORES), Items.DIAMOND, 1.0F, 100).addCriterion("has_diamond_ore", hasItem(MinestuckTags.Items.DIAMOND_ORES)).build(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "diamond"));
