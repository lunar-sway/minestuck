...
public class MinestuckRecipeProvider extends RecipeProvider
{
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> recipeBuilder)
	{
		...
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.COARSE_STONE), MSBlocks.COARSE_STONE_STAIRS).func_218643_a("has_coarse_stone", hasItem(MSBlocks.COARSE_STONE)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "coarse_stone_stairs_from_coarse_stone_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.COARSE_STONE), MSBlocks.CHISELED_COARSE_STONE).func_218643_a("has_coarse_stone", hasItem(MSBlocks.COARSE_STONE)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chiseled_coarse_stone_from_coarse_stone_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.SMOOTH_SHADE_STONE), MSBlocks.SHADE_BRICKS).func_218643_a("has_smooth_shade_stone", hasItem(MSBlocks.SMOOTH_SHADE_STONE)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "shade_bricks_from_smooth_shade_stone_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.SMOOTH_SHADE_STONE), MSBlocks.SHADE_BRICK_STAIRS).func_218643_a("has_smooth_shade_stone", hasItem(MSBlocks.SMOOTH_SHADE_STONE)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "shade_brick_stairs_from_smooth_shade_stone_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.SHADE_BRICKS), MSBlocks.SHADE_BRICK_STAIRS).func_218643_a("has_shade_bricks", hasItem(MSBlocks.SHADE_BRICKS)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "shade_brick_stairs_from_shade_bricks_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.FROST_TILE), MSBlocks.FROST_BRICKS).func_218643_a("has_frost_tile", hasItem(MSBlocks.FROST_TILE)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "frost_bricks_from_frost_tile_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.FROST_TILE), MSBlocks.FROST_BRICK_STAIRS).func_218643_a("has_frost_tile", hasItem(MSBlocks.FROST_TILE)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "frost_brick_stairs_from_frost_tile_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.FROST_TILE), MSBlocks.CHISELED_FROST_BRICKS).func_218643_a("has_frost_tile", hasItem(MSBlocks.FROST_TILE)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chiseled_frost_bricks_from_frost_tile_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.FROST_BRICKS), MSBlocks.FROST_BRICK_STAIRS).func_218643_a("has_frost_bricks", hasItem(MSBlocks.FROST_BRICKS)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "frost_brick_stairs_from_frost_bricks_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.FROST_BRICKS), MSBlocks.CHISELED_FROST_BRICKS).func_218643_a("has_frost_bricks", hasItem(MSBlocks.FROST_BRICKS)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chiseled_frost_bricks_from_frost_bricks_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.CAST_IRON), MSBlocks.CAST_IRON_STAIRS).func_218643_a("has_cast_iron", hasItem(MSBlocks.CAST_IRON)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "cast_iron_stairs_from_cast_iron_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.CAST_IRON), MSBlocks.CHISELED_CAST_IRON).func_218643_a("has_cast_iron", hasItem(MSBlocks.CAST_IRON)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chiseled_cast_iron_from_cast_iron_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.MYCELIUM_BRICKS), MSBlocks.MYCELIUM_BRICK_STAIRS).func_218643_a("has_mycelium_bricks", hasItem(MSBlocks.MYCELIUM_BRICKS)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "mycelium_brick_stairs_from_mycelium_bricks_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.CHALK), MSBlocks.CHALK_STAIRS).func_218643_a("has_chalk", hasItem(MSBlocks.CHALK)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chalk_stairs_from_chalk_stonecutting"));
		SingleItemRecipeBuilder.func_218644_a(Ingredient.fromItems(MSBlocks.CHALK), MSBlocks.CHALK_SLAB, 2).func_218643_a("has_chalk", hasItem(MSBlocks.CHALK)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chalk_slab_from_chalk_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.CHALK), MSBlocks.POLISHED_CHALK).func_218643_a("has_chalk", hasItem(MSBlocks.CHALK)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "polished_chalk_from_chalk_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.CHALK), MSBlocks.CHALK_BRICKS).func_218643_a("has_chalk", hasItem(MSBlocks.CHALK)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chalk_bricks_from_chalk_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.CHALK), MSBlocks.CHALK_BRICK_STAIRS).func_218643_a("has_chalk", hasItem(MSBlocks.CHALK)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chalk_brick_stairs_from_chalk_stonecutting"));
		SingleItemRecipeBuilder.func_218644_a(Ingredient.fromItems(MSBlocks.CHALK), MSBlocks.CHALK_BRICK_SLAB, 2).func_218643_a("has_chalk", hasItem(MSBlocks.CHALK)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chalk_brick_slab_from_chalk_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.POLISHED_CHALK), MSBlocks.CHALK_BRICKS).func_218643_a("has_polished_chalk", hasItem(MSBlocks.POLISHED_CHALK)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chalk_bricks_from_polished_chalk_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.POLISHED_CHALK), MSBlocks.CHALK_BRICK_STAIRS).func_218643_a("has_polished_chalk", hasItem(MSBlocks.POLISHED_CHALK)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chalk_brick_stairs_from_polished_chalk_stonecutting"));
		SingleItemRecipeBuilder.func_218644_a(Ingredient.fromItems(MSBlocks.POLISHED_CHALK), MSBlocks.CHALK_BRICK_SLAB, 2).func_218643_a("has_polished_chalk", hasItem(MSBlocks.POLISHED_CHALK)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chalk_brick_slab_from_polished_chalk_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.CHALK_BRICKS), MSBlocks.CHALK_BRICK_STAIRS).func_218643_a("has_chalk_bricks", hasItem(MSBlocks.CHALK_BRICKS)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chalk_brick_stairs_from_chalk_bricks_stonecutting"));
		SingleItemRecipeBuilder.func_218644_a(Ingredient.fromItems(MSBlocks.CHALK_BRICKS), MSBlocks.CHALK_BRICK_SLAB, 2).func_218643_a("has_chalk_bricks", hasItem(MSBlocks.CHALK_BRICKS)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "chalk_brick_slab_from_chalk_bricks_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.PINK_STONE), MSBlocks.POLISHED_PINK_STONE).func_218643_a("has_pink_stone", hasItem(MSBlocks.PINK_STONE)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "polished_pink_stone_from_pink_stone_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.PINK_STONE), MSBlocks.PINK_STONE_BRICKS).func_218643_a("has_pink_stone", hasItem(MSBlocks.PINK_STONE)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "pink_stone_bricks_from_pink_stone_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.PINK_STONE), MSBlocks.PINK_STONE_BRICK_STAIRS).func_218643_a("has_pink_stone", hasItem(MSBlocks.PINK_STONE)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "pink_stone_brick_stairs_from_pink_stone_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.PINK_STONE), MSBlocks.PINK_STONE_BRICK_SLAB).func_218643_a("has_pink_stone", hasItem(MSBlocks.PINK_STONE)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "pink_stone_brick_slab_from_pink_stone_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.POLISHED_PINK_STONE), MSBlocks.PINK_STONE_BRICKS).func_218643_a("has_polished_pink_stone", hasItem(MSBlocks.POLISHED_PINK_STONE)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "pink_stone_bricks_from_polished_pink_stone_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.POLISHED_PINK_STONE), MSBlocks.PINK_STONE_BRICK_STAIRS).func_218643_a("has_polished_pink_stone", hasItem(MSBlocks.POLISHED_PINK_STONE)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "pink_stone_brick_stairs_from_polished_pink_stone_stonecutting"));
		SingleItemRecipeBuilder.func_218644_a(Ingredient.fromItems(MSBlocks.POLISHED_PINK_STONE), MSBlocks.PINK_STONE_BRICK_SLAB, 2).func_218643_a("has_polished_pink_stone", hasItem(MSBlocks.POLISHED_PINK_STONE)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "pink_stone_brick_slab_from_polished_pink_stone_stonecutting"));
		SingleItemRecipeBuilder.func_218648_a(Ingredient.fromItems(MSBlocks.PINK_STONE_BRICKS), MSBlocks.PINK_STONE_BRICK_STAIRS).func_218643_a("has_pink_stone_bricks", hasItem(MSBlocks.PINK_STONE_BRICKS)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "pink_stone_brick_stairs_from_pink_stone_bricks_stonecutting"));
		SingleItemRecipeBuilder.func_218644_a(Ingredient.fromItems(MSBlocks.PINK_STONE_BRICKS), MSBlocks.PINK_STONE_BRICK_SLAB, 2).func_218643_a("has_pink_stone_bricks", hasItem(MSBlocks.PINK_STONE_BRICKS)).func_218647_a(recipeBuilder, new ResourceLocation(Minestuck.MOD_ID, "pink_stone_brick_slab_from_pink_stone_bricks_stonecutting"));
	}
