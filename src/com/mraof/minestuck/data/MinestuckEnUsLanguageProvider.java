...
public class MinestuckEnUsLanguageProvider extends MinestuckLanguageProvider
{
	...
	protected void addTranslations()
	{
		...
		add(MSItems.hereticusAurum, "Hereticus Aurum");
		addTooltip(MSItems.hereticusAurum, "Did the Dersites get their Latin correct? I dunno, probably not. Go ask a Roman.");
		add(MSItems.fancyGlove, "Fancy Glove");
		addTooltip(MSItems.fancyGlove, "A nice looking glove, it doesn't do much damage, but it sure looks fancy!");
		add(MSItems.spikedGlove, "Spiked Gloves");
		addTooltip(MSItems.spikedGlove, "This glove will sure leave your enemies with some scars, and probably anyone who tries to give you a fist bump.");
		add(MSItems.fluoriteGauntlet, "Fluorite Gauntlet");
		add(MSItems.cobbleBasher, "Cobble Basher");
		addTooltip(MSItems.cobbleBasher, "Punch your enemies in the face with the strength of ONE block of cobblestone!");
		add(MSItems.pogoFist, "Pogo Fist");
		addTooltip(MSItems.pogoFist, ".");
		add(MSItems.goldenGenesisGauntlet, "Golden Genesis Gauntlet");
		addTooltip(MSItems.goldenGenesisGauntlet, "Feel the power of frogs (and the cosmos) within your palm!");
		add(MSItems.natureBow, "Bow of Nature");
		add(MSItems.infernoShot, "Inferno Shot");
		add(MSItems.energyBow, "Energy Bow");
		addTooltip(MSItems.energyBow, "This bow has enough power to create energy arrows, or just power any appliance.");
		...
		add(MSItems.diverHelmet, "Diving Helmet");
		...
		add(MSItems.strifeCard, "Strife Specibus");
		...
		add("specibus.corrupted", "The specibus' data is corrupted and can't be allocated.");
		add("specibus.full", "Your strife portfolio is full!");
		add("specibus.success", "The %s specibus has been added to your strife portfolio.");
		add("specibus.success.blank", "A blank strife card has been added to your strife portfolio.");
		add("specibus.card.label", "kind abstrata");
		
		add(GristCacheScreen.TITLE, "Grist Cache");
		add(StrifeSpecibusScreen.TITLE, "Strife Portfolio");
