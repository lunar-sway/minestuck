...
public abstract class WaterColorsFluid extends FlowingFluid
{
	...
	{
		return ModFluids.FLOWING_WATER_COLORS;
	}
	
	@Override
	public Fluid getStillFluid()
	{
		return ModFluids.WATER_COLORS;
	}
	...
	{
		return MinestuckItems.WATER_COLORS_BUCKET;
	}
	...
	{
		return MinestuckBlocks.WATER_COLORS.getDefaultState().with(FlowingFluidBlock.LEVEL, getLevelFromState(state));
	}
	
	@Override
	public boolean isEquivalentTo(Fluid otherFluid)
	{
		return otherFluid == ModFluids.FLOWING_WATER_COLORS || otherFluid == ModFluids.WATER_COLORS;
	}
	
	@Override
	protected FluidAttributes createAttributes(Fluid fluid)
	{
		return FluidAttributes.builder("water_colors", STILL_TEXTURE, FLOWING_TEXTURE).build();
	}
