...
public abstract class BrainJuiceFluid extends FlowingFluid
{
	...
	private static final ResourceLocation STILL_TEXTURE = new ResourceLocation(Minestuck.MOD_ID, "block/brain_juice_still");
	private static final ResourceLocation FLOWING_TEXTURE = new ResourceLocation(Minestuck.MOD_ID, "block/brain_juice_flowing");
	...
	{
		return FluidAttributes.builder("brain_juice", STILL_TEXTURE, FLOWING_TEXTURE).build();
	}
	
	public static class Flowing extends BrainJuiceFluid
	{
		public Flowing()
		{
	...
	public static class Source extends BrainJuiceFluid
	{
		@Override
		public boolean isSource(IFluidState state)
		{
