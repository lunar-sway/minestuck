...
public class AlchemyRecipeHandler {
	...
	public static void registerVanillaRecipes() {
		...
		for (int meta = 0; meta < BlockSapling.field_149882_a.length; meta++) {
			...
			CombinationRegistry.addCombination("logWood", new ItemStack(Blocks.sapling, 1, meta), true, CombinationRegistry.MODE_AND, log);
			CombinationRegistry.addCombination("treeSapling", log, true, CombinationRegistry.MODE_OR, new ItemStack(Blocks.sapling, 1, meta));
		}
		...
		CombinationRegistry.addCombination(new ItemStack(Blocks.dirt),new ItemStack(Blocks.tallgrass), true, false, CombinationRegistry.MODE_OR, new ItemStack(Blocks.grass));
		...
		CombinationRegistry.addCombination(new ItemStack(Blocks.gravel),new ItemStack(Blocks.stone),CombinationRegistry.MODE_OR, new ItemStack(Blocks.cobblestone));
		...
		CombinationRegistry.addCombination(new ItemStack(Blocks.netherrack),new ItemStack(Blocks.brick_block),CombinationRegistry.MODE_AND, new ItemStack(Blocks.nether_brick));
		CombinationRegistry.addCombination(new ItemStack(Blocks.netherrack),new ItemStack(Items.brick),CombinationRegistry.MODE_AND, new ItemStack(Blocks.nether_brick));
		CombinationRegistry.addCombination(new ItemStack(Blocks.netherrack),new ItemStack(Items.brick),CombinationRegistry.MODE_OR, new ItemStack(Items.netherbrick));
		...
		CombinationRegistry.addCombination(new ItemStack(Blocks.stonebrick),new ItemStack(Items.wheat_seeds),CombinationRegistry.MODE_OR, new ItemStack(Blocks.stonebrick, 1, 1));
		CombinationRegistry.addCombination(new ItemStack(Blocks.stonebrick, 1, 0), new ItemStack(Blocks.cobblestone), CombinationRegistry.MODE_AND, new ItemStack(Blocks.stonebrick, 1, 2));
